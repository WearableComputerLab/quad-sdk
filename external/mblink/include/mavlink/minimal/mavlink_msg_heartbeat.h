...
MAVPACKED(typedef struct __mavlink_heartbeat_t {
  uint32_t custom_mode;  /*<  A bitfield for use for autopilot-specific flags*/
  uint8_t type;          /*<  Type of the system (quadrotor, helicopter, etc.).
  ...
  {                                                                      \
    0, "HEARTBEAT", 6, {                                                 \
      {"type", NULL, MAVLINK_TYPE_UINT8_T,                               \
       0,      4,    offsetof(mavlink_heartbeat_t, type)},               \
          {"autopilot", NULL, MAVLINK_TYPE_UINT8_T,                      \
           0,           5,    offsetof(mavlink_heartbeat_t, autopilot)}, \
          {"base_mode", NULL, MAVLINK_TYPE_UINT8_T,                      \
           0,           6,    offsetof(mavlink_heartbeat_t, base_mode)}, \
          {"custom_mode",                                                \
           NULL,                                                         \
           MAVLINK_TYPE_UINT32_T,                                        \
           0,                                                            \
           0,                                                            \
           offsetof(mavlink_heartbeat_t, custom_mode)},                  \
          {"system_status",                                              \
           NULL,                                                         \
           MAVLINK_TYPE_UINT8_T,                                         \
           0,                                                            \
           7,                                                            \
           offsetof(mavlink_heartbeat_t, system_status)},                \
          {"mavlink_version",                                            \
           NULL,                                                         \
           MAVLINK_TYPE_UINT8_T,                                         \
           0,                                                            \
           8,                                                            \
           offsetof(mavlink_heartbeat_t, mavlink_version)},              \
    }                                                                    \
  }
#else
#define MAVLINK_MESSAGE_INFO_HEARTBEAT                                   \
 ...
 *
 * @param type  Type of the system (quadrotor, helicopter, etc.). Components use
 * the same type as their associated system.
...
static inline uint16_t mavlink_msg_heartbeat_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_HEARTBEAT_MIN_LEN,
...
static inline uint16_t mavlink_msg_heartbeat_pack_chan(
    ...
    mavlink_message_t* msg, uint8_t type, uint8_t autopilot, uint8_t base_mode,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_HEARTBEAT_MIN_LEN,
      MAVLINK_MSG_ID_HEARTBEAT_LEN, MAVLINK_MSG_ID_HEARTBEAT_CRC);
}
...
static inline uint16_t mavlink_msg_heartbeat_encode(
  ...
  return mavlink_msg_heartbeat_pack(
      system_id, component_id, msg, heartbeat->type, heartbeat->autopilot,
...
static inline uint16_t mavlink_msg_heartbeat_encode_chan(
  ...
  return mavlink_msg_heartbeat_pack_chan(
      system_id, component_id, chan, msg, heartbeat->type, heartbeat->autopilot,
      heartbeat->base_mode, heartbeat->custom_mode, heartbeat->system_status);
}
...
static inline void mavlink_msg_heartbeat_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HEARTBEAT, buf, MAVLINK_MSG_ID_HEARTBEAT_MIN_LEN,
      MAVLINK_MSG_ID_HEARTBEAT_LEN, MAVLINK_MSG_ID_HEARTBEAT_CRC);
#else
  mavlink_heartbeat_t packet;
  packet.custom_mode = custom_mode;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HEARTBEAT, (const char*)&packet,
...
static inline void mavlink_msg_heartbeat_send_struct(
    mavlink_channel_t chan, const mavlink_heartbeat_t* heartbeat) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HEARTBEAT, (const char*)heartbeat,
      MAVLINK_MSG_ID_HEARTBEAT_MIN_LEN, MAVLINK_MSG_ID_HEARTBEAT_LEN,
      MAVLINK_MSG_ID_HEARTBEAT_CRC);
#endif
}
 ...
 *
 * @return  Type of the system (quadrotor, helicopter, etc.). Components use the
 ...
 *
 * @return  MAVLink version, not writable by user, gets added by protocol
