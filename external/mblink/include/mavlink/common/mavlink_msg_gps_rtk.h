...
MAVPACKED(typedef struct __mavlink_gps_rtk_t {
  ...
  {                                                                  \
    127, "GPS_RTK", 13, {                                            \
      {"time_last_baseline_ms",                                      \
       ...
       0,                                                            \
       0,                                                            \
       offsetof(mavlink_gps_rtk_t, time_last_baseline_ms)},          \
          {"rtk_receiver_id",                                        \
           NULL,                                                     \
           MAVLINK_TYPE_UINT8_T,                                     \
           0,                                                        \
           30,                                                       \
           offsetof(mavlink_gps_rtk_t, rtk_receiver_id)},            \
          {"wn", NULL, MAVLINK_TYPE_UINT16_T,                        \
           0,    28,   offsetof(mavlink_gps_rtk_t, wn)},             \
          {"tow", NULL, MAVLINK_TYPE_UINT32_T,                       \
           0,     4,    offsetof(mavlink_gps_rtk_t, tow)},           \
          {"rtk_health",                                             \
           NULL,                                                     \
           MAVLINK_TYPE_UINT8_T,                                     \
           0,                                                        \
           31,                                                       \
           offsetof(mavlink_gps_rtk_t, rtk_health)},                 \
          {"rtk_rate", NULL, MAVLINK_TYPE_UINT8_T,                   \
           0,          32,   offsetof(mavlink_gps_rtk_t, rtk_rate)}, \
          {"nsats", NULL, MAVLINK_TYPE_UINT8_T,                      \
           0,       33,   offsetof(mavlink_gps_rtk_t, nsats)},       \
          {"baseline_coords_type",                                   \
           NULL,                                                     \
           MAVLINK_TYPE_UINT8_T,                                     \
           0,                                                        \
           34,                                                       \
           offsetof(mavlink_gps_rtk_t, baseline_coords_type)},       \
          {"baseline_a_mm",                                          \
           NULL,                                                     \
           MAVLINK_TYPE_INT32_T,                                     \
           0,                                                        \
           8,                                                        \
           offsetof(mavlink_gps_rtk_t, baseline_a_mm)},              \
          {"baseline_b_mm",                                          \
           NULL,                                                     \
           MAVLINK_TYPE_INT32_T,                                     \
           0,                                                        \
           12,                                                       \
           offsetof(mavlink_gps_rtk_t, baseline_b_mm)},              \
          {"baseline_c_mm",                                          \
           NULL,                                                     \
           MAVLINK_TYPE_INT32_T,                                     \
           0,                                                        \
           16,                                                       \
           offsetof(mavlink_gps_rtk_t, baseline_c_mm)},              \
          {"accuracy", NULL, MAVLINK_TYPE_UINT32_T,                  \
           0,          20,   offsetof(mavlink_gps_rtk_t, accuracy)}, \
          {"iar_num_hypotheses",                                     \
           NULL,                                                     \
           MAVLINK_TYPE_INT32_T,                                     \
           0,                                                        \
           24,                                                       \
           offsetof(mavlink_gps_rtk_t, iar_num_hypotheses)},         \
    }                                                                \
  }
#else
#define MAVLINK_MESSAGE_INFO_GPS_RTK                                 \
...
static inline uint16_t mavlink_msg_gps_rtk_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_GPS_RTK_MIN_LEN,
...
static inline uint16_t mavlink_msg_gps_rtk_encode(
  ...
  return mavlink_msg_gps_rtk_pack(
      system_id, component_id, msg, gps_rtk->time_last_baseline_ms,
      gps_rtk->rtk_receiver_id, gps_rtk->wn, gps_rtk->tow, gps_rtk->rtk_health,
      gps_rtk->rtk_rate, gps_rtk->nsats, gps_rtk->baseline_coords_type,
      gps_rtk->baseline_a_mm, gps_rtk->baseline_b_mm, gps_rtk->baseline_c_mm,
...
static inline uint16_t mavlink_msg_gps_rtk_encode_chan(
  ...
  return mavlink_msg_gps_rtk_pack_chan(
      system_id, component_id, chan, msg, gps_rtk->time_last_baseline_ms,
      gps_rtk->rtk_receiver_id, gps_rtk->wn, gps_rtk->tow, gps_rtk->rtk_health,
      gps_rtk->rtk_rate, gps_rtk->nsats, gps_rtk->baseline_coords_type,
      gps_rtk->baseline_a_mm, gps_rtk->baseline_b_mm, gps_rtk->baseline_c_mm,
      gps_rtk->accuracy, gps_rtk->iar_num_hypotheses);
...
static inline void mavlink_msg_gps_rtk_send(
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_RTK, buf, MAVLINK_MSG_ID_GPS_RTK_MIN_LEN,
      MAVLINK_MSG_ID_GPS_RTK_LEN, MAVLINK_MSG_ID_GPS_RTK_CRC);
#else
  mavlink_gps_rtk_t packet;
  packet.time_last_baseline_ms = time_last_baseline_ms;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_RTK, (const char*)&packet,
 ...
 */
static inline void mavlink_msg_gps_rtk_send_struct(
    mavlink_channel_t chan, const mavlink_gps_rtk_t* gps_rtk) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_gps_rtk_send(
      chan, gps_rtk->time_last_baseline_ms, gps_rtk->rtk_receiver_id,
      gps_rtk->wn, gps_rtk->tow, gps_rtk->rtk_health, gps_rtk->rtk_rate,
      gps_rtk->nsats, gps_rtk->baseline_coords_type, gps_rtk->baseline_a_mm,
      gps_rtk->baseline_b_mm, gps_rtk->baseline_c_mm, gps_rtk->accuracy,
      gps_rtk->iar_num_hypotheses);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_RTK, (const char*)gps_rtk,
      MAVLINK_MSG_ID_GPS_RTK_MIN_LEN, MAVLINK_MSG_ID_GPS_RTK_LEN,
      MAVLINK_MSG_ID_GPS_RTK_CRC);
#endif
}
 ...
 */
static inline uint32_t mavlink_msg_gps_rtk_get_time_last_baseline_ms(
 ...
 */
static inline uint8_t mavlink_msg_gps_rtk_get_rtk_receiver_id(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_gps_rtk_get_wn(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_gps_rtk_get_tow(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_gps_rtk_get_rtk_health(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_gps_rtk_get_rtk_rate(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_gps_rtk_get_nsats(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_gps_rtk_get_baseline_coords_type(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_gps_rtk_get_baseline_b_mm(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_gps_rtk_get_baseline_c_mm(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_gps_rtk_get_accuracy(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_gps_rtk_get_iar_num_hypotheses(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_gps_rtk_decode(const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_GPS_RTK_LEN
                    ? msg->len
