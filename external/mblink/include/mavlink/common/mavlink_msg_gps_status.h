...
MAVPACKED(typedef struct __mavlink_gps_status_t {
  uint8_t satellites_visible; /*<  Number of satellites visible*/
  uint8_t satellite_prn[20];  /*<  Global satellite ID*/
  uint8_t
      satellite_used[20]; /*<  0: Satellite not used, 1: used for localization*/
  uint8_t
      satellite_elevation[20]; /*< [deg] Elevation (0: right on top of receiver,
                                  90: on the horizon) of satellite*/
  uint8_t satellite_azimuth[20]; /*< [deg] Direction of satellite, 0: 0 deg,
                                    255: 360 deg.*/
  ...
  {                                                              \
    25, "GPS_STATUS", 6, {                                       \
      {"satellites_visible",                                     \
       ...
       0,                                                        \
       0,                                                        \
       offsetof(mavlink_gps_status_t, satellites_visible)},      \
          {"satellite_prn",                                      \
           NULL,                                                 \
           MAVLINK_TYPE_UINT8_T,                                 \
           20,                                                   \
           1,                                                    \
           offsetof(mavlink_gps_status_t, satellite_prn)},       \
          {"satellite_used",                                     \
           NULL,                                                 \
           MAVLINK_TYPE_UINT8_T,                                 \
           20,                                                   \
           21,                                                   \
           offsetof(mavlink_gps_status_t, satellite_used)},      \
          {"satellite_elevation",                                \
           NULL,                                                 \
           MAVLINK_TYPE_UINT8_T,                                 \
           20,                                                   \
           41,                                                   \
           offsetof(mavlink_gps_status_t, satellite_elevation)}, \
          {"satellite_azimuth",                                  \
           NULL,                                                 \
           MAVLINK_TYPE_UINT8_T,                                 \
           20,                                                   \
           61,                                                   \
           offsetof(mavlink_gps_status_t, satellite_azimuth)},   \
          {"satellite_snr",                                      \
           NULL,                                                 \
           MAVLINK_TYPE_UINT8_T,                                 \
           20,                                                   \
           81,                                                   \
           offsetof(mavlink_gps_status_t, satellite_snr)},       \
    }                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_GPS_STATUS                          \
...
static inline uint16_t mavlink_msg_gps_status_pack(
  ...
  mav_array_memcpy(packet.satellite_elevation, satellite_elevation,
                   sizeof(uint8_t) * 20);
  mav_array_memcpy(packet.satellite_azimuth, satellite_azimuth,
                   sizeof(uint8_t) * 20);
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_GPS_STATUS_MIN_LEN,
...
static inline uint16_t mavlink_msg_gps_status_pack_chan(
    ...
    mavlink_message_t *msg, uint8_t satellites_visible,
    const uint8_t *satellite_prn, const uint8_t *satellite_used,
    const uint8_t *satellite_elevation, const uint8_t *satellite_azimuth,
...
static inline uint16_t mavlink_msg_gps_status_encode(
  ...
  return mavlink_msg_gps_status_pack(
      system_id, component_id, msg, gps_status->satellites_visible,
      gps_status->satellite_prn, gps_status->satellite_used,
      gps_status->satellite_elevation, gps_status->satellite_azimuth,
...
static inline uint16_t mavlink_msg_gps_status_encode_chan(
  ...
  return mavlink_msg_gps_status_pack_chan(
      system_id, component_id, chan, msg, gps_status->satellites_visible,
      gps_status->satellite_prn, gps_status->satellite_used,
      gps_status->satellite_elevation, gps_status->satellite_azimuth,
      gps_status->satellite_snr);
}
...
static inline void mavlink_msg_gps_status_send(
    mavlink_channel_t chan, uint8_t satellites_visible,
    const uint8_t *satellite_prn, const uint8_t *satellite_used,
    const uint8_t *satellite_elevation, const uint8_t *satellite_azimuth,
    const uint8_t *satellite_snr) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_STATUS, buf, MAVLINK_MSG_ID_GPS_STATUS_MIN_LEN,
      MAVLINK_MSG_ID_GPS_STATUS_LEN, MAVLINK_MSG_ID_GPS_STATUS_CRC);
#else
  mavlink_gps_status_t packet;
  packet.satellites_visible = satellites_visible;
  ...
  mav_array_memcpy(packet.satellite_snr, satellite_snr, sizeof(uint8_t) * 20);
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_STATUS, (const char *)&packet,
      MAVLINK_MSG_ID_GPS_STATUS_MIN_LEN, MAVLINK_MSG_ID_GPS_STATUS_LEN,
 ...
 */
static inline void mavlink_msg_gps_status_send_struct(
    mavlink_channel_t chan, const mavlink_gps_status_t *gps_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_gps_status_send(
      chan, gps_status->satellites_visible, gps_status->satellite_prn,
      gps_status->satellite_used, gps_status->satellite_elevation,
      gps_status->satellite_azimuth, gps_status->satellite_snr);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_STATUS, (const char *)gps_status,
      MAVLINK_MSG_ID_GPS_STATUS_MIN_LEN, MAVLINK_MSG_ID_GPS_STATUS_LEN,
      MAVLINK_MSG_ID_GPS_STATUS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_gps_status_send_buf(
  ...
  packet->satellites_visible = satellites_visible;
  mav_array_memcpy(packet->satellite_prn, satellite_prn, sizeof(uint8_t) * 20);
  mav_array_memcpy(packet->satellite_used, satellite_used,
                   sizeof(uint8_t) * 20);
  mav_array_memcpy(packet->satellite_elevation, satellite_elevation,
                   sizeof(uint8_t) * 20);
  mav_array_memcpy(packet->satellite_azimuth, satellite_azimuth,
 ...
 *
 * @return [deg] Elevation (0: right on top of receiver, 90: on the horizon) of
 * satellite
 */
 ...
 */
static inline void mavlink_msg_gps_status_decode(
    const mavlink_message_t *msg, mavlink_gps_status_t *gps_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  mavlink_msg_gps_status_get_satellite_elevation(
      msg, gps_status->satellite_elevation);
  mavlink_msg_gps_status_get_satellite_azimuth(msg,
                                               gps_status->satellite_azimuth);
  mavlink_msg_gps_status_get_satellite_snr(msg, gps_status->satellite_snr);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_GPS_STATUS_LEN
                    ? msg->len
