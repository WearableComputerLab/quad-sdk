...
MAVPACKED(typedef struct __mavlink_rc_channels_t {
  ...
  {                                                                        \
    65, "RC_CHANNELS", 21, {                                               \
      {"time_boot_ms",                                                     \
       ...
       0,                                                                  \
       0,                                                                  \
       offsetof(mavlink_rc_channels_t, time_boot_ms)},                     \
          {"chancount", NULL, MAVLINK_TYPE_UINT8_T,                        \
           0,           40,   offsetof(mavlink_rc_channels_t, chancount)}, \
          {"chan1_raw", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,           4,    offsetof(mavlink_rc_channels_t, chan1_raw)}, \
          {"chan2_raw", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,           6,    offsetof(mavlink_rc_channels_t, chan2_raw)}, \
          {"chan3_raw", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,           8,    offsetof(mavlink_rc_channels_t, chan3_raw)}, \
          {"chan4_raw", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,           10,   offsetof(mavlink_rc_channels_t, chan4_raw)}, \
          {"chan5_raw", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,           12,   offsetof(mavlink_rc_channels_t, chan5_raw)}, \
          {"chan6_raw", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,           14,   offsetof(mavlink_rc_channels_t, chan6_raw)}, \
          {"chan7_raw", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,           16,   offsetof(mavlink_rc_channels_t, chan7_raw)}, \
          {"chan8_raw", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,           18,   offsetof(mavlink_rc_channels_t, chan8_raw)}, \
          {"chan9_raw", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,           20,   offsetof(mavlink_rc_channels_t, chan9_raw)}, \
          {"chan10_raw",                                                   \
           NULL,                                                           \
           MAVLINK_TYPE_UINT16_T,                                          \
           0,                                                              \
           22,                                                             \
           offsetof(mavlink_rc_channels_t, chan10_raw)},                   \
          {"chan11_raw",                                                   \
           NULL,                                                           \
           MAVLINK_TYPE_UINT16_T,                                          \
           0,                                                              \
           24,                                                             \
           offsetof(mavlink_rc_channels_t, chan11_raw)},                   \
          {"chan12_raw",                                                   \
           NULL,                                                           \
           MAVLINK_TYPE_UINT16_T,                                          \
           0,                                                              \
           26,                                                             \
           offsetof(mavlink_rc_channels_t, chan12_raw)},                   \
          {"chan13_raw",                                                   \
           NULL,                                                           \
           MAVLINK_TYPE_UINT16_T,                                          \
           0,                                                              \
           28,                                                             \
           offsetof(mavlink_rc_channels_t, chan13_raw)},                   \
          {"chan14_raw",                                                   \
           NULL,                                                           \
           MAVLINK_TYPE_UINT16_T,                                          \
           0,                                                              \
           30,                                                             \
           offsetof(mavlink_rc_channels_t, chan14_raw)},                   \
          {"chan15_raw",                                                   \
           NULL,                                                           \
           MAVLINK_TYPE_UINT16_T,                                          \
           0,                                                              \
           32,                                                             \
           offsetof(mavlink_rc_channels_t, chan15_raw)},                   \
          {"chan16_raw",                                                   \
           NULL,                                                           \
           MAVLINK_TYPE_UINT16_T,                                          \
           0,                                                              \
           34,                                                             \
           offsetof(mavlink_rc_channels_t, chan16_raw)},                   \
          {"chan17_raw",                                                   \
           NULL,                                                           \
           MAVLINK_TYPE_UINT16_T,                                          \
           0,                                                              \
           36,                                                             \
           offsetof(mavlink_rc_channels_t, chan17_raw)},                   \
          {"chan18_raw",                                                   \
           NULL,                                                           \
           MAVLINK_TYPE_UINT16_T,                                          \
           0,                                                              \
           38,                                                             \
           offsetof(mavlink_rc_channels_t, chan18_raw)},                   \
          {"rssi", NULL, MAVLINK_TYPE_UINT8_T,                             \
           0,      41,   offsetof(mavlink_rc_channels_t, rssi)},           \
    }                                                                      \
  }
#else
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS                                   \
 ...
 * @param chancount  Total number of RC channels being received. This can be
 * larger than 18, indicating that more channels are available but not given in
...
static inline uint16_t mavlink_msg_rc_channels_pack_chan(
    ...
    mavlink_message_t* msg, uint32_t time_boot_ms, uint8_t chancount,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_RC_CHANNELS_MIN_LEN,
      MAVLINK_MSG_ID_RC_CHANNELS_LEN, MAVLINK_MSG_ID_RC_CHANNELS_CRC);
}
...
static inline uint16_t mavlink_msg_rc_channels_encode(
  ...
  return mavlink_msg_rc_channels_pack(
      system_id, component_id, msg, rc_channels->time_boot_ms,
      rc_channels->chancount, rc_channels->chan1_raw, rc_channels->chan2_raw,
      rc_channels->chan3_raw, rc_channels->chan4_raw, rc_channels->chan5_raw,
      rc_channels->chan6_raw, rc_channels->chan7_raw, rc_channels->chan8_raw,
      rc_channels->chan9_raw, rc_channels->chan10_raw, rc_channels->chan11_raw,
      rc_channels->chan12_raw, rc_channels->chan13_raw, rc_channels->chan14_raw,
      rc_channels->chan15_raw, rc_channels->chan16_raw, rc_channels->chan17_raw,
...
static inline uint16_t mavlink_msg_rc_channels_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_rc_channels_t* rc_channels) {
  return mavlink_msg_rc_channels_pack_chan(
      system_id, component_id, chan, msg, rc_channels->time_boot_ms,
      rc_channels->chancount, rc_channels->chan1_raw, rc_channels->chan2_raw,
      rc_channels->chan3_raw, rc_channels->chan4_raw, rc_channels->chan5_raw,
      rc_channels->chan6_raw, rc_channels->chan7_raw, rc_channels->chan8_raw,
      rc_channels->chan9_raw, rc_channels->chan10_raw, rc_channels->chan11_raw,
...
static inline void mavlink_msg_rc_channels_send(
    mavlink_channel_t chan, uint32_t time_boot_ms, uint8_t chancount,
    uint16_t chan1_raw, uint16_t chan2_raw, uint16_t chan3_raw,
    uint16_t chan4_raw, uint16_t chan5_raw, uint16_t chan6_raw,
    uint16_t chan7_raw, uint16_t chan8_raw, uint16_t chan9_raw,
    uint16_t chan10_raw, uint16_t chan11_raw, uint16_t chan12_raw,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_RC_CHANNELS, buf, MAVLINK_MSG_ID_RC_CHANNELS_MIN_LEN,
      MAVLINK_MSG_ID_RC_CHANNELS_LEN, MAVLINK_MSG_ID_RC_CHANNELS_CRC);
#else
  mavlink_rc_channels_t packet;
  packet.time_boot_ms = time_boot_ms;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_RC_CHANNELS, (const char*)&packet,
      MAVLINK_MSG_ID_RC_CHANNELS_MIN_LEN, MAVLINK_MSG_ID_RC_CHANNELS_LEN,
 ...
 */
static inline void mavlink_msg_rc_channels_send_struct(
    mavlink_channel_t chan, const mavlink_rc_channels_t* rc_channels) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_rc_channels_send(
      chan, rc_channels->time_boot_ms, rc_channels->chancount,
      ...
      rc_channels->chan7_raw, rc_channels->chan8_raw, rc_channels->chan9_raw,
      rc_channels->chan10_raw, rc_channels->chan11_raw, rc_channels->chan12_raw,
      rc_channels->chan13_raw, rc_channels->chan14_raw, rc_channels->chan15_raw,
      rc_channels->chan16_raw, rc_channels->chan17_raw, rc_channels->chan18_raw,
      rc_channels->rssi);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_RC_CHANNELS, (const char*)rc_channels,
      MAVLINK_MSG_ID_RC_CHANNELS_MIN_LEN, MAVLINK_MSG_ID_RC_CHANNELS_LEN,
      MAVLINK_MSG_ID_RC_CHANNELS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_rc_channels_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint32_t time_boot_ms,
    uint8_t chancount, uint16_t chan1_raw, uint16_t chan2_raw,
    ...
    uint16_t chan18_raw, uint8_t rssi) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint32_t mavlink_msg_rc_channels_get_time_boot_ms(
 ...
 * 18, indicating that more channels are available but not given in this
 * message. This value should be 0 when no RC channels are available.
 */
static inline uint8_t mavlink_msg_rc_channels_get_chancount(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan1_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan2_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan3_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan4_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan5_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan6_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan7_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan8_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan9_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan10_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan11_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan12_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan13_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan14_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan15_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan16_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan17_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_rc_channels_get_chan18_raw(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Receive signal strength indicator in device-dependent units/scale.
 * Values: [0-254], 255: invalid/unknown.
 */
static inline uint8_t mavlink_msg_rc_channels_get_rssi(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_rc_channels_decode(
