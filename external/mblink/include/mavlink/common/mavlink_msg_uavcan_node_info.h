...
MAVPACKED(typedef struct __mavlink_uavcan_node_info_t {
...
#define MAVLINK_MESSAGE_INFO_UAVCAN_NODE_INFO                               \
  {                                                                         \
    311, "UAVCAN_NODE_INFO", 9, {                                           \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                            \
       0,           0,    offsetof(mavlink_uavcan_node_info_t, time_usec)}, \
          {"uptime_sec",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_UINT32_T,                                           \
           0,                                                               \
           8,                                                               \
           offsetof(mavlink_uavcan_node_info_t, uptime_sec)},               \
          {"name", NULL, MAVLINK_TYPE_CHAR,                                 \
           80,     16,   offsetof(mavlink_uavcan_node_info_t, name)},       \
          {"hw_version_major",                                              \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           96,                                                              \
           offsetof(mavlink_uavcan_node_info_t, hw_version_major)},         \
          {"hw_version_minor",                                              \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           97,                                                              \
           offsetof(mavlink_uavcan_node_info_t, hw_version_minor)},         \
          {"hw_unique_id",                                                  \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           16,                                                              \
           98,                                                              \
           offsetof(mavlink_uavcan_node_info_t, hw_unique_id)},             \
          {"sw_version_major",                                              \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           114,                                                             \
           offsetof(mavlink_uavcan_node_info_t, sw_version_major)},         \
          {"sw_version_minor",                                              \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           115,                                                             \
           offsetof(mavlink_uavcan_node_info_t, sw_version_minor)},         \
          {"sw_vcs_commit",                                                 \
           NULL,                                                            \
           MAVLINK_TYPE_UINT32_T,                                           \
           0,                                                               \
           12,                                                              \
           offsetof(mavlink_uavcan_node_info_t, sw_vcs_commit)},            \
    }                                                                       \
  }
#else
#define MAVLINK_MESSAGE_INFO_UAVCAN_NODE_INFO                               \
 ...
 * @param sw_vcs_commit  Version control system (VCS) revision identifier (e.g.
 * git short commit hash). Zero if unknown.
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_uavcan_node_info_pack(
  ...
  return mavlink_finalize_message(
      ...
      MAVLINK_MSG_ID_UAVCAN_NODE_INFO_LEN, MAVLINK_MSG_ID_UAVCAN_NODE_INFO_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_uavcan_node_info_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint64_t time_usec, uint32_t uptime_sec,
    const char* name, uint8_t hw_version_major, uint8_t hw_version_minor,
    const uint8_t* hw_unique_id, uint8_t sw_version_major,
    uint8_t sw_version_minor, uint32_t sw_vcs_commit) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_UAVCAN_NODE_INFO_LEN];
 ...
 */
static inline uint16_t mavlink_msg_uavcan_node_info_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_uavcan_node_info_t* uavcan_node_info) {
  return mavlink_msg_uavcan_node_info_pack(
      system_id, component_id, msg, uavcan_node_info->time_usec,
      uavcan_node_info->uptime_sec, uavcan_node_info->name,
      uavcan_node_info->hw_version_major, uavcan_node_info->hw_version_minor,
      uavcan_node_info->hw_unique_id, uavcan_node_info->sw_version_major,
      uavcan_node_info->sw_version_minor, uavcan_node_info->sw_vcs_commit);
}
 ...
 * @param uavcan_node_info C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_uavcan_node_info_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_uavcan_node_info_t* uavcan_node_info) {
  return mavlink_msg_uavcan_node_info_pack_chan(
      system_id, component_id, chan, msg, uavcan_node_info->time_usec,
      uavcan_node_info->uptime_sec, uavcan_node_info->name,
      uavcan_node_info->hw_version_major, uavcan_node_info->hw_version_minor,
      uavcan_node_info->hw_unique_id, uavcan_node_info->sw_version_major,
      uavcan_node_info->sw_version_minor, uavcan_node_info->sw_vcs_commit);
...
static inline void mavlink_msg_uavcan_node_info_send(
    mavlink_channel_t chan, uint64_t time_usec, uint32_t uptime_sec,
    const char* name, uint8_t hw_version_major, uint8_t hw_version_minor,
    const uint8_t* hw_unique_id, uint8_t sw_version_major,
    uint8_t sw_version_minor, uint32_t sw_vcs_commit) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_put_char_array(buf, 16, name, 80);
  _mav_put_uint8_t_array(buf, 98, hw_unique_id, 16);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_UAVCAN_NODE_INFO, buf,
                                  MAVLINK_MSG_ID_UAVCAN_NODE_INFO_MIN_LEN,
                                  MAVLINK_MSG_ID_UAVCAN_NODE_INFO_LEN,
                                  MAVLINK_MSG_ID_UAVCAN_NODE_INFO_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_UAVCAN_NODE_INFO, (const char*)&packet,
      MAVLINK_MSG_ID_UAVCAN_NODE_INFO_MIN_LEN,
      MAVLINK_MSG_ID_UAVCAN_NODE_INFO_LEN, MAVLINK_MSG_ID_UAVCAN_NODE_INFO_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_uavcan_node_info_send_struct(
    mavlink_channel_t chan,
    const mavlink_uavcan_node_info_t* uavcan_node_info) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_uavcan_node_info_send(
      chan, uavcan_node_info->time_usec, uavcan_node_info->uptime_sec,
      uavcan_node_info->name, uavcan_node_info->hw_version_major,
      uavcan_node_info->hw_version_minor, uavcan_node_info->hw_unique_id,
      uavcan_node_info->sw_version_major, uavcan_node_info->sw_version_minor,
      uavcan_node_info->sw_vcs_commit);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_UAVCAN_NODE_INFO, (const char*)uavcan_node_info,
      MAVLINK_MSG_ID_UAVCAN_NODE_INFO_MIN_LEN,
      MAVLINK_MSG_ID_UAVCAN_NODE_INFO_LEN, MAVLINK_MSG_ID_UAVCAN_NODE_INFO_CRC);
#endif
}
...
static inline void mavlink_msg_uavcan_node_info_send_buf(
    ...
    uint32_t uptime_sec, const char* name, uint8_t hw_version_major,
    uint8_t hw_version_minor, const uint8_t* hw_unique_id,
    uint8_t sw_version_major, uint8_t sw_version_minor,
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_uavcan_node_info_get_time_usec(
 ...
 */
static inline uint32_t mavlink_msg_uavcan_node_info_get_uptime_sec(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_uavcan_node_info_get_name(
 ...
 */
static inline uint8_t mavlink_msg_uavcan_node_info_get_hw_version_major(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_uavcan_node_info_get_hw_version_minor(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_uavcan_node_info_get_hw_unique_id(
    const mavlink_message_t* msg, uint8_t* hw_unique_id) {
 ...
 */
static inline uint8_t mavlink_msg_uavcan_node_info_get_sw_version_major(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_uavcan_node_info_get_sw_version_minor(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_uavcan_node_info_get_sw_vcs_commit(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_uavcan_node_info_decode(
    const mavlink_message_t* msg,
  ...
  uavcan_node_info->uptime_sec =
      mavlink_msg_uavcan_node_info_get_uptime_sec(msg);
  uavcan_node_info->sw_vcs_commit =
      mavlink_msg_uavcan_node_info_get_sw_vcs_commit(msg);
  mavlink_msg_uavcan_node_info_get_name(msg, uavcan_node_info->name);
  uavcan_node_info->hw_version_major =
      mavlink_msg_uavcan_node_info_get_hw_version_major(msg);
  uavcan_node_info->hw_version_minor =
      mavlink_msg_uavcan_node_info_get_hw_version_minor(msg);
  mavlink_msg_uavcan_node_info_get_hw_unique_id(msg,
                                                uavcan_node_info->hw_unique_id);
  uavcan_node_info->sw_version_major =
      mavlink_msg_uavcan_node_info_get_sw_version_major(msg);
  uavcan_node_info->sw_version_minor =
      mavlink_msg_uavcan_node_info_get_sw_version_minor(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_UAVCAN_NODE_INFO_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_UAVCAN_NODE_INFO_LEN;
