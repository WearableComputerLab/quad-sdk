...
MAVPACKED(typedef struct __mavlink_hil_actuator_controls_t {
  ...
  {                                                                          \
    93, "HIL_ACTUATOR_CONTROLS", 4, {                                        \
      {                                                                      \
          ...
          0,                                                                 \
          0,                                                                 \
          offsetof(mavlink_hil_actuator_controls_t, time_usec)},             \
          {"controls",                                                       \
           NULL,                                                             \
           MAVLINK_TYPE_FLOAT,                                               \
           16,                                                               \
           16,                                                               \
           offsetof(mavlink_hil_actuator_controls_t, controls)},             \
          {"mode", NULL, MAVLINK_TYPE_UINT8_T,                               \
           0,      80,   offsetof(mavlink_hil_actuator_controls_t, mode)},   \
          {"flags", NULL, MAVLINK_TYPE_UINT64_T,                             \
           0,       8,    offsetof(mavlink_hil_actuator_controls_t, flags)}, \
    }                                                                        \
  }
#else
#define MAVLINK_MESSAGE_INFO_HIL_ACTUATOR_CONTROLS                           \
  {                                                                          \
    "HIL_ACTUATOR_CONTROLS", 4, {                                            \
      {                                                                      \
          "time_usec",                                                       \
          NULL,                                                              \
          MAVLINK_TYPE_UINT64_T,                                             \
 ...
 * @param controls  Control outputs -1 .. 1. Channel assignment depends on the
 * simulated hardware.
 * @param mode  System mode. Includes arming state.
 * @param flags  Flags as bitfield, reserved for future use.
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_hil_actuator_controls_pack(
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_hil_actuator_controls_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint64_t time_usec, const float* controls,
    uint8_t mode, uint64_t flags) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  _mav_put_uint64_t(buf, 8, flags);
 ...
 */
static inline uint16_t mavlink_msg_hil_actuator_controls_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_hil_actuator_controls_t* hil_actuator_controls) {
  return mavlink_msg_hil_actuator_controls_pack(
      system_id, component_id, msg, hil_actuator_controls->time_usec,
      hil_actuator_controls->controls, hil_actuator_controls->mode,
 ...
 * @param hil_actuator_controls C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_hil_actuator_controls_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_hil_actuator_controls_t* hil_actuator_controls) {
  return mavlink_msg_hil_actuator_controls_pack_chan(
      system_id, component_id, chan, msg, hil_actuator_controls->time_usec,
      hil_actuator_controls->controls, hil_actuator_controls->mode,
      hil_actuator_controls->flags);
}
...
static inline void mavlink_msg_hil_actuator_controls_send(
    mavlink_channel_t chan, uint64_t time_usec, const float* controls,
    uint8_t mode, uint64_t flags) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  ...
  _mav_put_uint8_t(buf, 80, mode);
  _mav_put_float_array(buf, 16, controls, 16);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS,
                                  buf,
                                  MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_MIN_LEN,
                                  MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_LEN,
                                  MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_CRC);
 ...
 */
static inline void mavlink_msg_hil_actuator_controls_send_struct(
    mavlink_channel_t chan,
    const mavlink_hil_actuator_controls_t* hil_actuator_controls) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_hil_actuator_controls_send(
      chan, hil_actuator_controls->time_usec, hil_actuator_controls->controls,
      hil_actuator_controls->mode, hil_actuator_controls->flags);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS,
 ...
 */
static inline void mavlink_msg_hil_actuator_controls_send_buf(
...
#else
  mavlink_hil_actuator_controls_t* packet =
      (mavlink_hil_actuator_controls_t*)msgbuf;
  packet->time_usec = time_usec;
  packet->flags = flags;
  packet->mode = mode;
  mav_array_memcpy(packet->controls, controls, sizeof(float) * 16);
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_hil_actuator_controls_get_time_usec(
 ...
 * hardware.
 */
static inline uint16_t mavlink_msg_hil_actuator_controls_get_controls(
 ...
 */
static inline uint8_t mavlink_msg_hil_actuator_controls_get_mode(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint64_t mavlink_msg_hil_actuator_controls_get_flags(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_hil_actuator_controls_decode(
    const mavlink_message_t* msg,
  ...
  mavlink_msg_hil_actuator_controls_get_controls(
      msg, hil_actuator_controls->controls);
  hil_actuator_controls->mode = mavlink_msg_hil_actuator_controls_get_mode(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_LEN;
