...
MAVPACKED(typedef struct __mavlink_data_stream_t {
  ...
  {                                                                    \
    67, "DATA_STREAM", 3, {                                            \
      {"stream_id", NULL, MAVLINK_TYPE_UINT8_T,                        \
       0,           2,    offsetof(mavlink_data_stream_t, stream_id)}, \
          {"message_rate",                                             \
           NULL,                                                       \
           MAVLINK_TYPE_UINT16_T,                                      \
           0,                                                          \
           0,                                                          \
           offsetof(mavlink_data_stream_t, message_rate)},             \
          {"on_off", NULL, MAVLINK_TYPE_UINT8_T,                       \
           0,        3,    offsetof(mavlink_data_stream_t, on_off)},   \
    }                                                                  \
  }
#else
#define MAVLINK_MESSAGE_INFO_DATA_STREAM                               \
...
static inline uint16_t mavlink_msg_data_stream_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_DATA_STREAM_MIN_LEN,
...
static inline uint16_t mavlink_msg_data_stream_pack_chan(
    ...
    mavlink_message_t* msg, uint8_t stream_id, uint16_t message_rate,
    uint8_t on_off) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_DATA_STREAM_LEN];
  _mav_put_uint16_t(buf, 0, message_rate);
...
static inline uint16_t mavlink_msg_data_stream_encode(
  ...
  return mavlink_msg_data_stream_pack(
      system_id, component_id, msg, data_stream->stream_id,
...
static inline uint16_t mavlink_msg_data_stream_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_data_stream_t* data_stream) {
  return mavlink_msg_data_stream_pack_chan(
      system_id, component_id, chan, msg, data_stream->stream_id,
      data_stream->message_rate, data_stream->on_off);
}
...
static inline void mavlink_msg_data_stream_send(mavlink_channel_t chan,
                                                uint8_t stream_id,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_DATA_STREAM, buf, MAVLINK_MSG_ID_DATA_STREAM_MIN_LEN,
      MAVLINK_MSG_ID_DATA_STREAM_LEN, MAVLINK_MSG_ID_DATA_STREAM_CRC);
#else
  mavlink_data_stream_t packet;
  packet.message_rate = message_rate;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_DATA_STREAM, (const char*)&packet,
      MAVLINK_MSG_ID_DATA_STREAM_MIN_LEN, MAVLINK_MSG_ID_DATA_STREAM_LEN,
 ...
 */
static inline void mavlink_msg_data_stream_send_struct(
    mavlink_channel_t chan, const mavlink_data_stream_t* data_stream) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_data_stream_send(chan, data_stream->stream_id,
                               data_stream->message_rate, data_stream->on_off);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_DATA_STREAM, (const char*)data_stream,
      MAVLINK_MSG_ID_DATA_STREAM_MIN_LEN, MAVLINK_MSG_ID_DATA_STREAM_LEN,
      MAVLINK_MSG_ID_DATA_STREAM_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_data_stream_send_buf(mavlink_message_t* msgbuf,
 ...
 */
static inline void mavlink_msg_data_stream_decode(
    const mavlink_message_t* msg, mavlink_data_stream_t* data_stream) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_DATA_STREAM_LEN
                    ? msg->len
