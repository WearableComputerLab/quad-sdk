...
MAVPACKED(typedef struct __mavlink_highres_imu_t {
  ...
  {                                                                    \
    105, "HIGHRES_IMU", 15, {                                          \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                       \
       0,           0,    offsetof(mavlink_highres_imu_t, time_usec)}, \
          {"xacc", NULL, MAVLINK_TYPE_FLOAT,                           \
           0,      8,    offsetof(mavlink_highres_imu_t, xacc)},       \
          {"yacc", NULL, MAVLINK_TYPE_FLOAT,                           \
           0,      12,   offsetof(mavlink_highres_imu_t, yacc)},       \
          {"zacc", NULL, MAVLINK_TYPE_FLOAT,                           \
           0,      16,   offsetof(mavlink_highres_imu_t, zacc)},       \
          {"xgyro", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,       20,   offsetof(mavlink_highres_imu_t, xgyro)},     \
          {"ygyro", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,       24,   offsetof(mavlink_highres_imu_t, ygyro)},     \
          {"zgyro", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,       28,   offsetof(mavlink_highres_imu_t, zgyro)},     \
          {"xmag", NULL, MAVLINK_TYPE_FLOAT,                           \
           0,      32,   offsetof(mavlink_highres_imu_t, xmag)},       \
          {"ymag", NULL, MAVLINK_TYPE_FLOAT,                           \
           0,      36,   offsetof(mavlink_highres_imu_t, ymag)},       \
          {"zmag", NULL, MAVLINK_TYPE_FLOAT,                           \
           0,      40,   offsetof(mavlink_highres_imu_t, zmag)},       \
          {"abs_pressure",                                             \
           NULL,                                                       \
           MAVLINK_TYPE_FLOAT,                                         \
           0,                                                          \
           44,                                                         \
           offsetof(mavlink_highres_imu_t, abs_pressure)},             \
          {"diff_pressure",                                            \
           NULL,                                                       \
           MAVLINK_TYPE_FLOAT,                                         \
           0,                                                          \
           48,                                                         \
           offsetof(mavlink_highres_imu_t, diff_pressure)},            \
          {"pressure_alt",                                             \
           NULL,                                                       \
           MAVLINK_TYPE_FLOAT,                                         \
           0,                                                          \
           52,                                                         \
           offsetof(mavlink_highres_imu_t, pressure_alt)},             \
          {"temperature",                                              \
           NULL,                                                       \
           MAVLINK_TYPE_FLOAT,                                         \
           0,                                                          \
           56,                                                         \
           offsetof(mavlink_highres_imu_t, temperature)},              \
          {"fields_updated",                                           \
           NULL,                                                       \
           MAVLINK_TYPE_UINT16_T,                                      \
           0,                                                          \
           60,                                                         \
           offsetof(mavlink_highres_imu_t, fields_updated)},           \
    }                                                                  \
  }
#else
#define MAVLINK_MESSAGE_INFO_HIGHRES_IMU                               \
...
static inline uint16_t mavlink_msg_highres_imu_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_HIGHRES_IMU_MIN_LEN,
      MAVLINK_MSG_ID_HIGHRES_IMU_LEN, MAVLINK_MSG_ID_HIGHRES_IMU_CRC);
}
...
static inline uint16_t mavlink_msg_highres_imu_encode(
  ...
  return mavlink_msg_highres_imu_pack(
      system_id, component_id, msg, highres_imu->time_usec, highres_imu->xacc,
      highres_imu->yacc, highres_imu->zacc, highres_imu->xgyro,
      highres_imu->ygyro, highres_imu->zgyro, highres_imu->xmag,
      highres_imu->ymag, highres_imu->zmag, highres_imu->abs_pressure,
      highres_imu->diff_pressure, highres_imu->pressure_alt,
      highres_imu->temperature, highres_imu->fields_updated);
}
...
static inline uint16_t mavlink_msg_highres_imu_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_highres_imu_t* highres_imu) {
  return mavlink_msg_highres_imu_pack_chan(
      system_id, component_id, chan, msg, highres_imu->time_usec,
...
static inline void mavlink_msg_highres_imu_send(
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIGHRES_IMU, buf, MAVLINK_MSG_ID_HIGHRES_IMU_MIN_LEN,
      MAVLINK_MSG_ID_HIGHRES_IMU_LEN, MAVLINK_MSG_ID_HIGHRES_IMU_CRC);
#else
  mavlink_highres_imu_t packet;
  packet.time_usec = time_usec;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIGHRES_IMU, (const char*)&packet,
      MAVLINK_MSG_ID_HIGHRES_IMU_MIN_LEN, MAVLINK_MSG_ID_HIGHRES_IMU_LEN,
 ...
 */
static inline void mavlink_msg_highres_imu_send_struct(
    mavlink_channel_t chan, const mavlink_highres_imu_t* highres_imu) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_highres_imu_send(
      chan, highres_imu->time_usec, highres_imu->xacc, highres_imu->yacc,
      highres_imu->zacc, highres_imu->xgyro, highres_imu->ygyro,
      highres_imu->zgyro, highres_imu->xmag, highres_imu->ymag,
      highres_imu->zmag, highres_imu->abs_pressure, highres_imu->diff_pressure,
      highres_imu->pressure_alt, highres_imu->temperature,
      highres_imu->fields_updated);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIGHRES_IMU, (const char*)highres_imu,
      MAVLINK_MSG_ID_HIGHRES_IMU_MIN_LEN, MAVLINK_MSG_ID_HIGHRES_IMU_LEN,
      MAVLINK_MSG_ID_HIGHRES_IMU_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_highres_imu_send_buf(
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_highres_imu_get_time_usec(
 ...
 */
static inline float mavlink_msg_highres_imu_get_xacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_highres_imu_get_yacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_highres_imu_get_zacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_highres_imu_get_xgyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_highres_imu_get_ygyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_highres_imu_get_zgyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_highres_imu_get_xmag(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_highres_imu_get_ymag(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_highres_imu_get_zmag(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_highres_imu_get_abs_pressure(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_highres_imu_get_diff_pressure(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_highres_imu_get_pressure_alt(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_highres_imu_get_temperature(
    const mavlink_message_t* msg) {
 ...
 * xacc, bit 12: temperature
 */
static inline uint16_t mavlink_msg_highres_imu_get_fields_updated(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_highres_imu_decode(
    const mavlink_message_t* msg, mavlink_highres_imu_t* highres_imu) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_HIGHRES_IMU_LEN
                    ? msg->len
