...
MAVPACKED(typedef struct __mavlink_vfr_hud_t {
  ...
  int16_t
      heading; /*< [deg] Current heading in compass units (0-360, 0=north).*/
...
#define MAVLINK_MESSAGE_INFO_VFR_HUD                                 \
  {                                                                  \
    74, "VFR_HUD", 6, {                                              \
      {"airspeed", NULL, MAVLINK_TYPE_FLOAT,                         \
       0,          0,    offsetof(mavlink_vfr_hud_t, airspeed)},     \
          {"groundspeed",                                            \
           NULL,                                                     \
           MAVLINK_TYPE_FLOAT,                                       \
           0,                                                        \
           4,                                                        \
           offsetof(mavlink_vfr_hud_t, groundspeed)},                \
          {"heading", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,         16,   offsetof(mavlink_vfr_hud_t, heading)},   \
          {"throttle", NULL, MAVLINK_TYPE_UINT16_T,                  \
           0,          18,   offsetof(mavlink_vfr_hud_t, throttle)}, \
          {"alt", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,     8,    offsetof(mavlink_vfr_hud_t, alt)},           \
          {"climb", NULL, MAVLINK_TYPE_FLOAT,                        \
           0,       12,   offsetof(mavlink_vfr_hud_t, climb)},       \
    }                                                                \
  }
#else
#define MAVLINK_MESSAGE_INFO_VFR_HUD                                 \
...
static inline uint16_t mavlink_msg_vfr_hud_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_VFR_HUD_MIN_LEN,
...
static inline uint16_t mavlink_msg_vfr_hud_pack_chan(
    ...
    mavlink_message_t* msg, float airspeed, float groundspeed, int16_t heading,
...
static inline uint16_t mavlink_msg_vfr_hud_encode(
  ...
  return mavlink_msg_vfr_hud_pack(
      system_id, component_id, msg, vfr_hud->airspeed, vfr_hud->groundspeed,
      vfr_hud->heading, vfr_hud->throttle, vfr_hud->alt, vfr_hud->climb);
}
...
static inline uint16_t mavlink_msg_vfr_hud_encode_chan(
  ...
  return mavlink_msg_vfr_hud_pack_chan(system_id, component_id, chan, msg,
...
static inline void mavlink_msg_vfr_hud_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_VFR_HUD, buf, MAVLINK_MSG_ID_VFR_HUD_MIN_LEN,
      MAVLINK_MSG_ID_VFR_HUD_LEN, MAVLINK_MSG_ID_VFR_HUD_CRC);
#else
  mavlink_vfr_hud_t packet;
  packet.airspeed = airspeed;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_VFR_HUD, (const char*)&packet,
 ...
 */
static inline void mavlink_msg_vfr_hud_send_struct(
    mavlink_channel_t chan, const mavlink_vfr_hud_t* vfr_hud) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_vfr_hud_send(chan, vfr_hud->airspeed, vfr_hud->groundspeed,
                           vfr_hud->heading, vfr_hud->throttle, vfr_hud->alt,
                           vfr_hud->climb);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_VFR_HUD, (const char*)vfr_hud,
      MAVLINK_MSG_ID_VFR_HUD_MIN_LEN, MAVLINK_MSG_ID_VFR_HUD_LEN,
      MAVLINK_MSG_ID_VFR_HUD_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_vfr_hud_send_buf(
 ...
 */
static inline float mavlink_msg_vfr_hud_get_climb(
    const mavlink_message_t* msg) {
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_VFR_HUD_LEN
                    ? msg->len
