...
MAVPACKED(typedef struct __mavlink_encapsulated_data_t {
...
#define MAVLINK_MESSAGE_INFO_ENCAPSULATED_DATA                         \
  {                                                                    \
    131, "ENCAPSULATED_DATA", 2, {                                     \
      {"seqnr", NULL, MAVLINK_TYPE_UINT16_T,                           \
       0,       0,    offsetof(mavlink_encapsulated_data_t, seqnr)},   \
          {"data", NULL, MAVLINK_TYPE_UINT8_T,                         \
           253,    2,    offsetof(mavlink_encapsulated_data_t, data)}, \
    }                                                                  \
  }
#else
#define MAVLINK_MESSAGE_INFO_ENCAPSULATED_DATA                         \
...
static inline uint16_t mavlink_msg_encapsulated_data_pack_chan(
    ...
    mavlink_message_t* msg, uint16_t seqnr, const uint8_t* data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_ENCAPSULATED_DATA_LEN];
  _mav_put_uint16_t(buf, 0, seqnr);
  _mav_put_uint8_t_array(buf, 2, data, 253);
...
static inline uint16_t mavlink_msg_encapsulated_data_encode_chan(
    ...
    const mavlink_encapsulated_data_t* encapsulated_data) {
  return mavlink_msg_encapsulated_data_pack_chan(system_id, component_id, chan,
                                                 msg, encapsulated_data->seqnr,
                                                 encapsulated_data->data);
}
...
static inline void mavlink_msg_encapsulated_data_send(mavlink_channel_t chan,
                                                      uint16_t seqnr,
                                                      const uint8_t* data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_ENCAPSULATED_DATA_LEN];
  _mav_put_uint16_t(buf, 0, seqnr);
  _mav_put_uint8_t_array(buf, 2, data, 253);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ENCAPSULATED_DATA, buf,
                                  MAVLINK_MSG_ID_ENCAPSULATED_DATA_MIN_LEN,
                                  MAVLINK_MSG_ID_ENCAPSULATED_DATA_LEN,
                                  MAVLINK_MSG_ID_ENCAPSULATED_DATA_CRC);
#else
  ...
  packet.seqnr = seqnr;
  mav_array_memcpy(packet.data, data, sizeof(uint8_t) * 253);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ENCAPSULATED_DATA,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_ENCAPSULATED_DATA_MIN_LEN,
                                  MAVLINK_MSG_ID_ENCAPSULATED_DATA_LEN,
                                  MAVLINK_MSG_ID_ENCAPSULATED_DATA_CRC);
 ...
 */
static inline void mavlink_msg_encapsulated_data_send_struct(
    mavlink_channel_t chan,
    const mavlink_encapsulated_data_t* encapsulated_data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_encapsulated_data_send(chan, encapsulated_data->seqnr,
                                     encapsulated_data->data);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ENCAPSULATED_DATA,
 ...
 */
static inline void mavlink_msg_encapsulated_data_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint16_t seqnr,
    const uint8_t* data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint16_t mavlink_msg_encapsulated_data_get_seqnr(
 ...
 */
static inline uint16_t mavlink_msg_encapsulated_data_get_data(
 ...
 */
static inline void mavlink_msg_encapsulated_data_decode(
    const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_ENCAPSULATED_DATA_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_ENCAPSULATED_DATA_LEN;
