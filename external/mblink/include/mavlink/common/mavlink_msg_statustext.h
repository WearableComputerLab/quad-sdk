...
MAVPACKED(typedef struct __mavlink_statustext_t {
  ...
  {                                                                 \
    253, "STATUSTEXT", 2, {                                         \
      {"severity", NULL, MAVLINK_TYPE_UINT8_T,                      \
       0,          0,    offsetof(mavlink_statustext_t, severity)}, \
          {"text", NULL, MAVLINK_TYPE_CHAR,                         \
           50,     1,    offsetof(mavlink_statustext_t, text)},     \
    }                                                               \
  }
#else
#define MAVLINK_MESSAGE_INFO_STATUSTEXT                             \
...
static inline uint16_t mavlink_msg_statustext_pack(uint8_t system_id,
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_STATUSTEXT_MIN_LEN,
...
static inline uint16_t mavlink_msg_statustext_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_STATUSTEXT_MIN_LEN,
      MAVLINK_MSG_ID_STATUSTEXT_LEN, MAVLINK_MSG_ID_STATUSTEXT_CRC);
}
...
static inline void mavlink_msg_statustext_send(mavlink_channel_t chan,
                                               uint8_t severity,
                                               const char* text) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_STATUSTEXT_LEN];
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_STATUSTEXT, buf, MAVLINK_MSG_ID_STATUSTEXT_MIN_LEN,
      MAVLINK_MSG_ID_STATUSTEXT_LEN, MAVLINK_MSG_ID_STATUSTEXT_CRC);
#else
  mavlink_statustext_t packet;
  packet.severity = severity;
  mav_array_memcpy(packet.text, text, sizeof(char) * 50);
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_STATUSTEXT, (const char*)&packet,
      MAVLINK_MSG_ID_STATUSTEXT_MIN_LEN, MAVLINK_MSG_ID_STATUSTEXT_LEN,
 ...
 */
static inline void mavlink_msg_statustext_send_struct(
    mavlink_channel_t chan, const mavlink_statustext_t* statustext) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_statustext_send(chan, statustext->severity, statustext->text);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_STATUSTEXT, (const char*)statustext,
      MAVLINK_MSG_ID_STATUSTEXT_MIN_LEN, MAVLINK_MSG_ID_STATUSTEXT_LEN,
      MAVLINK_MSG_ID_STATUSTEXT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_statustext_send_buf(mavlink_message_t* msgbuf,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_STATUSTEXT_LEN
                    ? msg->len
