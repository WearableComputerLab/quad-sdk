...
MAVPACKED(typedef struct __mavlink_logging_ack_t {
  ...
  {                                                                      \
    268, "LOGGING_ACK", 3, {                                             \
      {"target_system",                                                  \
       ...
       0,                                                                \
       2,                                                                \
       offsetof(mavlink_logging_ack_t, target_system)},                  \
          {"target_component",                                           \
           NULL,                                                         \
           MAVLINK_TYPE_UINT8_T,                                         \
           0,                                                            \
           3,                                                            \
           offsetof(mavlink_logging_ack_t, target_component)},           \
          {"sequence", NULL, MAVLINK_TYPE_UINT16_T,                      \
           0,          0,    offsetof(mavlink_logging_ack_t, sequence)}, \
    }                                                                    \
  }
#else
#define MAVLINK_MESSAGE_INFO_LOGGING_ACK                                 \
 ...
 */
static inline uint16_t mavlink_msg_logging_ack_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_LOGGING_ACK_MIN_LEN,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_logging_ack_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_LOGGING_ACK_MIN_LEN,
      MAVLINK_MSG_ID_LOGGING_ACK_LEN, MAVLINK_MSG_ID_LOGGING_ACK_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_logging_ack_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_logging_ack_t* logging_ack) {
  return mavlink_msg_logging_ack_pack(
      system_id, component_id, msg, logging_ack->target_system,
 ...
 * @param logging_ack C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_logging_ack_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_logging_ack_t* logging_ack) {
  return mavlink_msg_logging_ack_pack_chan(
      system_id, component_id, chan, msg, logging_ack->target_system,
      logging_ack->target_component, logging_ack->sequence);
}
...
static inline void mavlink_msg_logging_ack_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOGGING_ACK, buf, MAVLINK_MSG_ID_LOGGING_ACK_MIN_LEN,
      MAVLINK_MSG_ID_LOGGING_ACK_LEN, MAVLINK_MSG_ID_LOGGING_ACK_CRC);
#else
  mavlink_logging_ack_t packet;
  packet.sequence = sequence;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOGGING_ACK, (const char*)&packet,
 ...
 */
static inline void mavlink_msg_logging_ack_send_struct(
    mavlink_channel_t chan, const mavlink_logging_ack_t* logging_ack) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_logging_ack_send(chan, logging_ack->target_system,
                               logging_ack->target_component,
                               logging_ack->sequence);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOGGING_ACK, (const char*)logging_ack,
      MAVLINK_MSG_ID_LOGGING_ACK_MIN_LEN, MAVLINK_MSG_ID_LOGGING_ACK_LEN,
      MAVLINK_MSG_ID_LOGGING_ACK_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_logging_ack_send_buf(mavlink_message_t* msgbuf,
 ...
 */
static inline uint8_t mavlink_msg_logging_ack_get_target_system(
 ...
 */
static inline uint8_t mavlink_msg_logging_ack_get_target_component(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_logging_ack_get_sequence(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_logging_ack_decode(
    const mavlink_message_t* msg, mavlink_logging_ack_t* logging_ack) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  logging_ack->target_component =
      mavlink_msg_logging_ack_get_target_component(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_LOGGING_ACK_LEN
                    ? msg->len
