...
MAVPACKED(typedef struct __mavlink_log_request_data_t {
...
#define MAVLINK_MESSAGE_INFO_LOG_REQUEST_DATA                           \
  {                                                                     \
    119, "LOG_REQUEST_DATA", 5, {                                       \
      {"target_system",                                                 \
       NULL,                                                            \
       MAVLINK_TYPE_UINT8_T,                                            \
       0,                                                               \
       10,                                                              \
       offsetof(mavlink_log_request_data_t, target_system)},            \
          {"target_component",                                          \
           NULL,                                                        \
           MAVLINK_TYPE_UINT8_T,                                        \
           0,                                                           \
           11,                                                          \
           offsetof(mavlink_log_request_data_t, target_component)},     \
          {"id", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,    8,    offsetof(mavlink_log_request_data_t, id)},       \
          {"ofs", NULL, MAVLINK_TYPE_UINT32_T,                          \
           0,     0,    offsetof(mavlink_log_request_data_t, ofs)},     \
          {"count", NULL, MAVLINK_TYPE_UINT32_T,                        \
           0,       4,    offsetof(mavlink_log_request_data_t, count)}, \
    }                                                                   \
  }
#else
#define MAVLINK_MESSAGE_INFO_LOG_REQUEST_DATA                           \
...
static inline uint16_t mavlink_msg_log_request_data_pack(
    ...
    uint8_t target_system, uint8_t target_component, uint16_t id, uint32_t ofs,
    uint32_t count) {
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_LOG_REQUEST_DATA_MIN_LEN,
      MAVLINK_MSG_ID_LOG_REQUEST_DATA_LEN, MAVLINK_MSG_ID_LOG_REQUEST_DATA_CRC);
}
...
static inline uint16_t mavlink_msg_log_request_data_pack_chan(
    ...
    uint16_t id, uint32_t ofs, uint32_t count) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_LOG_REQUEST_DATA_LEN];
  _mav_put_uint32_t(buf, 0, ofs);
  _mav_put_uint32_t(buf, 4, count);
...
static inline uint16_t mavlink_msg_log_request_data_encode(
  ...
  return mavlink_msg_log_request_data_pack(
      system_id, component_id, msg, log_request_data->target_system,
      log_request_data->target_component, log_request_data->id,
      log_request_data->ofs, log_request_data->count);
}
...
static inline uint16_t mavlink_msg_log_request_data_encode_chan(
  ...
  return mavlink_msg_log_request_data_pack_chan(
      system_id, component_id, chan, msg, log_request_data->target_system,
      log_request_data->target_component, log_request_data->id,
      log_request_data->ofs, log_request_data->count);
}
...
static inline void mavlink_msg_log_request_data_send(mavlink_channel_t chan,
                                                     uint8_t target_system,
                                                     uint8_t target_component,
                                                     uint16_t id, uint32_t ofs,
                                                     uint32_t count) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_LOG_REQUEST_DATA_LEN];
  _mav_put_uint32_t(buf, 0, ofs);
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOG_REQUEST_DATA, buf,
                                  MAVLINK_MSG_ID_LOG_REQUEST_DATA_MIN_LEN,
                                  MAVLINK_MSG_ID_LOG_REQUEST_DATA_LEN,
                                  MAVLINK_MSG_ID_LOG_REQUEST_DATA_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_REQUEST_DATA, (const char*)&packet,
      MAVLINK_MSG_ID_LOG_REQUEST_DATA_MIN_LEN,
      MAVLINK_MSG_ID_LOG_REQUEST_DATA_LEN, MAVLINK_MSG_ID_LOG_REQUEST_DATA_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_log_request_data_send_struct(
    mavlink_channel_t chan,
    const mavlink_log_request_data_t* log_request_data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_log_request_data_send(
      chan, log_request_data->target_system, log_request_data->target_component,
      log_request_data->id, log_request_data->ofs, log_request_data->count);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_REQUEST_DATA, (const char*)log_request_data,
      MAVLINK_MSG_ID_LOG_REQUEST_DATA_MIN_LEN,
      MAVLINK_MSG_ID_LOG_REQUEST_DATA_LEN, MAVLINK_MSG_ID_LOG_REQUEST_DATA_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_log_request_data_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system,
    uint8_t target_component, uint16_t id, uint32_t ofs, uint32_t count) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  System ID
 */
static inline uint8_t mavlink_msg_log_request_data_get_target_system(
 ...
 * @return  Component ID
 */
static inline uint8_t mavlink_msg_log_request_data_get_target_component(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_log_request_data_get_id(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_log_request_data_get_ofs(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_log_request_data_get_count(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_log_request_data_decode(
    const mavlink_message_t* msg,
