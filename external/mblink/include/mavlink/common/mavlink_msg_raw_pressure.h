...
MAVPACKED(typedef struct __mavlink_raw_pressure_t {
  ...
  {                                                                         \
    28, "RAW_PRESSURE", 5, {                                                \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                            \
       0,           0,    offsetof(mavlink_raw_pressure_t, time_usec)},     \
          {"press_abs", NULL, MAVLINK_TYPE_INT16_T,                         \
           0,           8,    offsetof(mavlink_raw_pressure_t, press_abs)}, \
          {"press_diff1",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_INT16_T,                                            \
           0,                                                               \
           10,                                                              \
           offsetof(mavlink_raw_pressure_t, press_diff1)},                  \
          {"press_diff2",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_INT16_T,                                            \
           0,                                                               \
           12,                                                              \
           offsetof(mavlink_raw_pressure_t, press_diff2)},                  \
          {"temperature",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_INT16_T,                                            \
           0,                                                               \
...
static inline uint16_t mavlink_msg_raw_pressure_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_RAW_PRESSURE_MIN_LEN,
      MAVLINK_MSG_ID_RAW_PRESSURE_LEN, MAVLINK_MSG_ID_RAW_PRESSURE_CRC);
}
...
static inline uint16_t mavlink_msg_raw_pressure_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_usec, int16_t press_abs,
    int16_t press_diff1, int16_t press_diff2, int16_t temperature) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_RAW_PRESSURE_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  _mav_put_int16_t(buf, 8, press_abs);
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_RAW_PRESSURE_MIN_LEN,
      MAVLINK_MSG_ID_RAW_PRESSURE_LEN, MAVLINK_MSG_ID_RAW_PRESSURE_CRC);
}
...
static inline uint16_t mavlink_msg_raw_pressure_encode(
  ...
  return mavlink_msg_raw_pressure_pack(
      system_id, component_id, msg, raw_pressure->time_usec,
...
static inline uint16_t mavlink_msg_raw_pressure_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_raw_pressure_t* raw_pressure) {
  return mavlink_msg_raw_pressure_pack_chan(
      system_id, component_id, chan, msg, raw_pressure->time_usec,
      raw_pressure->press_abs, raw_pressure->press_diff1,
      raw_pressure->press_diff2, raw_pressure->temperature);
}
...
static inline void mavlink_msg_raw_pressure_send(
    mavlink_channel_t chan, uint64_t time_usec, int16_t press_abs,
    int16_t press_diff1, int16_t press_diff2, int16_t temperature) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_RAW_PRESSURE_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RAW_PRESSURE, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_RAW_PRESSURE, (const char*)&packet,
      MAVLINK_MSG_ID_RAW_PRESSURE_MIN_LEN, MAVLINK_MSG_ID_RAW_PRESSURE_LEN,
      MAVLINK_MSG_ID_RAW_PRESSURE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_raw_pressure_send_struct(
    mavlink_channel_t chan, const mavlink_raw_pressure_t* raw_pressure) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_raw_pressure_send(
      chan, raw_pressure->time_usec, raw_pressure->press_abs,
      raw_pressure->press_diff1, raw_pressure->press_diff2,
      raw_pressure->temperature);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_RAW_PRESSURE, (const char*)raw_pressure,
      MAVLINK_MSG_ID_RAW_PRESSURE_MIN_LEN, MAVLINK_MSG_ID_RAW_PRESSURE_LEN,
      MAVLINK_MSG_ID_RAW_PRESSURE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_raw_pressure_send_buf(
 ...
 */
static inline void mavlink_msg_raw_pressure_decode(
    const mavlink_message_t* msg, mavlink_raw_pressure_t* raw_pressure) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_RAW_PRESSURE_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_RAW_PRESSURE_LEN;
