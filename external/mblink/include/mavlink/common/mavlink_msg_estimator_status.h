...
MAVPACKED(typedef struct __mavlink_estimator_status_t {
  ...
  float pos_horiz_accuracy; /*< [m] Horizontal position 1-STD accuracy relative
                               to the EKF local origin*/
  float pos_vert_accuracy;  /*< [m] Vertical position 1-STD accuracy relative to
...
#define MAVLINK_MESSAGE_INFO_ESTIMATOR_STATUS                                   \
  {                                                                             \
    230, "ESTIMATOR_STATUS", 10, {                                              \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                                \
       0,           0,    offsetof(mavlink_estimator_status_t, time_usec)},     \
          {"flags", NULL, MAVLINK_TYPE_UINT16_T,                                \
           0,       40,   offsetof(mavlink_estimator_status_t, flags)},         \
          {"vel_ratio", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,           8,    offsetof(mavlink_estimator_status_t, vel_ratio)}, \
          {"pos_horiz_ratio",                                                   \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           12,                                                                  \
           offsetof(mavlink_estimator_status_t, pos_horiz_ratio)},              \
          {"pos_vert_ratio",                                                    \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           16,                                                                  \
           offsetof(mavlink_estimator_status_t, pos_vert_ratio)},               \
          {"mag_ratio", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,           20,   offsetof(mavlink_estimator_status_t, mag_ratio)}, \
          {"hagl_ratio",                                                        \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           24,                                                                  \
           offsetof(mavlink_estimator_status_t, hagl_ratio)},                   \
          {"tas_ratio", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,           28,   offsetof(mavlink_estimator_status_t, tas_ratio)}, \
          {"pos_horiz_accuracy",                                                \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           32,                                                                  \
           offsetof(mavlink_estimator_status_t, pos_horiz_accuracy)},           \
          {"pos_vert_accuracy",                                                 \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           36,                                                                  \
           offsetof(mavlink_estimator_status_t, pos_vert_accuracy)},            \
    }                                                                           \
  }
#else
#define MAVLINK_MESSAGE_INFO_ESTIMATOR_STATUS                                   \
 ...
 * @param pos_horiz_accuracy [m] Horizontal position 1-STD accuracy relative to
 * the EKF local origin
 * @param pos_vert_accuracy [m] Vertical position 1-STD accuracy relative to the
 * EKF local origin
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_estimator_status_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint64_t time_usec, uint16_t flags, float vel_ratio, float pos_horiz_ratio,
    float pos_vert_ratio, float mag_ratio, float hagl_ratio, float tas_ratio,
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_ESTIMATOR_STATUS_MIN_LEN,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_estimator_status_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint64_t time_usec, uint16_t flags, float vel_ratio,
 ...
 */
static inline uint16_t mavlink_msg_estimator_status_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_estimator_status_t* estimator_status) {
  return mavlink_msg_estimator_status_pack(
      system_id, component_id, msg, estimator_status->time_usec,
      estimator_status->flags, estimator_status->vel_ratio,
      estimator_status->pos_horiz_ratio, estimator_status->pos_vert_ratio,
      estimator_status->mag_ratio, estimator_status->hagl_ratio,
      estimator_status->tas_ratio, estimator_status->pos_horiz_accuracy,
 ...
 * @param estimator_status C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_estimator_status_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_estimator_status_t* estimator_status) {
  return mavlink_msg_estimator_status_pack_chan(
      system_id, component_id, chan, msg, estimator_status->time_usec,
      estimator_status->flags, estimator_status->vel_ratio,
      estimator_status->pos_horiz_ratio, estimator_status->pos_vert_ratio,
      estimator_status->mag_ratio, estimator_status->hagl_ratio,
      estimator_status->tas_ratio, estimator_status->pos_horiz_accuracy,
...
static inline void mavlink_msg_estimator_status_send(
    mavlink_channel_t chan, uint64_t time_usec, uint16_t flags, float vel_ratio,
    float pos_horiz_ratio, float pos_vert_ratio, float mag_ratio,
    float hagl_ratio, float tas_ratio, float pos_horiz_accuracy,
    float pos_vert_accuracy) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ESTIMATOR_STATUS, buf,
                                  MAVLINK_MSG_ID_ESTIMATOR_STATUS_MIN_LEN,
                                  MAVLINK_MSG_ID_ESTIMATOR_STATUS_LEN,
                                  MAVLINK_MSG_ID_ESTIMATOR_STATUS_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ESTIMATOR_STATUS, (const char*)&packet,
      MAVLINK_MSG_ID_ESTIMATOR_STATUS_MIN_LEN,
      MAVLINK_MSG_ID_ESTIMATOR_STATUS_LEN, MAVLINK_MSG_ID_ESTIMATOR_STATUS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_estimator_status_send_struct(
    mavlink_channel_t chan,
    const mavlink_estimator_status_t* estimator_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_estimator_status_send(
      chan, estimator_status->time_usec, estimator_status->flags,
      estimator_status->vel_ratio, estimator_status->pos_horiz_ratio,
      estimator_status->pos_vert_ratio, estimator_status->mag_ratio,
      estimator_status->hagl_ratio, estimator_status->tas_ratio,
      estimator_status->pos_horiz_accuracy,
      estimator_status->pos_vert_accuracy);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ESTIMATOR_STATUS, (const char*)estimator_status,
      MAVLINK_MSG_ID_ESTIMATOR_STATUS_MIN_LEN,
      MAVLINK_MSG_ID_ESTIMATOR_STATUS_LEN, MAVLINK_MSG_ID_ESTIMATOR_STATUS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_estimator_status_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    uint16_t flags, float vel_ratio, float pos_horiz_ratio,
    float pos_vert_ratio, float mag_ratio, float hagl_ratio, float tas_ratio,
    float pos_horiz_accuracy, float pos_vert_accuracy) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_estimator_status_get_time_usec(
 ...
 */
static inline uint16_t mavlink_msg_estimator_status_get_flags(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_estimator_status_get_vel_ratio(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_estimator_status_get_pos_horiz_ratio(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_estimator_status_get_pos_vert_ratio(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_estimator_status_get_mag_ratio(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_estimator_status_get_hagl_ratio(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_estimator_status_get_tas_ratio(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [m] Horizontal position 1-STD accuracy relative to the EKF local
 * origin
 */
static inline float mavlink_msg_estimator_status_get_pos_horiz_accuracy(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_estimator_status_get_pos_vert_accuracy(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_estimator_status_decode(
    const mavlink_message_t* msg,
  ...
  estimator_status->pos_horiz_ratio =
      mavlink_msg_estimator_status_get_pos_horiz_ratio(msg);
  estimator_status->pos_vert_ratio =
      mavlink_msg_estimator_status_get_pos_vert_ratio(msg);
  estimator_status->mag_ratio = mavlink_msg_estimator_status_get_mag_ratio(msg);
  estimator_status->hagl_ratio =
      mavlink_msg_estimator_status_get_hagl_ratio(msg);
  estimator_status->tas_ratio = mavlink_msg_estimator_status_get_tas_ratio(msg);
  estimator_status->pos_horiz_accuracy =
      mavlink_msg_estimator_status_get_pos_horiz_accuracy(msg);
  estimator_status->pos_vert_accuracy =
      mavlink_msg_estimator_status_get_pos_vert_accuracy(msg);
  estimator_status->flags = mavlink_msg_estimator_status_get_flags(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_ESTIMATOR_STATUS_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_ESTIMATOR_STATUS_LEN;
