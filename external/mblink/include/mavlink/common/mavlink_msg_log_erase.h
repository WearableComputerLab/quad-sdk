...
MAVPACKED(typedef struct __mavlink_log_erase_t {
  ...
  {                                                          \
    121, "LOG_ERASE", 2, {                                   \
      {"target_system",                                      \
       ...
       0,                                                    \
       0,                                                    \
       offsetof(mavlink_log_erase_t, target_system)},        \
          {"target_component",                               \
           NULL,                                             \
           MAVLINK_TYPE_UINT8_T,                             \
           0,                                                \
           1,                                                \
           offsetof(mavlink_log_erase_t, target_component)}, \
    }                                                        \
  }
#else
#define MAVLINK_MESSAGE_INFO_LOG_ERASE                       \
 ...
 */
static inline uint16_t mavlink_msg_log_erase_pack(uint8_t system_id,
...
static inline uint16_t mavlink_msg_log_erase_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_LOG_ERASE_MIN_LEN,
      MAVLINK_MSG_ID_LOG_ERASE_LEN, MAVLINK_MSG_ID_LOG_ERASE_CRC);
}
...
static inline uint16_t mavlink_msg_log_erase_encode(
  ...
  return mavlink_msg_log_erase_pack(system_id, component_id, msg,
...
static inline void mavlink_msg_log_erase_send(mavlink_channel_t chan,
                                              uint8_t target_system,
                                              uint8_t target_component) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_LOG_ERASE_LEN];
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_ERASE, buf, MAVLINK_MSG_ID_LOG_ERASE_MIN_LEN,
      MAVLINK_MSG_ID_LOG_ERASE_LEN, MAVLINK_MSG_ID_LOG_ERASE_CRC);
#else
  mavlink_log_erase_t packet;
  packet.target_system = target_system;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_ERASE, (const char*)&packet,
      MAVLINK_MSG_ID_LOG_ERASE_MIN_LEN, MAVLINK_MSG_ID_LOG_ERASE_LEN,
 ...
 */
static inline void mavlink_msg_log_erase_send_struct(
    mavlink_channel_t chan, const mavlink_log_erase_t* log_erase) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_log_erase_send(chan, log_erase->target_system,
                             log_erase->target_component);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_ERASE, (const char*)log_erase,
      MAVLINK_MSG_ID_LOG_ERASE_MIN_LEN, MAVLINK_MSG_ID_LOG_ERASE_LEN,
      MAVLINK_MSG_ID_LOG_ERASE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_log_erase_send_buf(mavlink_message_t* msgbuf,
 ...
 * @return  System ID
 */
static inline uint8_t mavlink_msg_log_erase_get_target_system(
 ...
 * @return  Component ID
 */
static inline uint8_t mavlink_msg_log_erase_get_target_component(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_log_erase_decode(
    const mavlink_message_t* msg, mavlink_log_erase_t* log_erase) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_LOG_ERASE_LEN
                    ? msg->len
