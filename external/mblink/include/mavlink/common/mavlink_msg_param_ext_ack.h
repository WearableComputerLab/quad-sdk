...
MAVPACKED(typedef struct __mavlink_param_ext_ack_t {
  ...
  char param_value[128]; /*<  Parameter value (new value if PARAM_ACK_ACCEPTED,
  ...
  {                                                                              \
    324, "PARAM_EXT_ACK", 4, {                                                   \
      {"param_id", NULL, MAVLINK_TYPE_CHAR,                                      \
       16,         0,    offsetof(mavlink_param_ext_ack_t, param_id)},           \
          {"param_value", NULL, MAVLINK_TYPE_CHAR,                               \
           128,           16,   offsetof(mavlink_param_ext_ack_t, param_value)}, \
          {"param_type",                                                         \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT8_T,                                                 \
           0,                                                                    \
           144,                                                                  \
           offsetof(mavlink_param_ext_ack_t, param_type)},                       \
          {"param_result",                                                       \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT8_T,                                                 \
           0,                                                                    \
           145,                                                                  \
           offsetof(mavlink_param_ext_ack_t, param_result)},                     \
    }                                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_ACK                                       \
 ...
 * if the ID is stored as string
 * @param param_value  Parameter value (new value if PARAM_ACK_ACCEPTED, current
 * value otherwise)
 * @param param_type  Parameter type.
 * @param param_result  Result code.
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_param_ext_ack_pack(
  ...
  return mavlink_finalize_message(
      ...
      MAVLINK_MSG_ID_PARAM_EXT_ACK_LEN, MAVLINK_MSG_ID_PARAM_EXT_ACK_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_param_ext_ack_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_PARAM_EXT_ACK_MIN_LEN,
      MAVLINK_MSG_ID_PARAM_EXT_ACK_LEN, MAVLINK_MSG_ID_PARAM_EXT_ACK_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_param_ext_ack_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_param_ext_ack_t* param_ext_ack) {
  return mavlink_msg_param_ext_ack_pack(
      system_id, component_id, msg, param_ext_ack->param_id,
 ...
 * @param param_ext_ack C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_param_ext_ack_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_param_ext_ack_t* param_ext_ack) {
  return mavlink_msg_param_ext_ack_pack_chan(
      system_id, component_id, chan, msg, param_ext_ack->param_id,
      param_ext_ack->param_value, param_ext_ack->param_type,
      param_ext_ack->param_result);
}
...
static inline void mavlink_msg_param_ext_ack_send(mavlink_channel_t chan,
                                                  const char* param_id,
  ...
  _mav_put_char_array(buf, 0, param_id, 16);
  _mav_put_char_array(buf, 16, param_value, 128);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PARAM_EXT_ACK, buf,
 ...
 */
static inline void mavlink_msg_param_ext_ack_send_struct(
    mavlink_channel_t chan, const mavlink_param_ext_ack_t* param_ext_ack) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_param_ext_ack_send(
      chan, param_ext_ack->param_id, param_ext_ack->param_value,
      param_ext_ack->param_type, param_ext_ack->param_result);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_PARAM_EXT_ACK, (const char*)param_ext_ack,
      MAVLINK_MSG_ID_PARAM_EXT_ACK_MIN_LEN, MAVLINK_MSG_ID_PARAM_EXT_ACK_LEN,
      MAVLINK_MSG_ID_PARAM_EXT_ACK_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_param_ext_ack_send_buf(
 ...
 */
static inline uint16_t mavlink_msg_param_ext_ack_get_param_id(
 ...
 * otherwise)
 */
static inline uint16_t mavlink_msg_param_ext_ack_get_param_value(
 ...
 */
static inline uint8_t mavlink_msg_param_ext_ack_get_param_type(
 ...
 * @return  Result code.
 */
static inline uint8_t mavlink_msg_param_ext_ack_get_param_result(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_param_ext_ack_decode(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_PARAM_EXT_ACK_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_PARAM_EXT_ACK_LEN;
