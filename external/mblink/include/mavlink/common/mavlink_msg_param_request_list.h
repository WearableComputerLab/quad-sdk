...
MAVPACKED(typedef struct __mavlink_param_request_list_t {
...
#define MAVLINK_MESSAGE_INFO_PARAM_REQUEST_LIST                       \
  {                                                                   \
    21, "PARAM_REQUEST_LIST", 2, {                                    \
      {"target_system",                                               \
       NULL,                                                          \
       MAVLINK_TYPE_UINT8_T,                                          \
       0,                                                             \
       0,                                                             \
       offsetof(mavlink_param_request_list_t, target_system)},        \
          {"target_component",                                        \
           NULL,                                                      \
           MAVLINK_TYPE_UINT8_T,                                      \
           0,                                                         \
           1,                                                         \
           offsetof(mavlink_param_request_list_t, target_component)}, \
    }                                                                 \
  }
#else
#define MAVLINK_MESSAGE_INFO_PARAM_REQUEST_LIST                       \
  {                                                                   \
    "PARAM_REQUEST_LIST", 2, {                                        \
      {"target_system",                                               \
       NULL,                                                          \
       MAVLINK_TYPE_UINT8_T,                                          \
       0,                                                             \
...
static inline uint16_t mavlink_msg_param_request_list_encode(
  ...
  return mavlink_msg_param_request_list_pack(
      system_id, component_id, msg, param_request_list->target_system,
...
static inline uint16_t mavlink_msg_param_request_list_encode_chan(
  ...
  return mavlink_msg_param_request_list_pack_chan(
      system_id, component_id, chan, msg, param_request_list->target_system,
      param_request_list->target_component);
}
...
static inline void mavlink_msg_param_request_list_send(
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PARAM_REQUEST_LIST, buf,
                                  MAVLINK_MSG_ID_PARAM_REQUEST_LIST_MIN_LEN,
                                  MAVLINK_MSG_ID_PARAM_REQUEST_LIST_LEN,
                                  MAVLINK_MSG_ID_PARAM_REQUEST_LIST_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PARAM_REQUEST_LIST,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_PARAM_REQUEST_LIST_MIN_LEN,
                                  MAVLINK_MSG_ID_PARAM_REQUEST_LIST_LEN,
                                  MAVLINK_MSG_ID_PARAM_REQUEST_LIST_CRC);
 ...
 */
static inline void mavlink_msg_param_request_list_send_struct(
 ...
 */
static inline void mavlink_msg_param_request_list_send_buf(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_PARAM_REQUEST_LIST_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_PARAM_REQUEST_LIST_LEN;
