...
MAVPACKED(typedef struct __mavlink_uavcan_node_status_t {
...
#define MAVLINK_MESSAGE_INFO_UAVCAN_NODE_STATUS                                 \
  {                                                                             \
    310, "UAVCAN_NODE_STATUS", 6, {                                             \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                                \
       0,           0,    offsetof(mavlink_uavcan_node_status_t, time_usec)},   \
          {"uptime_sec",                                                        \
           NULL,                                                                \
           MAVLINK_TYPE_UINT32_T,                                               \
           0,                                                                   \
           8,                                                                   \
           offsetof(mavlink_uavcan_node_status_t, uptime_sec)},                 \
          {"health", NULL, MAVLINK_TYPE_UINT8_T,                                \
           0,        14,   offsetof(mavlink_uavcan_node_status_t, health)},     \
          {"mode", NULL, MAVLINK_TYPE_UINT8_T,                                  \
           0,      15,   offsetof(mavlink_uavcan_node_status_t, mode)},         \
          {"sub_mode", NULL, MAVLINK_TYPE_UINT8_T,                              \
           0,          16,   offsetof(mavlink_uavcan_node_status_t, sub_mode)}, \
          {"vendor_specific_status_code",                                       \
           NULL,                                                                \
           MAVLINK_TYPE_UINT16_T,                                               \
           0,                                                                   \
           12,                                                                  \
           offsetof(mavlink_uavcan_node_status_t,                               \
                    vendor_specific_status_code)},                              \
    }                                                                           \
  }
#else
 ...
 */
static inline uint16_t mavlink_msg_uavcan_node_status_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint64_t time_usec, uint32_t uptime_sec, uint8_t health, uint8_t mode,
    uint8_t sub_mode, uint16_t vendor_specific_status_code) {
 ...
 */
static inline uint16_t mavlink_msg_uavcan_node_status_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_uavcan_node_status_t* uavcan_node_status) {
  return mavlink_msg_uavcan_node_status_pack(
      system_id, component_id, msg, uavcan_node_status->time_usec,
      uavcan_node_status->uptime_sec, uavcan_node_status->health,
      uavcan_node_status->mode, uavcan_node_status->sub_mode,
 ...
 * @param uavcan_node_status C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_uavcan_node_status_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_uavcan_node_status_t* uavcan_node_status) {
  return mavlink_msg_uavcan_node_status_pack_chan(
      system_id, component_id, chan, msg, uavcan_node_status->time_usec,
      uavcan_node_status->uptime_sec, uavcan_node_status->health,
      uavcan_node_status->mode, uavcan_node_status->sub_mode,
      uavcan_node_status->vendor_specific_status_code);
}
...
static inline void mavlink_msg_uavcan_node_status_send(
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_UAVCAN_NODE_STATUS, buf,
                                  MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_MIN_LEN,
                                  MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_LEN,
                                  MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_UAVCAN_NODE_STATUS,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_MIN_LEN,
                                  MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_LEN,
                                  MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_CRC);
 ...
 */
static inline void mavlink_msg_uavcan_node_status_send_struct(
    mavlink_channel_t chan,
    const mavlink_uavcan_node_status_t* uavcan_node_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_uavcan_node_status_send(
      chan, uavcan_node_status->time_usec, uavcan_node_status->uptime_sec,
      uavcan_node_status->health, uavcan_node_status->mode,
      uavcan_node_status->sub_mode,
      uavcan_node_status->vendor_specific_status_code);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_UAVCAN_NODE_STATUS,
                                  (const char*)uavcan_node_status,
                                  MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_MIN_LEN,
                                  MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_LEN,
                                  MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_CRC);
#endif
 ...
 */
static inline void mavlink_msg_uavcan_node_status_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    uint32_t uptime_sec, uint8_t health, uint8_t mode, uint8_t sub_mode,
    uint16_t vendor_specific_status_code) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_uavcan_node_status_get_time_usec(
 ...
 */
static inline uint32_t mavlink_msg_uavcan_node_status_get_uptime_sec(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_uavcan_node_status_get_health(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_uavcan_node_status_get_mode(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_uavcan_node_status_get_sub_mode(
    const mavlink_message_t* msg) {
...
mavlink_msg_uavcan_node_status_get_vendor_specific_status_code(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_uavcan_node_status_decode(
    const mavlink_message_t* msg,
    mavlink_uavcan_node_status_t* uavcan_node_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  uavcan_node_status->time_usec =
      mavlink_msg_uavcan_node_status_get_time_usec(msg);
  uavcan_node_status->uptime_sec =
      mavlink_msg_uavcan_node_status_get_uptime_sec(msg);
  uavcan_node_status->vendor_specific_status_code =
      mavlink_msg_uavcan_node_status_get_vendor_specific_status_code(msg);
  ...
  uavcan_node_status->sub_mode =
      mavlink_msg_uavcan_node_status_get_sub_mode(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_LEN;
