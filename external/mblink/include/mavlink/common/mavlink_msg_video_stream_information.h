...
MAVPACKED(typedef struct __mavlink_video_stream_information_t {
  ...
  char uri[160]; /*<  Video stream URI (TCP or RTSP URI ground station should
                    connect to) or port number (UDP port ground station should
                    listen to).*/
})
...
#define MAVLINK_MESSAGE_INFO_VIDEO_STREAM_INFORMATION                           \
  {                                                                             \
    269, "VIDEO_STREAM_INFORMATION", 12, {                                      \
      {"stream_id",                                                             \
       NULL,                                                                    \
       MAVLINK_TYPE_UINT8_T,                                                    \
       0,                                                                       \
       18,                                                                      \
       offsetof(mavlink_video_stream_information_t, stream_id)},                \
          {"count", NULL, MAVLINK_TYPE_UINT8_T,                                 \
           0,       19,   offsetof(mavlink_video_stream_information_t, count)}, \
          {"type", NULL, MAVLINK_TYPE_UINT8_T,                                  \
           0,      20,   offsetof(mavlink_video_stream_information_t, type)},   \
          {"flags", NULL, MAVLINK_TYPE_UINT16_T,                                \
           0,       8,    offsetof(mavlink_video_stream_information_t, flags)}, \
          {"framerate",                                                         \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           0,                                                                   \
           offsetof(mavlink_video_stream_information_t, framerate)},            \
          {"resolution_h",                                                      \
           NULL,                                                                \
           MAVLINK_TYPE_UINT16_T,                                               \
           0,                                                                   \
           10,                                                                  \
           offsetof(mavlink_video_stream_information_t, resolution_h)},         \
          {"resolution_v",                                                      \
           NULL,                                                                \
           MAVLINK_TYPE_UINT16_T,                                               \
           0,                                                                   \
           12,                                                                  \
           offsetof(mavlink_video_stream_information_t, resolution_v)},         \
          {"bitrate",                                                           \
           NULL,                                                                \
           MAVLINK_TYPE_UINT32_T,                                               \
           0,                                                                   \
           4,                                                                   \
           offsetof(mavlink_video_stream_information_t, bitrate)},              \
          {"rotation",                                                          \
           NULL,                                                                \
           MAVLINK_TYPE_UINT16_T,                                               \
           0,                                                                   \
           14,                                                                  \
           offsetof(mavlink_video_stream_information_t, rotation)},             \
          {"hfov", NULL, MAVLINK_TYPE_UINT16_T,                                 \
           0,      16,   offsetof(mavlink_video_stream_information_t, hfov)},   \
          {"name", NULL, MAVLINK_TYPE_CHAR,                                     \
           32,     21,   offsetof(mavlink_video_stream_information_t, name)},   \
          {"uri", NULL, MAVLINK_TYPE_CHAR,                                      \
           160,   53,   offsetof(mavlink_video_stream_information_t, uri)},     \
    }                                                                           \
  }
#else
#define MAVLINK_MESSAGE_INFO_VIDEO_STREAM_INFORMATION                           \
  {                                                                             \
    "VIDEO_STREAM_INFORMATION", 12, {                                           \
      {"stream_id",                                                             \
       NULL,                                                                    \
       MAVLINK_TYPE_UINT8_T,                                                    \
       0,                                                                       \
 ...
 * @param uri  Video stream URI (TCP or RTSP URI ground station should connect
 * to) or port number (UDP port ground station should listen to).
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_video_stream_information_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint8_t stream_id, uint8_t count, uint8_t type, uint16_t flags,
    float framerate, uint16_t resolution_h, uint16_t resolution_v,
    uint32_t bitrate, uint16_t rotation, uint16_t hfov, const char* name,
    const char* uri) {
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_video_stream_information_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint8_t stream_id, uint8_t count, uint8_t type,
    uint16_t flags, float framerate, uint16_t resolution_h,
    uint16_t resolution_v, uint32_t bitrate, uint16_t rotation, uint16_t hfov,
 ...
 */
static inline uint16_t mavlink_msg_video_stream_information_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_video_stream_information_t* video_stream_information) {
  return mavlink_msg_video_stream_information_pack(
      system_id, component_id, msg, video_stream_information->stream_id,
      video_stream_information->count, video_stream_information->type,
      video_stream_information->flags, video_stream_information->framerate,
      video_stream_information->resolution_h,
      video_stream_information->resolution_v, video_stream_information->bitrate,
      video_stream_information->rotation, video_stream_information->hfov,
      video_stream_information->name, video_stream_information->uri);
}
 ...
 * @param video_stream_information C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_video_stream_information_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_video_stream_information_t* video_stream_information) {
  return mavlink_msg_video_stream_information_pack_chan(
      system_id, component_id, chan, msg, video_stream_information->stream_id,
      video_stream_information->count, video_stream_information->type,
      video_stream_information->flags, video_stream_information->framerate,
      video_stream_information->resolution_h,
      video_stream_information->resolution_v, video_stream_information->bitrate,
...
static inline void mavlink_msg_video_stream_information_send(
    mavlink_channel_t chan, uint8_t stream_id, uint8_t count, uint8_t type,
    uint16_t flags, float framerate, uint16_t resolution_h,
    uint16_t resolution_v, uint32_t bitrate, uint16_t rotation, uint16_t hfov,
    const char* name, const char* uri) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION, buf,
      MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION_MIN_LEN,
      MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION_LEN,
      MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION_CRC);
#else
  ...
  mav_array_memcpy(packet.uri, uri, sizeof(char) * 160);
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION, (const char*)&packet,
      MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION_MIN_LEN,
      MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION_LEN,
      MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION_CRC);
#endif
 ...
 */
static inline void mavlink_msg_video_stream_information_send_struct(
    mavlink_channel_t chan,
    const mavlink_video_stream_information_t* video_stream_information) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_video_stream_information_send(
      chan, video_stream_information->stream_id,
      video_stream_information->count, video_stream_information->type,
      video_stream_information->flags, video_stream_information->framerate,
      video_stream_information->resolution_h,
      video_stream_information->resolution_v, video_stream_information->bitrate,
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION,
 ...
 */
static inline void mavlink_msg_video_stream_information_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t stream_id,
    uint8_t count, uint8_t type, uint16_t flags, float framerate,
    uint16_t resolution_h, uint16_t resolution_v, uint32_t bitrate,
    uint16_t rotation, uint16_t hfov, const char* name, const char* uri) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  mavlink_video_stream_information_t* packet =
      (mavlink_video_stream_information_t*)msgbuf;
  packet->framerate = framerate;
  packet->bitrate = bitrate;
  packet->flags = flags;
  packet->resolution_h = resolution_h;
 ...
 */
static inline uint8_t mavlink_msg_video_stream_information_get_stream_id(
 ...
 */
static inline uint8_t mavlink_msg_video_stream_information_get_count(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_video_stream_information_get_type(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_video_stream_information_get_flags(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_video_stream_information_get_framerate(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_video_stream_information_get_resolution_h(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_video_stream_information_get_resolution_v(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_video_stream_information_get_bitrate(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_video_stream_information_get_rotation(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_video_stream_information_get_hfov(
    const mavlink_message_t* msg) {
 ...
 * @return  Stream name.
 */
static inline uint16_t mavlink_msg_video_stream_information_get_name(
 ...
 *
 * @return  Video stream URI (TCP or RTSP URI ground station should connect to)
 * or port number (UDP port ground station should listen to).
 */
static inline uint16_t mavlink_msg_video_stream_information_get_uri(
 ...
 */
static inline void mavlink_msg_video_stream_information_decode(
    const mavlink_message_t* msg,
  ...
  mavlink_msg_video_stream_information_get_name(msg,
                                                video_stream_information->name);
  mavlink_msg_video_stream_information_get_uri(msg,
                                               video_stream_information->uri);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION_LEN;
  memset(video_stream_information, 0,
         MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION_LEN);
