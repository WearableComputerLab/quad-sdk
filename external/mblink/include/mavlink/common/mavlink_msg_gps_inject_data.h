...
MAVPACKED(typedef struct __mavlink_gps_inject_data_t {
...
#define MAVLINK_MESSAGE_INFO_GPS_INJECT_DATA                         \
  {                                                                  \
    123, "GPS_INJECT_DATA", 4, {                                     \
      {"target_system",                                              \
       NULL,                                                         \
       MAVLINK_TYPE_UINT8_T,                                         \
       0,                                                            \
       0,                                                            \
       offsetof(mavlink_gps_inject_data_t, target_system)},          \
          {"target_component",                                       \
           NULL,                                                     \
           MAVLINK_TYPE_UINT8_T,                                     \
           0,                                                        \
           1,                                                        \
           offsetof(mavlink_gps_inject_data_t, target_component)},   \
          {"len", NULL, MAVLINK_TYPE_UINT8_T,                        \
           0,     2,    offsetof(mavlink_gps_inject_data_t, len)},   \
          {"data", NULL, MAVLINK_TYPE_UINT8_T,                       \
           110,    3,    offsetof(mavlink_gps_inject_data_t, data)}, \
    }                                                                \
  }
#else
#define MAVLINK_MESSAGE_INFO_GPS_INJECT_DATA                         \
...
static inline uint16_t mavlink_msg_gps_inject_data_pack(
  ...
  return mavlink_finalize_message(
      ...
      MAVLINK_MSG_ID_GPS_INJECT_DATA_LEN, MAVLINK_MSG_ID_GPS_INJECT_DATA_CRC);
}
...
static inline uint16_t mavlink_msg_gps_inject_data_encode(
  ...
  return mavlink_msg_gps_inject_data_pack(
      system_id, component_id, msg, gps_inject_data->target_system,
...
static inline uint16_t mavlink_msg_gps_inject_data_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_gps_inject_data_t* gps_inject_data) {
  return mavlink_msg_gps_inject_data_pack_chan(
      system_id, component_id, chan, msg, gps_inject_data->target_system,
      gps_inject_data->target_component, gps_inject_data->len,
      gps_inject_data->data);
}
...
static inline void mavlink_msg_gps_inject_data_send(mavlink_channel_t chan,
  ...
  _mav_put_uint8_t(buf, 2, len);
  _mav_put_uint8_t_array(buf, 3, data, 110);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GPS_INJECT_DATA, buf,
                                  MAVLINK_MSG_ID_GPS_INJECT_DATA_MIN_LEN,
                                  MAVLINK_MSG_ID_GPS_INJECT_DATA_LEN,
                                  MAVLINK_MSG_ID_GPS_INJECT_DATA_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_INJECT_DATA, (const char*)&packet,
      MAVLINK_MSG_ID_GPS_INJECT_DATA_MIN_LEN,
      MAVLINK_MSG_ID_GPS_INJECT_DATA_LEN, MAVLINK_MSG_ID_GPS_INJECT_DATA_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_gps_inject_data_send_struct(
    mavlink_channel_t chan, const mavlink_gps_inject_data_t* gps_inject_data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_gps_inject_data_send(chan, gps_inject_data->target_system,
                                   gps_inject_data->target_component,
                                   gps_inject_data->len, gps_inject_data->data);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_INJECT_DATA, (const char*)gps_inject_data,
      MAVLINK_MSG_ID_GPS_INJECT_DATA_MIN_LEN,
      MAVLINK_MSG_ID_GPS_INJECT_DATA_LEN, MAVLINK_MSG_ID_GPS_INJECT_DATA_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_gps_inject_data_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system,
    uint8_t target_component, uint8_t len, const uint8_t* data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  System ID
 */
static inline uint8_t mavlink_msg_gps_inject_data_get_target_system(
 ...
 * @return  Component ID
 */
static inline uint8_t mavlink_msg_gps_inject_data_get_target_component(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_gps_inject_data_get_len(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_gps_inject_data_get_data(
 ...
 */
static inline void mavlink_msg_gps_inject_data_decode(
    const mavlink_message_t* msg, mavlink_gps_inject_data_t* gps_inject_data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
