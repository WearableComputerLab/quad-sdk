...
MAVPACKED(typedef struct __mavlink_debug_vect_t {
  ...
  {                                                                       \
    250, "DEBUG_VECT", 5, {                                               \
      {"name", NULL, MAVLINK_TYPE_CHAR,                                   \
       10,     20,   offsetof(mavlink_debug_vect_t, name)},               \
          {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                      \
           0,           0,    offsetof(mavlink_debug_vect_t, time_usec)}, \
          {"x", NULL, MAVLINK_TYPE_FLOAT,                                 \
           0,   8,    offsetof(mavlink_debug_vect_t, x)},                 \
          {"y", NULL, MAVLINK_TYPE_FLOAT,                                 \
           0,   12,   offsetof(mavlink_debug_vect_t, y)},                 \
          {"z", NULL, MAVLINK_TYPE_FLOAT,                                 \
           0,   16,   offsetof(mavlink_debug_vect_t, z)},                 \
    }                                                                     \
  }
#else
#define MAVLINK_MESSAGE_INFO_DEBUG_VECT                                   \
...
static inline uint16_t mavlink_msg_debug_vect_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_DEBUG_VECT_MIN_LEN,
...
static inline uint16_t mavlink_msg_debug_vect_pack_chan(
    ...
    mavlink_message_t* msg, const char* name, uint64_t time_usec, float x,
    float y, float z) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_DEBUG_VECT_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_DEBUG_VECT_MIN_LEN,
      MAVLINK_MSG_ID_DEBUG_VECT_LEN, MAVLINK_MSG_ID_DEBUG_VECT_CRC);
}
...
static inline uint16_t mavlink_msg_debug_vect_encode(
  ...
  return mavlink_msg_debug_vect_pack(
      system_id, component_id, msg, debug_vect->name, debug_vect->time_usec,
...
static inline uint16_t mavlink_msg_debug_vect_encode_chan(
  ...
  return mavlink_msg_debug_vect_pack_chan(
      system_id, component_id, chan, msg, debug_vect->name,
      debug_vect->time_usec, debug_vect->x, debug_vect->y, debug_vect->z);
}
...
static inline void mavlink_msg_debug_vect_send(mavlink_channel_t chan,
                                               const char* name,
                                               uint64_t time_usec, float x,
                                               float y, float z) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_DEBUG_VECT_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_DEBUG_VECT, buf, MAVLINK_MSG_ID_DEBUG_VECT_MIN_LEN,
      MAVLINK_MSG_ID_DEBUG_VECT_LEN, MAVLINK_MSG_ID_DEBUG_VECT_CRC);
#else
  mavlink_debug_vect_t packet;
  packet.time_usec = time_usec;
  ...
  mav_array_memcpy(packet.name, name, sizeof(char) * 10);
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_DEBUG_VECT, (const char*)&packet,
      MAVLINK_MSG_ID_DEBUG_VECT_MIN_LEN, MAVLINK_MSG_ID_DEBUG_VECT_LEN,
 ...
 */
static inline void mavlink_msg_debug_vect_send_struct(
    mavlink_channel_t chan, const mavlink_debug_vect_t* debug_vect) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_debug_vect_send(chan, debug_vect->name, debug_vect->time_usec,
                              debug_vect->x, debug_vect->y, debug_vect->z);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_DEBUG_VECT, (const char*)debug_vect,
      MAVLINK_MSG_ID_DEBUG_VECT_MIN_LEN, MAVLINK_MSG_ID_DEBUG_VECT_LEN,
      MAVLINK_MSG_ID_DEBUG_VECT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_debug_vect_send_buf(mavlink_message_t* msgbuf,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_DEBUG_VECT_LEN
                    ? msg->len
