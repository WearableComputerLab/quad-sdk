...
MAVPACKED(typedef struct __mavlink_param_ext_value_t {
  uint16_t param_count; /*<  Total number of parameters*/
  uint16_t param_index; /*<  Index of this parameter*/
  char param_id[16]; /*<  Parameter id, terminated by NULL if the length is less
                        than 16 human-readable chars and WITHOUT null
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_VALUE                             \
  {                                                                      \
    322, "PARAM_EXT_VALUE", 5, {                                         \
      {"param_id", NULL, MAVLINK_TYPE_CHAR,                              \
       16,         4,    offsetof(mavlink_param_ext_value_t, param_id)}, \
          {"param_value",                                                \
           NULL,                                                         \
           MAVLINK_TYPE_CHAR,                                            \
           128,                                                          \
           20,                                                           \
           offsetof(mavlink_param_ext_value_t, param_value)},            \
          {"param_type",                                                 \
           NULL,                                                         \
           MAVLINK_TYPE_UINT8_T,                                         \
           0,                                                            \
           148,                                                          \
           offsetof(mavlink_param_ext_value_t, param_type)},             \
          {"param_count",                                                \
           NULL,                                                         \
           MAVLINK_TYPE_UINT16_T,                                        \
           0,                                                            \
           0,                                                            \
           offsetof(mavlink_param_ext_value_t, param_count)},            \
          {"param_index",                                                \
           NULL,                                                         \
           MAVLINK_TYPE_UINT16_T,                                        \
           0,                                                            \
           2,                                                            \
           offsetof(mavlink_param_ext_value_t, param_index)},            \
    }                                                                    \
  }
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_VALUE                             \
 ...
 *
 * @param param_id  Parameter id, terminated by NULL if the length is less than
 ...
 */
static inline uint16_t mavlink_msg_param_ext_value_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_PARAM_EXT_VALUE_MIN_LEN,
      MAVLINK_MSG_ID_PARAM_EXT_VALUE_LEN, MAVLINK_MSG_ID_PARAM_EXT_VALUE_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_param_ext_value_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const char* param_id, const char* param_value,
 ...
 */
static inline uint16_t mavlink_msg_param_ext_value_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_param_ext_value_t* param_ext_value) {
  return mavlink_msg_param_ext_value_pack(
      system_id, component_id, msg, param_ext_value->param_id,
      param_ext_value->param_value, param_ext_value->param_type,
      param_ext_value->param_count, param_ext_value->param_index);
}
 ...
 * @param param_ext_value C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_param_ext_value_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_param_ext_value_t* param_ext_value) {
  return mavlink_msg_param_ext_value_pack_chan(
      system_id, component_id, chan, msg, param_ext_value->param_id,
      param_ext_value->param_value, param_ext_value->param_type,
      param_ext_value->param_count, param_ext_value->param_index);
}
...
static inline void mavlink_msg_param_ext_value_send(
    mavlink_channel_t chan, const char* param_id, const char* param_value,
    uint8_t param_type, uint16_t param_count, uint16_t param_index) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_PARAM_EXT_VALUE_LEN];
  _mav_put_uint16_t(buf, 0, param_count);
  ...
  _mav_put_char_array(buf, 4, param_id, 16);
  _mav_put_char_array(buf, 20, param_value, 128);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PARAM_EXT_VALUE, buf,
                                  MAVLINK_MSG_ID_PARAM_EXT_VALUE_MIN_LEN,
                                  MAVLINK_MSG_ID_PARAM_EXT_VALUE_LEN,
                                  MAVLINK_MSG_ID_PARAM_EXT_VALUE_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_PARAM_EXT_VALUE, (const char*)&packet,
      MAVLINK_MSG_ID_PARAM_EXT_VALUE_MIN_LEN,
      MAVLINK_MSG_ID_PARAM_EXT_VALUE_LEN, MAVLINK_MSG_ID_PARAM_EXT_VALUE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_param_ext_value_send_struct(
    mavlink_channel_t chan, const mavlink_param_ext_value_t* param_ext_value) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_param_ext_value_send(
      chan, param_ext_value->param_id, param_ext_value->param_value,
      param_ext_value->param_type, param_ext_value->param_count,
      param_ext_value->param_index);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_PARAM_EXT_VALUE, (const char*)param_ext_value,
      MAVLINK_MSG_ID_PARAM_EXT_VALUE_MIN_LEN,
      MAVLINK_MSG_ID_PARAM_EXT_VALUE_LEN, MAVLINK_MSG_ID_PARAM_EXT_VALUE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_param_ext_value_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, const char* param_id,
    const char* param_value, uint8_t param_type, uint16_t param_count,
 ...
 */
static inline uint16_t mavlink_msg_param_ext_value_get_param_id(
 ...
 */
static inline uint16_t mavlink_msg_param_ext_value_get_param_value(
    const mavlink_message_t* msg, char* param_value) {
 ...
 */
static inline uint8_t mavlink_msg_param_ext_value_get_param_type(
 ...
 */
static inline uint16_t mavlink_msg_param_ext_value_get_param_count(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_param_ext_value_get_param_index(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_param_ext_value_decode(
    const mavlink_message_t* msg, mavlink_param_ext_value_t* param_ext_value) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  param_ext_value->param_count =
      mavlink_msg_param_ext_value_get_param_count(msg);
  param_ext_value->param_index =
      mavlink_msg_param_ext_value_get_param_index(msg);
  mavlink_msg_param_ext_value_get_param_id(msg, param_ext_value->param_id);
  mavlink_msg_param_ext_value_get_param_value(msg,
                                              param_ext_value->param_value);
  param_ext_value->param_type = mavlink_msg_param_ext_value_get_param_type(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_PARAM_EXT_VALUE_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_PARAM_EXT_VALUE_LEN;
