...
MAVPACKED(typedef struct __mavlink_camera_settings_t {
...
#define MAVLINK_MESSAGE_INFO_CAMERA_SETTINGS                                   \
  {                                                                            \
    260, "CAMERA_SETTINGS", 4, {                                               \
      {"time_boot_ms",                                                         \
       NULL,                                                                   \
       MAVLINK_TYPE_UINT32_T,                                                  \
       0,                                                                      \
       0,                                                                      \
       offsetof(mavlink_camera_settings_t, time_boot_ms)},                     \
          {"mode_id", NULL, MAVLINK_TYPE_UINT8_T,                              \
           0,         4,    offsetof(mavlink_camera_settings_t, mode_id)},     \
          {"zoomLevel", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,           5,    offsetof(mavlink_camera_settings_t, zoomLevel)}, \
          {"focusLevel",                                                       \
           NULL,                                                               \
           MAVLINK_TYPE_FLOAT,                                                 \
           0,                                                                  \
           9,                                                                  \
           offsetof(mavlink_camera_settings_t, focusLevel)},                   \
    }                                                                          \
  }
#else
#define MAVLINK_MESSAGE_INFO_CAMERA_SETTINGS                                   \
 ...
 */
static inline uint16_t mavlink_msg_camera_settings_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_CAMERA_SETTINGS_MIN_LEN,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_camera_settings_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint32_t time_boot_ms, uint8_t mode_id,
    float zoomLevel, float focusLevel) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN];
  _mav_put_uint32_t(buf, 0, time_boot_ms);
  _mav_put_uint8_t(buf, 4, mode_id);
 ...
 */
static inline uint16_t mavlink_msg_camera_settings_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_camera_settings_t* camera_settings) {
  return mavlink_msg_camera_settings_pack(
      system_id, component_id, msg, camera_settings->time_boot_ms,
      camera_settings->mode_id, camera_settings->zoomLevel,
 ...
 * @param camera_settings C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_camera_settings_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_camera_settings_t* camera_settings) {
  return mavlink_msg_camera_settings_pack_chan(
      system_id, component_id, chan, msg, camera_settings->time_boot_ms,
      camera_settings->mode_id, camera_settings->zoomLevel,
      camera_settings->focusLevel);
}
...
static inline void mavlink_msg_camera_settings_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CAMERA_SETTINGS, buf,
                                  MAVLINK_MSG_ID_CAMERA_SETTINGS_MIN_LEN,
                                  MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN,
                                  MAVLINK_MSG_ID_CAMERA_SETTINGS_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_CAMERA_SETTINGS, (const char*)&packet,
      MAVLINK_MSG_ID_CAMERA_SETTINGS_MIN_LEN,
      MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN, MAVLINK_MSG_ID_CAMERA_SETTINGS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_camera_settings_send_struct(
    mavlink_channel_t chan, const mavlink_camera_settings_t* camera_settings) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_camera_settings_send(
      chan, camera_settings->time_boot_ms, camera_settings->mode_id,
      camera_settings->zoomLevel, camera_settings->focusLevel);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_CAMERA_SETTINGS, (const char*)camera_settings,
      MAVLINK_MSG_ID_CAMERA_SETTINGS_MIN_LEN,
      MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN, MAVLINK_MSG_ID_CAMERA_SETTINGS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_camera_settings_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint32_t time_boot_ms,
    uint8_t mode_id, float zoomLevel, float focusLevel) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint32_t mavlink_msg_camera_settings_get_time_boot_ms(
 ...
 * @return  Camera mode
 */
static inline uint8_t mavlink_msg_camera_settings_get_mode_id(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_camera_settings_get_zoomLevel(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_camera_settings_get_focusLevel(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_camera_settings_decode(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN;
