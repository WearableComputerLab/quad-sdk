...
MAVPACKED(typedef struct __mavlink_terrain_request_t {
...
#define MAVLINK_MESSAGE_INFO_TERRAIN_REQUEST                             \
  {                                                                      \
    133, "TERRAIN_REQUEST", 4, {                                         \
      {"lat", NULL, MAVLINK_TYPE_INT32_T,                                \
       0,     8,    offsetof(mavlink_terrain_request_t, lat)},           \
          {"lon", NULL, MAVLINK_TYPE_INT32_T,                            \
           0,     12,   offsetof(mavlink_terrain_request_t, lon)},       \
          {"grid_spacing",                                               \
           NULL,                                                         \
           MAVLINK_TYPE_UINT16_T,                                        \
           0,                                                            \
           16,                                                           \
           offsetof(mavlink_terrain_request_t, grid_spacing)},           \
          {"mask", "0x%07x", MAVLINK_TYPE_UINT64_T,                      \
           0,      0,        offsetof(mavlink_terrain_request_t, mask)}, \
    }                                                                    \
  }
#else
#define MAVLINK_MESSAGE_INFO_TERRAIN_REQUEST                             \
 ...
 * @param mask  Bitmask of requested 4x4 grids (row major 8x7 array of grids, 56
 * bits)
...
static inline uint16_t mavlink_msg_terrain_request_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_TERRAIN_REQUEST_MIN_LEN,
...
static inline uint16_t mavlink_msg_terrain_request_pack_chan(
    ...
    mavlink_message_t* msg, int32_t lat, int32_t lon, uint16_t grid_spacing,
    uint64_t mask) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_TERRAIN_REQUEST_LEN];
  _mav_put_uint64_t(buf, 0, mask);
...
static inline uint16_t mavlink_msg_terrain_request_encode(
  ...
  return mavlink_msg_terrain_request_pack(
      system_id, component_id, msg, terrain_request->lat, terrain_request->lon,
      terrain_request->grid_spacing, terrain_request->mask);
}
...
static inline uint16_t mavlink_msg_terrain_request_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_terrain_request_t* terrain_request) {
  return mavlink_msg_terrain_request_pack_chan(
      system_id, component_id, chan, msg, terrain_request->lat,
...
static inline void mavlink_msg_terrain_request_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TERRAIN_REQUEST, buf,
                                  MAVLINK_MSG_ID_TERRAIN_REQUEST_MIN_LEN,
                                  MAVLINK_MSG_ID_TERRAIN_REQUEST_LEN,
                                  MAVLINK_MSG_ID_TERRAIN_REQUEST_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_TERRAIN_REQUEST, (const char*)&packet,
      MAVLINK_MSG_ID_TERRAIN_REQUEST_MIN_LEN,
      MAVLINK_MSG_ID_TERRAIN_REQUEST_LEN, MAVLINK_MSG_ID_TERRAIN_REQUEST_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_terrain_request_send_struct(
    mavlink_channel_t chan, const mavlink_terrain_request_t* terrain_request) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_terrain_request_send(
      chan, terrain_request->lat, terrain_request->lon,
      terrain_request->grid_spacing, terrain_request->mask);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_TERRAIN_REQUEST, (const char*)terrain_request,
      MAVLINK_MSG_ID_TERRAIN_REQUEST_MIN_LEN,
      MAVLINK_MSG_ID_TERRAIN_REQUEST_LEN, MAVLINK_MSG_ID_TERRAIN_REQUEST_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_terrain_request_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, int32_t lat, int32_t lon,
    uint16_t grid_spacing, uint64_t mask) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline int32_t mavlink_msg_terrain_request_get_lat(
 ...
 */
static inline int32_t mavlink_msg_terrain_request_get_lon(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_terrain_request_get_grid_spacing(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Bitmask of requested 4x4 grids (row major 8x7 array of grids, 56
 * bits)
 */
static inline uint64_t mavlink_msg_terrain_request_get_mask(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_terrain_request_decode(
    const mavlink_message_t* msg, mavlink_terrain_request_t* terrain_request) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_TERRAIN_REQUEST_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_TERRAIN_REQUEST_LEN;
