...
MAVPACKED(typedef struct __mavlink_log_entry_t {
  uint32_t
      time_utc; /*< [s] UTC timestamp of log since 1970, or 0 if not available*/
  ...
  {                                                                    \
    118, "LOG_ENTRY", 5, {                                             \
      {"id", NULL, MAVLINK_TYPE_UINT16_T,                              \
       0,    8,    offsetof(mavlink_log_entry_t, id)},                 \
          {"num_logs", NULL, MAVLINK_TYPE_UINT16_T,                    \
           0,          10,   offsetof(mavlink_log_entry_t, num_logs)}, \
          {"last_log_num",                                             \
           NULL,                                                       \
           MAVLINK_TYPE_UINT16_T,                                      \
           0,                                                          \
           12,                                                         \
           offsetof(mavlink_log_entry_t, last_log_num)},               \
          {"time_utc", NULL, MAVLINK_TYPE_UINT32_T,                    \
           0,          0,    offsetof(mavlink_log_entry_t, time_utc)}, \
          {"size", NULL, MAVLINK_TYPE_UINT32_T,                        \
           0,      4,    offsetof(mavlink_log_entry_t, size)},         \
    }                                                                  \
  }
#else
#define MAVLINK_MESSAGE_INFO_LOG_ENTRY                                 \
...
static inline uint16_t mavlink_msg_log_entry_pack_chan(
    ...
    mavlink_message_t* msg, uint16_t id, uint16_t num_logs,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_LOG_ENTRY_MIN_LEN,
      MAVLINK_MSG_ID_LOG_ENTRY_LEN, MAVLINK_MSG_ID_LOG_ENTRY_CRC);
}
...
static inline uint16_t mavlink_msg_log_entry_encode(
  ...
  return mavlink_msg_log_entry_pack(
      system_id, component_id, msg, log_entry->id, log_entry->num_logs,
      log_entry->last_log_num, log_entry->time_utc, log_entry->size);
}
...
static inline uint16_t mavlink_msg_log_entry_encode_chan(
  ...
  return mavlink_msg_log_entry_pack_chan(
      system_id, component_id, chan, msg, log_entry->id, log_entry->num_logs,
      log_entry->last_log_num, log_entry->time_utc, log_entry->size);
}
...
static inline void mavlink_msg_log_entry_send(mavlink_channel_t chan,
                                              uint16_t id, uint16_t num_logs,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_ENTRY, buf, MAVLINK_MSG_ID_LOG_ENTRY_MIN_LEN,
      MAVLINK_MSG_ID_LOG_ENTRY_LEN, MAVLINK_MSG_ID_LOG_ENTRY_CRC);
#else
  mavlink_log_entry_t packet;
  packet.time_utc = time_utc;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_ENTRY, (const char*)&packet,
      MAVLINK_MSG_ID_LOG_ENTRY_MIN_LEN, MAVLINK_MSG_ID_LOG_ENTRY_LEN,
 ...
 */
static inline void mavlink_msg_log_entry_send_struct(
    mavlink_channel_t chan, const mavlink_log_entry_t* log_entry) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_log_entry_send(chan, log_entry->id, log_entry->num_logs,
                             log_entry->last_log_num, log_entry->time_utc,
                             log_entry->size);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_ENTRY, (const char*)log_entry,
      MAVLINK_MSG_ID_LOG_ENTRY_MIN_LEN, MAVLINK_MSG_ID_LOG_ENTRY_LEN,
      MAVLINK_MSG_ID_LOG_ENTRY_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_log_entry_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint16_t id,
    uint16_t num_logs, uint16_t last_log_num, uint32_t time_utc,
    uint32_t size) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  Log id
 */
static inline uint16_t mavlink_msg_log_entry_get_id(
 ...
 */
static inline uint16_t mavlink_msg_log_entry_get_num_logs(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_log_entry_get_last_log_num(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_log_entry_get_time_utc(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_log_entry_get_size(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_log_entry_decode(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_LOG_ENTRY_LEN
                    ? msg->len
