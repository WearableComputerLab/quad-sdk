...
MAVPACKED(typedef struct __mavlink_utm_global_position_t {
  uint64_t time; /*< [us] Time of applicability of position (microseconds since
                    UNIX epoch).*/
  ...
  uint16_t
      h_acc; /*< [mm] Horizontal position uncertainty (standard deviation)*/
  uint16_t v_acc;       /*< [mm] Altitude uncertainty (standard deviation)*/
  uint16_t vel_acc;     /*< [cm/s] Speed uncertainty (standard deviation)*/
  uint16_t update_rate; /*< [cs] Time until next update. Set to 0 if unknown or
                           in data driven mode.*/
...
#define MAVLINK_MESSAGE_INFO_UTM_GLOBAL_POSITION                                 \
  {                                                                              \
    340, "UTM_GLOBAL_POSITION", 18, {                                            \
      {"time", NULL, MAVLINK_TYPE_UINT64_T,                                      \
       0,      0,    offsetof(mavlink_utm_global_position_t, time)},             \
          {"uas_id", NULL, MAVLINK_TYPE_UINT8_T,                                 \
           18,       50,   offsetof(mavlink_utm_global_position_t, uas_id)},     \
          {"lat", NULL, MAVLINK_TYPE_INT32_T,                                    \
           0,     8,    offsetof(mavlink_utm_global_position_t, lat)},           \
          {"lon", NULL, MAVLINK_TYPE_INT32_T,                                    \
           0,     12,   offsetof(mavlink_utm_global_position_t, lon)},           \
          {"alt", NULL, MAVLINK_TYPE_INT32_T,                                    \
           0,     16,   offsetof(mavlink_utm_global_position_t, alt)},           \
          {"relative_alt",                                                       \
           NULL,                                                                 \
           MAVLINK_TYPE_INT32_T,                                                 \
           0,                                                                    \
           20,                                                                   \
           offsetof(mavlink_utm_global_position_t, relative_alt)},               \
          {"vx", NULL, MAVLINK_TYPE_INT16_T,                                     \
           0,    36,   offsetof(mavlink_utm_global_position_t, vx)},             \
          {"vy", NULL, MAVLINK_TYPE_INT16_T,                                     \
           0,    38,   offsetof(mavlink_utm_global_position_t, vy)},             \
          {"vz", NULL, MAVLINK_TYPE_INT16_T,                                     \
           0,    40,   offsetof(mavlink_utm_global_position_t, vz)},             \
          {"h_acc", NULL, MAVLINK_TYPE_UINT16_T,                                 \
           0,       42,   offsetof(mavlink_utm_global_position_t, h_acc)},       \
          {"v_acc", NULL, MAVLINK_TYPE_UINT16_T,                                 \
           0,       44,   offsetof(mavlink_utm_global_position_t, v_acc)},       \
          {"vel_acc", NULL, MAVLINK_TYPE_UINT16_T,                               \
           0,         46,   offsetof(mavlink_utm_global_position_t, vel_acc)},   \
          {"next_lat", NULL, MAVLINK_TYPE_INT32_T,                               \
           0,          24,   offsetof(mavlink_utm_global_position_t, next_lat)}, \
          {"next_lon", NULL, MAVLINK_TYPE_INT32_T,                               \
           0,          28,   offsetof(mavlink_utm_global_position_t, next_lon)}, \
          {"next_alt", NULL, MAVLINK_TYPE_INT32_T,                               \
           0,          32,   offsetof(mavlink_utm_global_position_t, next_alt)}, \
          {"update_rate",                                                        \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT16_T,                                                \
           0,                                                                    \
           48,                                                                   \
           offsetof(mavlink_utm_global_position_t, update_rate)},                \
          {"flight_state",                                                       \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT8_T,                                                 \
           0,                                                                    \
           68,                                                                   \
           offsetof(mavlink_utm_global_position_t, flight_state)},               \
          {"flags", NULL, MAVLINK_TYPE_UINT8_T,                                  \
           0,       69,   offsetof(mavlink_utm_global_position_t, flags)},       \
    }                                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_UTM_GLOBAL_POSITION                                 \
  {                                                                              \
    "UTM_GLOBAL_POSITION", 18, {                                                 \
      {"time", NULL, MAVLINK_TYPE_UINT64_T,                                      \
       0,      0,    offsetof(mavlink_utm_global_position_t, time)},             \
          {"uas_id", NULL, MAVLINK_TYPE_UINT8_T,                                 \
           18,       50,   offsetof(mavlink_utm_global_position_t, uas_id)},     \
 ...
 * @param update_rate [cs] Time until next update. Set to 0 if unknown or in
 * data driven mode.
 * @param flight_state  Flight state
 * @param flags  Bitwise OR combination of the data available flags.
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_utm_global_position_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint64_t time, const uint8_t* uas_id, int32_t lat, int32_t lon, int32_t alt,
    int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint16_t h_acc,
    uint16_t v_acc, uint16_t vel_acc, int32_t next_lat, int32_t next_lon,
    int32_t next_alt, uint16_t update_rate, uint8_t flight_state,
    uint8_t flags) {
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_utm_global_position_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint64_t time, const uint8_t* uas_id, int32_t lat,
    int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy,
    int16_t vz, uint16_t h_acc, uint16_t v_acc, uint16_t vel_acc,
    int32_t next_lat, int32_t next_lon, int32_t next_alt, uint16_t update_rate,
 ...
 */
static inline uint16_t mavlink_msg_utm_global_position_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_utm_global_position_t* utm_global_position) {
  return mavlink_msg_utm_global_position_pack(
      system_id, component_id, msg, utm_global_position->time,
      utm_global_position->uas_id, utm_global_position->lat,
      utm_global_position->lon, utm_global_position->alt,
      utm_global_position->relative_alt, utm_global_position->vx,
      utm_global_position->vy, utm_global_position->vz,
      utm_global_position->h_acc, utm_global_position->v_acc,
      utm_global_position->vel_acc, utm_global_position->next_lat,
      utm_global_position->next_lon, utm_global_position->next_alt,
      utm_global_position->update_rate, utm_global_position->flight_state,
 ...
 * @param utm_global_position C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_utm_global_position_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_utm_global_position_t* utm_global_position) {
  return mavlink_msg_utm_global_position_pack_chan(
      system_id, component_id, chan, msg, utm_global_position->time,
      utm_global_position->uas_id, utm_global_position->lat,
      utm_global_position->lon, utm_global_position->alt,
      utm_global_position->relative_alt, utm_global_position->vx,
      utm_global_position->vy, utm_global_position->vz,
...
static inline void mavlink_msg_utm_global_position_send(
    mavlink_channel_t chan, uint64_t time, const uint8_t* uas_id, int32_t lat,
    int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy,
    int16_t vz, uint16_t h_acc, uint16_t v_acc, uint16_t vel_acc,
    int32_t next_lat, int32_t next_lon, int32_t next_alt, uint16_t update_rate,
    uint8_t flight_state, uint8_t flags) {
  ...
  _mav_put_uint8_t(buf, 69, flags);
  _mav_put_uint8_t_array(buf, 50, uas_id, 18);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_UTM_GLOBAL_POSITION, buf,
                                  MAVLINK_MSG_ID_UTM_GLOBAL_POSITION_MIN_LEN,
                                  MAVLINK_MSG_ID_UTM_GLOBAL_POSITION_LEN,
                                  MAVLINK_MSG_ID_UTM_GLOBAL_POSITION_CRC);
#else
  ...
  packet.flags = flags;
  mav_array_memcpy(packet.uas_id, uas_id, sizeof(uint8_t) * 18);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_UTM_GLOBAL_POSITION,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_UTM_GLOBAL_POSITION_MIN_LEN,
                                  MAVLINK_MSG_ID_UTM_GLOBAL_POSITION_LEN,
                                  MAVLINK_MSG_ID_UTM_GLOBAL_POSITION_CRC);
 ...
 */
static inline void mavlink_msg_utm_global_position_send_struct(
    mavlink_channel_t chan,
    const mavlink_utm_global_position_t* utm_global_position) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_utm_global_position_send(
      chan, utm_global_position->time, utm_global_position->uas_id,
      utm_global_position->lat, utm_global_position->lon,
      utm_global_position->alt, utm_global_position->relative_alt,
      utm_global_position->vx, utm_global_position->vy, utm_global_position->vz,
      utm_global_position->h_acc, utm_global_position->v_acc,
      utm_global_position->vel_acc, utm_global_position->next_lat,
      utm_global_position->next_lon, utm_global_position->next_alt,
      utm_global_position->update_rate, utm_global_position->flight_state,
 ...
 */
static inline void mavlink_msg_utm_global_position_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time,
    const uint8_t* uas_id, int32_t lat, int32_t lon, int32_t alt,
    int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint16_t h_acc,
    uint16_t v_acc, uint16_t vel_acc, int32_t next_lat, int32_t next_lon,
    int32_t next_alt, uint16_t update_rate, uint8_t flight_state,
    uint8_t flags) {
...
#else
  mavlink_utm_global_position_t* packet =
      (mavlink_utm_global_position_t*)msgbuf;
  packet->time = time;
  packet->lat = lat;
  packet->lon = lon;
  packet->alt = alt;
 ...
 * epoch).
 */
static inline uint64_t mavlink_msg_utm_global_position_get_time(
 ...
 */
static inline uint16_t mavlink_msg_utm_global_position_get_uas_id(
    const mavlink_message_t* msg, uint8_t* uas_id) {
 ...
 */
static inline int32_t mavlink_msg_utm_global_position_get_lat(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_utm_global_position_get_lon(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_utm_global_position_get_relative_alt(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_utm_global_position_get_vx(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_utm_global_position_get_vy(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_utm_global_position_get_vz(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_utm_global_position_get_h_acc(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_utm_global_position_get_v_acc(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_utm_global_position_get_vel_acc(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_utm_global_position_get_next_lat(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_utm_global_position_get_next_lon(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_utm_global_position_get_next_alt(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [cs] Time until next update. Set to 0 if unknown or in data driven
 * mode.
 */
static inline uint16_t mavlink_msg_utm_global_position_get_update_rate(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_utm_global_position_get_flags(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_utm_global_position_decode(
    const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_UTM_GLOBAL_POSITION_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_UTM_GLOBAL_POSITION_LEN;
