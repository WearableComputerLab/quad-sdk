...
MAVPACKED(typedef struct __mavlink_safety_set_allowed_area_t {
  ...
  uint8_t frame; /*<  Coordinate frame. Can be either global, GPS, right-handed
...
#define MAVLINK_MESSAGE_INFO_SAFETY_SET_ALLOWED_AREA                           \
  {                                                                            \
    54, "SAFETY_SET_ALLOWED_AREA", 9, {                                        \
      {"target_system",                                                        \
       NULL,                                                                   \
       MAVLINK_TYPE_UINT8_T,                                                   \
       0,                                                                      \
       24,                                                                     \
       offsetof(mavlink_safety_set_allowed_area_t, target_system)},            \
          {"target_component",                                                 \
           NULL,                                                               \
           MAVLINK_TYPE_UINT8_T,                                               \
           0,                                                                  \
           25,                                                                 \
           offsetof(mavlink_safety_set_allowed_area_t, target_component)},     \
          {"frame", NULL, MAVLINK_TYPE_UINT8_T,                                \
           0,       26,   offsetof(mavlink_safety_set_allowed_area_t, frame)}, \
          {"p1x", NULL, MAVLINK_TYPE_FLOAT,                                    \
           0,     0,    offsetof(mavlink_safety_set_allowed_area_t, p1x)},     \
          {"p1y", NULL, MAVLINK_TYPE_FLOAT,                                    \
           0,     4,    offsetof(mavlink_safety_set_allowed_area_t, p1y)},     \
          {"p1z", NULL, MAVLINK_TYPE_FLOAT,                                    \
           0,     8,    offsetof(mavlink_safety_set_allowed_area_t, p1z)},     \
          {"p2x", NULL, MAVLINK_TYPE_FLOAT,                                    \
           0,     12,   offsetof(mavlink_safety_set_allowed_area_t, p2x)},     \
          {"p2y", NULL, MAVLINK_TYPE_FLOAT,                                    \
           0,     16,   offsetof(mavlink_safety_set_allowed_area_t, p2y)},     \
          {"p2z", NULL, MAVLINK_TYPE_FLOAT,                                    \
           0,     20,   offsetof(mavlink_safety_set_allowed_area_t, p2z)},     \
    }                                                                          \
  }
#else
#define MAVLINK_MESSAGE_INFO_SAFETY_SET_ALLOWED_AREA                           \
  {                                                                            \
    "SAFETY_SET_ALLOWED_AREA", 9, {                                            \
      {"target_system",                                                        \
       NULL,                                                                   \
       MAVLINK_TYPE_UINT8_T,                                                   \
       0,                                                                      \
 ...
 * @param frame  Coordinate frame. Can be either global, GPS, right-handed with
 * Z axis up or local, right handed, Z axis down.
...
static inline uint16_t mavlink_msg_safety_set_allowed_area_pack(
    ...
    uint8_t target_system, uint8_t target_component, uint8_t frame, float p1x,
...
static inline uint16_t mavlink_msg_safety_set_allowed_area_encode(
  ...
  return mavlink_msg_safety_set_allowed_area_pack(
      system_id, component_id, msg, safety_set_allowed_area->target_system,
      safety_set_allowed_area->target_component, safety_set_allowed_area->frame,
      safety_set_allowed_area->p1x, safety_set_allowed_area->p1y,
      safety_set_allowed_area->p1z, safety_set_allowed_area->p2x,
      safety_set_allowed_area->p2y, safety_set_allowed_area->p2z);
}
...
static inline void mavlink_msg_safety_set_allowed_area_send(
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA, buf,
      MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_MIN_LEN,
      MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_LEN,
      MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA, (const char*)&packet,
      MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_MIN_LEN,
      MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_LEN,
      MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_CRC);
#endif
 ...
 */
static inline void mavlink_msg_safety_set_allowed_area_send_struct(
    mavlink_channel_t chan,
    const mavlink_safety_set_allowed_area_t* safety_set_allowed_area) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_safety_set_allowed_area_send(
      chan, safety_set_allowed_area->target_system,
      safety_set_allowed_area->target_component, safety_set_allowed_area->frame,
      safety_set_allowed_area->p1x, safety_set_allowed_area->p1y,
      safety_set_allowed_area->p1z, safety_set_allowed_area->p2x,
      safety_set_allowed_area->p2y, safety_set_allowed_area->p2z);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA,
      (const char*)safety_set_allowed_area,
      MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_MIN_LEN,
      MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_LEN,
      MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_CRC);
#endif
 ...
 */
static inline void mavlink_msg_safety_set_allowed_area_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system,
    uint8_t target_component, uint8_t frame, float p1x, float p1y, float p1z,
...
#else
  mavlink_safety_set_allowed_area_t* packet =
      (mavlink_safety_set_allowed_area_t*)msgbuf;
  packet->p1x = p1x;
  packet->p1y = p1y;
  packet->p1z = p1z;
  packet->p2x = p2x;
 ...
 *
 * @return  Coordinate frame. Can be either global, GPS, right-handed with Z
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_LEN;
  memset(safety_set_allowed_area, 0,
         MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_LEN);
