...
MAVPACKED(typedef struct __mavlink_param_value_t {
  ...
  {                                                                  \
    22, "PARAM_VALUE", 5, {                                          \
      {"param_id", NULL, MAVLINK_TYPE_CHAR,                          \
       16,         8,    offsetof(mavlink_param_value_t, param_id)}, \
          {"param_value",                                            \
           NULL,                                                     \
           MAVLINK_TYPE_FLOAT,                                       \
           0,                                                        \
           0,                                                        \
           offsetof(mavlink_param_value_t, param_value)},            \
          {"param_type",                                             \
           NULL,                                                     \
           MAVLINK_TYPE_UINT8_T,                                     \
           0,                                                        \
           24,                                                       \
           offsetof(mavlink_param_value_t, param_type)},             \
          {"param_count",                                            \
           NULL,                                                     \
           MAVLINK_TYPE_UINT16_T,                                    \
           0,                                                        \
           4,                                                        \
           offsetof(mavlink_param_value_t, param_count)},            \
          {"param_index",                                            \
           NULL,                                                     \
           MAVLINK_TYPE_UINT16_T,                                    \
           0,                                                        \
           6,                                                        \
           offsetof(mavlink_param_value_t, param_index)},            \
    }                                                                \
  }
#else
#define MAVLINK_MESSAGE_INFO_PARAM_VALUE                             \
...
static inline uint16_t mavlink_msg_param_value_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_PARAM_VALUE_MIN_LEN,
...
static inline uint16_t mavlink_msg_param_value_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_PARAM_VALUE_MIN_LEN,
      MAVLINK_MSG_ID_PARAM_VALUE_LEN, MAVLINK_MSG_ID_PARAM_VALUE_CRC);
}
...
static inline uint16_t mavlink_msg_param_value_encode(
  ...
  return mavlink_msg_param_value_pack(
      system_id, component_id, msg, param_value->param_id,
...
static inline uint16_t mavlink_msg_param_value_encode_chan(
  ...
  return mavlink_msg_param_value_pack_chan(
      system_id, component_id, chan, msg, param_value->param_id,
      param_value->param_value, param_value->param_type,
      param_value->param_count, param_value->param_index);
}
...
static inline void mavlink_msg_param_value_send(
    mavlink_channel_t chan, const char* param_id, float param_value,
    uint8_t param_type, uint16_t param_count, uint16_t param_index) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_PARAM_VALUE_LEN];
  _mav_put_float(buf, 0, param_value);
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_PARAM_VALUE, buf, MAVLINK_MSG_ID_PARAM_VALUE_MIN_LEN,
      MAVLINK_MSG_ID_PARAM_VALUE_LEN, MAVLINK_MSG_ID_PARAM_VALUE_CRC);
#else
  mavlink_param_value_t packet;
  packet.param_value = param_value;
  ...
  mav_array_memcpy(packet.param_id, param_id, sizeof(char) * 16);
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_PARAM_VALUE, (const char*)&packet,
 ...
 */
static inline void mavlink_msg_param_value_send_struct(
    mavlink_channel_t chan, const mavlink_param_value_t* param_value) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_param_value_send(
      chan, param_value->param_id, param_value->param_value,
      param_value->param_type, param_value->param_count,
      param_value->param_index);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_PARAM_VALUE, (const char*)param_value,
      MAVLINK_MSG_ID_PARAM_VALUE_MIN_LEN, MAVLINK_MSG_ID_PARAM_VALUE_LEN,
      MAVLINK_MSG_ID_PARAM_VALUE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_param_value_send_buf(
 ...
 */
static inline void mavlink_msg_param_value_decode(
    const mavlink_message_t* msg, mavlink_param_value_t* param_value) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
