...
MAVPACKED(typedef struct __mavlink_set_attitude_target_t {
  ...
  float q[4]; /*<  Attitude quaternion (w, x, y, z order, zero-rotation is 1, 0,
                 0, 0)*/
...
#define MAVLINK_MESSAGE_INFO_SET_ATTITUDE_TARGET                             \
  {                                                                          \
    82, "SET_ATTITUDE_TARGET", 9, {                                          \
      {"time_boot_ms",                                                       \
       NULL,                                                                 \
       MAVLINK_TYPE_UINT32_T,                                                \
       0,                                                                    \
       0,                                                                    \
       offsetof(mavlink_set_attitude_target_t, time_boot_ms)},               \
          {"target_system",                                                  \
           NULL,                                                             \
           MAVLINK_TYPE_UINT8_T,                                             \
           0,                                                                \
           36,                                                               \
           offsetof(mavlink_set_attitude_target_t, target_system)},          \
          {"target_component",                                               \
           NULL,                                                             \
           MAVLINK_TYPE_UINT8_T,                                             \
           0,                                                                \
           37,                                                               \
           offsetof(mavlink_set_attitude_target_t, target_component)},       \
          {"type_mask",                                                      \
           NULL,                                                             \
           MAVLINK_TYPE_UINT8_T,                                             \
           0,                                                                \
           38,                                                               \
           offsetof(mavlink_set_attitude_target_t, type_mask)},              \
          {"q", NULL, MAVLINK_TYPE_FLOAT,                                    \
           4,   4,    offsetof(mavlink_set_attitude_target_t, q)},           \
          {"body_roll_rate",                                                 \
           NULL,                                                             \
           MAVLINK_TYPE_FLOAT,                                               \
           0,                                                                \
           20,                                                               \
           offsetof(mavlink_set_attitude_target_t, body_roll_rate)},         \
          {"body_pitch_rate",                                                \
           NULL,                                                             \
           MAVLINK_TYPE_FLOAT,                                               \
           0,                                                                \
           24,                                                               \
           offsetof(mavlink_set_attitude_target_t, body_pitch_rate)},        \
          {"body_yaw_rate",                                                  \
           NULL,                                                             \
           MAVLINK_TYPE_FLOAT,                                               \
           0,                                                                \
           28,                                                               \
           offsetof(mavlink_set_attitude_target_t, body_yaw_rate)},          \
          {"thrust", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,        32,   offsetof(mavlink_set_attitude_target_t, thrust)}, \
    }                                                                        \
  }
#else
#define MAVLINK_MESSAGE_INFO_SET_ATTITUDE_TARGET                             \
  {                                                                          \
    "SET_ATTITUDE_TARGET", 9, {                                              \
      {"time_boot_ms",                                                       \
       NULL,                                                                 \
       MAVLINK_TYPE_UINT32_T,                                                \
       0,                                                                    \
 ...
 * @param type_mask  Mappings: If any of these bits are set, the corresponding
 * input should be ignored: bit 1: body roll rate, bit 2: body pitch rate, bit
 * 3: body yaw rate. bit 4-bit 6: reserved, bit 7: throttle, bit 8: attitude
 ...
 * @param thrust  Collective thrust, normalized to 0 .. 1 (-1 .. 1 for vehicles
...
static inline uint16_t mavlink_msg_set_attitude_target_pack(
    ...
    uint8_t type_mask, const float* q, float body_roll_rate,
...
static inline uint16_t mavlink_msg_set_attitude_target_pack_chan(
    ...
    uint8_t target_component, uint8_t type_mask, const float* q,
...
static inline uint16_t mavlink_msg_set_attitude_target_encode(
  ...
  return mavlink_msg_set_attitude_target_pack(
      system_id, component_id, msg, set_attitude_target->time_boot_ms,
      set_attitude_target->target_system, set_attitude_target->target_component,
      set_attitude_target->type_mask, set_attitude_target->q,
      set_attitude_target->body_roll_rate, set_attitude_target->body_pitch_rate,
      set_attitude_target->body_yaw_rate, set_attitude_target->thrust);
}
...
static inline uint16_t mavlink_msg_set_attitude_target_encode_chan(
  ...
  return mavlink_msg_set_attitude_target_pack_chan(
      system_id, component_id, chan, msg, set_attitude_target->time_boot_ms,
      set_attitude_target->target_system, set_attitude_target->target_component,
      set_attitude_target->type_mask, set_attitude_target->q,
      set_attitude_target->body_roll_rate, set_attitude_target->body_pitch_rate,
      set_attitude_target->body_yaw_rate, set_attitude_target->thrust);
...
static inline void mavlink_msg_set_attitude_target_send(
  ...
  _mav_put_uint8_t(buf, 38, type_mask);
  _mav_put_float_array(buf, 4, q, 4);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_ATTITUDE_TARGET, buf,
                                  MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_MIN_LEN,
                                  MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_LEN,
                                  MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_CRC);
#else
  ...
  packet.type_mask = type_mask;
  mav_array_memcpy(packet.q, q, sizeof(float) * 4);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_ATTITUDE_TARGET,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_MIN_LEN,
                                  MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_LEN,
                                  MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_CRC);
 ...
 */
static inline void mavlink_msg_set_attitude_target_send_struct(
    mavlink_channel_t chan,
    const mavlink_set_attitude_target_t* set_attitude_target) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_set_attitude_target_send(
      chan, set_attitude_target->time_boot_ms,
      set_attitude_target->target_system, set_attitude_target->target_component,
      set_attitude_target->type_mask, set_attitude_target->q,
      set_attitude_target->body_roll_rate, set_attitude_target->body_pitch_rate,
      set_attitude_target->body_yaw_rate, set_attitude_target->thrust);
...
static inline void mavlink_msg_set_attitude_target_send_buf(
    ...
    uint8_t target_system, uint8_t target_component, uint8_t type_mask,
    const float* q, float body_roll_rate, float body_pitch_rate,
...
#else
  mavlink_set_attitude_target_t* packet =
      (mavlink_set_attitude_target_t*)msgbuf;
  packet->time_boot_ms = time_boot_ms;
  packet->body_roll_rate = body_roll_rate;
  packet->body_pitch_rate = body_pitch_rate;
  packet->body_yaw_rate = body_yaw_rate;
 ...
 */
static inline uint32_t mavlink_msg_set_attitude_target_get_time_boot_ms(
 ...
 * @return  System ID
 */
static inline uint8_t mavlink_msg_set_attitude_target_get_target_system(
    const mavlink_message_t* msg) {
 ...
 * @return  Component ID
 */
static inline uint8_t mavlink_msg_set_attitude_target_get_target_component(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Mappings: If any of these bits are set, the corresponding input
 * should be ignored: bit 1: body roll rate, bit 2: body pitch rate, bit 3: body
 * yaw rate. bit 4-bit 6: reserved, bit 7: throttle, bit 8: attitude
 */
static inline uint8_t mavlink_msg_set_attitude_target_get_type_mask(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_set_attitude_target_get_q(
 ...
 */
static inline float mavlink_msg_set_attitude_target_get_body_roll_rate(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_attitude_target_get_body_pitch_rate(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_attitude_target_get_body_yaw_rate(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Collective thrust, normalized to 0 .. 1 (-1 .. 1 for vehicles
 * capable of reverse trust)
 */
static inline float mavlink_msg_set_attitude_target_get_thrust(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_set_attitude_target_decode(
    const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_LEN;
