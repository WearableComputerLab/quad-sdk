...
MAVPACKED(typedef struct __mavlink_hil_state_t {
  ...
  {                                                                      \
    90, "HIL_STATE", 16, {                                               \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                         \
       0,           0,    offsetof(mavlink_hil_state_t, time_usec)},     \
          {"roll", NULL, MAVLINK_TYPE_FLOAT,                             \
           0,      8,    offsetof(mavlink_hil_state_t, roll)},           \
          {"pitch", NULL, MAVLINK_TYPE_FLOAT,                            \
           0,       12,   offsetof(mavlink_hil_state_t, pitch)},         \
          {"yaw", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,     16,   offsetof(mavlink_hil_state_t, yaw)},             \
          {"rollspeed", NULL, MAVLINK_TYPE_FLOAT,                        \
           0,           20,   offsetof(mavlink_hil_state_t, rollspeed)}, \
          {"pitchspeed",                                                 \
           NULL,                                                         \
           MAVLINK_TYPE_FLOAT,                                           \
           0,                                                            \
           24,                                                           \
           offsetof(mavlink_hil_state_t, pitchspeed)},                   \
          {"yawspeed", NULL, MAVLINK_TYPE_FLOAT,                         \
           0,          28,   offsetof(mavlink_hil_state_t, yawspeed)},   \
          {"lat", NULL, MAVLINK_TYPE_INT32_T,                            \
           0,     32,   offsetof(mavlink_hil_state_t, lat)},             \
          {"lon", NULL, MAVLINK_TYPE_INT32_T,                            \
           0,     36,   offsetof(mavlink_hil_state_t, lon)},             \
          {"alt", NULL, MAVLINK_TYPE_INT32_T,                            \
           0,     40,   offsetof(mavlink_hil_state_t, alt)},             \
          {"vx", NULL, MAVLINK_TYPE_INT16_T,                             \
           0,    44,   offsetof(mavlink_hil_state_t, vx)},               \
          {"vy", NULL, MAVLINK_TYPE_INT16_T,                             \
           0,    46,   offsetof(mavlink_hil_state_t, vy)},               \
          {"vz", NULL, MAVLINK_TYPE_INT16_T,                             \
           0,    48,   offsetof(mavlink_hil_state_t, vz)},               \
          {"xacc", NULL, MAVLINK_TYPE_INT16_T,                           \
           0,      50,   offsetof(mavlink_hil_state_t, xacc)},           \
          {"yacc", NULL, MAVLINK_TYPE_INT16_T,                           \
           0,      52,   offsetof(mavlink_hil_state_t, yacc)},           \
          {"zacc", NULL, MAVLINK_TYPE_INT16_T,                           \
           0,      54,   offsetof(mavlink_hil_state_t, zacc)},           \
    }                                                                    \
  }
#else
#define MAVLINK_MESSAGE_INFO_HIL_STATE                                   \
...
static inline uint16_t mavlink_msg_hil_state_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_HIL_STATE_MIN_LEN,
...
static inline uint16_t mavlink_msg_hil_state_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_usec, float roll, float pitch,
    float yaw, float rollspeed, float pitchspeed, float yawspeed, int32_t lat,
    int32_t lon, int32_t alt, int16_t vx, int16_t vy, int16_t vz, int16_t xacc,
    int16_t yacc, int16_t zacc) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_HIL_STATE_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  _mav_put_float(buf, 8, roll);
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_HIL_STATE_MIN_LEN,
      MAVLINK_MSG_ID_HIL_STATE_LEN, MAVLINK_MSG_ID_HIL_STATE_CRC);
}
...
static inline uint16_t mavlink_msg_hil_state_encode(
  ...
  return mavlink_msg_hil_state_pack(
      system_id, component_id, msg, hil_state->time_usec, hil_state->roll,
      hil_state->pitch, hil_state->yaw, hil_state->rollspeed,
      hil_state->pitchspeed, hil_state->yawspeed, hil_state->lat,
      hil_state->lon, hil_state->alt, hil_state->vx, hil_state->vy,
      hil_state->vz, hil_state->xacc, hil_state->yacc, hil_state->zacc);
}
...
static inline uint16_t mavlink_msg_hil_state_encode_chan(
  ...
  return mavlink_msg_hil_state_pack_chan(
      system_id, component_id, chan, msg, hil_state->time_usec, hil_state->roll,
      hil_state->pitch, hil_state->yaw, hil_state->rollspeed,
      hil_state->pitchspeed, hil_state->yawspeed, hil_state->lat,
      hil_state->lon, hil_state->alt, hil_state->vx, hil_state->vy,
      hil_state->vz, hil_state->xacc, hil_state->yacc, hil_state->zacc);
...
static inline void mavlink_msg_hil_state_send(
    mavlink_channel_t chan, uint64_t time_usec, float roll, float pitch,
    float yaw, float rollspeed, float pitchspeed, float yawspeed, int32_t lat,
    int32_t lon, int32_t alt, int16_t vx, int16_t vy, int16_t vz, int16_t xacc,
    int16_t yacc, int16_t zacc) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIL_STATE, buf, MAVLINK_MSG_ID_HIL_STATE_MIN_LEN,
      MAVLINK_MSG_ID_HIL_STATE_LEN, MAVLINK_MSG_ID_HIL_STATE_CRC);
#else
  mavlink_hil_state_t packet;
  packet.time_usec = time_usec;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIL_STATE, (const char*)&packet,
      MAVLINK_MSG_ID_HIL_STATE_MIN_LEN, MAVLINK_MSG_ID_HIL_STATE_LEN,
 ...
 */
static inline void mavlink_msg_hil_state_send_struct(
    mavlink_channel_t chan, const mavlink_hil_state_t* hil_state) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_hil_state_send(
      chan, hil_state->time_usec, hil_state->roll, hil_state->pitch,
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIL_STATE, (const char*)hil_state,
      MAVLINK_MSG_ID_HIL_STATE_MIN_LEN, MAVLINK_MSG_ID_HIL_STATE_LEN,
      MAVLINK_MSG_ID_HIL_STATE_CRC);
#endif
}
 ...
 */
static inline float mavlink_msg_hil_state_get_roll(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_state_get_yaw(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_hil_state_get_vx(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_hil_state_get_vy(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_hil_state_get_vz(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_hil_state_decode(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_HIL_STATE_LEN
                    ? msg->len
