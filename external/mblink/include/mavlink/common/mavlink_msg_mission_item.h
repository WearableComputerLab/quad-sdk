...
MAVPACKED(typedef struct __mavlink_mission_item_t {
  ...
  {                                                                     \
    39, "MISSION_ITEM", 15, {                                           \
      {"target_system",                                                 \
       ...
       0,                                                               \
       32,                                                              \
       offsetof(mavlink_mission_item_t, target_system)},                \
          {"target_component",                                          \
           NULL,                                                        \
           MAVLINK_TYPE_UINT8_T,                                        \
           0,                                                           \
           33,                                                          \
           offsetof(mavlink_mission_item_t, target_component)},         \
          {"seq", NULL, MAVLINK_TYPE_UINT16_T,                          \
           0,     28,   offsetof(mavlink_mission_item_t, seq)},         \
          {"frame", NULL, MAVLINK_TYPE_UINT8_T,                         \
           0,       34,   offsetof(mavlink_mission_item_t, frame)},     \
          {"command", NULL, MAVLINK_TYPE_UINT16_T,                      \
           0,         30,   offsetof(mavlink_mission_item_t, command)}, \
          {"current", NULL, MAVLINK_TYPE_UINT8_T,                       \
           0,         35,   offsetof(mavlink_mission_item_t, current)}, \
          {"autocontinue",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_UINT8_T,                                        \
           0,                                                           \
           36,                                                          \
           offsetof(mavlink_mission_item_t, autocontinue)},             \
          {"param1", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        0,    offsetof(mavlink_mission_item_t, param1)},   \
          {"param2", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        4,    offsetof(mavlink_mission_item_t, param2)},   \
          {"param3", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        8,    offsetof(mavlink_mission_item_t, param3)},   \
          {"param4", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        12,   offsetof(mavlink_mission_item_t, param4)},   \
          {"x", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,   16,   offsetof(mavlink_mission_item_t, x)},             \
          {"y", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,   20,   offsetof(mavlink_mission_item_t, y)},             \
          {"z", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,   24,   offsetof(mavlink_mission_item_t, z)},             \
          {"mission_type",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_UINT8_T,                                        \
           0,                                                           \
           37,                                                          \
           offsetof(mavlink_mission_item_t, mission_type)},             \
    }                                                                   \
  }
#else
#define MAVLINK_MESSAGE_INFO_MISSION_ITEM                               \
...
static inline uint16_t mavlink_msg_mission_item_pack(
    ...
    float param1, float param2, float param3, float param4, float x, float y,
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_MISSION_ITEM_MIN_LEN,
      MAVLINK_MSG_ID_MISSION_ITEM_LEN, MAVLINK_MSG_ID_MISSION_ITEM_CRC);
}
...
static inline uint16_t mavlink_msg_mission_item_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_MISSION_ITEM_MIN_LEN,
      MAVLINK_MSG_ID_MISSION_ITEM_LEN, MAVLINK_MSG_ID_MISSION_ITEM_CRC);
}
...
static inline uint16_t mavlink_msg_mission_item_encode(
  ...
  return mavlink_msg_mission_item_pack(
      system_id, component_id, msg, mission_item->target_system,
      mission_item->target_component, mission_item->seq, mission_item->frame,
      mission_item->command, mission_item->current, mission_item->autocontinue,
      mission_item->param1, mission_item->param2, mission_item->param3,
      mission_item->param4, mission_item->x, mission_item->y, mission_item->z,
...
static inline uint16_t mavlink_msg_mission_item_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_mission_item_t* mission_item) {
  return mavlink_msg_mission_item_pack_chan(
      system_id, component_id, chan, msg, mission_item->target_system,
      mission_item->target_component, mission_item->seq, mission_item->frame,
      mission_item->command, mission_item->current, mission_item->autocontinue,
      mission_item->param1, mission_item->param2, mission_item->param3,
      mission_item->param4, mission_item->x, mission_item->y, mission_item->z,
...
static inline void mavlink_msg_mission_item_send(
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_ITEM, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_MISSION_ITEM, (const char*)&packet,
      MAVLINK_MSG_ID_MISSION_ITEM_MIN_LEN, MAVLINK_MSG_ID_MISSION_ITEM_LEN,
      MAVLINK_MSG_ID_MISSION_ITEM_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_mission_item_send_struct(
    mavlink_channel_t chan, const mavlink_mission_item_t* mission_item) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_mission_item_send(
      chan, mission_item->target_system, mission_item->target_component,
      mission_item->seq, mission_item->frame, mission_item->command,
      mission_item->current, mission_item->autocontinue, mission_item->param1,
      mission_item->param2, mission_item->param3, mission_item->param4,
      mission_item->x, mission_item->y, mission_item->z,
      mission_item->mission_type);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_MISSION_ITEM, (const char*)mission_item,
      MAVLINK_MSG_ID_MISSION_ITEM_MIN_LEN, MAVLINK_MSG_ID_MISSION_ITEM_LEN,
      MAVLINK_MSG_ID_MISSION_ITEM_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_mission_item_send_buf(
 ...
 */
static inline float mavlink_msg_mission_item_get_x(
    const mavlink_message_t* msg) {
 ...
 * absolute, depending on frame).
 */
static inline float mavlink_msg_mission_item_get_z(
    const mavlink_message_t* msg) {
 ...
 * @return  Mission type.
 */
static inline uint8_t mavlink_msg_mission_item_get_mission_type(
    const mavlink_message_t* msg) {
...
static inline void mavlink_msg_mission_item_decode(
    const mavlink_message_t* msg, mavlink_mission_item_t* mission_item) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_MISSION_ITEM_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_MISSION_ITEM_LEN;
