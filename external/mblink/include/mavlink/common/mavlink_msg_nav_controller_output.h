...
MAVPACKED(typedef struct __mavlink_nav_controller_output_t {
...
#define MAVLINK_MESSAGE_INFO_NAV_CONTROLLER_OUTPUT                               \
  {                                                                              \
    62, "NAV_CONTROLLER_OUTPUT", 8, {                                            \
      {"nav_roll", NULL, MAVLINK_TYPE_FLOAT,                                     \
       0,          0,    offsetof(mavlink_nav_controller_output_t, nav_roll)},   \
          {"nav_pitch",                                                          \
           NULL,                                                                 \
           MAVLINK_TYPE_FLOAT,                                                   \
           0,                                                                    \
           4,                                                                    \
           offsetof(mavlink_nav_controller_output_t, nav_pitch)},                \
          {"nav_bearing",                                                        \
           NULL,                                                                 \
           MAVLINK_TYPE_INT16_T,                                                 \
           0,                                                                    \
           20,                                                                   \
           offsetof(mavlink_nav_controller_output_t, nav_bearing)},              \
          {"target_bearing",                                                     \
           NULL,                                                                 \
           MAVLINK_TYPE_INT16_T,                                                 \
           0,                                                                    \
           22,                                                                   \
           offsetof(mavlink_nav_controller_output_t, target_bearing)},           \
          {"wp_dist", NULL, MAVLINK_TYPE_UINT16_T,                               \
           0,         24,   offsetof(mavlink_nav_controller_output_t, wp_dist)}, \
          {"alt_error",                                                          \
           NULL,                                                                 \
           MAVLINK_TYPE_FLOAT,                                                   \
           0,                                                                    \
           8,                                                                    \
           offsetof(mavlink_nav_controller_output_t, alt_error)},                \
          {"aspd_error",                                                         \
           NULL,                                                                 \
           MAVLINK_TYPE_FLOAT,                                                   \
           0,                                                                    \
           12,                                                                   \
           offsetof(mavlink_nav_controller_output_t, aspd_error)},               \
          {"xtrack_error",                                                       \
           NULL,                                                                 \
           MAVLINK_TYPE_FLOAT,                                                   \
           0,                                                                    \
           16,                                                                   \
           offsetof(mavlink_nav_controller_output_t, xtrack_error)},             \
    }                                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_NAV_CONTROLLER_OUTPUT                               \
  {                                                                              \
    "NAV_CONTROLLER_OUTPUT", 8, {                                                \
      {"nav_roll", NULL, MAVLINK_TYPE_FLOAT,                                     \
       0,          0,    offsetof(mavlink_nav_controller_output_t, nav_roll)},   \
          {"nav_pitch",                                                          \
           NULL,                                                                 \
...
static inline uint16_t mavlink_msg_nav_controller_output_pack(
    ...
    int16_t target_bearing, uint16_t wp_dist, float alt_error, float aspd_error,
    float xtrack_error) {
...
static inline uint16_t mavlink_msg_nav_controller_output_encode(
  ...
  return mavlink_msg_nav_controller_output_pack(
      system_id, component_id, msg, nav_controller_output->nav_roll,
      nav_controller_output->nav_pitch, nav_controller_output->nav_bearing,
      nav_controller_output->target_bearing, nav_controller_output->wp_dist,
      nav_controller_output->alt_error, nav_controller_output->aspd_error,
...
static inline uint16_t mavlink_msg_nav_controller_output_encode_chan(
  ...
  return mavlink_msg_nav_controller_output_pack_chan(
      system_id, component_id, chan, msg, nav_controller_output->nav_roll,
      nav_controller_output->nav_pitch, nav_controller_output->nav_bearing,
      nav_controller_output->target_bearing, nav_controller_output->wp_dist,
      nav_controller_output->alt_error, nav_controller_output->aspd_error,
      nav_controller_output->xtrack_error);
...
static inline void mavlink_msg_nav_controller_output_send(
    mavlink_channel_t chan, float nav_roll, float nav_pitch,
    int16_t nav_bearing, int16_t target_bearing, uint16_t wp_dist,
    float alt_error, float aspd_error, float xtrack_error) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT_LEN];
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT,
                                  buf,
                                  MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT_MIN_LEN,
                                  MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT_LEN,
                                  MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT_CRC);
 ...
 */
static inline void mavlink_msg_nav_controller_output_send_struct(
    mavlink_channel_t chan,
    const mavlink_nav_controller_output_t* nav_controller_output) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_nav_controller_output_send(
      chan, nav_controller_output->nav_roll, nav_controller_output->nav_pitch,
      nav_controller_output->nav_bearing, nav_controller_output->target_bearing,
      nav_controller_output->wp_dist, nav_controller_output->alt_error,
      nav_controller_output->aspd_error, nav_controller_output->xtrack_error);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT,
 ...
 */
static inline void mavlink_msg_nav_controller_output_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, float nav_roll,
...
#else
  mavlink_nav_controller_output_t* packet =
      (mavlink_nav_controller_output_t*)msgbuf;
  packet->nav_roll = nav_roll;
  packet->nav_pitch = nav_pitch;
  packet->alt_error = alt_error;
  packet->aspd_error = aspd_error;
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT_LEN;
