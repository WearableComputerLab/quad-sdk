...
MAVPACKED(typedef struct __mavlink_logging_data_t {
  ...
  {                                                                       \
    266, "LOGGING_DATA", 6, {                                             \
      {"target_system",                                                   \
       ...
       0,                                                                 \
       2,                                                                 \
       offsetof(mavlink_logging_data_t, target_system)},                  \
          {"target_component",                                            \
           NULL,                                                          \
           MAVLINK_TYPE_UINT8_T,                                          \
           0,                                                             \
           3,                                                             \
           offsetof(mavlink_logging_data_t, target_component)},           \
          {"sequence", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,          0,    offsetof(mavlink_logging_data_t, sequence)}, \
          {"length", NULL, MAVLINK_TYPE_UINT8_T,                          \
           0,        4,    offsetof(mavlink_logging_data_t, length)},     \
          {"first_message_offset",                                        \
           NULL,                                                          \
           MAVLINK_TYPE_UINT8_T,                                          \
           0,                                                             \
           5,                                                             \
           offsetof(mavlink_logging_data_t, first_message_offset)},       \
          {"data", NULL, MAVLINK_TYPE_UINT8_T,                            \
           249,    6,    offsetof(mavlink_logging_data_t, data)},         \
    }                                                                     \
  }
#else
#define MAVLINK_MESSAGE_INFO_LOGGING_DATA                                 \
 ...
 */
static inline uint16_t mavlink_msg_logging_data_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_LOGGING_DATA_MIN_LEN,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_logging_data_pack_chan(
 ...
 */
static inline uint16_t mavlink_msg_logging_data_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_logging_data_t* logging_data) {
  return mavlink_msg_logging_data_pack(
      system_id, component_id, msg, logging_data->target_system,
 ...
 * @param logging_data C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_logging_data_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_logging_data_t* logging_data) {
  return mavlink_msg_logging_data_pack_chan(
      system_id, component_id, chan, msg, logging_data->target_system,
      logging_data->target_component, logging_data->sequence,
      logging_data->length, logging_data->first_message_offset,
      logging_data->data);
}
...
static inline void mavlink_msg_logging_data_send(
  ...
  _mav_put_uint8_t(buf, 5, first_message_offset);
  _mav_put_uint8_t_array(buf, 6, data, 249);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOGGING_DATA, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOGGING_DATA, (const char*)&packet,
      MAVLINK_MSG_ID_LOGGING_DATA_MIN_LEN, MAVLINK_MSG_ID_LOGGING_DATA_LEN,
      MAVLINK_MSG_ID_LOGGING_DATA_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_logging_data_send_struct(
    mavlink_channel_t chan, const mavlink_logging_data_t* logging_data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_logging_data_send(
      chan, logging_data->target_system, logging_data->target_component,
      logging_data->sequence, logging_data->length,
      logging_data->first_message_offset, logging_data->data);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOGGING_DATA, (const char*)logging_data,
      MAVLINK_MSG_ID_LOGGING_DATA_MIN_LEN, MAVLINK_MSG_ID_LOGGING_DATA_LEN,
      MAVLINK_MSG_ID_LOGGING_DATA_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_logging_data_send_buf(
 ...
 */
static inline uint8_t mavlink_msg_logging_data_get_target_system(
 ...
 */
static inline uint8_t mavlink_msg_logging_data_get_target_component(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_logging_data_get_sequence(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_logging_data_get_length(
    const mavlink_message_t* msg) {
 ...
 * exists).
 */
static inline uint8_t mavlink_msg_logging_data_get_first_message_offset(
    const mavlink_message_t* msg) {
 ...
 * @return  logged data
 */
static inline uint16_t mavlink_msg_logging_data_get_data(
 ...
 */
static inline void mavlink_msg_logging_data_decode(
    const mavlink_message_t* msg, mavlink_logging_data_t* logging_data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_LOGGING_DATA_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_LOGGING_DATA_LEN;
