...
MAVPACKED(typedef struct __mavlink_global_position_int_cov_t {
  ...
  float
      covariance[36];     /*<  Row-major representation of a 6x6 position and
                             velocity 6x6 cross-covariance matrix (states: lat, lon,
                             alt, vx, vy, vz; first six entries are the first ROW,
                             next six entries are the second row, etc.). If unknown,
...
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT_COV                       \
  {                                                                        \
    63, "GLOBAL_POSITION_INT_COV", 10, {                                   \
      {"time_usec",                                                        \
       NULL,                                                               \
       MAVLINK_TYPE_UINT64_T,                                              \
       0,                                                                  \
       0,                                                                  \
       offsetof(mavlink_global_position_int_cov_t, time_usec)},            \
          {"estimator_type",                                               \
           NULL,                                                           \
           MAVLINK_TYPE_UINT8_T,                                           \
           0,                                                              \
           180,                                                            \
           offsetof(mavlink_global_position_int_cov_t, estimator_type)},   \
          {"lat", NULL, MAVLINK_TYPE_INT32_T,                              \
           0,     8,    offsetof(mavlink_global_position_int_cov_t, lat)}, \
          {"lon", NULL, MAVLINK_TYPE_INT32_T,                              \
           0,     12,   offsetof(mavlink_global_position_int_cov_t, lon)}, \
          {"alt", NULL, MAVLINK_TYPE_INT32_T,                              \
           0,     16,   offsetof(mavlink_global_position_int_cov_t, alt)}, \
          {"relative_alt",                                                 \
           NULL,                                                           \
           MAVLINK_TYPE_INT32_T,                                           \
           0,                                                              \
           20,                                                             \
           offsetof(mavlink_global_position_int_cov_t, relative_alt)},     \
          {"vx", NULL, MAVLINK_TYPE_FLOAT,                                 \
           0,    24,   offsetof(mavlink_global_position_int_cov_t, vx)},   \
          {"vy", NULL, MAVLINK_TYPE_FLOAT,                                 \
           0,    28,   offsetof(mavlink_global_position_int_cov_t, vy)},   \
          {"vz", NULL, MAVLINK_TYPE_FLOAT,                                 \
           0,    32,   offsetof(mavlink_global_position_int_cov_t, vz)},   \
          {"covariance",                                                   \
           NULL,                                                           \
           MAVLINK_TYPE_FLOAT,                                             \
           36,                                                             \
           36,                                                             \
           offsetof(mavlink_global_position_int_cov_t, covariance)},       \
    }                                                                      \
  }
#else
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT_COV                       \
  {                                                                        \
    "GLOBAL_POSITION_INT_COV", 10, {                                       \
      {"time_usec",                                                        \
       NULL,                                                               \
       MAVLINK_TYPE_UINT64_T,                                              \
       0,                                                                  \
 ...
 * @param covariance  Row-major representation of a 6x6 position and velocity
 * 6x6 cross-covariance matrix (states: lat, lon, alt, vx, vy, vz; first six
...
static inline uint16_t mavlink_msg_global_position_int_cov_pack(
    ...
    uint64_t time_usec, uint8_t estimator_type, int32_t lat, int32_t lon,
    int32_t alt, int32_t relative_alt, float vx, float vy, float vz,
...
static inline uint16_t mavlink_msg_global_position_int_cov_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_usec, uint8_t estimator_type,
    int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, float vx,
...
static inline uint16_t mavlink_msg_global_position_int_cov_encode(
  ...
  return mavlink_msg_global_position_int_cov_pack(
      system_id, component_id, msg, global_position_int_cov->time_usec,
      global_position_int_cov->estimator_type, global_position_int_cov->lat,
      global_position_int_cov->lon, global_position_int_cov->alt,
      global_position_int_cov->relative_alt, global_position_int_cov->vx,
      global_position_int_cov->vy, global_position_int_cov->vz,
...
static inline uint16_t mavlink_msg_global_position_int_cov_encode_chan(
  ...
  return mavlink_msg_global_position_int_cov_pack_chan(
      system_id, component_id, chan, msg, global_position_int_cov->time_usec,
      global_position_int_cov->estimator_type, global_position_int_cov->lat,
      global_position_int_cov->lon, global_position_int_cov->alt,
      global_position_int_cov->relative_alt, global_position_int_cov->vx,
      global_position_int_cov->vy, global_position_int_cov->vz,
...
static inline void mavlink_msg_global_position_int_cov_send(
    mavlink_channel_t chan, uint64_t time_usec, uint8_t estimator_type,
    int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, float vx,
    float vy, float vz, const float* covariance) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_LEN];
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV, buf,
      MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_MIN_LEN,
      MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_LEN,
      MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_CRC);
#else
  ...
  mav_array_memcpy(packet.covariance, covariance, sizeof(float) * 36);
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV, (const char*)&packet,
      MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_MIN_LEN,
      MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_LEN,
      MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_CRC);
#endif
 ...
 */
static inline void mavlink_msg_global_position_int_cov_send_struct(
    mavlink_channel_t chan,
    const mavlink_global_position_int_cov_t* global_position_int_cov) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_global_position_int_cov_send(
      chan, global_position_int_cov->time_usec,
      global_position_int_cov->estimator_type, global_position_int_cov->lat,
      global_position_int_cov->lon, global_position_int_cov->alt,
      global_position_int_cov->relative_alt, global_position_int_cov->vx,
      global_position_int_cov->vy, global_position_int_cov->vz,
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV,
 ...
 */
static inline void mavlink_msg_global_position_int_cov_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    uint8_t estimator_type, int32_t lat, int32_t lon, int32_t alt,
...
#else
  mavlink_global_position_int_cov_t* packet =
      (mavlink_global_position_int_cov_t*)msgbuf;
  packet->time_usec = time_usec;
  packet->lat = lat;
  packet->lon = lon;
  packet->alt = alt;
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_global_position_int_cov_get_time_usec(
 ...
 */
static inline uint8_t mavlink_msg_global_position_int_cov_get_estimator_type(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_global_position_int_cov_get_lat(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_global_position_int_cov_get_lon(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_global_position_int_cov_get_alt(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_global_position_int_cov_get_relative_alt(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_global_position_int_cov_get_vx(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_global_position_int_cov_get_vy(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_global_position_int_cov_get_vz(
    const mavlink_message_t* msg) {
 ...
 * cross-covariance matrix (states: lat, lon, alt, vx, vy, vz; first six entries
 * are the first ROW, next six entries are the second row, etc.). If unknown,
 * assign NaN value to first element in the array.
 */
static inline uint16_t mavlink_msg_global_position_int_cov_get_covariance(
 ...
 */
static inline void mavlink_msg_global_position_int_cov_decode(
    const mavlink_message_t* msg,
  ...
  mavlink_msg_global_position_int_cov_get_covariance(
      msg, global_position_int_cov->covariance);
  global_position_int_cov->estimator_type =
      mavlink_msg_global_position_int_cov_get_estimator_type(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_LEN;
  memset(global_position_int_cov, 0,
         MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_LEN);
