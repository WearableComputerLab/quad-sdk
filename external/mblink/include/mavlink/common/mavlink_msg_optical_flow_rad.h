...
MAVPACKED(typedef struct __mavlink_optical_flow_rad_t {
  ...
  uint32_t integration_time_us; /*< [us] Integration time. Divide integrated_x
                                   ...
                                   also indicates the.*/
  float integrated_x; /*< [rad] Flow around X axis (Sensor RH rotation about the
                         X axis induces a positive flow. Sensor linear motion
                         along the positive Y axis induces a negative flow.)*/
  float integrated_y; /*< [rad] Flow around Y axis (Sensor RH rotation about the
                         Y axis induces a positive flow. Sensor linear motion
...
#define MAVLINK_MESSAGE_INFO_OPTICAL_FLOW_RAD                                   \
  {                                                                             \
    106, "OPTICAL_FLOW_RAD", 12, {                                              \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                                \
       0,           0,    offsetof(mavlink_optical_flow_rad_t, time_usec)},     \
          {"sensor_id", NULL, MAVLINK_TYPE_UINT8_T,                             \
           0,           42,   offsetof(mavlink_optical_flow_rad_t, sensor_id)}, \
          {"integration_time_us",                                               \
           NULL,                                                                \
           MAVLINK_TYPE_UINT32_T,                                               \
           0,                                                                   \
           8,                                                                   \
           offsetof(mavlink_optical_flow_rad_t, integration_time_us)},          \
          {"integrated_x",                                                      \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           12,                                                                  \
           offsetof(mavlink_optical_flow_rad_t, integrated_x)},                 \
          {"integrated_y",                                                      \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           16,                                                                  \
           offsetof(mavlink_optical_flow_rad_t, integrated_y)},                 \
          {"integrated_xgyro",                                                  \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           20,                                                                  \
           offsetof(mavlink_optical_flow_rad_t, integrated_xgyro)},             \
          {"integrated_ygyro",                                                  \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           24,                                                                  \
           offsetof(mavlink_optical_flow_rad_t, integrated_ygyro)},             \
          {"integrated_zgyro",                                                  \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           28,                                                                  \
           offsetof(mavlink_optical_flow_rad_t, integrated_zgyro)},             \
          {"temperature",                                                       \
           NULL,                                                                \
           MAVLINK_TYPE_INT16_T,                                                \
           0,                                                                   \
           40,                                                                  \
           offsetof(mavlink_optical_flow_rad_t, temperature)},                  \
          {"quality", NULL, MAVLINK_TYPE_UINT8_T,                               \
           0,         43,   offsetof(mavlink_optical_flow_rad_t, quality)},     \
          {"time_delta_distance_us",                                            \
           NULL,                                                                \
           MAVLINK_TYPE_UINT32_T,                                               \
           0,                                                                   \
           32,                                                                  \
           offsetof(mavlink_optical_flow_rad_t, time_delta_distance_us)},       \
          {"distance", NULL, MAVLINK_TYPE_FLOAT,                                \
           0,          36,   offsetof(mavlink_optical_flow_rad_t, distance)},   \
    }                                                                           \
  }
#else
#define MAVLINK_MESSAGE_INFO_OPTICAL_FLOW_RAD                                   \
 ...
 * @param integrated_x [rad] Flow around X axis (Sensor RH rotation about the X
 * axis induces a positive flow. Sensor linear motion along the positive Y axis
 * induces a negative flow.)
 * @param integrated_y [rad] Flow around Y axis (Sensor RH rotation about the Y
...
static inline uint16_t mavlink_msg_optical_flow_rad_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_MIN_LEN,
      MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_LEN, MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_CRC);
}
...
static inline uint16_t mavlink_msg_optical_flow_rad_encode(
  ...
  return mavlink_msg_optical_flow_rad_pack(
      system_id, component_id, msg, optical_flow_rad->time_usec,
      optical_flow_rad->sensor_id, optical_flow_rad->integration_time_us,
      optical_flow_rad->integrated_x, optical_flow_rad->integrated_y,
      optical_flow_rad->integrated_xgyro, optical_flow_rad->integrated_ygyro,
      optical_flow_rad->integrated_zgyro, optical_flow_rad->temperature,
      optical_flow_rad->quality, optical_flow_rad->time_delta_distance_us,
...
static inline uint16_t mavlink_msg_optical_flow_rad_encode_chan(
  ...
  return mavlink_msg_optical_flow_rad_pack_chan(
      system_id, component_id, chan, msg, optical_flow_rad->time_usec,
      optical_flow_rad->sensor_id, optical_flow_rad->integration_time_us,
      optical_flow_rad->integrated_x, optical_flow_rad->integrated_y,
      optical_flow_rad->integrated_xgyro, optical_flow_rad->integrated_ygyro,
      optical_flow_rad->integrated_zgyro, optical_flow_rad->temperature,
...
static inline void mavlink_msg_optical_flow_rad_send(
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_OPTICAL_FLOW_RAD, buf,
                                  MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_MIN_LEN,
                                  MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_LEN,
                                  MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_OPTICAL_FLOW_RAD, (const char*)&packet,
      MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_MIN_LEN,
      MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_LEN, MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_optical_flow_rad_send_struct(
    mavlink_channel_t chan,
    const mavlink_optical_flow_rad_t* optical_flow_rad) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_optical_flow_rad_send(
      chan, optical_flow_rad->time_usec, optical_flow_rad->sensor_id,
      optical_flow_rad->integration_time_us, optical_flow_rad->integrated_x,
      optical_flow_rad->integrated_y, optical_flow_rad->integrated_xgyro,
      optical_flow_rad->integrated_ygyro, optical_flow_rad->integrated_zgyro,
      optical_flow_rad->temperature, optical_flow_rad->quality,
      optical_flow_rad->time_delta_distance_us, optical_flow_rad->distance);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_OPTICAL_FLOW_RAD, (const char*)optical_flow_rad,
      MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_MIN_LEN,
      MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_LEN, MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_CRC);
#endif
}
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_optical_flow_rad_get_time_usec(
 ...
 * @return  Sensor ID
 */
static inline uint8_t mavlink_msg_optical_flow_rad_get_sensor_id(
    const mavlink_message_t* msg) {
 ...
 * the.
 */
static inline uint32_t mavlink_msg_optical_flow_rad_get_integration_time_us(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [rad] Flow around X axis (Sensor RH rotation about the X axis induces
 * a positive flow. Sensor linear motion along the positive Y axis induces a
 * negative flow.)
 */
static inline float mavlink_msg_optical_flow_rad_get_integrated_x(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [rad] Flow around Y axis (Sensor RH rotation about the Y axis induces
 * a positive flow. Sensor linear motion along the positive X axis induces a
 * positive flow.)
 */
static inline float mavlink_msg_optical_flow_rad_get_integrated_y(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_optical_flow_rad_get_integrated_xgyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_optical_flow_rad_get_integrated_ygyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_optical_flow_rad_get_integrated_zgyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_optical_flow_rad_get_temperature(
    const mavlink_message_t* msg) {
 ...
 * quality
 */
static inline uint8_t mavlink_msg_optical_flow_rad_get_quality(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_optical_flow_rad_get_time_delta_distance_us(
    const mavlink_message_t* msg) {
 ...
 * (including zero): distance known. Negative value: Unknown distance.
 */
static inline float mavlink_msg_optical_flow_rad_get_distance(
    const mavlink_message_t* msg) {
