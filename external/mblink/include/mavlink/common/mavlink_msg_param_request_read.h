...
#define MAVLINK_MESSAGE_INFO_PARAM_REQUEST_READ                                 \
  {                                                                             \
    20, "PARAM_REQUEST_READ", 4, {                                              \
      {"target_system",                                                         \
       NULL,                                                                    \
       MAVLINK_TYPE_UINT8_T,                                                    \
       0,                                                                       \
       2,                                                                       \
       offsetof(mavlink_param_request_read_t, target_system)},                  \
          {"target_component",                                                  \
           NULL,                                                                \
           MAVLINK_TYPE_UINT8_T,                                                \
           0,                                                                   \
           3,                                                                   \
           offsetof(mavlink_param_request_read_t, target_component)},           \
          {"param_id", NULL, MAVLINK_TYPE_CHAR,                                 \
           16,         4,    offsetof(mavlink_param_request_read_t, param_id)}, \
          {"param_index",                                                       \
           NULL,                                                                \
           MAVLINK_TYPE_INT16_T,                                                \
           0,                                                                   \
           0,                                                                   \
           offsetof(mavlink_param_request_read_t, param_index)},                \
    }                                                                           \
  }
#else
#define MAVLINK_MESSAGE_INFO_PARAM_REQUEST_READ                                 \
  {                                                                             \
    "PARAM_REQUEST_READ", 4, {                                                  \
      {"target_system",                                                         \
       NULL,                                                                    \
       MAVLINK_TYPE_UINT8_T,                                                    \
       0,                                                                       \
...
static inline uint16_t mavlink_msg_param_request_read_encode(
  ...
  return mavlink_msg_param_request_read_pack(
      system_id, component_id, msg, param_request_read->target_system,
...
static inline uint16_t mavlink_msg_param_request_read_encode_chan(
  ...
  return mavlink_msg_param_request_read_pack_chan(
      system_id, component_id, chan, msg, param_request_read->target_system,
      param_request_read->target_component, param_request_read->param_id,
      param_request_read->param_index);
}
...
static inline void mavlink_msg_param_request_read_send(mavlink_channel_t chan,
  ...
  _mav_put_uint8_t(buf, 3, target_component);
  _mav_put_char_array(buf, 4, param_id, 16);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PARAM_REQUEST_READ, buf,
                                  MAVLINK_MSG_ID_PARAM_REQUEST_READ_MIN_LEN,
                                  MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN,
                                  MAVLINK_MSG_ID_PARAM_REQUEST_READ_CRC);
#else
  ...
  packet.target_component = target_component;
  mav_array_memcpy(packet.param_id, param_id, sizeof(char) * 16);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PARAM_REQUEST_READ,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_PARAM_REQUEST_READ_MIN_LEN,
                                  MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN,
                                  MAVLINK_MSG_ID_PARAM_REQUEST_READ_CRC);
 ...
 */
static inline void mavlink_msg_param_request_read_send_struct(
    mavlink_channel_t chan,
    const mavlink_param_request_read_t* param_request_read) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_param_request_read_send(chan, param_request_read->target_system,
 ...
 */
static inline void mavlink_msg_param_request_read_send_buf(
...
static inline void mavlink_msg_param_request_read_decode(
  ...
  mavlink_msg_param_request_read_get_param_id(msg,
                                              param_request_read->param_id);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN;
