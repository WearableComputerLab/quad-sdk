...
#define MAVLINK_MESSAGE_INFO_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET           \
  {                                                                            \
    89, "LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET", 7, {                        \
      {"time_boot_ms",                                                         \
       NULL,                                                                   \
       MAVLINK_TYPE_UINT32_T,                                                  \
       0,                                                                      \
       0,                                                                      \
       offsetof(mavlink_local_position_ned_system_global_offset_t,             \
                time_boot_ms)},                                                \
          {"x",                                                                \
           NULL,                                                               \
           MAVLINK_TYPE_FLOAT,                                                 \
           0,                                                                  \
           4,                                                                  \
           offsetof(mavlink_local_position_ned_system_global_offset_t, x)},    \
          {"y",                                                                \
           NULL,                                                               \
           MAVLINK_TYPE_FLOAT,                                                 \
           0,                                                                  \
           8,                                                                  \
           offsetof(mavlink_local_position_ned_system_global_offset_t, y)},    \
          {"z",                                                                \
           NULL,                                                               \
           MAVLINK_TYPE_FLOAT,                                                 \
           0,                                                                  \
           12,                                                                 \
           offsetof(mavlink_local_position_ned_system_global_offset_t, z)},    \
          {"roll",                                                             \
           NULL,                                                               \
           MAVLINK_TYPE_FLOAT,                                                 \
           0,                                                                  \
           16,                                                                 \
           offsetof(mavlink_local_position_ned_system_global_offset_t, roll)}, \
          {"pitch",                                                            \
           NULL,                                                               \
           MAVLINK_TYPE_FLOAT,                                                 \
           0,                                                                  \
          ...
          {"yaw",                                                              \
           ...
           0,                                                                  \
           24,                                                                 \
           offsetof(mavlink_local_position_ned_system_global_offset_t, yaw)},  \
    }                                                                          \
  }
#else
#define MAVLINK_MESSAGE_INFO_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET           \
  {                                                                            \
    "LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET", 7, {                            \
      {"time_boot_ms",                                                         \
       NULL,                                                                   \
       MAVLINK_TYPE_UINT32_T,                                                  \
       0,                                                                      \
...
static inline uint16_t mavlink_msg_local_position_ned_system_global_offset_pack(
    ...
    uint32_t time_boot_ms, float x, float y, float z, float roll, float pitch,
    float yaw) {
...
mavlink_msg_local_position_ned_system_global_offset_pack_chan(
    ...
    mavlink_message_t* msg, uint32_t time_boot_ms, float x, float y, float z,
 ...
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 * @param local_position_ned_system_global_offset C-struct to read the message
 * contents from
 */
static inline uint16_t
mavlink_msg_local_position_ned_system_global_offset_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_local_position_ned_system_global_offset_t*
 ...
 */
static inline uint16_t
mavlink_msg_local_position_ned_system_global_offset_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
...
static inline void mavlink_msg_local_position_ned_system_global_offset_send(
    mavlink_channel_t chan, uint32_t time_boot_ms, float x, float y, float z,
    float roll, float pitch, float yaw) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_LEN];
  _mav_put_uint32_t(buf, 0, time_boot_ms);
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET, buf,
      MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_MIN_LEN,
      MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_LEN,
      MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET,
      (const char*)&packet,
      MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_MIN_LEN,
      MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_LEN,
      MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_CRC);
...
mavlink_msg_local_position_ned_system_global_offset_send_struct(
  ...
  mavlink_msg_local_position_ned_system_global_offset_send(
      chan, local_position_ned_system_global_offset->time_boot_ms,
      local_position_ned_system_global_offset->x,
      local_position_ned_system_global_offset->y,
      local_position_ned_system_global_offset->z,
      local_position_ned_system_global_offset->roll,
...
#if MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_LEN <= \
 ...
 */
static inline void mavlink_msg_local_position_ned_system_global_offset_send_buf(
...
#else
  mavlink_local_position_ned_system_global_offset_t* packet =
      (mavlink_local_position_ned_system_global_offset_t*)msgbuf;
  packet->time_boot_ms = time_boot_ms;
  packet->x = x;
  packet->y = y;
  packet->z = z;
...
/**
 * @brief Get field time_boot_ms from local_position_ned_system_global_offset
 * message
 *
 * @return [ms] Timestamp (time since system boot).
 */
static inline uint32_t
mavlink_msg_local_position_ned_system_global_offset_get_time_boot_ms(
 ...
 * @return [m] Y Position
 */
static inline float mavlink_msg_local_position_ned_system_global_offset_get_y(
    const mavlink_message_t* msg) {
 ...
 * @return [m] Z Position
 */
static inline float mavlink_msg_local_position_ned_system_global_offset_get_z(
    const mavlink_message_t* msg) {
 ...
 */
static inline float
mavlink_msg_local_position_ned_system_global_offset_get_roll(
    const mavlink_message_t* msg) {
 ...
 * @param local_position_ned_system_global_offset C-struct to decode the message
 * contents into
 */
...
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  local_position_ned_system_global_offset->time_boot_ms =
      mavlink_msg_local_position_ned_system_global_offset_get_time_boot_ms(msg);
  local_position_ned_system_global_offset->x =
      mavlink_msg_local_position_ned_system_global_offset_get_x(msg);
  local_position_ned_system_global_offset->y =
      mavlink_msg_local_position_ned_system_global_offset_get_y(msg);
  local_position_ned_system_global_offset->z =
      mavlink_msg_local_position_ned_system_global_offset_get_z(msg);
  local_position_ned_system_global_offset->roll =
      mavlink_msg_local_position_ned_system_global_offset_get_roll(msg);
  local_position_ned_system_global_offset->pitch =
      mavlink_msg_local_position_ned_system_global_offset_get_pitch(msg);
  local_position_ned_system_global_offset->yaw =
      mavlink_msg_local_position_ned_system_global_offset_get_yaw(msg);
#else
  uint8_t len =
      msg->len < MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_LEN
          ? msg->len
          : MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_LEN;
