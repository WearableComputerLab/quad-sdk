...
MAVPACKED(typedef struct __mavlink_scaled_pressure_t {
  ...
  {                                                                            \
    29, "SCALED_PRESSURE", 4, {                                                \
      {"time_boot_ms",                                                         \
       ...
       0,                                                                      \
       0,                                                                      \
       offsetof(mavlink_scaled_pressure_t, time_boot_ms)},                     \
          {"press_abs", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,           4,    offsetof(mavlink_scaled_pressure_t, press_abs)}, \
          {"press_diff",                                                       \
           NULL,                                                               \
           MAVLINK_TYPE_FLOAT,                                                 \
           0,                                                                  \
           8,                                                                  \
           offsetof(mavlink_scaled_pressure_t, press_diff)},                   \
          {"temperature",                                                      \
           NULL,                                                               \
           MAVLINK_TYPE_INT16_T,                                               \
           0,                                                                  \
           12,                                                                 \
           offsetof(mavlink_scaled_pressure_t, temperature)},                  \
    }                                                                          \
  }
#else
#define MAVLINK_MESSAGE_INFO_SCALED_PRESSURE                                   \
...
static inline uint16_t mavlink_msg_scaled_pressure_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_SCALED_PRESSURE_MIN_LEN,
      MAVLINK_MSG_ID_SCALED_PRESSURE_LEN, MAVLINK_MSG_ID_SCALED_PRESSURE_CRC);
}
...
static inline uint16_t mavlink_msg_scaled_pressure_encode(
  ...
  return mavlink_msg_scaled_pressure_pack(
      system_id, component_id, msg, scaled_pressure->time_boot_ms,
...
static inline uint16_t mavlink_msg_scaled_pressure_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_scaled_pressure_t* scaled_pressure) {
  return mavlink_msg_scaled_pressure_pack_chan(
      system_id, component_id, chan, msg, scaled_pressure->time_boot_ms,
      scaled_pressure->press_abs, scaled_pressure->press_diff,
      scaled_pressure->temperature);
}
...
static inline void mavlink_msg_scaled_pressure_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SCALED_PRESSURE, buf,
                                  MAVLINK_MSG_ID_SCALED_PRESSURE_MIN_LEN,
                                  MAVLINK_MSG_ID_SCALED_PRESSURE_LEN,
                                  MAVLINK_MSG_ID_SCALED_PRESSURE_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SCALED_PRESSURE, (const char*)&packet,
      MAVLINK_MSG_ID_SCALED_PRESSURE_MIN_LEN,
      MAVLINK_MSG_ID_SCALED_PRESSURE_LEN, MAVLINK_MSG_ID_SCALED_PRESSURE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_scaled_pressure_send_struct(
    mavlink_channel_t chan, const mavlink_scaled_pressure_t* scaled_pressure) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_scaled_pressure_send(
      chan, scaled_pressure->time_boot_ms, scaled_pressure->press_abs,
      scaled_pressure->press_diff, scaled_pressure->temperature);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SCALED_PRESSURE, (const char*)scaled_pressure,
      MAVLINK_MSG_ID_SCALED_PRESSURE_MIN_LEN,
      MAVLINK_MSG_ID_SCALED_PRESSURE_LEN, MAVLINK_MSG_ID_SCALED_PRESSURE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_scaled_pressure_send_buf(
...
static inline void mavlink_msg_scaled_pressure_decode(
    const mavlink_message_t* msg, mavlink_scaled_pressure_t* scaled_pressure) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SCALED_PRESSURE_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_SCALED_PRESSURE_LEN;
