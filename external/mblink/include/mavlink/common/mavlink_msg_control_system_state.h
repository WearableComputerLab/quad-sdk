...
MAVPACKED(typedef struct __mavlink_control_system_state_t {
  ...
  {                                                                         \
    146, "CONTROL_SYSTEM_STATE", 17, {                                      \
      {                                                                     \
          ...
          0,                                                                \
          0,                                                                \
          offsetof(mavlink_control_system_state_t, time_usec)},             \
          {"x_acc", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,       8,    offsetof(mavlink_control_system_state_t, x_acc)}, \
          {"y_acc", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,       12,   offsetof(mavlink_control_system_state_t, y_acc)}, \
          {"z_acc", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,       16,   offsetof(mavlink_control_system_state_t, z_acc)}, \
          {"x_vel", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,       20,   offsetof(mavlink_control_system_state_t, x_vel)}, \
          {"y_vel", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,       24,   offsetof(mavlink_control_system_state_t, y_vel)}, \
          {"z_vel", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,       28,   offsetof(mavlink_control_system_state_t, z_vel)}, \
          {"x_pos", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,       32,   offsetof(mavlink_control_system_state_t, x_pos)}, \
          {"y_pos", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,       36,   offsetof(mavlink_control_system_state_t, y_pos)}, \
          {"z_pos", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,       40,   offsetof(mavlink_control_system_state_t, z_pos)}, \
          {"airspeed",                                                      \
           NULL,                                                            \
           MAVLINK_TYPE_FLOAT,                                              \
           0,                                                               \
           44,                                                              \
           offsetof(mavlink_control_system_state_t, airspeed)},             \
          {"vel_variance",                                                  \
           NULL,                                                            \
           MAVLINK_TYPE_FLOAT,                                              \
           3,                                                               \
           48,                                                              \
           offsetof(mavlink_control_system_state_t, vel_variance)},         \
          {"pos_variance",                                                  \
           NULL,                                                            \
           MAVLINK_TYPE_FLOAT,                                              \
           3,                                                               \
           60,                                                              \
           offsetof(mavlink_control_system_state_t, pos_variance)},         \
          {"q", NULL, MAVLINK_TYPE_FLOAT,                                   \
           4,   72,   offsetof(mavlink_control_system_state_t, q)},         \
          {"roll_rate",                                                     \
           NULL,                                                            \
           MAVLINK_TYPE_FLOAT,                                              \
           0,                                                               \
           88,                                                              \
           offsetof(mavlink_control_system_state_t, roll_rate)},            \
          {"pitch_rate",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_FLOAT,                                              \
           0,                                                               \
           92,                                                              \
           offsetof(mavlink_control_system_state_t, pitch_rate)},           \
          {"yaw_rate",                                                      \
           NULL,                                                            \
           MAVLINK_TYPE_FLOAT,                                              \
           0,                                                               \
           96,                                                              \
           offsetof(mavlink_control_system_state_t, yaw_rate)},             \
    }                                                                       \
  }
#else
#define MAVLINK_MESSAGE_INFO_CONTROL_SYSTEM_STATE                           \
  {                                                                         \
    "CONTROL_SYSTEM_STATE", 17, {                                           \
      {                                                                     \
          "time_usec",                                                      \
          NULL,                                                             \
          MAVLINK_TYPE_UINT64_T,                                            \
 ...
 */
static inline uint16_t mavlink_msg_control_system_state_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint64_t time_usec, float x_acc, float y_acc, float z_acc, float x_vel,
    float y_vel, float z_vel, float x_pos, float y_pos, float z_pos,
    float airspeed, const float* vel_variance, const float* pos_variance,
    const float* q, float roll_rate, float pitch_rate, float yaw_rate) {
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_control_system_state_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint64_t time_usec, float x_acc, float y_acc,
    float z_acc, float x_vel, float y_vel, float z_vel, float x_pos,
    float y_pos, float z_pos, float airspeed, const float* vel_variance,
    const float* pos_variance, const float* q, float roll_rate,
 ...
 */
static inline uint16_t mavlink_msg_control_system_state_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_control_system_state_t* control_system_state) {
  return mavlink_msg_control_system_state_pack(
      system_id, component_id, msg, control_system_state->time_usec,
      control_system_state->x_acc, control_system_state->y_acc,
      control_system_state->z_acc, control_system_state->x_vel,
      control_system_state->y_vel, control_system_state->z_vel,
      control_system_state->x_pos, control_system_state->y_pos,
      control_system_state->z_pos, control_system_state->airspeed,
      control_system_state->vel_variance, control_system_state->pos_variance,
      control_system_state->q, control_system_state->roll_rate,
      control_system_state->pitch_rate, control_system_state->yaw_rate);
}
 ...
 * @param control_system_state C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_control_system_state_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_control_system_state_t* control_system_state) {
  return mavlink_msg_control_system_state_pack_chan(
      system_id, component_id, chan, msg, control_system_state->time_usec,
      control_system_state->x_acc, control_system_state->y_acc,
      control_system_state->z_acc, control_system_state->x_vel,
      control_system_state->y_vel, control_system_state->z_vel,
      control_system_state->x_pos, control_system_state->y_pos,
...
static inline void mavlink_msg_control_system_state_send(
    mavlink_channel_t chan, uint64_t time_usec, float x_acc, float y_acc,
    float z_acc, float x_vel, float y_vel, float z_vel, float x_pos,
    float y_pos, float z_pos, float airspeed, const float* vel_variance,
    const float* pos_variance, const float* q, float roll_rate,
    float pitch_rate, float yaw_rate) {
  ...
  _mav_put_float_array(buf, 60, pos_variance, 3);
  _mav_put_float_array(buf, 72, q, 4);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CONTROL_SYSTEM_STATE,
                                  buf,
                                  MAVLINK_MSG_ID_CONTROL_SYSTEM_STATE_MIN_LEN,
                                  MAVLINK_MSG_ID_CONTROL_SYSTEM_STATE_LEN,
                                  MAVLINK_MSG_ID_CONTROL_SYSTEM_STATE_CRC);
 ...
 */
static inline void mavlink_msg_control_system_state_send_struct(
    mavlink_channel_t chan,
    const mavlink_control_system_state_t* control_system_state) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_control_system_state_send(
      chan, control_system_state->time_usec, control_system_state->x_acc,
      control_system_state->y_acc, control_system_state->z_acc,
      control_system_state->x_vel, control_system_state->y_vel,
      control_system_state->z_vel, control_system_state->x_pos,
      control_system_state->y_pos, control_system_state->z_pos,
      control_system_state->airspeed, control_system_state->vel_variance,
      control_system_state->pos_variance, control_system_state->q,
      control_system_state->roll_rate, control_system_state->pitch_rate,
...
static inline void mavlink_msg_control_system_state_send_buf(
    ...
    float x_acc, float y_acc, float z_acc, float x_vel, float y_vel,
    float z_vel, float x_pos, float y_pos, float z_pos, float airspeed,
    const float* vel_variance, const float* pos_variance, const float* q,
...
#else
  mavlink_control_system_state_t* packet =
      (mavlink_control_system_state_t*)msgbuf;
  packet->time_usec = time_usec;
  packet->x_acc = x_acc;
  packet->y_acc = y_acc;
  packet->z_acc = z_acc;
 ...
 */
static inline float mavlink_msg_control_system_state_get_x_acc(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_control_system_state_get_y_acc(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_control_system_state_get_z_acc(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_control_system_state_get_x_vel(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_control_system_state_get_y_vel(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_control_system_state_get_z_vel(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_control_system_state_get_x_pos(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_control_system_state_get_y_pos(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_control_system_state_get_z_pos(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_control_system_state_get_airspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_control_system_state_get_vel_variance(
    const mavlink_message_t* msg, float* vel_variance) {
...
static inline uint16_t mavlink_msg_control_system_state_get_pos_variance(
    const mavlink_message_t* msg, float* pos_variance) {
 ...
 */
static inline uint16_t mavlink_msg_control_system_state_get_q(
    const mavlink_message_t* msg, float* q) {
 ...
 */
static inline float mavlink_msg_control_system_state_get_roll_rate(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_control_system_state_get_pitch_rate(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_control_system_state_get_yaw_rate(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_control_system_state_decode(
    const mavlink_message_t* msg,
  ...
  mavlink_msg_control_system_state_get_vel_variance(
      msg, control_system_state->vel_variance);
  mavlink_msg_control_system_state_get_pos_variance(
      msg, control_system_state->pos_variance);
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_CONTROL_SYSTEM_STATE_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_CONTROL_SYSTEM_STATE_LEN;
