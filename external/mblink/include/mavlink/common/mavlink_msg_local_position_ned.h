...
MAVPACKED(typedef struct __mavlink_local_position_ned_t {
...
#define MAVLINK_MESSAGE_INFO_LOCAL_POSITION_NED                     \
  {                                                                 \
    32, "LOCAL_POSITION_NED", 7, {                                  \
      {"time_boot_ms",                                              \
       NULL,                                                        \
       MAVLINK_TYPE_UINT32_T,                                       \
       0,                                                           \
       0,                                                           \
       offsetof(mavlink_local_position_ned_t, time_boot_ms)},       \
          {"x", NULL, MAVLINK_TYPE_FLOAT,                           \
           0,   4,    offsetof(mavlink_local_position_ned_t, x)},   \
          {"y", NULL, MAVLINK_TYPE_FLOAT,                           \
           0,   8,    offsetof(mavlink_local_position_ned_t, y)},   \
          {"z", NULL, MAVLINK_TYPE_FLOAT,                           \
           0,   12,   offsetof(mavlink_local_position_ned_t, z)},   \
          {"vx", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,    16,   offsetof(mavlink_local_position_ned_t, vx)}, \
          {"vy", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,    20,   offsetof(mavlink_local_position_ned_t, vy)}, \
          {"vz", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,    24,   offsetof(mavlink_local_position_ned_t, vz)}, \
    }                                                               \
  }
#else
#define MAVLINK_MESSAGE_INFO_LOCAL_POSITION_NED                     \
...
static inline uint16_t mavlink_msg_local_position_ned_pack(
    ...
    uint32_t time_boot_ms, float x, float y, float z, float vx, float vy,
    float vz) {
...
static inline void mavlink_msg_local_position_ned_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOCAL_POSITION_NED, buf,
                                  MAVLINK_MSG_ID_LOCAL_POSITION_NED_MIN_LEN,
                                  MAVLINK_MSG_ID_LOCAL_POSITION_NED_LEN,
                                  MAVLINK_MSG_ID_LOCAL_POSITION_NED_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOCAL_POSITION_NED,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_LOCAL_POSITION_NED_MIN_LEN,
                                  MAVLINK_MSG_ID_LOCAL_POSITION_NED_LEN,
                                  MAVLINK_MSG_ID_LOCAL_POSITION_NED_CRC);
 ...
 */
static inline void mavlink_msg_local_position_ned_send_struct(
    mavlink_channel_t chan,
    const mavlink_local_position_ned_t* local_position_ned) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_local_position_ned_send(
      chan, local_position_ned->time_boot_ms, local_position_ned->x,
      local_position_ned->y, local_position_ned->z, local_position_ned->vx,
 ...
 */
static inline void mavlink_msg_local_position_ned_send_buf(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_LOCAL_POSITION_NED_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_LOCAL_POSITION_NED_LEN;
