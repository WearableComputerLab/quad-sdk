...
MAVPACKED(typedef struct __mavlink_logging_data_acked_t {
  ...
  uint8_t first_message_offset; /*< [bytes] offset into data where first message
                                   starts. This can be used for recovery, when a
                                   previous message got lost (set to 255 if no
                                   start exists).*/
...
#define MAVLINK_MESSAGE_INFO_LOGGING_DATA_ACKED                                 \
  {                                                                             \
    267, "LOGGING_DATA_ACKED", 6, {                                             \
      {"target_system",                                                         \
       NULL,                                                                    \
       MAVLINK_TYPE_UINT8_T,                                                    \
       0,                                                                       \
       2,                                                                       \
       offsetof(mavlink_logging_data_acked_t, target_system)},                  \
          {"target_component",                                                  \
           NULL,                                                                \
           MAVLINK_TYPE_UINT8_T,                                                \
           0,                                                                   \
           3,                                                                   \
           offsetof(mavlink_logging_data_acked_t, target_component)},           \
          {"sequence", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,          0,    offsetof(mavlink_logging_data_acked_t, sequence)}, \
          {"length", NULL, MAVLINK_TYPE_UINT8_T,                                \
           0,        4,    offsetof(mavlink_logging_data_acked_t, length)},     \
          {"first_message_offset",                                              \
           NULL,                                                                \
           MAVLINK_TYPE_UINT8_T,                                                \
           0,                                                                   \
           5,                                                                   \
           offsetof(mavlink_logging_data_acked_t, first_message_offset)},       \
          {"data", NULL, MAVLINK_TYPE_UINT8_T,                                  \
           249,    6,    offsetof(mavlink_logging_data_acked_t, data)},         \
    }                                                                           \
  }
#else
#define MAVLINK_MESSAGE_INFO_LOGGING_DATA_ACKED                                 \
  {                                                                             \
    "LOGGING_DATA_ACKED", 6, {                                                  \
      {"target_system",                                                         \
       NULL,                                                                    \
       MAVLINK_TYPE_UINT8_T,                                                    \
       0,                                                                       \
 ...
 * @param first_message_offset [bytes] offset into data where first message
 * starts. This can be used for recovery, when a previous message got lost (set
 * to 255 if no start exists).
 * @param data  logged data
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_logging_data_acked_pack(
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_logging_data_acked_pack_chan(
 ...
 */
static inline uint16_t mavlink_msg_logging_data_acked_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_logging_data_acked_t* logging_data_acked) {
  return mavlink_msg_logging_data_acked_pack(
      system_id, component_id, msg, logging_data_acked->target_system,
      logging_data_acked->target_component, logging_data_acked->sequence,
      logging_data_acked->length, logging_data_acked->first_message_offset,
 ...
 * @param logging_data_acked C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_logging_data_acked_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_logging_data_acked_t* logging_data_acked) {
  return mavlink_msg_logging_data_acked_pack_chan(
      system_id, component_id, chan, msg, logging_data_acked->target_system,
      logging_data_acked->target_component, logging_data_acked->sequence,
      logging_data_acked->length, logging_data_acked->first_message_offset,
      logging_data_acked->data);
}
...
static inline void mavlink_msg_logging_data_acked_send(
  ...
  _mav_put_uint8_t(buf, 5, first_message_offset);
  _mav_put_uint8_t_array(buf, 6, data, 249);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOGGING_DATA_ACKED, buf,
                                  MAVLINK_MSG_ID_LOGGING_DATA_ACKED_MIN_LEN,
                                  MAVLINK_MSG_ID_LOGGING_DATA_ACKED_LEN,
                                  MAVLINK_MSG_ID_LOGGING_DATA_ACKED_CRC);
#else
  ...
  packet.first_message_offset = first_message_offset;
  mav_array_memcpy(packet.data, data, sizeof(uint8_t) * 249);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOGGING_DATA_ACKED,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_LOGGING_DATA_ACKED_MIN_LEN,
                                  MAVLINK_MSG_ID_LOGGING_DATA_ACKED_LEN,
                                  MAVLINK_MSG_ID_LOGGING_DATA_ACKED_CRC);
 ...
 */
static inline void mavlink_msg_logging_data_acked_send_struct(
    mavlink_channel_t chan,
    const mavlink_logging_data_acked_t* logging_data_acked) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_logging_data_acked_send(
      chan, logging_data_acked->target_system,
      logging_data_acked->target_component, logging_data_acked->sequence,
      logging_data_acked->length, logging_data_acked->first_message_offset,
      logging_data_acked->data);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOGGING_DATA_ACKED,
                                  (const char*)logging_data_acked,
                                  MAVLINK_MSG_ID_LOGGING_DATA_ACKED_MIN_LEN,
                                  MAVLINK_MSG_ID_LOGGING_DATA_ACKED_LEN,
                                  MAVLINK_MSG_ID_LOGGING_DATA_ACKED_CRC);
#endif
 ...
 */
static inline void mavlink_msg_logging_data_acked_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system,
    uint8_t target_component, uint16_t sequence, uint8_t length,
 ...
 */
static inline uint8_t mavlink_msg_logging_data_acked_get_target_system(
 ...
 */
static inline uint8_t mavlink_msg_logging_data_acked_get_target_component(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_logging_data_acked_get_sequence(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_logging_data_acked_get_length(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [bytes] offset into data where first message starts. This can be used
 * for recovery, when a previous message got lost (set to 255 if no start
 * exists).
 */
static inline uint8_t mavlink_msg_logging_data_acked_get_first_message_offset(
    const mavlink_message_t* msg) {
 ...
 * @return  logged data
 */
static inline uint16_t mavlink_msg_logging_data_acked_get_data(
 ...
 */
static inline void mavlink_msg_logging_data_acked_decode(
    const mavlink_message_t* msg,
    mavlink_logging_data_acked_t* logging_data_acked) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  logging_data_acked->sequence =
      mavlink_msg_logging_data_acked_get_sequence(msg);
  logging_data_acked->target_system =
      mavlink_msg_logging_data_acked_get_target_system(msg);
  logging_data_acked->target_component =
      mavlink_msg_logging_data_acked_get_target_component(msg);
  logging_data_acked->length = mavlink_msg_logging_data_acked_get_length(msg);
  logging_data_acked->first_message_offset =
      mavlink_msg_logging_data_acked_get_first_message_offset(msg);
  mavlink_msg_logging_data_acked_get_data(msg, logging_data_acked->data);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_LOGGING_DATA_ACKED_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_LOGGING_DATA_ACKED_LEN;
