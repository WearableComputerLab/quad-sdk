...
MAVPACKED(typedef struct __mavlink_wifi_config_ap_t {
...
#define MAVLINK_MESSAGE_INFO_WIFI_CONFIG_AP                                 \
  {                                                                         \
    299, "WIFI_CONFIG_AP", 2, {                                             \
      {"ssid", NULL, MAVLINK_TYPE_CHAR,                                     \
       32,     0,    offsetof(mavlink_wifi_config_ap_t, ssid)},             \
          {"password", NULL, MAVLINK_TYPE_CHAR,                             \
           64,         32,   offsetof(mavlink_wifi_config_ap_t, password)}, \
    }                                                                       \
  }
#else
#define MAVLINK_MESSAGE_INFO_WIFI_CONFIG_AP                                 \
 ...
 *
 * @param ssid  Name of Wi-Fi network (SSID). Leave it blank to leave it
 * unchanged.
 * @param password  Password. Leave it blank for an open AP.
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_wifi_config_ap_pack(uint8_t system_id,
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_WIFI_CONFIG_AP_MIN_LEN,
      MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN, MAVLINK_MSG_ID_WIFI_CONFIG_AP_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_wifi_config_ap_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t *msg, const char *ssid, const char *password) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN];
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_WIFI_CONFIG_AP_MIN_LEN,
      MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN, MAVLINK_MSG_ID_WIFI_CONFIG_AP_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_wifi_config_ap_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t *msg,
    const mavlink_wifi_config_ap_t *wifi_config_ap) {
  return mavlink_msg_wifi_config_ap_pack(system_id, component_id, msg,
                                         wifi_config_ap->ssid,
 ...
 * @param wifi_config_ap C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_wifi_config_ap_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t *msg, const mavlink_wifi_config_ap_t *wifi_config_ap) {
  return mavlink_msg_wifi_config_ap_pack_chan(system_id, component_id, chan,
                                              msg, wifi_config_ap->ssid,
                                              wifi_config_ap->password);
}
...
static inline void mavlink_msg_wifi_config_ap_send(mavlink_channel_t chan,
                                                   const char *ssid,
                                                   const char *password) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN];
  ...
  _mav_put_char_array(buf, 0, ssid, 32);
  _mav_put_char_array(buf, 32, password, 64);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WIFI_CONFIG_AP, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_WIFI_CONFIG_AP, (const char*)&packet,
      MAVLINK_MSG_ID_WIFI_CONFIG_AP_MIN_LEN, MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN,
      MAVLINK_MSG_ID_WIFI_CONFIG_AP_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_wifi_config_ap_send_struct(
    mavlink_channel_t chan, const mavlink_wifi_config_ap_t *wifi_config_ap) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_wifi_config_ap_send(chan, wifi_config_ap->ssid,
                                  wifi_config_ap->password);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_WIFI_CONFIG_AP, (const char*)wifi_config_ap,
      MAVLINK_MSG_ID_WIFI_CONFIG_AP_MIN_LEN, MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN,
      MAVLINK_MSG_ID_WIFI_CONFIG_AP_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_wifi_config_ap_send_buf(
    mavlink_message_t *msgbuf, mavlink_channel_t chan, const char *ssid,
    const char *password) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint16_t mavlink_msg_wifi_config_ap_get_ssid(
    const mavlink_message_t *msg, char *ssid) {
 ...
 */
static inline uint16_t mavlink_msg_wifi_config_ap_get_password(
 ...
 */
static inline void mavlink_msg_wifi_config_ap_decode(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN;
