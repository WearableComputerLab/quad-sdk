...
MAVPACKED(typedef struct __mavlink_rc_channels_raw_t {
...
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS_RAW                                   \
  {                                                                            \
    35, "RC_CHANNELS_RAW", 11, {                                               \
      {"time_boot_ms",                                                         \
       NULL,                                                                   \
       MAVLINK_TYPE_UINT32_T,                                                  \
       0,                                                                      \
       0,                                                                      \
       offsetof(mavlink_rc_channels_raw_t, time_boot_ms)},                     \
          {"port", NULL, MAVLINK_TYPE_UINT8_T,                                 \
           0,      20,   offsetof(mavlink_rc_channels_raw_t, port)},           \
          {"chan1_raw", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,           4,    offsetof(mavlink_rc_channels_raw_t, chan1_raw)}, \
          {"chan2_raw", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,           6,    offsetof(mavlink_rc_channels_raw_t, chan2_raw)}, \
          {"chan3_raw", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,           8,    offsetof(mavlink_rc_channels_raw_t, chan3_raw)}, \
          {"chan4_raw", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,           10,   offsetof(mavlink_rc_channels_raw_t, chan4_raw)}, \
          {"chan5_raw", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,           12,   offsetof(mavlink_rc_channels_raw_t, chan5_raw)}, \
          {"chan6_raw", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,           14,   offsetof(mavlink_rc_channels_raw_t, chan6_raw)}, \
          {"chan7_raw", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,           16,   offsetof(mavlink_rc_channels_raw_t, chan7_raw)}, \
          {"chan8_raw", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,           18,   offsetof(mavlink_rc_channels_raw_t, chan8_raw)}, \
          {"rssi", NULL, MAVLINK_TYPE_UINT8_T,                                 \
           0,      21,   offsetof(mavlink_rc_channels_raw_t, rssi)},           \
    }                                                                          \
  }
#else
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS_RAW                                   \
...
static inline uint16_t mavlink_msg_rc_channels_raw_pack(
    ...
    uint32_t time_boot_ms, uint8_t port, uint16_t chan1_raw, uint16_t chan2_raw,
  ...
  return mavlink_finalize_message(
      ...
      MAVLINK_MSG_ID_RC_CHANNELS_RAW_LEN, MAVLINK_MSG_ID_RC_CHANNELS_RAW_CRC);
}
...
static inline uint16_t mavlink_msg_rc_channels_raw_encode(
  ...
  return mavlink_msg_rc_channels_raw_pack(
      system_id, component_id, msg, rc_channels_raw->time_boot_ms,
      rc_channels_raw->port, rc_channels_raw->chan1_raw,
      rc_channels_raw->chan2_raw, rc_channels_raw->chan3_raw,
      rc_channels_raw->chan4_raw, rc_channels_raw->chan5_raw,
      rc_channels_raw->chan6_raw, rc_channels_raw->chan7_raw,
...
static inline uint16_t mavlink_msg_rc_channels_raw_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_rc_channels_raw_t* rc_channels_raw) {
  return mavlink_msg_rc_channels_raw_pack_chan(
      system_id, component_id, chan, msg, rc_channels_raw->time_boot_ms,
      rc_channels_raw->port, rc_channels_raw->chan1_raw,
      rc_channels_raw->chan2_raw, rc_channels_raw->chan3_raw,
      rc_channels_raw->chan4_raw, rc_channels_raw->chan5_raw,
      rc_channels_raw->chan6_raw, rc_channels_raw->chan7_raw,
...
static inline void mavlink_msg_rc_channels_raw_send(
    mavlink_channel_t chan, uint32_t time_boot_ms, uint8_t port,
    uint16_t chan1_raw, uint16_t chan2_raw, uint16_t chan3_raw,
    uint16_t chan4_raw, uint16_t chan5_raw, uint16_t chan6_raw,
    uint16_t chan7_raw, uint16_t chan8_raw, uint8_t rssi) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RC_CHANNELS_RAW, buf,
                                  MAVLINK_MSG_ID_RC_CHANNELS_RAW_MIN_LEN,
                                  MAVLINK_MSG_ID_RC_CHANNELS_RAW_LEN,
                                  MAVLINK_MSG_ID_RC_CHANNELS_RAW_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_RC_CHANNELS_RAW, (const char*)&packet,
      MAVLINK_MSG_ID_RC_CHANNELS_RAW_MIN_LEN,
      MAVLINK_MSG_ID_RC_CHANNELS_RAW_LEN, MAVLINK_MSG_ID_RC_CHANNELS_RAW_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_rc_channels_raw_send_struct(
    mavlink_channel_t chan, const mavlink_rc_channels_raw_t* rc_channels_raw) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_rc_channels_raw_send(
      chan, rc_channels_raw->time_boot_ms, rc_channels_raw->port,
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_RC_CHANNELS_RAW, (const char*)rc_channels_raw,
      MAVLINK_MSG_ID_RC_CHANNELS_RAW_MIN_LEN,
      MAVLINK_MSG_ID_RC_CHANNELS_RAW_LEN, MAVLINK_MSG_ID_RC_CHANNELS_RAW_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_rc_channels_raw_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint32_t time_boot_ms,
    uint8_t port, uint16_t chan1_raw, uint16_t chan2_raw, uint16_t chan3_raw,
    uint16_t chan4_raw, uint16_t chan5_raw, uint16_t chan6_raw,
    uint16_t chan7_raw, uint16_t chan8_raw, uint8_t rssi) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
static inline void mavlink_msg_rc_channels_raw_decode(
    const mavlink_message_t* msg, mavlink_rc_channels_raw_t* rc_channels_raw) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_RC_CHANNELS_RAW_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_RC_CHANNELS_RAW_LEN;
