...
#define MAVLINK_MESSAGE_INFO_MISSION_ITEM_REACHED                   \
  {                                                                 \
    46, "MISSION_ITEM_REACHED", 1, {                                \
      {"seq", NULL, MAVLINK_TYPE_UINT16_T,                          \
       0,     0,    offsetof(mavlink_mission_item_reached_t, seq)}, \
    }                                                               \
  }
#else
#define MAVLINK_MESSAGE_INFO_MISSION_ITEM_REACHED                   \
...
static inline uint16_t mavlink_msg_mission_item_reached_encode_chan(
  ...
  return mavlink_msg_mission_item_reached_pack_chan(
      system_id, component_id, chan, msg, mission_item_reached->seq);
}
...
static inline void mavlink_msg_mission_item_reached_send(mavlink_channel_t chan,
                                                         uint16_t seq) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_MISSION_ITEM_REACHED_LEN];
  _mav_put_uint16_t(buf, 0, seq);

  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_ITEM_REACHED,
                                  buf,
                                  MAVLINK_MSG_ID_MISSION_ITEM_REACHED_MIN_LEN,
                                  MAVLINK_MSG_ID_MISSION_ITEM_REACHED_LEN,
                                  MAVLINK_MSG_ID_MISSION_ITEM_REACHED_CRC);
 ...
 */
static inline void mavlink_msg_mission_item_reached_send_struct(
...
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_ITEM_REACHED,
                                  (const char*)mission_item_reached,
                                  MAVLINK_MSG_ID_MISSION_ITEM_REACHED_MIN_LEN,
                                  MAVLINK_MSG_ID_MISSION_ITEM_REACHED_LEN,
                                  MAVLINK_MSG_ID_MISSION_ITEM_REACHED_CRC);
#endif
 ...
 */
static inline void mavlink_msg_mission_item_reached_send_buf(
...
#else
  mavlink_mission_item_reached_t* packet =
      (mavlink_mission_item_reached_t*)msgbuf;
  packet->seq = seq;
