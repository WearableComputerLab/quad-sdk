...
MAVPACKED(typedef struct __mavlink_param_ext_set_t {
  ...
  {                                                                              \
    323, "PARAM_EXT_SET", 5, {                                                   \
      {"target_system",                                                          \
       ...
       0,                                                                        \
       0,                                                                        \
       offsetof(mavlink_param_ext_set_t, target_system)},                        \
          {"target_component",                                                   \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT8_T,                                                 \
           0,                                                                    \
          ...
          {"param_id", NULL, MAVLINK_TYPE_CHAR,                                  \
           16,         2,    offsetof(mavlink_param_ext_set_t, param_id)},       \
          {"param_value", NULL, MAVLINK_TYPE_CHAR,                               \
           128,           18,   offsetof(mavlink_param_ext_set_t, param_value)}, \
          {"param_type",                                                         \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT8_T,                                                 \
           0,                                                                    \
           146,                                                                  \
           offsetof(mavlink_param_ext_set_t, param_type)},                       \
    }                                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_SET                                       \
 ...
 */
static inline uint16_t mavlink_msg_param_ext_set_pack(
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_param_ext_set_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_PARAM_EXT_SET_MIN_LEN,
      MAVLINK_MSG_ID_PARAM_EXT_SET_LEN, MAVLINK_MSG_ID_PARAM_EXT_SET_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_param_ext_set_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_param_ext_set_t* param_ext_set) {
  return mavlink_msg_param_ext_set_pack(
      system_id, component_id, msg, param_ext_set->target_system,
 ...
 * @param param_ext_set C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_param_ext_set_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_param_ext_set_t* param_ext_set) {
  return mavlink_msg_param_ext_set_pack_chan(
      system_id, component_id, chan, msg, param_ext_set->target_system,
      param_ext_set->target_component, param_ext_set->param_id,
      param_ext_set->param_value, param_ext_set->param_type);
}
...
static inline void mavlink_msg_param_ext_set_send(
  ...
  _mav_put_char_array(buf, 2, param_id, 16);
  _mav_put_char_array(buf, 18, param_value, 128);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PARAM_EXT_SET, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_PARAM_EXT_SET, (const char*)&packet,
      MAVLINK_MSG_ID_PARAM_EXT_SET_MIN_LEN, MAVLINK_MSG_ID_PARAM_EXT_SET_LEN,
      MAVLINK_MSG_ID_PARAM_EXT_SET_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_param_ext_set_send_struct(
    mavlink_channel_t chan, const mavlink_param_ext_set_t* param_ext_set) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_param_ext_set_send(
      chan, param_ext_set->target_system, param_ext_set->target_component,
      param_ext_set->param_id, param_ext_set->param_value,
      param_ext_set->param_type);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_PARAM_EXT_SET, (const char*)param_ext_set,
      MAVLINK_MSG_ID_PARAM_EXT_SET_MIN_LEN, MAVLINK_MSG_ID_PARAM_EXT_SET_LEN,
      MAVLINK_MSG_ID_PARAM_EXT_SET_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_param_ext_set_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system,
    uint8_t target_component, const char* param_id, const char* param_value,
    uint8_t param_type) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  System ID
 */
static inline uint8_t mavlink_msg_param_ext_set_get_target_system(
 ...
 * @return  Component ID
 */
static inline uint8_t mavlink_msg_param_ext_set_get_target_component(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_param_ext_set_get_param_id(
 ...
 */
static inline uint16_t mavlink_msg_param_ext_set_get_param_value(
 ...
 */
static inline uint8_t mavlink_msg_param_ext_set_get_param_type(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_param_ext_set_decode(
    const mavlink_message_t* msg, mavlink_param_ext_set_t* param_ext_set) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  param_ext_set->target_system =
      mavlink_msg_param_ext_set_get_target_system(msg);
  param_ext_set->target_component =
      mavlink_msg_param_ext_set_get_target_component(msg);
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_PARAM_EXT_SET_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_PARAM_EXT_SET_LEN;
