...
MAVPACKED(typedef struct __mavlink_scaled_imu3_t {
  ...
  {                                                                \
    129, "SCALED_IMU3", 10, {                                      \
      {"time_boot_ms",                                             \
       ...
       0,                                                          \
       0,                                                          \
       offsetof(mavlink_scaled_imu3_t, time_boot_ms)},             \
          {"xacc", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      4,    offsetof(mavlink_scaled_imu3_t, xacc)},   \
          {"yacc", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      6,    offsetof(mavlink_scaled_imu3_t, yacc)},   \
          {"zacc", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      8,    offsetof(mavlink_scaled_imu3_t, zacc)},   \
          {"xgyro", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,       10,   offsetof(mavlink_scaled_imu3_t, xgyro)}, \
          {"ygyro", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,       12,   offsetof(mavlink_scaled_imu3_t, ygyro)}, \
          {"zgyro", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,       14,   offsetof(mavlink_scaled_imu3_t, zgyro)}, \
          {"xmag", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      16,   offsetof(mavlink_scaled_imu3_t, xmag)},   \
          {"ymag", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      18,   offsetof(mavlink_scaled_imu3_t, ymag)},   \
          {"zmag", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      20,   offsetof(mavlink_scaled_imu3_t, zmag)},   \
    }                                                              \
  }
#else
#define MAVLINK_MESSAGE_INFO_SCALED_IMU3                           \
...
static inline uint16_t mavlink_msg_scaled_imu3_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_SCALED_IMU3_MIN_LEN,
...
static inline uint16_t mavlink_msg_scaled_imu3_pack_chan(
    ...
    mavlink_message_t* msg, uint32_t time_boot_ms, int16_t xacc, int16_t yacc,
    int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro, int16_t xmag,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_SCALED_IMU3_MIN_LEN,
      MAVLINK_MSG_ID_SCALED_IMU3_LEN, MAVLINK_MSG_ID_SCALED_IMU3_CRC);
}
...
static inline uint16_t mavlink_msg_scaled_imu3_encode(
  ...
  return mavlink_msg_scaled_imu3_pack(
      system_id, component_id, msg, scaled_imu3->time_boot_ms,
...
static inline uint16_t mavlink_msg_scaled_imu3_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_scaled_imu3_t* scaled_imu3) {
...
static inline void mavlink_msg_scaled_imu3_send(
    mavlink_channel_t chan, uint32_t time_boot_ms, int16_t xacc, int16_t yacc,
    int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro, int16_t xmag,
    int16_t ymag, int16_t zmag) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_SCALED_IMU3_LEN];
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SCALED_IMU3, buf, MAVLINK_MSG_ID_SCALED_IMU3_MIN_LEN,
      MAVLINK_MSG_ID_SCALED_IMU3_LEN, MAVLINK_MSG_ID_SCALED_IMU3_CRC);
#else
  mavlink_scaled_imu3_t packet;
  packet.time_boot_ms = time_boot_ms;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SCALED_IMU3, (const char*)&packet,
      MAVLINK_MSG_ID_SCALED_IMU3_MIN_LEN, MAVLINK_MSG_ID_SCALED_IMU3_LEN,
 ...
 */
static inline void mavlink_msg_scaled_imu3_send_struct(
    mavlink_channel_t chan, const mavlink_scaled_imu3_t* scaled_imu3) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_scaled_imu3_send(
      chan, scaled_imu3->time_boot_ms, scaled_imu3->xacc, scaled_imu3->yacc,
      scaled_imu3->zacc, scaled_imu3->xgyro, scaled_imu3->ygyro,
      scaled_imu3->zgyro, scaled_imu3->xmag, scaled_imu3->ymag,
      scaled_imu3->zmag);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SCALED_IMU3, (const char*)scaled_imu3,
      MAVLINK_MSG_ID_SCALED_IMU3_MIN_LEN, MAVLINK_MSG_ID_SCALED_IMU3_LEN,
      MAVLINK_MSG_ID_SCALED_IMU3_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_scaled_imu3_send_buf(
 ...
 */
static inline uint32_t mavlink_msg_scaled_imu3_get_time_boot_ms(
 ...
 */
static inline int16_t mavlink_msg_scaled_imu3_get_xacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu3_get_yacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu3_get_zacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu3_get_xgyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu3_get_ygyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu3_get_zgyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu3_get_xmag(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu3_get_ymag(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu3_get_zmag(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_scaled_imu3_decode(
    const mavlink_message_t* msg, mavlink_scaled_imu3_t* scaled_imu3) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SCALED_IMU3_LEN
                    ? msg->len
