...
MAVPACKED(typedef struct __mavlink_actuator_control_target_t {
...
#define MAVLINK_MESSAGE_INFO_ACTUATOR_CONTROL_TARGET                \
  {                                                                 \
    140, "ACTUATOR_CONTROL_TARGET", 3, {                            \
      {"time_usec",                                                 \
       NULL,                                                        \
       MAVLINK_TYPE_UINT64_T,                                       \
       0,                                                           \
       0,                                                           \
       offsetof(mavlink_actuator_control_target_t, time_usec)},     \
          {"group_mlx",                                             \
           NULL,                                                    \
           MAVLINK_TYPE_UINT8_T,                                    \
           0,                                                       \
           40,                                                      \
           offsetof(mavlink_actuator_control_target_t, group_mlx)}, \
          {"controls",                                              \
           NULL,                                                    \
           MAVLINK_TYPE_FLOAT,                                      \
           8,                                                       \
           8,                                                       \
           offsetof(mavlink_actuator_control_target_t, controls)},  \
    }                                                               \
  }
#else
#define MAVLINK_MESSAGE_INFO_ACTUATOR_CONTROL_TARGET                \
  {                                                                 \
    "ACTUATOR_CONTROL_TARGET", 3, {                                 \
      {"time_usec",                                                 \
       NULL,                                                        \
       MAVLINK_TYPE_UINT64_T,                                       \
       0,                                                           \
...
static inline uint16_t mavlink_msg_actuator_control_target_encode(
  ...
  return mavlink_msg_actuator_control_target_pack(
      system_id, component_id, msg, actuator_control_target->time_usec,
...
static inline uint16_t mavlink_msg_actuator_control_target_encode_chan(
  ...
  return mavlink_msg_actuator_control_target_pack_chan(
      system_id, component_id, chan, msg, actuator_control_target->time_usec,
      actuator_control_target->group_mlx, actuator_control_target->controls);
}
...
static inline void mavlink_msg_actuator_control_target_send(
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET, buf,
      MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_MIN_LEN,
      MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_LEN,
      MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_CRC);
#else
  ...
  mav_array_memcpy(packet.controls, controls, sizeof(float) * 8);
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET, (const char*)&packet,
      MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_MIN_LEN,
      MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_LEN,
      MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_CRC);
#endif
 ...
 */
static inline void mavlink_msg_actuator_control_target_send_struct(
    mavlink_channel_t chan,
    const mavlink_actuator_control_target_t* actuator_control_target) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_actuator_control_target_send(
      chan, actuator_control_target->time_usec,
      actuator_control_target->group_mlx, actuator_control_target->controls);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET,
 ...
 */
static inline void mavlink_msg_actuator_control_target_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    uint8_t group_mlx, const float* controls) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  mavlink_actuator_control_target_t* packet =
      (mavlink_actuator_control_target_t*)msgbuf;
  packet->time_usec = time_usec;
  packet->group_mlx = group_mlx;
  mav_array_memcpy(packet->controls, controls, sizeof(float) * 8);
  _mav_finalize_message_chan_send(
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_actuator_control_target_get_time_usec(
 ...
 * instances.
 */
static inline uint8_t mavlink_msg_actuator_control_target_get_group_mlx(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_actuator_control_target_get_controls(
 ...
 */
static inline void mavlink_msg_actuator_control_target_decode(
    const mavlink_message_t* msg,
  ...
  mavlink_msg_actuator_control_target_get_controls(
      msg, actuator_control_target->controls);
  actuator_control_target->group_mlx =
      mavlink_msg_actuator_control_target_get_group_mlx(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_LEN;
  memset(actuator_control_target, 0,
         MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_LEN);
