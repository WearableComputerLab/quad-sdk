...
MAVPACKED(typedef struct __mavlink_raw_imu_t {
  ...
  {                                                                \
    27, "RAW_IMU", 10, {                                           \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                   \
       0,           0,    offsetof(mavlink_raw_imu_t, time_usec)}, \
          {"xacc", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      8,    offsetof(mavlink_raw_imu_t, xacc)},       \
          {"yacc", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      10,   offsetof(mavlink_raw_imu_t, yacc)},       \
          {"zacc", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      12,   offsetof(mavlink_raw_imu_t, zacc)},       \
          {"xgyro", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,       14,   offsetof(mavlink_raw_imu_t, xgyro)},     \
          {"ygyro", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,       16,   offsetof(mavlink_raw_imu_t, ygyro)},     \
          {"zgyro", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,       18,   offsetof(mavlink_raw_imu_t, zgyro)},     \
          {"xmag", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      20,   offsetof(mavlink_raw_imu_t, xmag)},       \
          {"ymag", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      22,   offsetof(mavlink_raw_imu_t, ymag)},       \
          {"zmag", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      24,   offsetof(mavlink_raw_imu_t, zmag)},       \
    }                                                              \
  }
#else
#define MAVLINK_MESSAGE_INFO_RAW_IMU                               \
...
static inline uint16_t mavlink_msg_raw_imu_pack(
    ...
    uint64_t time_usec, int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro,
    int16_t ygyro, int16_t zgyro, int16_t xmag, int16_t ymag, int16_t zmag) {
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_RAW_IMU_MIN_LEN,
...
static inline uint16_t mavlink_msg_raw_imu_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_usec, int16_t xacc, int16_t yacc,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_RAW_IMU_MIN_LEN,
      MAVLINK_MSG_ID_RAW_IMU_LEN, MAVLINK_MSG_ID_RAW_IMU_CRC);
}
...
static inline uint16_t mavlink_msg_raw_imu_encode(
  ...
  return mavlink_msg_raw_imu_pack(
      system_id, component_id, msg, raw_imu->time_usec, raw_imu->xacc,
...
static inline uint16_t mavlink_msg_raw_imu_encode_chan(
  ...
  return mavlink_msg_raw_imu_pack_chan(
      system_id, component_id, chan, msg, raw_imu->time_usec, raw_imu->xacc,
      raw_imu->yacc, raw_imu->zacc, raw_imu->xgyro, raw_imu->ygyro,
      raw_imu->zgyro, raw_imu->xmag, raw_imu->ymag, raw_imu->zmag);
}
...
static inline void mavlink_msg_raw_imu_send(mavlink_channel_t chan,
                                            uint64_t time_usec, int16_t xacc,
                                            int16_t yacc, int16_t zacc,
                                            int16_t xgyro, int16_t ygyro,
                                            int16_t zgyro, int16_t xmag,
                                            int16_t ymag, int16_t zmag) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_RAW_IMU_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_RAW_IMU, buf, MAVLINK_MSG_ID_RAW_IMU_MIN_LEN,
      MAVLINK_MSG_ID_RAW_IMU_LEN, MAVLINK_MSG_ID_RAW_IMU_CRC);
#else
  mavlink_raw_imu_t packet;
  packet.time_usec = time_usec;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_RAW_IMU, (const char*)&packet,
 ...
 */
static inline void mavlink_msg_raw_imu_send_struct(
    mavlink_channel_t chan, const mavlink_raw_imu_t* raw_imu) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_raw_imu_send(chan, raw_imu->time_usec, raw_imu->xacc,
                           raw_imu->yacc, raw_imu->zacc, raw_imu->xgyro,
                           raw_imu->ygyro, raw_imu->zgyro, raw_imu->xmag,
                           raw_imu->ymag, raw_imu->zmag);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_RAW_IMU, (const char*)raw_imu,
      MAVLINK_MSG_ID_RAW_IMU_MIN_LEN, MAVLINK_MSG_ID_RAW_IMU_LEN,
      MAVLINK_MSG_ID_RAW_IMU_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_raw_imu_send_buf(
 ...
 */
static inline int16_t mavlink_msg_raw_imu_get_xacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_raw_imu_get_yacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_raw_imu_get_zacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_raw_imu_get_xmag(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_raw_imu_get_ymag(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_raw_imu_get_zmag(
    const mavlink_message_t* msg) {
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_RAW_IMU_LEN
                    ? msg->len
