...
MAVPACKED(typedef struct __mavlink_mission_request_t {
...
#define MAVLINK_MESSAGE_INFO_MISSION_REQUEST                       \
  {                                                                \
    40, "MISSION_REQUEST", 4, {                                    \
      {"target_system",                                            \
       NULL,                                                       \
       MAVLINK_TYPE_UINT8_T,                                       \
       0,                                                          \
       2,                                                          \
       offsetof(mavlink_mission_request_t, target_system)},        \
          {"target_component",                                     \
           NULL,                                                   \
           MAVLINK_TYPE_UINT8_T,                                   \
           0,                                                      \
           3,                                                      \
           offsetof(mavlink_mission_request_t, target_component)}, \
          {"seq", NULL, MAVLINK_TYPE_UINT16_T,                     \
           0,     0,    offsetof(mavlink_mission_request_t, seq)}, \
          {"mission_type",                                         \
           NULL,                                                   \
           MAVLINK_TYPE_UINT8_T,                                   \
           0,                                                      \
           4,                                                      \
           offsetof(mavlink_mission_request_t, mission_type)},     \
    }                                                              \
  }
#else
#define MAVLINK_MESSAGE_INFO_MISSION_REQUEST                       \
...
static inline uint16_t mavlink_msg_mission_request_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_MISSION_REQUEST_MIN_LEN,
      MAVLINK_MSG_ID_MISSION_REQUEST_LEN, MAVLINK_MSG_ID_MISSION_REQUEST_CRC);
}
...
static inline uint16_t mavlink_msg_mission_request_encode(
  ...
  return mavlink_msg_mission_request_pack(
      system_id, component_id, msg, mission_request->target_system,
...
static inline uint16_t mavlink_msg_mission_request_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_mission_request_t* mission_request) {
  return mavlink_msg_mission_request_pack_chan(
      system_id, component_id, chan, msg, mission_request->target_system,
      mission_request->target_component, mission_request->seq,
      mission_request->mission_type);
}
...
static inline void mavlink_msg_mission_request_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_REQUEST, buf,
                                  MAVLINK_MSG_ID_MISSION_REQUEST_MIN_LEN,
                                  MAVLINK_MSG_ID_MISSION_REQUEST_LEN,
                                  MAVLINK_MSG_ID_MISSION_REQUEST_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_MISSION_REQUEST, (const char*)&packet,
      MAVLINK_MSG_ID_MISSION_REQUEST_MIN_LEN,
      MAVLINK_MSG_ID_MISSION_REQUEST_LEN, MAVLINK_MSG_ID_MISSION_REQUEST_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_mission_request_send_struct(
    mavlink_channel_t chan, const mavlink_mission_request_t* mission_request) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_mission_request_send(
      chan, mission_request->target_system, mission_request->target_component,
      mission_request->seq, mission_request->mission_type);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_MISSION_REQUEST, (const char*)mission_request,
      MAVLINK_MSG_ID_MISSION_REQUEST_MIN_LEN,
      MAVLINK_MSG_ID_MISSION_REQUEST_LEN, MAVLINK_MSG_ID_MISSION_REQUEST_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_mission_request_send_buf(
 ...
 * @return  Mission type.
 */
static inline uint8_t mavlink_msg_mission_request_get_mission_type(
    const mavlink_message_t* msg) {
...
static inline void mavlink_msg_mission_request_decode(
    const mavlink_message_t* msg, mavlink_mission_request_t* mission_request) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  mission_request->mission_type =
      mavlink_msg_mission_request_get_mission_type(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_MISSION_REQUEST_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_MISSION_REQUEST_LEN;
