...
MAVPACKED(typedef struct __mavlink_rc_channels_scaled_t {
...
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS_SCALED                         \
  {                                                                     \
    34, "RC_CHANNELS_SCALED", 11, {                                     \
      {"time_boot_ms",                                                  \
       NULL,                                                            \
       MAVLINK_TYPE_UINT32_T,                                           \
       0,                                                               \
       0,                                                               \
       offsetof(mavlink_rc_channels_scaled_t, time_boot_ms)},           \
          {"port", NULL, MAVLINK_TYPE_UINT8_T,                          \
           0,      20,   offsetof(mavlink_rc_channels_scaled_t, port)}, \
          {"chan1_scaled",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_INT16_T,                                        \
           0,                                                           \
           4,                                                           \
           offsetof(mavlink_rc_channels_scaled_t, chan1_scaled)},       \
          {"chan2_scaled",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_INT16_T,                                        \
           0,                                                           \
           6,                                                           \
           offsetof(mavlink_rc_channels_scaled_t, chan2_scaled)},       \
          {"chan3_scaled",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_INT16_T,                                        \
           0,                                                           \
           8,                                                           \
           offsetof(mavlink_rc_channels_scaled_t, chan3_scaled)},       \
          {"chan4_scaled",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_INT16_T,                                        \
           0,                                                           \
           10,                                                          \
           offsetof(mavlink_rc_channels_scaled_t, chan4_scaled)},       \
          {"chan5_scaled",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_INT16_T,                                        \
           0,                                                           \
           12,                                                          \
           offsetof(mavlink_rc_channels_scaled_t, chan5_scaled)},       \
          {"chan6_scaled",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_INT16_T,                                        \
           0,                                                           \
           14,                                                          \
           offsetof(mavlink_rc_channels_scaled_t, chan6_scaled)},       \
          {"chan7_scaled",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_INT16_T,                                        \
           0,                                                           \
           16,                                                          \
           offsetof(mavlink_rc_channels_scaled_t, chan7_scaled)},       \
          {"chan8_scaled",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_INT16_T,                                        \
           0,                                                           \
           18,                                                          \
           offsetof(mavlink_rc_channels_scaled_t, chan8_scaled)},       \
          {"rssi", NULL, MAVLINK_TYPE_UINT8_T,                          \
           0,      21,   offsetof(mavlink_rc_channels_scaled_t, rssi)}, \
    }                                                                   \
  }
#else
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS_SCALED                         \
  {                                                                     \
    "RC_CHANNELS_SCALED", 11, {                                         \
      {"time_boot_ms",                                                  \
       NULL,                                                            \
       MAVLINK_TYPE_UINT32_T,                                           \
       0,                                                               \
...
static inline uint16_t mavlink_msg_rc_channels_scaled_pack(
    ...
    int16_t chan2_scaled, int16_t chan3_scaled, int16_t chan4_scaled,
    int16_t chan5_scaled, int16_t chan6_scaled, int16_t chan7_scaled,
...
static inline uint16_t mavlink_msg_rc_channels_scaled_encode(
  ...
  return mavlink_msg_rc_channels_scaled_pack(
      system_id, component_id, msg, rc_channels_scaled->time_boot_ms,
      rc_channels_scaled->port, rc_channels_scaled->chan1_scaled,
      rc_channels_scaled->chan2_scaled, rc_channels_scaled->chan3_scaled,
      rc_channels_scaled->chan4_scaled, rc_channels_scaled->chan5_scaled,
      rc_channels_scaled->chan6_scaled, rc_channels_scaled->chan7_scaled,
      rc_channels_scaled->chan8_scaled, rc_channels_scaled->rssi);
}
...
static inline uint16_t mavlink_msg_rc_channels_scaled_encode_chan(
  ...
  return mavlink_msg_rc_channels_scaled_pack_chan(
      system_id, component_id, chan, msg, rc_channels_scaled->time_boot_ms,
      rc_channels_scaled->port, rc_channels_scaled->chan1_scaled,
      rc_channels_scaled->chan2_scaled, rc_channels_scaled->chan3_scaled,
      rc_channels_scaled->chan4_scaled, rc_channels_scaled->chan5_scaled,
      rc_channels_scaled->chan6_scaled, rc_channels_scaled->chan7_scaled,
...
static inline void mavlink_msg_rc_channels_scaled_send(
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RC_CHANNELS_SCALED, buf,
                                  MAVLINK_MSG_ID_RC_CHANNELS_SCALED_MIN_LEN,
                                  MAVLINK_MSG_ID_RC_CHANNELS_SCALED_LEN,
                                  MAVLINK_MSG_ID_RC_CHANNELS_SCALED_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RC_CHANNELS_SCALED,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_RC_CHANNELS_SCALED_MIN_LEN,
                                  MAVLINK_MSG_ID_RC_CHANNELS_SCALED_LEN,
                                  MAVLINK_MSG_ID_RC_CHANNELS_SCALED_CRC);
 ...
 */
static inline void mavlink_msg_rc_channels_scaled_send_struct(
 ...
 */
static inline void mavlink_msg_rc_channels_scaled_send_buf(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_RC_CHANNELS_SCALED_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_RC_CHANNELS_SCALED_LEN;
