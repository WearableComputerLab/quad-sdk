...
MAVPACKED(typedef struct __mavlink_resource_request_t {
  ...
  uint8_t uri[120];   /*<  The requested unique resource identifier (URI). It is
                         ...
                         URI type enum)*/
  uint8_t transfer_type; /*<  The way the autopilot wants to receive the URI. 0
                            = MAVLink FTP. 1 = binary stream.*/
  uint8_t storage[120];  /*<  The storage path the autopilot wants the URI to be
...
#define MAVLINK_MESSAGE_INFO_RESOURCE_REQUEST                                 \
  {                                                                           \
    142, "RESOURCE_REQUEST", 5, {                                             \
      {"request_id",                                                          \
       NULL,                                                                  \
       MAVLINK_TYPE_UINT8_T,                                                  \
       0,                                                                     \
       0,                                                                     \
       offsetof(mavlink_resource_request_t, request_id)},                     \
          {"uri_type", NULL, MAVLINK_TYPE_UINT8_T,                            \
           0,          1,    offsetof(mavlink_resource_request_t, uri_type)}, \
          {"uri", NULL, MAVLINK_TYPE_UINT8_T,                                 \
           120,   2,    offsetof(mavlink_resource_request_t, uri)},           \
          {"transfer_type",                                                   \
           NULL,                                                              \
           MAVLINK_TYPE_UINT8_T,                                              \
           0,                                                                 \
           122,                                                               \
           offsetof(mavlink_resource_request_t, transfer_type)},              \
          {"storage", NULL, MAVLINK_TYPE_UINT8_T,                             \
           120,       123,  offsetof(mavlink_resource_request_t, storage)},   \
    }                                                                         \
  }
#else
#define MAVLINK_MESSAGE_INFO_RESOURCE_REQUEST                                 \
 ...
 *
 * @param request_id  Request ID. This ID should be re-used when sending back
 * URI contents
 * @param uri_type  The type of requested URI. 0 = a file via URL. 1 = a UAVCAN
 * binary
 * @param uri  The requested unique resource identifier (URI). It is not
 * necessarily a straight domain name (depends on the URI type enum)
 * @param transfer_type  The way the autopilot wants to receive the URI. 0 =
 * MAVLink FTP. 1 = binary stream.
 * @param storage  The storage path the autopilot wants the URI to be stored in.
 * Will only be valid if the transfer_type has a storage associated (e.g.
 * MAVLink FTP).
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_resource_request_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_RESOURCE_REQUEST_MIN_LEN,
      MAVLINK_MSG_ID_RESOURCE_REQUEST_LEN, MAVLINK_MSG_ID_RESOURCE_REQUEST_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_resource_request_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint8_t request_id, uint8_t uri_type,
    const uint8_t* uri, uint8_t transfer_type, const uint8_t* storage) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_RESOURCE_REQUEST_LEN];
  _mav_put_uint8_t(buf, 0, request_id);
  _mav_put_uint8_t(buf, 1, uri_type);
 ...
 */
static inline uint16_t mavlink_msg_resource_request_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_resource_request_t* resource_request) {
  return mavlink_msg_resource_request_pack(
      system_id, component_id, msg, resource_request->request_id,
      resource_request->uri_type, resource_request->uri,
      resource_request->transfer_type, resource_request->storage);
}
 ...
 * @param resource_request C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_resource_request_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_resource_request_t* resource_request) {
  return mavlink_msg_resource_request_pack_chan(
      system_id, component_id, chan, msg, resource_request->request_id,
      resource_request->uri_type, resource_request->uri,
      resource_request->transfer_type, resource_request->storage);
}
...
static inline void mavlink_msg_resource_request_send(
    mavlink_channel_t chan, uint8_t request_id, uint8_t uri_type,
    const uint8_t* uri, uint8_t transfer_type, const uint8_t* storage) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_RESOURCE_REQUEST_LEN];
  _mav_put_uint8_t(buf, 0, request_id);
  ...
  _mav_put_uint8_t_array(buf, 2, uri, 120);
  _mav_put_uint8_t_array(buf, 123, storage, 120);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RESOURCE_REQUEST, buf,
                                  MAVLINK_MSG_ID_RESOURCE_REQUEST_MIN_LEN,
                                  MAVLINK_MSG_ID_RESOURCE_REQUEST_LEN,
                                  MAVLINK_MSG_ID_RESOURCE_REQUEST_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_RESOURCE_REQUEST, (const char*)&packet,
      MAVLINK_MSG_ID_RESOURCE_REQUEST_MIN_LEN,
      MAVLINK_MSG_ID_RESOURCE_REQUEST_LEN, MAVLINK_MSG_ID_RESOURCE_REQUEST_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_resource_request_send_struct(
    mavlink_channel_t chan,
    const mavlink_resource_request_t* resource_request) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_resource_request_send(
      chan, resource_request->request_id, resource_request->uri_type,
      resource_request->uri, resource_request->transfer_type,
      resource_request->storage);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_RESOURCE_REQUEST, (const char*)resource_request,
      MAVLINK_MSG_ID_RESOURCE_REQUEST_MIN_LEN,
      MAVLINK_MSG_ID_RESOURCE_REQUEST_LEN, MAVLINK_MSG_ID_RESOURCE_REQUEST_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_resource_request_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t request_id,
    uint8_t uri_type, const uint8_t* uri, uint8_t transfer_type,
 ...
 */
static inline uint8_t mavlink_msg_resource_request_get_request_id(
 ...
 */
static inline uint8_t mavlink_msg_resource_request_get_uri_type(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  The requested unique resource identifier (URI). It is not
 * necessarily a straight domain name (depends on the URI type enum)
 */
static inline uint16_t mavlink_msg_resource_request_get_uri(
 ...
 *
 * @return  The way the autopilot wants to receive the URI. 0 = MAVLink FTP. 1 =
 * binary stream.
 */
static inline uint8_t mavlink_msg_resource_request_get_transfer_type(
    const mavlink_message_t* msg) {
 ...
 * only be valid if the transfer_type has a storage associated (e.g. MAVLink
 * FTP).
 */
static inline uint16_t mavlink_msg_resource_request_get_storage(
 ...
 */
static inline void mavlink_msg_resource_request_decode(
    const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_RESOURCE_REQUEST_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_RESOURCE_REQUEST_LEN;
