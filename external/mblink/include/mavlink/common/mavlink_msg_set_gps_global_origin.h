...
MAVPACKED(typedef struct __mavlink_set_gps_global_origin_t {
...
#define MAVLINK_MESSAGE_INFO_SET_GPS_GLOBAL_ORIGIN                \
  {                                                               \
    48, "SET_GPS_GLOBAL_ORIGIN", 5, {                             \
      {"target_system",                                           \
       NULL,                                                      \
       MAVLINK_TYPE_UINT8_T,                                      \
       0,                                                         \
       12,                                                        \
       offsetof(mavlink_set_gps_global_origin_t, target_system)}, \
          {"latitude",                                            \
           NULL,                                                  \
           MAVLINK_TYPE_INT32_T,                                  \
           0,                                                     \
           0,                                                     \
           offsetof(mavlink_set_gps_global_origin_t, latitude)},  \
          {"longitude",                                           \
           NULL,                                                  \
           MAVLINK_TYPE_INT32_T,                                  \
           0,                                                     \
           4,                                                     \
           offsetof(mavlink_set_gps_global_origin_t, longitude)}, \
          {"altitude",                                            \
           NULL,                                                  \
           MAVLINK_TYPE_INT32_T,                                  \
           0,                                                     \
           8,                                                     \
           offsetof(mavlink_set_gps_global_origin_t, altitude)},  \
          {"time_usec",                                           \
           NULL,                                                  \
           MAVLINK_TYPE_UINT64_T,                                 \
           0,                                                     \
           13,                                                    \
           offsetof(mavlink_set_gps_global_origin_t, time_usec)}, \
    }                                                             \
  }
#else
#define MAVLINK_MESSAGE_INFO_SET_GPS_GLOBAL_ORIGIN                \
  {                                                               \
    "SET_GPS_GLOBAL_ORIGIN", 5, {                                 \
      {"target_system",                                           \
       NULL,                                                      \
       MAVLINK_TYPE_UINT8_T,                                      \
       0,                                                         \
...
static inline uint16_t mavlink_msg_set_gps_global_origin_pack_chan(
    ...
    int32_t longitude, int32_t altitude, uint64_t time_usec) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_LEN];
  _mav_put_int32_t(buf, 0, latitude);
  _mav_put_int32_t(buf, 4, longitude);
...
static inline uint16_t mavlink_msg_set_gps_global_origin_encode(
  ...
  return mavlink_msg_set_gps_global_origin_pack(
      system_id, component_id, msg, set_gps_global_origin->target_system,
      set_gps_global_origin->latitude, set_gps_global_origin->longitude,
      set_gps_global_origin->altitude, set_gps_global_origin->time_usec);
}
...
static inline uint16_t mavlink_msg_set_gps_global_origin_encode_chan(
  ...
  return mavlink_msg_set_gps_global_origin_pack_chan(
      system_id, component_id, chan, msg, set_gps_global_origin->target_system,
      set_gps_global_origin->latitude, set_gps_global_origin->longitude,
      set_gps_global_origin->altitude, set_gps_global_origin->time_usec);
}
...
static inline void mavlink_msg_set_gps_global_origin_send(
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN,
                                  buf,
                                  MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_MIN_LEN,
                                  MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_LEN,
                                  MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_CRC);
 ...
 */
static inline void mavlink_msg_set_gps_global_origin_send_struct(
    mavlink_channel_t chan,
    const mavlink_set_gps_global_origin_t* set_gps_global_origin) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_set_gps_global_origin_send(
      chan, set_gps_global_origin->target_system,
      set_gps_global_origin->latitude, set_gps_global_origin->longitude,
      set_gps_global_origin->altitude, set_gps_global_origin->time_usec);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN,
 ...
 */
static inline void mavlink_msg_set_gps_global_origin_send_buf(
...
#else
  mavlink_set_gps_global_origin_t* packet =
      (mavlink_set_gps_global_origin_t*)msgbuf;
  packet->latitude = latitude;
  packet->longitude = longitude;
  packet->altitude = altitude;
  packet->target_system = target_system;
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_set_gps_global_origin_get_time_usec(
    const mavlink_message_t* msg) {
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_LEN;
