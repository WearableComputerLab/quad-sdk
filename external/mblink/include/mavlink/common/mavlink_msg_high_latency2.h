...
MAVPACKED(typedef struct __mavlink_high_latency2_t {
  uint32_t
      timestamp;    /*< [ms] Timestamp (milliseconds since boot or Unix epoch)*/
  int32_t latitude; /*< [degE7] Latitude*/
  int32_t longitude;    /*< [degE7] Longitude*/
  uint16_t custom_mode; /*<  A bitfield for use for autopilot-specific flags (2
                           byte version).*/
  ...
  int8_t
      climb_rate; /*< [dm/s] Maximum climb rate magnitude since last message*/
...
#define MAVLINK_MESSAGE_INFO_HIGH_LATENCY2                                   \
  {                                                                          \
    235, "HIGH_LATENCY2", 27, {                                              \
      {"timestamp", NULL, MAVLINK_TYPE_UINT32_T,                             \
       0,           0,    offsetof(mavlink_high_latency2_t, timestamp)},     \
          {"type", NULL, MAVLINK_TYPE_UINT8_T,                               \
           0,      24,   offsetof(mavlink_high_latency2_t, type)},           \
          {"autopilot", NULL, MAVLINK_TYPE_UINT8_T,                          \
           0,           25,   offsetof(mavlink_high_latency2_t, autopilot)}, \
          {"custom_mode",                                                    \
           NULL,                                                             \
           MAVLINK_TYPE_UINT16_T,                                            \
           0,                                                                \
           12,                                                               \
           offsetof(mavlink_high_latency2_t, custom_mode)},                  \
          {"latitude", NULL, MAVLINK_TYPE_INT32_T,                           \
           0,          4,    offsetof(mavlink_high_latency2_t, latitude)},   \
          {"longitude", NULL, MAVLINK_TYPE_INT32_T,                          \
           0,           8,    offsetof(mavlink_high_latency2_t, longitude)}, \
          {"altitude", NULL, MAVLINK_TYPE_INT16_T,                           \
           0,          14,   offsetof(mavlink_high_latency2_t, altitude)},   \
          {"target_altitude",                                                \
           NULL,                                                             \
           MAVLINK_TYPE_INT16_T,                                             \
           0,                                                                \
           16,                                                               \
           offsetof(mavlink_high_latency2_t, target_altitude)},              \
          {"heading", NULL, MAVLINK_TYPE_UINT8_T,                            \
           0,         26,   offsetof(mavlink_high_latency2_t, heading)},     \
          {"target_heading",                                                 \
           NULL,                                                             \
           MAVLINK_TYPE_UINT8_T,                                             \
           0,                                                                \
           27,                                                               \
           offsetof(mavlink_high_latency2_t, target_heading)},               \
          {"target_distance",                                                \
           NULL,                                                             \
           MAVLINK_TYPE_UINT16_T,                                            \
           0,                                                                \
           18,                                                               \
           offsetof(mavlink_high_latency2_t, target_distance)},              \
          {"throttle", NULL, MAVLINK_TYPE_UINT8_T,                           \
           0,          28,   offsetof(mavlink_high_latency2_t, throttle)},   \
          {"airspeed", NULL, MAVLINK_TYPE_UINT8_T,                           \
           0,          29,   offsetof(mavlink_high_latency2_t, airspeed)},   \
          {"airspeed_sp",                                                    \
           NULL,                                                             \
           MAVLINK_TYPE_UINT8_T,                                             \
           0,                                                                \
           30,                                                               \
           offsetof(mavlink_high_latency2_t, airspeed_sp)},                  \
          {"groundspeed",                                                    \
           NULL,                                                             \
           MAVLINK_TYPE_UINT8_T,                                             \
           0,                                                                \
           31,                                                               \
           offsetof(mavlink_high_latency2_t, groundspeed)},                  \
          {"windspeed", NULL, MAVLINK_TYPE_UINT8_T,                          \
           0,           32,   offsetof(mavlink_high_latency2_t, windspeed)}, \
          {"wind_heading",                                                   \
           NULL,                                                             \
           MAVLINK_TYPE_UINT8_T,                                             \
           0,                                                                \
           33,                                                               \
           offsetof(mavlink_high_latency2_t, wind_heading)},                 \
          {"eph", NULL, MAVLINK_TYPE_UINT8_T,                                \
           0,     34,   offsetof(mavlink_high_latency2_t, eph)},             \
          {"epv", NULL, MAVLINK_TYPE_UINT8_T,                                \
           0,     35,   offsetof(mavlink_high_latency2_t, epv)},             \
          {"temperature_air",                                                \
           NULL,                                                             \
           MAVLINK_TYPE_INT8_T,                                              \
           0,                                                                \
           36,                                                               \
           offsetof(mavlink_high_latency2_t, temperature_air)},              \
          {"climb_rate",                                                     \
           NULL,                                                             \
           MAVLINK_TYPE_INT8_T,                                              \
           0,                                                                \
           37,                                                               \
           offsetof(mavlink_high_latency2_t, climb_rate)},                   \
          {"battery", NULL, MAVLINK_TYPE_INT8_T,                             \
           0,         38,   offsetof(mavlink_high_latency2_t, battery)},     \
          {"wp_num", NULL, MAVLINK_TYPE_UINT16_T,                            \
           0,        20,   offsetof(mavlink_high_latency2_t, wp_num)},       \
          {"failure_flags",                                                  \
           NULL,                                                             \
           MAVLINK_TYPE_UINT16_T,                                            \
           0,                                                                \
           22,                                                               \
           offsetof(mavlink_high_latency2_t, failure_flags)},                \
          {"custom0", NULL, MAVLINK_TYPE_INT8_T,                             \
           0,         39,   offsetof(mavlink_high_latency2_t, custom0)},     \
          {"custom1", NULL, MAVLINK_TYPE_INT8_T,                             \
           0,         40,   offsetof(mavlink_high_latency2_t, custom1)},     \
          {"custom2", NULL, MAVLINK_TYPE_INT8_T,                             \
           0,         41,   offsetof(mavlink_high_latency2_t, custom2)},     \
    }                                                                        \
  }
#else
#define MAVLINK_MESSAGE_INFO_HIGH_LATENCY2                                   \
 ...
 * @param custom_mode  A bitfield for use for autopilot-specific flags (2 byte
 * version).
 ...
 */
static inline uint16_t mavlink_msg_high_latency2_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint32_t timestamp, uint8_t type, uint8_t autopilot, uint16_t custom_mode,
    int32_t latitude, int32_t longitude, int16_t altitude,
    int16_t target_altitude, uint8_t heading, uint8_t target_heading,
    uint16_t target_distance, uint8_t throttle, uint8_t airspeed,
    uint8_t airspeed_sp, uint8_t groundspeed, uint8_t windspeed,
    uint8_t wind_heading, uint8_t eph, uint8_t epv, int8_t temperature_air,
    int8_t climb_rate, int8_t battery, uint16_t wp_num, uint16_t failure_flags,
    int8_t custom0, int8_t custom1, int8_t custom2) {
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_high_latency2_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint32_t timestamp, uint8_t type, uint8_t autopilot,
    uint16_t custom_mode, int32_t latitude, int32_t longitude, int16_t altitude,
    int16_t target_altitude, uint8_t heading, uint8_t target_heading,
    uint16_t target_distance, uint8_t throttle, uint8_t airspeed,
    uint8_t airspeed_sp, uint8_t groundspeed, uint8_t windspeed,
    uint8_t wind_heading, uint8_t eph, uint8_t epv, int8_t temperature_air,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_HIGH_LATENCY2_MIN_LEN,
      MAVLINK_MSG_ID_HIGH_LATENCY2_LEN, MAVLINK_MSG_ID_HIGH_LATENCY2_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_high_latency2_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_high_latency2_t* high_latency2) {
  return mavlink_msg_high_latency2_pack(
      system_id, component_id, msg, high_latency2->timestamp,
      high_latency2->type, high_latency2->autopilot, high_latency2->custom_mode,
      high_latency2->latitude, high_latency2->longitude,
      high_latency2->altitude, high_latency2->target_altitude,
      high_latency2->heading, high_latency2->target_heading,
      ...
      high_latency2->wind_heading, high_latency2->eph, high_latency2->epv,
      high_latency2->temperature_air, high_latency2->climb_rate,
      high_latency2->battery, high_latency2->wp_num,
      high_latency2->failure_flags, high_latency2->custom0,
      high_latency2->custom1, high_latency2->custom2);
}
 ...
 * @param high_latency2 C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_high_latency2_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_high_latency2_t* high_latency2) {
  return mavlink_msg_high_latency2_pack_chan(
      system_id, component_id, chan, msg, high_latency2->timestamp,
      high_latency2->type, high_latency2->autopilot, high_latency2->custom_mode,
      high_latency2->latitude, high_latency2->longitude,
      high_latency2->altitude, high_latency2->target_altitude,
      high_latency2->heading, high_latency2->target_heading,
...
static inline void mavlink_msg_high_latency2_send(
    mavlink_channel_t chan, uint32_t timestamp, uint8_t type, uint8_t autopilot,
    uint16_t custom_mode, int32_t latitude, int32_t longitude, int16_t altitude,
    int16_t target_altitude, uint8_t heading, uint8_t target_heading,
    uint16_t target_distance, uint8_t throttle, uint8_t airspeed,
    uint8_t airspeed_sp, uint8_t groundspeed, uint8_t windspeed,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HIGH_LATENCY2, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIGH_LATENCY2, (const char*)&packet,
      MAVLINK_MSG_ID_HIGH_LATENCY2_MIN_LEN, MAVLINK_MSG_ID_HIGH_LATENCY2_LEN,
      MAVLINK_MSG_ID_HIGH_LATENCY2_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_high_latency2_send_struct(
    mavlink_channel_t chan, const mavlink_high_latency2_t* high_latency2) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_high_latency2_send(
      chan, high_latency2->timestamp, high_latency2->type,
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIGH_LATENCY2, (const char*)high_latency2,
      MAVLINK_MSG_ID_HIGH_LATENCY2_MIN_LEN, MAVLINK_MSG_ID_HIGH_LATENCY2_LEN,
      MAVLINK_MSG_ID_HIGH_LATENCY2_CRC);
#endif
}
...
static inline void mavlink_msg_high_latency2_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint32_t timestamp,
    uint8_t type, uint8_t autopilot, uint16_t custom_mode, int32_t latitude,
    int32_t longitude, int16_t altitude, int16_t target_altitude,
    uint8_t heading, uint8_t target_heading, uint16_t target_distance,
    uint8_t throttle, uint8_t airspeed, uint8_t airspeed_sp,
    uint8_t groundspeed, uint8_t windspeed, uint8_t wind_heading, uint8_t eph,
    uint8_t epv, int8_t temperature_air, int8_t climb_rate, int8_t battery,
    uint16_t wp_num, uint16_t failure_flags, int8_t custom0, int8_t custom1,
    int8_t custom2) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint32_t mavlink_msg_high_latency2_get_timestamp(
 ...
 */
static inline uint8_t mavlink_msg_high_latency2_get_type(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency2_get_autopilot(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_high_latency2_get_custom_mode(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_high_latency2_get_latitude(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_high_latency2_get_longitude(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_high_latency2_get_altitude(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_high_latency2_get_target_altitude(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency2_get_heading(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency2_get_target_heading(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_high_latency2_get_target_distance(
    const mavlink_message_t* msg) {
 ...
 * @return [%] Throttle
 */
static inline uint8_t mavlink_msg_high_latency2_get_throttle(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency2_get_airspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency2_get_airspeed_sp(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency2_get_groundspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency2_get_windspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency2_get_wind_heading(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency2_get_eph(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency2_get_epv(
    const mavlink_message_t* msg) {
 ...
 */
static inline int8_t mavlink_msg_high_latency2_get_temperature_air(
    const mavlink_message_t* msg) {
 ...
 */
static inline int8_t mavlink_msg_high_latency2_get_climb_rate(
    const mavlink_message_t* msg) {
 ...
 */
static inline int8_t mavlink_msg_high_latency2_get_battery(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_high_latency2_get_wp_num(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_high_latency2_get_failure_flags(
    const mavlink_message_t* msg) {
 ...
 */
static inline int8_t mavlink_msg_high_latency2_get_custom0(
    const mavlink_message_t* msg) {
 ...
 * @return  Field for custom payload.
 */
static inline int8_t mavlink_msg_high_latency2_get_custom1(
    const mavlink_message_t* msg) {
 ...
 * @return  Field for custom payload.
 */
static inline int8_t mavlink_msg_high_latency2_get_custom2(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_high_latency2_decode(
    const mavlink_message_t* msg, mavlink_high_latency2_t* high_latency2) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_HIGH_LATENCY2_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_HIGH_LATENCY2_LEN;
