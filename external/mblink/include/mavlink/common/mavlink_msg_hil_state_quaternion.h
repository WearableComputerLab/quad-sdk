...
MAVPACKED(typedef struct __mavlink_hil_state_quaternion_t {
  ...
  float attitude_quaternion[4]; /*<  Vehicle attitude expressed as normalized
                                   quaternion in w, x, y, z order (with 1 0 0 0
                                   being the null-rotation)*/
  ...
  {                                                                        \
    115, "HIL_STATE_QUATERNION", 16, {                                     \
      {                                                                    \
          ...
          0,                                                               \
          0,                                                               \
          offsetof(mavlink_hil_state_quaternion_t, time_usec)},            \
          {"attitude_quaternion",                                          \
           NULL,                                                           \
           MAVLINK_TYPE_FLOAT,                                             \
           4,                                                              \
           8,                                                              \
           offsetof(mavlink_hil_state_quaternion_t, attitude_quaternion)}, \
          {"rollspeed",                                                    \
           NULL,                                                           \
           MAVLINK_TYPE_FLOAT,                                             \
           0,                                                              \
           24,                                                             \
           offsetof(mavlink_hil_state_quaternion_t, rollspeed)},           \
          {"pitchspeed",                                                   \
           NULL,                                                           \
           MAVLINK_TYPE_FLOAT,                                             \
           0,                                                              \
           28,                                                             \
           offsetof(mavlink_hil_state_quaternion_t, pitchspeed)},          \
          {"yawspeed",                                                     \
           NULL,                                                           \
           MAVLINK_TYPE_FLOAT,                                             \
           0,                                                              \
           32,                                                             \
           offsetof(mavlink_hil_state_quaternion_t, yawspeed)},            \
          {"lat", NULL, MAVLINK_TYPE_INT32_T,                              \
           0,     36,   offsetof(mavlink_hil_state_quaternion_t, lat)},    \
          {"lon", NULL, MAVLINK_TYPE_INT32_T,                              \
           0,     40,   offsetof(mavlink_hil_state_quaternion_t, lon)},    \
          {"alt", NULL, MAVLINK_TYPE_INT32_T,                              \
           0,     44,   offsetof(mavlink_hil_state_quaternion_t, alt)},    \
          {"vx", NULL, MAVLINK_TYPE_INT16_T,                               \
           0,    48,   offsetof(mavlink_hil_state_quaternion_t, vx)},      \
          {"vy", NULL, MAVLINK_TYPE_INT16_T,                               \
           0,    50,   offsetof(mavlink_hil_state_quaternion_t, vy)},      \
          {"vz", NULL, MAVLINK_TYPE_INT16_T,                               \
           0,    52,   offsetof(mavlink_hil_state_quaternion_t, vz)},      \
          {"ind_airspeed",                                                 \
           NULL,                                                           \
           MAVLINK_TYPE_UINT16_T,                                          \
           0,                                                              \
           54,                                                             \
           offsetof(mavlink_hil_state_quaternion_t, ind_airspeed)},        \
          {"true_airspeed",                                                \
           NULL,                                                           \
           MAVLINK_TYPE_UINT16_T,                                          \
           0,                                                              \
           56,                                                             \
           offsetof(mavlink_hil_state_quaternion_t, true_airspeed)},       \
          {"xacc", NULL, MAVLINK_TYPE_INT16_T,                             \
           0,      58,   offsetof(mavlink_hil_state_quaternion_t, xacc)},  \
          {"yacc", NULL, MAVLINK_TYPE_INT16_T,                             \
           0,      60,   offsetof(mavlink_hil_state_quaternion_t, yacc)},  \
          {"zacc", NULL, MAVLINK_TYPE_INT16_T,                             \
           0,      62,   offsetof(mavlink_hil_state_quaternion_t, zacc)},  \
    }                                                                      \
  }
#else
#define MAVLINK_MESSAGE_INFO_HIL_STATE_QUATERNION                          \
  {                                                                        \
    "HIL_STATE_QUATERNION", 16, {                                          \
      {                                                                    \
          "time_usec",                                                     \
          NULL,                                                            \
          MAVLINK_TYPE_UINT64_T,                                           \
 ...
 * @param attitude_quaternion  Vehicle attitude expressed as normalized
 * quaternion in w, x, y, z order (with 1 0 0 0 being the null-rotation)
...
static inline uint16_t mavlink_msg_hil_state_quaternion_pack(
    ...
    uint64_t time_usec, const float* attitude_quaternion, float rollspeed,
    float pitchspeed, float yawspeed, int32_t lat, int32_t lon, int32_t alt,
    int16_t vx, int16_t vy, int16_t vz, uint16_t ind_airspeed,
    uint16_t true_airspeed, int16_t xacc, int16_t yacc, int16_t zacc) {
  ...
  packet.yacc = yacc;
  packet.zacc = zacc;
  mav_array_memcpy(packet.attitude_quaternion, attitude_quaternion,
                   sizeof(float) * 4);
...
static inline uint16_t mavlink_msg_hil_state_quaternion_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_usec,
    const float* attitude_quaternion, float rollspeed, float pitchspeed,
    float yawspeed, int32_t lat, int32_t lon, int32_t alt, int16_t vx,
    int16_t vy, int16_t vz, uint16_t ind_airspeed, uint16_t true_airspeed,
...
static inline uint16_t mavlink_msg_hil_state_quaternion_encode(
  ...
  return mavlink_msg_hil_state_quaternion_pack(
      system_id, component_id, msg, hil_state_quaternion->time_usec,
      hil_state_quaternion->attitude_quaternion,
      hil_state_quaternion->rollspeed, hil_state_quaternion->pitchspeed,
      hil_state_quaternion->yawspeed, hil_state_quaternion->lat,
      hil_state_quaternion->lon, hil_state_quaternion->alt,
      hil_state_quaternion->vx, hil_state_quaternion->vy,
      hil_state_quaternion->vz, hil_state_quaternion->ind_airspeed,
      hil_state_quaternion->true_airspeed, hil_state_quaternion->xacc,
...
static inline uint16_t mavlink_msg_hil_state_quaternion_encode_chan(
  ...
  return mavlink_msg_hil_state_quaternion_pack_chan(
      system_id, component_id, chan, msg, hil_state_quaternion->time_usec,
      hil_state_quaternion->attitude_quaternion,
      hil_state_quaternion->rollspeed, hil_state_quaternion->pitchspeed,
      hil_state_quaternion->yawspeed, hil_state_quaternion->lat,
      hil_state_quaternion->lon, hil_state_quaternion->alt,
...
static inline void mavlink_msg_hil_state_quaternion_send(
  ...
  _mav_put_int16_t(buf, 62, zacc);
  _mav_put_float_array(buf, 8, attitude_quaternion, 4);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HIL_STATE_QUATERNION,
                                  buf,
                                  MAVLINK_MSG_ID_HIL_STATE_QUATERNION_MIN_LEN,
                                  MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN,
                                  MAVLINK_MSG_ID_HIL_STATE_QUATERNION_CRC);
 ...
 */
static inline void mavlink_msg_hil_state_quaternion_send_struct(
    mavlink_channel_t chan,
    const mavlink_hil_state_quaternion_t* hil_state_quaternion) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_hil_state_quaternion_send(
      chan, hil_state_quaternion->time_usec,
      hil_state_quaternion->attitude_quaternion,
      hil_state_quaternion->rollspeed, hil_state_quaternion->pitchspeed,
      hil_state_quaternion->yawspeed, hil_state_quaternion->lat,
      hil_state_quaternion->lon, hil_state_quaternion->alt,
...
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HIL_STATE_QUATERNION,
                                  (const char*)hil_state_quaternion,
                                  MAVLINK_MSG_ID_HIL_STATE_QUATERNION_MIN_LEN,
                                  MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN,
                                  MAVLINK_MSG_ID_HIL_STATE_QUATERNION_CRC);
#endif
...
#else
  mavlink_hil_state_quaternion_t* packet =
      (mavlink_hil_state_quaternion_t*)msgbuf;
  packet->time_usec = time_usec;
  packet->rollspeed = rollspeed;
  packet->pitchspeed = pitchspeed;
  packet->yawspeed = yawspeed;
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_hil_state_quaternion_get_time_usec(
 ...
 *
 * @return  Vehicle attitude expressed as normalized quaternion in w, x, y, z
 * order (with 1 0 0 0 being the null-rotation)
 */
static inline uint16_t mavlink_msg_hil_state_quaternion_get_attitude_quaternion(
    const mavlink_message_t* msg, float* attitude_quaternion) {
 ...
 */
static inline float mavlink_msg_hil_state_quaternion_get_rollspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_state_quaternion_get_pitchspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_state_quaternion_get_yawspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_hil_state_quaternion_get_lat(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_hil_state_quaternion_get_lon(
    const mavlink_message_t* msg) {
 ...
 * @return [mm] Altitude
 */
static inline int32_t mavlink_msg_hil_state_quaternion_get_alt(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_hil_state_quaternion_get_vx(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_hil_state_quaternion_get_vy(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_hil_state_quaternion_get_vz(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_hil_state_quaternion_get_ind_airspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_hil_state_quaternion_get_true_airspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_hil_state_quaternion_get_xacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_hil_state_quaternion_get_yacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_hil_state_quaternion_get_zacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_hil_state_quaternion_decode(
    const mavlink_message_t* msg,
  ...
  mavlink_msg_hil_state_quaternion_get_attitude_quaternion(
      msg, hil_state_quaternion->attitude_quaternion);
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN;
