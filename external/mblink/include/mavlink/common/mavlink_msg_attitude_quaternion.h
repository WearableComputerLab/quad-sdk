...
MAVPACKED(typedef struct __mavlink_attitude_quaternion_t {
...
#define MAVLINK_MESSAGE_INFO_ATTITUDE_QUATERNION                                 \
  {                                                                              \
    31, "ATTITUDE_QUATERNION", 8, {                                              \
      {"time_boot_ms",                                                           \
       NULL,                                                                     \
       MAVLINK_TYPE_UINT32_T,                                                    \
       0,                                                                        \
       0,                                                                        \
       offsetof(mavlink_attitude_quaternion_t, time_boot_ms)},                   \
          {"q1", NULL, MAVLINK_TYPE_FLOAT,                                       \
           0,    4,    offsetof(mavlink_attitude_quaternion_t, q1)},             \
          {"q2", NULL, MAVLINK_TYPE_FLOAT,                                       \
           0,    8,    offsetof(mavlink_attitude_quaternion_t, q2)},             \
          {"q3", NULL, MAVLINK_TYPE_FLOAT,                                       \
           0,    12,   offsetof(mavlink_attitude_quaternion_t, q3)},             \
          {"q4", NULL, MAVLINK_TYPE_FLOAT,                                       \
           0,    16,   offsetof(mavlink_attitude_quaternion_t, q4)},             \
          {"rollspeed",                                                          \
           NULL,                                                                 \
           MAVLINK_TYPE_FLOAT,                                                   \
           0,                                                                    \
           20,                                                                   \
           offsetof(mavlink_attitude_quaternion_t, rollspeed)},                  \
          {"pitchspeed",                                                         \
           NULL,                                                                 \
           MAVLINK_TYPE_FLOAT,                                                   \
           0,                                                                    \
           24,                                                                   \
           offsetof(mavlink_attitude_quaternion_t, pitchspeed)},                 \
          {"yawspeed", NULL, MAVLINK_TYPE_FLOAT,                                 \
           0,          28,   offsetof(mavlink_attitude_quaternion_t, yawspeed)}, \
    }                                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_ATTITUDE_QUATERNION                                 \
...
static inline uint16_t mavlink_msg_attitude_quaternion_pack(
    ...
    uint32_t time_boot_ms, float q1, float q2, float q3, float q4,
...
static inline uint16_t mavlink_msg_attitude_quaternion_pack_chan(
    ...
    mavlink_message_t* msg, uint32_t time_boot_ms, float q1, float q2, float q3,
    float q4, float rollspeed, float pitchspeed, float yawspeed) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_ATTITUDE_QUATERNION_LEN];
  _mav_put_uint32_t(buf, 0, time_boot_ms);
  _mav_put_float(buf, 4, q1);
...
static inline uint16_t mavlink_msg_attitude_quaternion_encode(
  ...
  return mavlink_msg_attitude_quaternion_pack(
      system_id, component_id, msg, attitude_quaternion->time_boot_ms,
      attitude_quaternion->q1, attitude_quaternion->q2, attitude_quaternion->q3,
...
static inline uint16_t mavlink_msg_attitude_quaternion_encode_chan(
  ...
  return mavlink_msg_attitude_quaternion_pack_chan(
      system_id, component_id, chan, msg, attitude_quaternion->time_boot_ms,
      attitude_quaternion->q1, attitude_quaternion->q2, attitude_quaternion->q3,
      attitude_quaternion->q4, attitude_quaternion->rollspeed,
      attitude_quaternion->pitchspeed, attitude_quaternion->yawspeed);
}
...
static inline void mavlink_msg_attitude_quaternion_send(
    mavlink_channel_t chan, uint32_t time_boot_ms, float q1, float q2, float q3,
    float q4, float rollspeed, float pitchspeed, float yawspeed) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_ATTITUDE_QUATERNION_LEN];
  _mav_put_uint32_t(buf, 0, time_boot_ms);
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_QUATERNION, buf,
                                  MAVLINK_MSG_ID_ATTITUDE_QUATERNION_MIN_LEN,
                                  MAVLINK_MSG_ID_ATTITUDE_QUATERNION_LEN,
                                  MAVLINK_MSG_ID_ATTITUDE_QUATERNION_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_QUATERNION,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_ATTITUDE_QUATERNION_MIN_LEN,
                                  MAVLINK_MSG_ID_ATTITUDE_QUATERNION_LEN,
                                  MAVLINK_MSG_ID_ATTITUDE_QUATERNION_CRC);
 ...
 */
static inline void mavlink_msg_attitude_quaternion_send_struct(
    mavlink_channel_t chan,
    const mavlink_attitude_quaternion_t* attitude_quaternion) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_attitude_quaternion_send(
      chan, attitude_quaternion->time_boot_ms, attitude_quaternion->q1,
      attitude_quaternion->q2, attitude_quaternion->q3, attitude_quaternion->q4,
      attitude_quaternion->rollspeed, attitude_quaternion->pitchspeed,
 ...
 */
static inline void mavlink_msg_attitude_quaternion_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint32_t time_boot_ms,
    float q1, float q2, float q3, float q4, float rollspeed, float pitchspeed,
    float yawspeed) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  mavlink_attitude_quaternion_t* packet =
      (mavlink_attitude_quaternion_t*)msgbuf;
  packet->time_boot_ms = time_boot_ms;
  packet->q1 = q1;
  packet->q2 = q2;
  packet->q3 = q3;
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_ATTITUDE_QUATERNION_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_ATTITUDE_QUATERNION_LEN;
