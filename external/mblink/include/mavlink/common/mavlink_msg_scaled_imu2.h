  ...
  {                                                                \
    116, "SCALED_IMU2", 10, {                                      \
      {"time_boot_ms",                                             \
       ...
       0,                                                          \
       0,                                                          \
       offsetof(mavlink_scaled_imu2_t, time_boot_ms)},             \
          {"xacc", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      4,    offsetof(mavlink_scaled_imu2_t, xacc)},   \
          {"yacc", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      6,    offsetof(mavlink_scaled_imu2_t, yacc)},   \
          {"zacc", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      8,    offsetof(mavlink_scaled_imu2_t, zacc)},   \
          {"xgyro", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,       10,   offsetof(mavlink_scaled_imu2_t, xgyro)}, \
          {"ygyro", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,       12,   offsetof(mavlink_scaled_imu2_t, ygyro)}, \
          {"zgyro", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,       14,   offsetof(mavlink_scaled_imu2_t, zgyro)}, \
          {"xmag", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      16,   offsetof(mavlink_scaled_imu2_t, xmag)},   \
          {"ymag", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      18,   offsetof(mavlink_scaled_imu2_t, ymag)},   \
          {"zmag", NULL, MAVLINK_TYPE_INT16_T,                     \
           0,      20,   offsetof(mavlink_scaled_imu2_t, zmag)},   \
    }                                                              \
  }
#else
#define MAVLINK_MESSAGE_INFO_SCALED_IMU2                           \
...
static inline uint16_t mavlink_msg_scaled_imu2_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_SCALED_IMU2_MIN_LEN,
...
static inline uint16_t mavlink_msg_scaled_imu2_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_SCALED_IMU2_MIN_LEN,
      MAVLINK_MSG_ID_SCALED_IMU2_LEN, MAVLINK_MSG_ID_SCALED_IMU2_CRC);
}
...
static inline uint16_t mavlink_msg_scaled_imu2_encode(
  ...
  return mavlink_msg_scaled_imu2_pack(
      system_id, component_id, msg, scaled_imu2->time_boot_ms,
...
static inline uint16_t mavlink_msg_scaled_imu2_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_scaled_imu2_t* scaled_imu2) {
  return mavlink_msg_scaled_imu2_pack_chan(
      system_id, component_id, chan, msg, scaled_imu2->time_boot_ms,
      scaled_imu2->xacc, scaled_imu2->yacc, scaled_imu2->zacc,
      scaled_imu2->xgyro, scaled_imu2->ygyro, scaled_imu2->zgyro,
      scaled_imu2->xmag, scaled_imu2->ymag, scaled_imu2->zmag);
}
...
static inline void mavlink_msg_scaled_imu2_send(
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SCALED_IMU2, buf, MAVLINK_MSG_ID_SCALED_IMU2_MIN_LEN,
      MAVLINK_MSG_ID_SCALED_IMU2_LEN, MAVLINK_MSG_ID_SCALED_IMU2_CRC);
#else
  mavlink_scaled_imu2_t packet;
  packet.time_boot_ms = time_boot_ms;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SCALED_IMU2, (const char*)&packet,
      MAVLINK_MSG_ID_SCALED_IMU2_MIN_LEN, MAVLINK_MSG_ID_SCALED_IMU2_LEN,
 ...
 */
static inline void mavlink_msg_scaled_imu2_send_struct(
    mavlink_channel_t chan, const mavlink_scaled_imu2_t* scaled_imu2) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_scaled_imu2_send(
      chan, scaled_imu2->time_boot_ms, scaled_imu2->xacc, scaled_imu2->yacc,
      scaled_imu2->zacc, scaled_imu2->xgyro, scaled_imu2->ygyro,
      scaled_imu2->zgyro, scaled_imu2->xmag, scaled_imu2->ymag,
      scaled_imu2->zmag);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SCALED_IMU2, (const char*)scaled_imu2,
      MAVLINK_MSG_ID_SCALED_IMU2_MIN_LEN, MAVLINK_MSG_ID_SCALED_IMU2_LEN,
      MAVLINK_MSG_ID_SCALED_IMU2_CRC);
#endif
}
 ...
 */
static inline uint32_t mavlink_msg_scaled_imu2_get_time_boot_ms(
 ...
 */
static inline int16_t mavlink_msg_scaled_imu2_get_xacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu2_get_yacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu2_get_zacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu2_get_xgyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu2_get_ygyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu2_get_zgyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu2_get_xmag(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu2_get_ymag(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu2_get_zmag(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_scaled_imu2_decode(
    const mavlink_message_t* msg, mavlink_scaled_imu2_t* scaled_imu2) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SCALED_IMU2_LEN
                    ? msg->len
