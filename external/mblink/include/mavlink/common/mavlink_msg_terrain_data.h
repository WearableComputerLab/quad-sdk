  ...
  {                                                                     \
    134, "TERRAIN_DATA", 5, {                                           \
      {"lat", NULL, MAVLINK_TYPE_INT32_T,                               \
       0,     0,    offsetof(mavlink_terrain_data_t, lat)},             \
          {"lon", NULL, MAVLINK_TYPE_INT32_T,                           \
           0,     4,    offsetof(mavlink_terrain_data_t, lon)},         \
          {"grid_spacing",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_UINT16_T,                                       \
           0,                                                           \
           8,                                                           \
           offsetof(mavlink_terrain_data_t, grid_spacing)},             \
          {"gridbit", NULL, MAVLINK_TYPE_UINT8_T,                       \
           0,         42,   offsetof(mavlink_terrain_data_t, gridbit)}, \
          {"data", NULL, MAVLINK_TYPE_INT16_T,                          \
           16,     10,   offsetof(mavlink_terrain_data_t, data)},       \
    }                                                                   \
  }
#else
#define MAVLINK_MESSAGE_INFO_TERRAIN_DATA                               \
...
static inline uint16_t mavlink_msg_terrain_data_pack_chan(
    ...
    uint8_t gridbit, const int16_t* data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_TERRAIN_DATA_LEN];
  _mav_put_int32_t(buf, 0, lat);
  _mav_put_int32_t(buf, 4, lon);
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_TERRAIN_DATA_MIN_LEN,
      MAVLINK_MSG_ID_TERRAIN_DATA_LEN, MAVLINK_MSG_ID_TERRAIN_DATA_CRC);
}
...
static inline uint16_t mavlink_msg_terrain_data_encode(
  ...
  return mavlink_msg_terrain_data_pack(
      system_id, component_id, msg, terrain_data->lat, terrain_data->lon,
      terrain_data->grid_spacing, terrain_data->gridbit, terrain_data->data);
}
...
static inline uint16_t mavlink_msg_terrain_data_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_terrain_data_t* terrain_data) {
  return mavlink_msg_terrain_data_pack_chan(
      system_id, component_id, chan, msg, terrain_data->lat, terrain_data->lon,
      terrain_data->grid_spacing, terrain_data->gridbit, terrain_data->data);
}
...
static inline void mavlink_msg_terrain_data_send(mavlink_channel_t chan,
  ...
  _mav_put_uint8_t(buf, 42, gridbit);
  _mav_put_int16_t_array(buf, 10, data, 16);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TERRAIN_DATA, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_TERRAIN_DATA, (const char*)&packet,
      MAVLINK_MSG_ID_TERRAIN_DATA_MIN_LEN, MAVLINK_MSG_ID_TERRAIN_DATA_LEN,
      MAVLINK_MSG_ID_TERRAIN_DATA_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_terrain_data_send_struct(
    mavlink_channel_t chan, const mavlink_terrain_data_t* terrain_data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_terrain_data_send(chan, terrain_data->lat, terrain_data->lon,
                                terrain_data->grid_spacing,
                                terrain_data->gridbit, terrain_data->data);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_TERRAIN_DATA, (const char*)terrain_data,
      MAVLINK_MSG_ID_TERRAIN_DATA_MIN_LEN, MAVLINK_MSG_ID_TERRAIN_DATA_LEN,
      MAVLINK_MSG_ID_TERRAIN_DATA_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_terrain_data_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, int32_t lat, int32_t lon,
    uint16_t grid_spacing, uint8_t gridbit, const int16_t* data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline int32_t mavlink_msg_terrain_data_get_lat(
 ...
 */
static inline int32_t mavlink_msg_terrain_data_get_lon(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_terrain_data_get_grid_spacing(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_terrain_data_get_gridbit(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_terrain_data_get_data(
 ...
 */
static inline void mavlink_msg_terrain_data_decode(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_TERRAIN_DATA_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_TERRAIN_DATA_LEN;
