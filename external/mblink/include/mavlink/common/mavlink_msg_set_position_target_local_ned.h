...
MAVPACKED(typedef struct __mavlink_set_position_target_local_ned_t {
  ...
  uint8_t
      coordinate_frame; /*<  Valid options are: MAV_FRAME_LOCAL_NED = 1,
                           MAV_FRAME_LOCAL_OFFSET_NED = 7, MAV_FRAME_BODY_NED =
...
#define MAVLINK_MESSAGE_INFO_SET_POSITION_TARGET_LOCAL_NED                       \
  {                                                                              \
    84, "SET_POSITION_TARGET_LOCAL_NED", 16, {                                   \
      {"time_boot_ms",                                                           \
       NULL,                                                                     \
       MAVLINK_TYPE_UINT32_T,                                                    \
       0,                                                                        \
       0,                                                                        \
       offsetof(mavlink_set_position_target_local_ned_t, time_boot_ms)},         \
          {"target_system",                                                      \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT8_T,                                                 \
           0,                                                                    \
           50,                                                                   \
           offsetof(mavlink_set_position_target_local_ned_t, target_system)},    \
          {"target_component",                                                   \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT8_T,                                                 \
           0,                                                                    \
           51,                                                                   \
           offsetof(mavlink_set_position_target_local_ned_t,                     \
                    target_component)},                                          \
          {"coordinate_frame",                                                   \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT8_T,                                                 \
          ...
          {"type_mask",                                                          \
           ...
           0,                                                                    \
           48,                                                                   \
           offsetof(mavlink_set_position_target_local_ned_t, type_mask)},        \
          {"x", NULL, MAVLINK_TYPE_FLOAT,                                        \
           0,   4,    offsetof(mavlink_set_position_target_local_ned_t, x)},     \
          {"y", NULL, MAVLINK_TYPE_FLOAT,                                        \
           0,   8,    offsetof(mavlink_set_position_target_local_ned_t, y)},     \
          {"z", NULL, MAVLINK_TYPE_FLOAT,                                        \
           0,   12,   offsetof(mavlink_set_position_target_local_ned_t, z)},     \
          {"vx", NULL, MAVLINK_TYPE_FLOAT,                                       \
           0,    16,   offsetof(mavlink_set_position_target_local_ned_t, vx)},   \
          {"vy", NULL, MAVLINK_TYPE_FLOAT,                                       \
           0,    20,   offsetof(mavlink_set_position_target_local_ned_t, vy)},   \
          {"vz", NULL, MAVLINK_TYPE_FLOAT,                                       \
           0,    24,   offsetof(mavlink_set_position_target_local_ned_t, vz)},   \
          {"afx", NULL, MAVLINK_TYPE_FLOAT,                                      \
           0,     28,   offsetof(mavlink_set_position_target_local_ned_t, afx)}, \
          {"afy", NULL, MAVLINK_TYPE_FLOAT,                                      \
           0,     32,   offsetof(mavlink_set_position_target_local_ned_t, afy)}, \
          {"afz", NULL, MAVLINK_TYPE_FLOAT,                                      \
           0,     36,   offsetof(mavlink_set_position_target_local_ned_t, afz)}, \
          {"yaw", NULL, MAVLINK_TYPE_FLOAT,                                      \
           0,     40,   offsetof(mavlink_set_position_target_local_ned_t, yaw)}, \
          {"yaw_rate",                                                           \
           NULL,                                                                 \
           MAVLINK_TYPE_FLOAT,                                                   \
           0,                                                                    \
           44,                                                                   \
           offsetof(mavlink_set_position_target_local_ned_t, yaw_rate)},         \
    }                                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_SET_POSITION_TARGET_LOCAL_NED                       \
  {                                                                              \
    "SET_POSITION_TARGET_LOCAL_NED", 16, {                                       \
      {"time_boot_ms",                                                           \
       NULL,                                                                     \
       MAVLINK_TYPE_UINT32_T,                                                    \
       0,                                                                        \
...
static inline uint16_t mavlink_msg_set_position_target_local_ned_pack(
    ...
    uint8_t coordinate_frame, uint16_t type_mask, float x, float y, float z,
...
static inline uint16_t mavlink_msg_set_position_target_local_ned_pack_chan(
    ...
    float x, float y, float z, float vx, float vy, float vz, float afx,
 ...
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 * @param set_position_target_local_ned C-struct to read the message contents
 * from
 */
static inline uint16_t mavlink_msg_set_position_target_local_ned_encode(
  ...
  return mavlink_msg_set_position_target_local_ned_pack(
      system_id, component_id, msg, set_position_target_local_ned->time_boot_ms,
      ...
      set_position_target_local_ned->x, set_position_target_local_ned->y,
      set_position_target_local_ned->z, set_position_target_local_ned->vx,
      set_position_target_local_ned->vy, set_position_target_local_ned->vz,
      set_position_target_local_ned->afx, set_position_target_local_ned->afy,
      set_position_target_local_ned->afz, set_position_target_local_ned->yaw,
...
static inline void mavlink_msg_set_position_target_local_ned_send(
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED, buf,
      MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED_MIN_LEN,
      MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED_LEN,
      MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED, (const char*)&packet,
      MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED_MIN_LEN,
      MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED_LEN,
      MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED_CRC);
#endif
 ...
 */
static inline void mavlink_msg_set_position_target_local_ned_send_struct(
    mavlink_channel_t chan, const mavlink_set_position_target_local_ned_t*
                                set_position_target_local_ned) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_set_position_target_local_ned_send(
      chan, set_position_target_local_ned->time_boot_ms,
      set_position_target_local_ned->target_system,
      set_position_target_local_ned->target_component,
      set_position_target_local_ned->coordinate_frame,
      set_position_target_local_ned->type_mask,
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED,
...
#else
  mavlink_set_position_target_local_ned_t* packet =
      (mavlink_set_position_target_local_ned_t*)msgbuf;
  packet->time_boot_ms = time_boot_ms;
  packet->x = x;
  packet->y = y;
  packet->z = z;
...
mavlink_msg_set_position_target_local_ned_get_time_boot_ms(
 ...
 * vehicle.
 */
static inline uint16_t mavlink_msg_set_position_target_local_ned_get_type_mask(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_local_ned_get_x(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_local_ned_get_y(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_local_ned_get_z(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_local_ned_get_vx(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_local_ned_get_vy(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_local_ned_get_vz(
    const mavlink_message_t* msg) {
 ...
 * NED frame in meter / s^2 or N
 */
static inline float mavlink_msg_set_position_target_local_ned_get_afx(
    const mavlink_message_t* msg) {
 ...
 * NED frame in meter / s^2 or N
 */
static inline float mavlink_msg_set_position_target_local_ned_get_afy(
    const mavlink_message_t* msg) {
 ...
 * NED frame in meter / s^2 or N
 */
static inline float mavlink_msg_set_position_target_local_ned_get_afz(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_local_ned_get_yaw(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_local_ned_get_yaw_rate(
    const mavlink_message_t* msg) {
 ...
 * @param set_position_target_local_ned C-struct to decode the message contents
 * into
 */
static inline void mavlink_msg_set_position_target_local_ned_decode(
    const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED_LEN;
  memset(set_position_target_local_ned, 0,
         MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED_LEN);
