  ...
  {                                                                       \
    91, "HIL_CONTROLS", 11, {                                             \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                          \
       0,           0,    offsetof(mavlink_hil_controls_t, time_usec)},   \
          {"roll_ailerons",                                               \
           NULL,                                                          \
           MAVLINK_TYPE_FLOAT,                                            \
           0,                                                             \
           8,                                                             \
           offsetof(mavlink_hil_controls_t, roll_ailerons)},              \
          {"pitch_elevator",                                              \
           NULL,                                                          \
           MAVLINK_TYPE_FLOAT,                                            \
           0,                                                             \
           12,                                                            \
           offsetof(mavlink_hil_controls_t, pitch_elevator)},             \
          {"yaw_rudder",                                                  \
           NULL,                                                          \
           MAVLINK_TYPE_FLOAT,                                            \
           0,                                                             \
           16,                                                            \
           offsetof(mavlink_hil_controls_t, yaw_rudder)},                 \
          {"throttle", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,          20,   offsetof(mavlink_hil_controls_t, throttle)}, \
          {"aux1", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,      24,   offsetof(mavlink_hil_controls_t, aux1)},         \
          {"aux2", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,      28,   offsetof(mavlink_hil_controls_t, aux2)},         \
          {"aux3", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,      32,   offsetof(mavlink_hil_controls_t, aux3)},         \
          {"aux4", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,      36,   offsetof(mavlink_hil_controls_t, aux4)},         \
          {"mode", NULL, MAVLINK_TYPE_UINT8_T,                            \
           0,      40,   offsetof(mavlink_hil_controls_t, mode)},         \
          {"nav_mode", NULL, MAVLINK_TYPE_UINT8_T,                        \
           0,          41,   offsetof(mavlink_hil_controls_t, nav_mode)}, \
    }                                                                     \
  }
#else
#define MAVLINK_MESSAGE_INFO_HIL_CONTROLS                                 \
...
static inline uint16_t mavlink_msg_hil_controls_pack(
  ...
  return mavlink_finalize_message(
      ...
      MAVLINK_MSG_ID_HIL_CONTROLS_LEN, MAVLINK_MSG_ID_HIL_CONTROLS_CRC);
}
...
static inline uint16_t mavlink_msg_hil_controls_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_usec, float roll_ailerons,
    float pitch_elevator, float yaw_rudder, float throttle, float aux1,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_HIL_CONTROLS_MIN_LEN,
      MAVLINK_MSG_ID_HIL_CONTROLS_LEN, MAVLINK_MSG_ID_HIL_CONTROLS_CRC);
}
...
static inline uint16_t mavlink_msg_hil_controls_encode(
  ...
  return mavlink_msg_hil_controls_pack(
      system_id, component_id, msg, hil_controls->time_usec,
      hil_controls->roll_ailerons, hil_controls->pitch_elevator,
      hil_controls->yaw_rudder, hil_controls->throttle, hil_controls->aux1,
      hil_controls->aux2, hil_controls->aux3, hil_controls->aux4,
...
static inline uint16_t mavlink_msg_hil_controls_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_hil_controls_t* hil_controls) {
  return mavlink_msg_hil_controls_pack_chan(
      system_id, component_id, chan, msg, hil_controls->time_usec,
      hil_controls->roll_ailerons, hil_controls->pitch_elevator,
      hil_controls->yaw_rudder, hil_controls->throttle, hil_controls->aux1,
      hil_controls->aux2, hil_controls->aux3, hil_controls->aux4,
      hil_controls->mode, hil_controls->nav_mode);
...
static inline void mavlink_msg_hil_controls_send(
    mavlink_channel_t chan, uint64_t time_usec, float roll_ailerons,
    float pitch_elevator, float yaw_rudder, float throttle, float aux1,
    float aux2, float aux3, float aux4, uint8_t mode, uint8_t nav_mode) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_HIL_CONTROLS_LEN];
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HIL_CONTROLS, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIL_CONTROLS, (const char*)&packet,
      MAVLINK_MSG_ID_HIL_CONTROLS_MIN_LEN, MAVLINK_MSG_ID_HIL_CONTROLS_LEN,
      MAVLINK_MSG_ID_HIL_CONTROLS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_hil_controls_send_struct(
    mavlink_channel_t chan, const mavlink_hil_controls_t* hil_controls) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_hil_controls_send(
      chan, hil_controls->time_usec, hil_controls->roll_ailerons,
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIL_CONTROLS, (const char*)hil_controls,
      MAVLINK_MSG_ID_HIL_CONTROLS_MIN_LEN, MAVLINK_MSG_ID_HIL_CONTROLS_LEN,
      MAVLINK_MSG_ID_HIL_CONTROLS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_hil_controls_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    float roll_ailerons, float pitch_elevator, float yaw_rudder, float throttle,
    float aux1, float aux2, float aux3, float aux4, uint8_t mode,
    uint8_t nav_mode) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline void mavlink_msg_hil_controls_decode(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_HIL_CONTROLS_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_HIL_CONTROLS_LEN;
