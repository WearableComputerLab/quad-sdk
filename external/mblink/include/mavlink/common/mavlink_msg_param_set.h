  ...
  {                                                                    \
    23, "PARAM_SET", 5, {                                              \
      {"target_system",                                                \
       ...
       0,                                                              \
       4,                                                              \
       offsetof(mavlink_param_set_t, target_system)},                  \
          {"target_component",                                         \
           NULL,                                                       \
           MAVLINK_TYPE_UINT8_T,                                       \
           0,                                                          \
           5,                                                          \
           offsetof(mavlink_param_set_t, target_component)},           \
          {"param_id", NULL, MAVLINK_TYPE_CHAR,                        \
           16,         6,    offsetof(mavlink_param_set_t, param_id)}, \
          {"param_value",                                              \
           NULL,                                                       \
           MAVLINK_TYPE_FLOAT,                                         \
           0,                                                          \
           0,                                                          \
           offsetof(mavlink_param_set_t, param_value)},                \
          {"param_type",                                               \
           NULL,                                                       \
           MAVLINK_TYPE_UINT8_T,                                       \
           0,                                                          \
           22,                                                         \
           offsetof(mavlink_param_set_t, param_type)},                 \
    }                                                                  \
  }
#else
#define MAVLINK_MESSAGE_INFO_PARAM_SET                                 \
...
static inline uint16_t mavlink_msg_param_set_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_PARAM_SET_MIN_LEN,
...
static inline uint16_t mavlink_msg_param_set_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_PARAM_SET_MIN_LEN,
      MAVLINK_MSG_ID_PARAM_SET_LEN, MAVLINK_MSG_ID_PARAM_SET_CRC);
}
...
static inline uint16_t mavlink_msg_param_set_encode(
  ...
  return mavlink_msg_param_set_pack(
      system_id, component_id, msg, param_set->target_system,
      param_set->target_component, param_set->param_id, param_set->param_value,
...
static inline uint16_t mavlink_msg_param_set_encode_chan(
  ...
  return mavlink_msg_param_set_pack_chan(
      system_id, component_id, chan, msg, param_set->target_system,
      param_set->target_component, param_set->param_id, param_set->param_value,
      param_set->param_type);
}
...
static inline void mavlink_msg_param_set_send(
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_PARAM_SET, buf, MAVLINK_MSG_ID_PARAM_SET_MIN_LEN,
      MAVLINK_MSG_ID_PARAM_SET_LEN, MAVLINK_MSG_ID_PARAM_SET_CRC);
#else
  mavlink_param_set_t packet;
  packet.param_value = param_value;
  ...
  mav_array_memcpy(packet.param_id, param_id, sizeof(char) * 16);
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_PARAM_SET, (const char*)&packet,
      MAVLINK_MSG_ID_PARAM_SET_MIN_LEN, MAVLINK_MSG_ID_PARAM_SET_LEN,
 ...
 */
static inline void mavlink_msg_param_set_send_struct(
    mavlink_channel_t chan, const mavlink_param_set_t* param_set) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_param_set_send(chan, param_set->target_system,
                             param_set->target_component, param_set->param_id,
                             param_set->param_value, param_set->param_type);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_PARAM_SET, (const char*)param_set,
      MAVLINK_MSG_ID_PARAM_SET_MIN_LEN, MAVLINK_MSG_ID_PARAM_SET_LEN,
      MAVLINK_MSG_ID_PARAM_SET_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_param_set_send_buf(
 ...
 */
static inline void mavlink_msg_param_set_decode(
    const mavlink_message_t* msg, mavlink_param_set_t* param_set) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
