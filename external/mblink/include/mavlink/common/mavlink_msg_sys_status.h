...
MAVPACKED(typedef struct __mavlink_sys_status_t {
  uint32_t onboard_control_sensors_present; /*<  Bitmap showing which onboard
                                               controllers and sensors are
                                               present. Value of 0: not present.
                                               Value of 1: present.*/
  uint32_t onboard_control_sensors_enabled; /*<  Bitmap showing which onboard
                                               controllers and sensors are
                                               enabled:  Value of 0: not
                                               enabled. Value of 1: enabled.*/
  uint32_t
      onboard_control_sensors_health; /*<  Bitmap showing which onboard
                                         controllers and sensors have an error
                                         (or are operational). Value of 0:
  ...
  int16_t current_battery;  /*< [cA] Battery current, -1: autopilot does not
                               measure the current*/
  uint16_t drop_rate_comm;  /*< [c%] Communication drop rate, (UART, I2C, SPI,
                               CAN), dropped packets on all links (packets that
                               were corrupted on reception on the MAV)*/
  uint16_t errors_comm; /*<  Communication errors (UART, I2C, SPI, CAN), dropped
                           packets on all links (packets that were corrupted on
  ...
  {                                                                          \
    1, "SYS_STATUS", 13, {                                                   \
      {"onboard_control_sensors_present",                                    \
       ...
       0,                                                                    \
       0,                                                                    \
       offsetof(mavlink_sys_status_t, onboard_control_sensors_present)},     \
          {"onboard_control_sensors_enabled",                                \
           "0x%04x",                                                         \
           MAVLINK_TYPE_UINT32_T,                                            \
           0,                                                                \
           4,                                                                \
           offsetof(mavlink_sys_status_t, onboard_control_sensors_enabled)}, \
          {"onboard_control_sensors_health",                                 \
           "0x%04x",                                                         \
           MAVLINK_TYPE_UINT32_T,                                            \
           0,                                                                \
           8,                                                                \
           offsetof(mavlink_sys_status_t, onboard_control_sensors_health)},  \
          {"load", NULL, MAVLINK_TYPE_UINT16_T,                              \
           0,      12,   offsetof(mavlink_sys_status_t, load)},              \
          {"voltage_battery",                                                \
           NULL,                                                             \
          ...
          {"current_battery",                                                \
           ...
           0,                                                                \
           16,                                                               \
           offsetof(mavlink_sys_status_t, current_battery)},                 \
          {"battery_remaining",                                              \
           NULL,                                                             \
           MAVLINK_TYPE_INT8_T,                                              \
           0,                                                                \
           30,                                                               \
           offsetof(mavlink_sys_status_t, battery_remaining)},               \
          {"drop_rate_comm",                                                 \
           NULL,                                                             \
           MAVLINK_TYPE_UINT16_T,                                            \
           0,                                                                \
           18,                                                               \
           offsetof(mavlink_sys_status_t, drop_rate_comm)},                  \
          {"errors_comm",                                                    \
           NULL,                                                             \
           MAVLINK_TYPE_UINT16_T,                                            \
           0,                                                                \
           20,                                                               \
           offsetof(mavlink_sys_status_t, errors_comm)},                     \
          {"errors_count1",                                                  \
           NULL,                                                             \
           MAVLINK_TYPE_UINT16_T,                                            \
           0,                                                                \
           22,                                                               \
           offsetof(mavlink_sys_status_t, errors_count1)},                   \
          {"errors_count2",                                                  \
           NULL,                                                             \
           MAVLINK_TYPE_UINT16_T,                                            \
           0,                                                                \
           24,                                                               \
           offsetof(mavlink_sys_status_t, errors_count2)},                   \
          {"errors_count3",                                                  \
           NULL,                                                             \
           MAVLINK_TYPE_UINT16_T,                                            \
           0,                                                                \
           26,                                                               \
           offsetof(mavlink_sys_status_t, errors_count3)},                   \
          {"errors_count4",                                                  \
           NULL,                                                             \
           MAVLINK_TYPE_UINT16_T,                                            \
           0,                                                                \
           28,                                                               \
           offsetof(mavlink_sys_status_t, errors_count4)},                   \
    }                                                                        \
  }
#else
#define MAVLINK_MESSAGE_INFO_SYS_STATUS                                      \
 ...
 * enabled.
 * @param onboard_control_sensors_health  Bitmap showing which onboard
 * controllers and sensors have an error (or are operational). Value of 0:
 * error. Value of 1: healthy.
 ...
 * MAV)
 * @param errors_comm  Communication errors (UART, I2C, SPI, CAN), dropped
...
static inline uint16_t mavlink_msg_sys_status_pack_chan(
    ...
    mavlink_message_t* msg, uint32_t onboard_control_sensors_present,
    uint32_t onboard_control_sensors_enabled,
    uint32_t onboard_control_sensors_health, uint16_t load,
    uint16_t voltage_battery, int16_t current_battery, int8_t battery_remaining,
    uint16_t drop_rate_comm, uint16_t errors_comm, uint16_t errors_count1,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_SYS_STATUS_MIN_LEN,
      MAVLINK_MSG_ID_SYS_STATUS_LEN, MAVLINK_MSG_ID_SYS_STATUS_CRC);
}
...
static inline uint16_t mavlink_msg_sys_status_encode(
  ...
  return mavlink_msg_sys_status_pack(
      system_id, component_id, msg, sys_status->onboard_control_sensors_present,
...
static inline void mavlink_msg_sys_status_send(
    mavlink_channel_t chan, uint32_t onboard_control_sensors_present,
    uint32_t onboard_control_sensors_enabled,
    uint32_t onboard_control_sensors_health, uint16_t load,
    uint16_t voltage_battery, int16_t current_battery, int8_t battery_remaining,
    uint16_t drop_rate_comm, uint16_t errors_comm, uint16_t errors_count1,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SYS_STATUS, buf, MAVLINK_MSG_ID_SYS_STATUS_MIN_LEN,
      MAVLINK_MSG_ID_SYS_STATUS_LEN, MAVLINK_MSG_ID_SYS_STATUS_CRC);
#else
  mavlink_sys_status_t packet;
  packet.onboard_control_sensors_present = onboard_control_sensors_present;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SYS_STATUS, (const char*)&packet,
      MAVLINK_MSG_ID_SYS_STATUS_MIN_LEN, MAVLINK_MSG_ID_SYS_STATUS_LEN,
 ...
 */
static inline void mavlink_msg_sys_status_send_struct(
    mavlink_channel_t chan, const mavlink_sys_status_t* sys_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_sys_status_send(
      chan, sys_status->onboard_control_sensors_present,
      sys_status->onboard_control_sensors_enabled,
      sys_status->onboard_control_sensors_health, sys_status->load,
      sys_status->voltage_battery, sys_status->current_battery,
      sys_status->battery_remaining, sys_status->drop_rate_comm,
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SYS_STATUS, (const char*)sys_status,
      MAVLINK_MSG_ID_SYS_STATUS_MIN_LEN, MAVLINK_MSG_ID_SYS_STATUS_LEN,
      MAVLINK_MSG_ID_SYS_STATUS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_sys_status_send_buf(
 ...
 *
 * @return  Bitmap showing which onboard controllers and sensors have an error
 ...
 *
 * @return [d%] Maximum usage in percent of the mainloop time. Values: [0-1000]
 ...
 *
 * @return [%] Remaining battery energy, -1: autopilot estimate the remaining
 * battery
 */
 ...
 *
 * @return [c%] Communication drop rate, (UART, I2C, SPI, CAN), dropped packets
 ...
 */
static inline void mavlink_msg_sys_status_decode(
    const mavlink_message_t* msg, mavlink_sys_status_t* sys_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  sys_status->onboard_control_sensors_present =
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SYS_STATUS_LEN
                    ? msg->len
