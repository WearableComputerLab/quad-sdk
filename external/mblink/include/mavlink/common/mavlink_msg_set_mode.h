...
MAVPACKED(typedef struct __mavlink_set_mode_t {
  uint32_t custom_mode;  /*<  The new autopilot-specific mode. This field can be
                            ignored by an autopilot.*/
  ...
  {                                                                     \
    11, "SET_MODE", 3, {                                                \
      {"target_system",                                                 \
       ...
       0,                                                               \
       4,                                                               \
       offsetof(mavlink_set_mode_t, target_system)},                    \
          {"base_mode", NULL, MAVLINK_TYPE_UINT8_T,                     \
           0,           5,    offsetof(mavlink_set_mode_t, base_mode)}, \
          {"custom_mode",                                               \
           NULL,                                                        \
           MAVLINK_TYPE_UINT32_T,                                       \
           0,                                                           \
           0,                                                           \
           offsetof(mavlink_set_mode_t, custom_mode)},                  \
    }                                                                   \
  }
#else
#define MAVLINK_MESSAGE_INFO_SET_MODE                                   \
 ...
 * @param custom_mode  The new autopilot-specific mode. This field can be
 * ignored by an autopilot.
...
static inline uint16_t mavlink_msg_set_mode_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_SET_MODE_MIN_LEN,
...
static inline uint16_t mavlink_msg_set_mode_pack_chan(
    ...
    mavlink_message_t* msg, uint8_t target_system, uint8_t base_mode,
...
static inline uint16_t mavlink_msg_set_mode_encode_chan(
  ...
  return mavlink_msg_set_mode_pack_chan(
      system_id, component_id, chan, msg, set_mode->target_system,
...
static inline void mavlink_msg_set_mode_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SET_MODE, buf, MAVLINK_MSG_ID_SET_MODE_MIN_LEN,
      MAVLINK_MSG_ID_SET_MODE_LEN, MAVLINK_MSG_ID_SET_MODE_CRC);
#else
  mavlink_set_mode_t packet;
  packet.custom_mode = custom_mode;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SET_MODE, (const char*)&packet,
      MAVLINK_MSG_ID_SET_MODE_MIN_LEN, MAVLINK_MSG_ID_SET_MODE_LEN,
      MAVLINK_MSG_ID_SET_MODE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_set_mode_send_struct(
    mavlink_channel_t chan, const mavlink_set_mode_t* set_mode) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_set_mode_send(chan, set_mode->target_system, set_mode->base_mode,
                            set_mode->custom_mode);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SET_MODE, (const char*)set_mode,
      MAVLINK_MSG_ID_SET_MODE_MIN_LEN, MAVLINK_MSG_ID_SET_MODE_LEN,
      MAVLINK_MSG_ID_SET_MODE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_set_mode_send_buf(mavlink_message_t* msgbuf,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SET_MODE_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_SET_MODE_LEN;
