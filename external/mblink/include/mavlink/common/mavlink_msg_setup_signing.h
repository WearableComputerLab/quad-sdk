...
MAVPACKED(typedef struct __mavlink_setup_signing_t {
  ...
  {                                                                            \
    256, "SETUP_SIGNING", 4, {                                                 \
      {"target_system",                                                        \
       ...
       0,                                                                      \
       8,                                                                      \
       offsetof(mavlink_setup_signing_t, target_system)},                      \
          {"target_component",                                                 \
           NULL,                                                               \
           MAVLINK_TYPE_UINT8_T,                                               \
           0,                                                                  \
           9,                                                                  \
           offsetof(mavlink_setup_signing_t, target_component)},               \
          {"secret_key", NULL, MAVLINK_TYPE_UINT8_T,                           \
           32,           10,   offsetof(mavlink_setup_signing_t, secret_key)}, \
          {"initial_timestamp",                                                \
           NULL,                                                               \
           MAVLINK_TYPE_UINT64_T,                                              \
           0,                                                                  \
           0,                                                                  \
           offsetof(mavlink_setup_signing_t, initial_timestamp)},              \
    }                                                                          \
  }
#else
#define MAVLINK_MESSAGE_INFO_SETUP_SIGNING                                     \
 ...
 */
static inline uint16_t mavlink_msg_setup_signing_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint8_t target_system, uint8_t target_component, const uint8_t* secret_key,
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_SETUP_SIGNING_MIN_LEN,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_setup_signing_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_SETUP_SIGNING_MIN_LEN,
      MAVLINK_MSG_ID_SETUP_SIGNING_LEN, MAVLINK_MSG_ID_SETUP_SIGNING_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_setup_signing_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_setup_signing_t* setup_signing) {
  return mavlink_msg_setup_signing_pack(
      system_id, component_id, msg, setup_signing->target_system,
      setup_signing->target_component, setup_signing->secret_key,
 ...
 * @param setup_signing C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_setup_signing_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_setup_signing_t* setup_signing) {
  return mavlink_msg_setup_signing_pack_chan(
      system_id, component_id, chan, msg, setup_signing->target_system,
      setup_signing->target_component, setup_signing->secret_key,
      setup_signing->initial_timestamp);
}
...
static inline void mavlink_msg_setup_signing_send(mavlink_channel_t chan,
  ...
  _mav_put_uint8_t(buf, 9, target_component);
  _mav_put_uint8_t_array(buf, 10, secret_key, 32);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SETUP_SIGNING, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SETUP_SIGNING, (const char*)&packet,
      MAVLINK_MSG_ID_SETUP_SIGNING_MIN_LEN, MAVLINK_MSG_ID_SETUP_SIGNING_LEN,
      MAVLINK_MSG_ID_SETUP_SIGNING_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_setup_signing_send_struct(
    mavlink_channel_t chan, const mavlink_setup_signing_t* setup_signing) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_setup_signing_send(
      chan, setup_signing->target_system, setup_signing->target_component,
      setup_signing->secret_key, setup_signing->initial_timestamp);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SETUP_SIGNING, (const char*)setup_signing,
      MAVLINK_MSG_ID_SETUP_SIGNING_MIN_LEN, MAVLINK_MSG_ID_SETUP_SIGNING_LEN,
      MAVLINK_MSG_ID_SETUP_SIGNING_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_setup_signing_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system,
    uint8_t target_component, const uint8_t* secret_key,
    uint64_t initial_timestamp) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint8_t mavlink_msg_setup_signing_get_target_system(
 ...
 */
static inline uint8_t mavlink_msg_setup_signing_get_target_component(
    const mavlink_message_t* msg) {
 ...
 * @return  signing key
 */
static inline uint16_t mavlink_msg_setup_signing_get_secret_key(
    const mavlink_message_t* msg, uint8_t* secret_key) {
 ...
 */
static inline uint64_t mavlink_msg_setup_signing_get_initial_timestamp(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_setup_signing_decode(
    const mavlink_message_t* msg, mavlink_setup_signing_t* setup_signing) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  setup_signing->initial_timestamp =
      mavlink_msg_setup_signing_get_initial_timestamp(msg);
  setup_signing->target_system =
      mavlink_msg_setup_signing_get_target_system(msg);
  setup_signing->target_component =
      mavlink_msg_setup_signing_get_target_component(msg);
  mavlink_msg_setup_signing_get_secret_key(msg, setup_signing->secret_key);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SETUP_SIGNING_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_SETUP_SIGNING_LEN;
