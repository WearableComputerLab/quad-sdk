...
MAVPACKED(typedef struct __mavlink_gps_raw_int_t {
  ...
  int32_t alt; /*< [mm] Altitude (MSL). Positive for up. Note that virtually all
                  GPS modules provide the MSL altitude in addition to the WGS84
                  altitude.*/
  ...
  uint16_t cog; /*< [cdeg] Course over ground (NOT heading, but direction of
                   movement) in degrees * 100, 0.0..359.99 degrees. If unknown,
                   set to: UINT16_MAX*/
  ...
  {                                                                      \
    24, "GPS_RAW_INT", 15, {                                             \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                         \
       0,           0,    offsetof(mavlink_gps_raw_int_t, time_usec)},   \
          {"fix_type", NULL, MAVLINK_TYPE_UINT8_T,                       \
           0,          28,   offsetof(mavlink_gps_raw_int_t, fix_type)}, \
          {"lat", NULL, MAVLINK_TYPE_INT32_T,                            \
           0,     8,    offsetof(mavlink_gps_raw_int_t, lat)},           \
          {"lon", NULL, MAVLINK_TYPE_INT32_T,                            \
           0,     12,   offsetof(mavlink_gps_raw_int_t, lon)},           \
          {"alt", NULL, MAVLINK_TYPE_INT32_T,                            \
           0,     16,   offsetof(mavlink_gps_raw_int_t, alt)},           \
          {"eph", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,     20,   offsetof(mavlink_gps_raw_int_t, eph)},           \
          {"epv", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,     22,   offsetof(mavlink_gps_raw_int_t, epv)},           \
          {"vel", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,     24,   offsetof(mavlink_gps_raw_int_t, vel)},           \
          {"cog", NULL, MAVLINK_TYPE_UINT16_T,                           \
           0,     26,   offsetof(mavlink_gps_raw_int_t, cog)},           \
          {"satellites_visible",                                         \
           NULL,                                                         \
           MAVLINK_TYPE_UINT8_T,                                         \
           0,                                                            \
           29,                                                           \
           offsetof(mavlink_gps_raw_int_t, satellites_visible)},         \
          {"alt_ellipsoid",                                              \
           NULL,                                                         \
           MAVLINK_TYPE_INT32_T,                                         \
           0,                                                            \
           30,                                                           \
           offsetof(mavlink_gps_raw_int_t, alt_ellipsoid)},              \
          {"h_acc", NULL, MAVLINK_TYPE_UINT32_T,                         \
           0,       34,   offsetof(mavlink_gps_raw_int_t, h_acc)},       \
          {"v_acc", NULL, MAVLINK_TYPE_UINT32_T,                         \
           0,       38,   offsetof(mavlink_gps_raw_int_t, v_acc)},       \
          {"vel_acc", NULL, MAVLINK_TYPE_UINT32_T,                       \
           0,         42,   offsetof(mavlink_gps_raw_int_t, vel_acc)},   \
          {"hdg_acc", NULL, MAVLINK_TYPE_UINT32_T,                       \
           0,         46,   offsetof(mavlink_gps_raw_int_t, hdg_acc)},   \
    }                                                                    \
  }
#else
#define MAVLINK_MESSAGE_INFO_GPS_RAW_INT                                 \
 ...
 * @param eph  GPS HDOP horizontal dilution of position (unitless). If unknown,
 * set to: UINT16_MAX
 * @param epv  GPS VDOP vertical dilution of position (unitless). If unknown,
 * set to: UINT16_MAX
 ...
 * 255
 * @param alt_ellipsoid [mm] Altitude (above WGS84, EGM96 ellipsoid). Positive
 * for up.
...
static inline uint16_t mavlink_msg_gps_raw_int_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_GPS_RAW_INT_MIN_LEN,
...
static inline uint16_t mavlink_msg_gps_raw_int_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_GPS_RAW_INT_MIN_LEN,
      MAVLINK_MSG_ID_GPS_RAW_INT_LEN, MAVLINK_MSG_ID_GPS_RAW_INT_CRC);
}
...
static inline uint16_t mavlink_msg_gps_raw_int_encode(
  ...
  return mavlink_msg_gps_raw_int_pack(
      system_id, component_id, msg, gps_raw_int->time_usec,
      gps_raw_int->fix_type, gps_raw_int->lat, gps_raw_int->lon,
      gps_raw_int->alt, gps_raw_int->eph, gps_raw_int->epv, gps_raw_int->vel,
      gps_raw_int->cog, gps_raw_int->satellites_visible,
      gps_raw_int->alt_ellipsoid, gps_raw_int->h_acc, gps_raw_int->v_acc,
...
static inline uint16_t mavlink_msg_gps_raw_int_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_gps_raw_int_t* gps_raw_int) {
  return mavlink_msg_gps_raw_int_pack_chan(
      system_id, component_id, chan, msg, gps_raw_int->time_usec,
      gps_raw_int->fix_type, gps_raw_int->lat, gps_raw_int->lon,
      gps_raw_int->alt, gps_raw_int->eph, gps_raw_int->epv, gps_raw_int->vel,
      gps_raw_int->cog, gps_raw_int->satellites_visible,
      gps_raw_int->alt_ellipsoid, gps_raw_int->h_acc, gps_raw_int->v_acc,
...
static inline void mavlink_msg_gps_raw_int_send(
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_RAW_INT, buf, MAVLINK_MSG_ID_GPS_RAW_INT_MIN_LEN,
      MAVLINK_MSG_ID_GPS_RAW_INT_LEN, MAVLINK_MSG_ID_GPS_RAW_INT_CRC);
#else
  mavlink_gps_raw_int_t packet;
  packet.time_usec = time_usec;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_RAW_INT, (const char*)&packet,
      MAVLINK_MSG_ID_GPS_RAW_INT_MIN_LEN, MAVLINK_MSG_ID_GPS_RAW_INT_LEN,
 ...
 */
static inline void mavlink_msg_gps_raw_int_send_struct(
    mavlink_channel_t chan, const mavlink_gps_raw_int_t* gps_raw_int) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_gps_raw_int_send(
      chan, gps_raw_int->time_usec, gps_raw_int->fix_type, gps_raw_int->lat,
      gps_raw_int->lon, gps_raw_int->alt, gps_raw_int->eph, gps_raw_int->epv,
      gps_raw_int->vel, gps_raw_int->cog, gps_raw_int->satellites_visible,
      gps_raw_int->alt_ellipsoid, gps_raw_int->h_acc, gps_raw_int->v_acc,
      gps_raw_int->vel_acc, gps_raw_int->hdg_acc);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_RAW_INT, (const char*)gps_raw_int,
      MAVLINK_MSG_ID_GPS_RAW_INT_MIN_LEN, MAVLINK_MSG_ID_GPS_RAW_INT_LEN,
      MAVLINK_MSG_ID_GPS_RAW_INT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_gps_raw_int_send_buf(
    ...
    int32_t alt_ellipsoid, uint32_t h_acc, uint32_t v_acc, uint32_t vel_acc,
    uint32_t hdg_acc) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return  GPS HDOP horizontal dilution of position (unitless). If unknown, set
 * to: UINT16_MAX
 */
 ...
 *
 * @return  GPS VDOP vertical dilution of position (unitless). If unknown, set
 * to: UINT16_MAX
 */
 ...
 *
 * @return [cdeg] Course over ground (NOT heading, but direction of movement) in
 ...
 */
static inline int32_t mavlink_msg_gps_raw_int_get_alt_ellipsoid(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_gps_raw_int_get_v_acc(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_gps_raw_int_get_vel_acc(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_gps_raw_int_decode(
    const mavlink_message_t* msg, mavlink_gps_raw_int_t* gps_raw_int) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_GPS_RAW_INT_LEN
                    ? msg->len
