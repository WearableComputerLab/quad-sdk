  ...
  {                                                                  \
    241, "VIBRATION", 7, {                                           \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                     \
       0,           0,    offsetof(mavlink_vibration_t, time_usec)}, \
          {"vibration_x",                                            \
           NULL,                                                     \
           MAVLINK_TYPE_FLOAT,                                       \
           0,                                                        \
           8,                                                        \
           offsetof(mavlink_vibration_t, vibration_x)},              \
          {"vibration_y",                                            \
           NULL,                                                     \
           MAVLINK_TYPE_FLOAT,                                       \
           0,                                                        \
           12,                                                       \
           offsetof(mavlink_vibration_t, vibration_y)},              \
          {"vibration_z",                                            \
           NULL,                                                     \
           MAVLINK_TYPE_FLOAT,                                       \
           0,                                                        \
           16,                                                       \
           offsetof(mavlink_vibration_t, vibration_z)},              \
          {"clipping_0",                                             \
           NULL,                                                     \
           MAVLINK_TYPE_UINT32_T,                                    \
           0,                                                        \
           20,                                                       \
           offsetof(mavlink_vibration_t, clipping_0)},               \
          {"clipping_1",                                             \
           NULL,                                                     \
           MAVLINK_TYPE_UINT32_T,                                    \
           0,                                                        \
           24,                                                       \
           offsetof(mavlink_vibration_t, clipping_1)},               \
          {"clipping_2",                                             \
           NULL,                                                     \
           MAVLINK_TYPE_UINT32_T,                                    \
           0,                                                        \
           28,                                                       \
           offsetof(mavlink_vibration_t, clipping_2)},               \
    }                                                                \
  }
#else
#define MAVLINK_MESSAGE_INFO_VIBRATION                               \
 ...
 */
static inline uint16_t mavlink_msg_vibration_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint64_t time_usec, float vibration_x, float vibration_y, float vibration_z,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_vibration_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint64_t time_usec, float vibration_x,
    float vibration_y, float vibration_z, uint32_t clipping_0,
    uint32_t clipping_1, uint32_t clipping_2) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_VIBRATION_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  _mav_put_float(buf, 8, vibration_x);
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_VIBRATION_MIN_LEN,
      MAVLINK_MSG_ID_VIBRATION_LEN, MAVLINK_MSG_ID_VIBRATION_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_vibration_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_vibration_t* vibration) {
  return mavlink_msg_vibration_pack(
      system_id, component_id, msg, vibration->time_usec,
 ...
 * @param vibration C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_vibration_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_vibration_t* vibration) {
  return mavlink_msg_vibration_pack_chan(
      system_id, component_id, chan, msg, vibration->time_usec,
      vibration->vibration_x, vibration->vibration_y, vibration->vibration_z,
      vibration->clipping_0, vibration->clipping_1, vibration->clipping_2);
}
...
static inline void mavlink_msg_vibration_send(
    mavlink_channel_t chan, uint64_t time_usec, float vibration_x,
    float vibration_y, float vibration_z, uint32_t clipping_0,
    uint32_t clipping_1, uint32_t clipping_2) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_VIBRATION_LEN];
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_VIBRATION, buf, MAVLINK_MSG_ID_VIBRATION_MIN_LEN,
      MAVLINK_MSG_ID_VIBRATION_LEN, MAVLINK_MSG_ID_VIBRATION_CRC);
#else
  mavlink_vibration_t packet;
  packet.time_usec = time_usec;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_VIBRATION, (const char*)&packet,
      MAVLINK_MSG_ID_VIBRATION_MIN_LEN, MAVLINK_MSG_ID_VIBRATION_LEN,
 ...
 */
static inline void mavlink_msg_vibration_send_struct(
    mavlink_channel_t chan, const mavlink_vibration_t* vibration) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_vibration_send(chan, vibration->time_usec, vibration->vibration_x,
                             vibration->vibration_y, vibration->vibration_z,
                             vibration->clipping_0, vibration->clipping_1,
                             vibration->clipping_2);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_VIBRATION, (const char*)vibration,
      MAVLINK_MSG_ID_VIBRATION_MIN_LEN, MAVLINK_MSG_ID_VIBRATION_LEN,
      MAVLINK_MSG_ID_VIBRATION_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_vibration_send_buf(
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_vibration_get_time_usec(
 ...
 */
static inline float mavlink_msg_vibration_get_vibration_x(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_vibration_get_vibration_y(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_vibration_get_vibration_z(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_vibration_get_clipping_0(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_vibration_get_clipping_1(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_vibration_get_clipping_2(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_vibration_decode(
    const mavlink_message_t* msg, mavlink_vibration_t* vibration) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_VIBRATION_LEN
                    ? msg->len
