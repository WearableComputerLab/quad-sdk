...
MAVPACKED(typedef struct __mavlink_set_position_target_global_int_t {
  ...
  float alt; /*< [m] Altitude (MSL, Relative to home, or AGL - depending on
                frame)*/
...
#define MAVLINK_MESSAGE_INFO_SET_POSITION_TARGET_GLOBAL_INT                     \
  {                                                                             \
    86, "SET_POSITION_TARGET_GLOBAL_INT", 16, {                                 \
      {"time_boot_ms",                                                          \
       NULL,                                                                    \
       MAVLINK_TYPE_UINT32_T,                                                   \
       0,                                                                       \
       0,                                                                       \
       offsetof(mavlink_set_position_target_global_int_t, time_boot_ms)},       \
          {"target_system",                                                     \
           NULL,                                                                \
           MAVLINK_TYPE_UINT8_T,                                                \
           0,                                                                   \
           50,                                                                  \
           offsetof(mavlink_set_position_target_global_int_t, target_system)},  \
          {"target_component",                                                  \
           NULL,                                                                \
           MAVLINK_TYPE_UINT8_T,                                                \
           0,                                                                   \
           51,                                                                  \
           offsetof(mavlink_set_position_target_global_int_t,                   \
                    target_component)},                                         \
          {"coordinate_frame",                                                  \
           NULL,                                                                \
           MAVLINK_TYPE_UINT8_T,                                                \
          ...
          {"type_mask",                                                         \
           ...
           0,                                                                   \
           48,                                                                  \
           offsetof(mavlink_set_position_target_global_int_t, type_mask)},      \
          {"lat_int",                                                           \
           NULL,                                                                \
           MAVLINK_TYPE_INT32_T,                                                \
           0,                                                                   \
           4,                                                                   \
           offsetof(mavlink_set_position_target_global_int_t, lat_int)},        \
          {"lon_int",                                                           \
           NULL,                                                                \
           MAVLINK_TYPE_INT32_T,                                                \
           0,                                                                   \
           8,                                                                   \
           offsetof(mavlink_set_position_target_global_int_t, lon_int)},        \
          {"alt",                                                               \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           12,                                                                  \
           offsetof(mavlink_set_position_target_global_int_t, alt)},            \
          {"vx", NULL, MAVLINK_TYPE_FLOAT,                                      \
           0,    16,   offsetof(mavlink_set_position_target_global_int_t, vx)}, \
          {"vy", NULL, MAVLINK_TYPE_FLOAT,                                      \
           0,    20,   offsetof(mavlink_set_position_target_global_int_t, vy)}, \
          {"vz", NULL, MAVLINK_TYPE_FLOAT,                                      \
           0,    24,   offsetof(mavlink_set_position_target_global_int_t, vz)}, \
          {"afx",                                                               \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           28,                                                                  \
           offsetof(mavlink_set_position_target_global_int_t, afx)},            \
          {"afy",                                                               \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           32,                                                                  \
           offsetof(mavlink_set_position_target_global_int_t, afy)},            \
          {"afz",                                                               \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           36,                                                                  \
           offsetof(mavlink_set_position_target_global_int_t, afz)},            \
          {"yaw",                                                               \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           40,                                                                  \
           offsetof(mavlink_set_position_target_global_int_t, yaw)},            \
          {"yaw_rate",                                                          \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           0,                                                                   \
           44,                                                                  \
           offsetof(mavlink_set_position_target_global_int_t, yaw_rate)},       \
    }                                                                           \
  }
#else
#define MAVLINK_MESSAGE_INFO_SET_POSITION_TARGET_GLOBAL_INT                     \
  {                                                                             \
    "SET_POSITION_TARGET_GLOBAL_INT", 16, {                                     \
      {"time_boot_ms",                                                          \
       NULL,                                                                    \
       MAVLINK_TYPE_UINT32_T,                                                   \
       0,                                                                       \
...
static inline uint16_t mavlink_msg_set_position_target_global_int_pack(
    ...
    uint32_t time_boot_ms, uint8_t target_system, uint8_t target_component,
...
static inline uint16_t mavlink_msg_set_position_target_global_int_pack_chan(
    ...
    mavlink_message_t* msg, uint32_t time_boot_ms, uint8_t target_system,
    uint8_t target_component, uint8_t coordinate_frame, uint16_t type_mask,
 ...
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 * @param set_position_target_global_int C-struct to read the message contents
 * from
 */
static inline uint16_t mavlink_msg_set_position_target_global_int_encode(
  ...
  return mavlink_msg_set_position_target_global_int_pack(
      ...
      set_position_target_global_int->alt, set_position_target_global_int->vx,
      set_position_target_global_int->vy, set_position_target_global_int->vz,
      set_position_target_global_int->afx, set_position_target_global_int->afy,
      set_position_target_global_int->afz, set_position_target_global_int->yaw,
...
static inline void mavlink_msg_set_position_target_global_int_send(
    mavlink_channel_t chan, uint32_t time_boot_ms, uint8_t target_system,
    uint8_t target_component, uint8_t coordinate_frame, uint16_t type_mask,
    int32_t lat_int, int32_t lon_int, float alt, float vx, float vy, float vz,
    float afx, float afy, float afz, float yaw, float yaw_rate) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT, buf,
      MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT_MIN_LEN,
      MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT_LEN,
      MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT, (const char*)&packet,
      MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT_MIN_LEN,
      MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT_LEN,
      MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT_CRC);
#endif
 ...
 */
static inline void mavlink_msg_set_position_target_global_int_send_struct(
    mavlink_channel_t chan, const mavlink_set_position_target_global_int_t*
                                set_position_target_global_int) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_set_position_target_global_int_send(
      chan, set_position_target_global_int->time_boot_ms,
      set_position_target_global_int->target_system,
      set_position_target_global_int->target_component,
      set_position_target_global_int->coordinate_frame,
      set_position_target_global_int->type_mask,
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT,
 ...
 */
static inline void mavlink_msg_set_position_target_global_int_send_buf(
...
#else
  mavlink_set_position_target_global_int_t* packet =
      (mavlink_set_position_target_global_int_t*)msgbuf;
  packet->time_boot_ms = time_boot_ms;
  packet->lat_int = lat_int;
  packet->lon_int = lon_int;
  packet->alt = alt;
...
mavlink_msg_set_position_target_global_int_get_target_system(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t
mavlink_msg_set_position_target_global_int_get_target_component(
    const mavlink_message_t* msg) {
 ...
 * vehicle.
 */
static inline uint16_t mavlink_msg_set_position_target_global_int_get_type_mask(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_set_position_target_global_int_get_lon_int(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_global_int_get_alt(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_global_int_get_vx(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_global_int_get_vy(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_global_int_get_vz(
    const mavlink_message_t* msg) {
 ...
 * NED frame in meter / s^2 or N
 */
static inline float mavlink_msg_set_position_target_global_int_get_afx(
    const mavlink_message_t* msg) {
 ...
 * NED frame in meter / s^2 or N
 */
static inline float mavlink_msg_set_position_target_global_int_get_afy(
    const mavlink_message_t* msg) {
 ...
 * NED frame in meter / s^2 or N
 */
static inline float mavlink_msg_set_position_target_global_int_get_afz(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_position_target_global_int_get_yaw_rate(
    const mavlink_message_t* msg) {
 ...
 * @param set_position_target_global_int C-struct to decode the message contents
 * into
 */
static inline void mavlink_msg_set_position_target_global_int_decode(
    const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT_LEN;
  memset(set_position_target_global_int, 0,
         MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT_LEN);
