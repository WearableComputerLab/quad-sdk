  ...
  {                                                                              \
    49, "GPS_GLOBAL_ORIGIN", 4, {                                                \
      {"latitude", NULL, MAVLINK_TYPE_INT32_T,                                   \
       0,          0,    offsetof(mavlink_gps_global_origin_t, latitude)},       \
          {"longitude", NULL, MAVLINK_TYPE_INT32_T,                              \
           0,           4,    offsetof(mavlink_gps_global_origin_t, longitude)}, \
          {"altitude", NULL, MAVLINK_TYPE_INT32_T,                               \
           0,          8,    offsetof(mavlink_gps_global_origin_t, altitude)},   \
          {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                             \
           0,           12,   offsetof(mavlink_gps_global_origin_t, time_usec)}, \
    }                                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_GPS_GLOBAL_ORIGIN                                   \
...
static inline uint16_t mavlink_msg_gps_global_origin_encode(
  ...
  return mavlink_msg_gps_global_origin_pack(
      system_id, component_id, msg, gps_global_origin->latitude,
      gps_global_origin->longitude, gps_global_origin->altitude,
...
static inline uint16_t mavlink_msg_gps_global_origin_encode_chan(
  ...
  return mavlink_msg_gps_global_origin_pack_chan(
      system_id, component_id, chan, msg, gps_global_origin->latitude,
      gps_global_origin->longitude, gps_global_origin->altitude,
      gps_global_origin->time_usec);
}
...
static inline void mavlink_msg_gps_global_origin_send(mavlink_channel_t chan,
                                                      int32_t latitude,
                                                      int32_t longitude,
                                                      int32_t altitude,
                                                      uint64_t time_usec) {
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN, buf,
                                  MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN_MIN_LEN,
                                  MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN_LEN,
                                  MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN_MIN_LEN,
                                  MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN_LEN,
                                  MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN_CRC);
 ...
 */
static inline void mavlink_msg_gps_global_origin_send_struct(
    mavlink_channel_t chan,
    const mavlink_gps_global_origin_t* gps_global_origin) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_gps_global_origin_send(
      chan, gps_global_origin->latitude, gps_global_origin->longitude,
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_gps_global_origin_get_time_usec(
    const mavlink_message_t* msg) {
...
static inline void mavlink_msg_gps_global_origin_decode(
  ...
  gps_global_origin->time_usec =
      mavlink_msg_gps_global_origin_get_time_usec(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN_LEN;
