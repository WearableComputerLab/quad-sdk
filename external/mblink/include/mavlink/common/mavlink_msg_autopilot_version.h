...
MAVPACKED(typedef struct __mavlink_autopilot_version_t {
  ...
  uint8_t
      flight_custom_version[8]; /*<  Custom version field, commonly the first 8
  ...
  uint8_t middleware_custom_version
      [8]; /*<  Custom version field, commonly the first 8 bytes of the git
              ...
              identify the commit using the main version number even for very
              large code bases.*/
  uint8_t os_custom_version[8]; /*<  Custom version field, commonly the first 8
                                   bytes of the git hash. This is not an unique
                                   identifier, but should allow to identify the
                                   commit using the main version number even for
                                   very large code bases.*/
  uint8_t uid2[18]; /*<  UID if provided by hardware (supersedes the uid field.
...
#define MAVLINK_MESSAGE_INFO_AUTOPILOT_VERSION                                   \
  {                                                                              \
    148, "AUTOPILOT_VERSION", 12, {                                              \
      {"capabilities",                                                           \
       NULL,                                                                     \
       MAVLINK_TYPE_UINT64_T,                                                    \
       0,                                                                        \
       0,                                                                        \
       offsetof(mavlink_autopilot_version_t, capabilities)},                     \
          {"flight_sw_version",                                                  \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT32_T,                                                \
           0,                                                                    \
           16,                                                                   \
           offsetof(mavlink_autopilot_version_t, flight_sw_version)},            \
          {"middleware_sw_version",                                              \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT32_T,                                                \
           0,                                                                    \
           20,                                                                   \
           offsetof(mavlink_autopilot_version_t, middleware_sw_version)},        \
          {"os_sw_version",                                                      \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT32_T,                                                \
           0,                                                                    \
           24,                                                                   \
           offsetof(mavlink_autopilot_version_t, os_sw_version)},                \
          {"board_version",                                                      \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT32_T,                                                \
           0,                                                                    \
           28,                                                                   \
           offsetof(mavlink_autopilot_version_t, board_version)},                \
          {"flight_custom_version",                                              \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT8_T,                                                 \
           8,                                                                    \
           36,                                                                   \
           offsetof(mavlink_autopilot_version_t, flight_custom_version)},        \
          {"middleware_custom_version",                                          \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT8_T,                                                 \
           8,                                                                    \
           44,                                                                   \
           offsetof(mavlink_autopilot_version_t, middleware_custom_version)},    \
          {"os_custom_version",                                                  \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT8_T,                                                 \
           8,                                                                    \
           52,                                                                   \
           offsetof(mavlink_autopilot_version_t, os_custom_version)},            \
          {"vendor_id", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,           32,   offsetof(mavlink_autopilot_version_t, vendor_id)}, \
          {"product_id",                                                         \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT16_T,                                                \
           0,                                                                    \
           34,                                                                   \
           offsetof(mavlink_autopilot_version_t, product_id)},                   \
          {"uid", NULL, MAVLINK_TYPE_UINT64_T,                                   \
           0,     8,    offsetof(mavlink_autopilot_version_t, uid)},             \
          {"uid2", NULL, MAVLINK_TYPE_UINT8_T,                                   \
           18,     60,   offsetof(mavlink_autopilot_version_t, uid2)},           \
    }                                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_AUTOPILOT_VERSION                                   \
  {                                                                              \
    "AUTOPILOT_VERSION", 12, {                                                   \
      {"capabilities",                                                           \
       NULL,                                                                     \
       MAVLINK_TYPE_UINT64_T,                                                    \
       0,                                                                        \
 ...
 * @param board_version  HW / board version (last 8 bytes should be silicon ID,
 * if any)
 * @param flight_custom_version  Custom version field, commonly the first 8
 * bytes of the git hash. This is not an unique identifier, but should allow to
 * identify the commit using the main version number even for very large code
 * bases.
 * @param middleware_custom_version  Custom version field, commonly the first 8
 * bytes of the git hash. This is not an unique identifier, but should allow to
 * identify the commit using the main version number even for very large code
 * bases.
 * @param os_custom_version  Custom version field, commonly the first 8 bytes of
 * the git hash. This is not an unique identifier, but should allow to identify
 * the commit using the main version number even for very large code bases.
...
static inline uint16_t mavlink_msg_autopilot_version_pack(
    ...
    const uint8_t *middleware_custom_version, const uint8_t *os_custom_version,
    uint16_t vendor_id, uint16_t product_id, uint64_t uid,
    const uint8_t *uid2) {
  ...
  mav_array_memcpy(packet.flight_custom_version, flight_custom_version,
                   sizeof(uint8_t) * 8);
  mav_array_memcpy(packet.middleware_custom_version, middleware_custom_version,
                   sizeof(uint8_t) * 8);
  mav_array_memcpy(packet.os_custom_version, os_custom_version,
                   sizeof(uint8_t) * 8);
...
static inline uint16_t mavlink_msg_autopilot_version_pack_chan(
    ...
    mavlink_message_t *msg, uint64_t capabilities, uint32_t flight_sw_version,
    uint32_t middleware_sw_version, uint32_t os_sw_version,
    uint32_t board_version, const uint8_t *flight_custom_version,
    const uint8_t *middleware_custom_version, const uint8_t *os_custom_version,
    uint16_t vendor_id, uint16_t product_id, uint64_t uid,
...
static inline uint16_t mavlink_msg_autopilot_version_encode(
  ...
  return mavlink_msg_autopilot_version_pack(
      system_id, component_id, msg, autopilot_version->capabilities,
      autopilot_version->flight_sw_version,
      autopilot_version->middleware_sw_version,
      autopilot_version->os_sw_version, autopilot_version->board_version,
      autopilot_version->flight_custom_version,
      autopilot_version->middleware_custom_version,
      autopilot_version->os_custom_version, autopilot_version->vendor_id,
...
static inline uint16_t mavlink_msg_autopilot_version_encode_chan(
  ...
  return mavlink_msg_autopilot_version_pack_chan(
      system_id, component_id, chan, msg, autopilot_version->capabilities,
      autopilot_version->flight_sw_version,
      autopilot_version->middleware_sw_version,
      autopilot_version->os_sw_version, autopilot_version->board_version,
      autopilot_version->flight_custom_version,
...
static inline void mavlink_msg_autopilot_version_send(
    mavlink_channel_t chan, uint64_t capabilities, uint32_t flight_sw_version,
    uint32_t middleware_sw_version, uint32_t os_sw_version,
    uint32_t board_version, const uint8_t *flight_custom_version,
    const uint8_t *middleware_custom_version, const uint8_t *os_custom_version,
    uint16_t vendor_id, uint16_t product_id, uint64_t uid,
  ...
  _mav_put_uint8_t_array(buf, 52, os_custom_version, 8);
  _mav_put_uint8_t_array(buf, 60, uid2, 18);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AUTOPILOT_VERSION, buf,
                                  MAVLINK_MSG_ID_AUTOPILOT_VERSION_MIN_LEN,
                                  MAVLINK_MSG_ID_AUTOPILOT_VERSION_LEN,
                                  MAVLINK_MSG_ID_AUTOPILOT_VERSION_CRC);
#else
 ...
 */
static inline void mavlink_msg_autopilot_version_send_struct(
...
static inline void mavlink_msg_autopilot_version_send_buf(
    mavlink_message_t *msgbuf, mavlink_channel_t chan, uint64_t capabilities,
    uint32_t flight_sw_version, uint32_t middleware_sw_version,
    uint32_t os_sw_version, uint32_t board_version,
 ...
 */
static inline uint64_t mavlink_msg_autopilot_version_get_capabilities(
 ...
 */
static inline uint32_t mavlink_msg_autopilot_version_get_flight_sw_version(
    const mavlink_message_t *msg) {
 ...
 */
static inline uint32_t mavlink_msg_autopilot_version_get_middleware_sw_version(
    const mavlink_message_t *msg) {
 ...
 */
static inline uint32_t mavlink_msg_autopilot_version_get_os_sw_version(
    const mavlink_message_t *msg) {
 ...
 */
static inline uint32_t mavlink_msg_autopilot_version_get_board_version(
    const mavlink_message_t *msg) {
 ...
 *
 * @return  Custom version field, commonly the first 8 bytes of the git hash.
 * This is not an unique identifier, but should allow to identify the commit
 * using the main version number even for very large code bases.
 */
static inline uint16_t mavlink_msg_autopilot_version_get_flight_custom_version(
...
mavlink_msg_autopilot_version_get_middleware_custom_version(
 ...
 */
static inline uint16_t mavlink_msg_autopilot_version_get_vendor_id(
    const mavlink_message_t *msg) {
 ...
 */
static inline uint16_t mavlink_msg_autopilot_version_get_product_id(
    const mavlink_message_t *msg) {
 ...
 */
static inline uint64_t mavlink_msg_autopilot_version_get_uid(
    const mavlink_message_t *msg) {
 ...
 */
static inline uint16_t mavlink_msg_autopilot_version_get_uid2(
 ...
 */
static inline void mavlink_msg_autopilot_version_decode(
    const mavlink_message_t *msg,
  ...
  mavlink_msg_autopilot_version_get_flight_custom_version(
      msg, autopilot_version->flight_custom_version);
  mavlink_msg_autopilot_version_get_middleware_custom_version(
      msg, autopilot_version->middleware_custom_version);
  mavlink_msg_autopilot_version_get_os_custom_version(
      msg, autopilot_version->os_custom_version);
  mavlink_msg_autopilot_version_get_uid2(msg, autopilot_version->uid2);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_AUTOPILOT_VERSION_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_AUTOPILOT_VERSION_LEN;
