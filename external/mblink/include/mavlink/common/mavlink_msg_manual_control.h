...
MAVPACKED(typedef struct __mavlink_manual_control_t {
  ...
  int16_t y; /*<  Y-axis, normalized to the range [-1000,1000]. A value of
                INT16_MAX indicates that this axis is invalid. Generally
                corresponds to left(-1000)-right(1000) movement on a joystick
                and the roll of a vehicle.*/
  int16_t
...
#define MAVLINK_MESSAGE_INFO_MANUAL_CONTROL                               \
  {                                                                       \
    69, "MANUAL_CONTROL", 6, {                                            \
      {"target", NULL, MAVLINK_TYPE_UINT8_T,                              \
       0,        10,   offsetof(mavlink_manual_control_t, target)},       \
          {"x", NULL, MAVLINK_TYPE_INT16_T,                               \
           0,   0,    offsetof(mavlink_manual_control_t, x)},             \
          {"y", NULL, MAVLINK_TYPE_INT16_T,                               \
           0,   2,    offsetof(mavlink_manual_control_t, y)},             \
          {"z", NULL, MAVLINK_TYPE_INT16_T,                               \
           0,   4,    offsetof(mavlink_manual_control_t, z)},             \
          {"r", NULL, MAVLINK_TYPE_INT16_T,                               \
           0,   6,    offsetof(mavlink_manual_control_t, r)},             \
          {"buttons", NULL, MAVLINK_TYPE_UINT16_T,                        \
           0,         8,    offsetof(mavlink_manual_control_t, buttons)}, \
    }                                                                     \
  }
#else
#define MAVLINK_MESSAGE_INFO_MANUAL_CONTROL                               \
 ...
 * @param x  X-axis, normalized to the range [-1000,1000]. A value of INT16_MAX
 ...
 * vehicle.
 * @param y  Y-axis, normalized to the range [-1000,1000]. A value of INT16_MAX
 * indicates that this axis is invalid. Generally corresponds to
 * left(-1000)-right(1000) movement on a joystick and the roll of a vehicle.
 * @param z  Z-axis, normalized to the range [-1000,1000]. A value of INT16_MAX
 * indicates that this axis is invalid. Generally corresponds to a separate
 * slider movement with maximum being 1000 and minimum being -1000 on a joystick
 * and the thrust of a vehicle. Positive values are positive thrust, negative
 * values are negative thrust.
 * @param r  R-axis, normalized to the range [-1000,1000]. A value of INT16_MAX
 ...
 * @param buttons  A bitfield corresponding to the joystick buttons' current
 * state, 1 for pressed, 0 for released. The lowest bit corresponds to Button 1.
...
static inline uint16_t mavlink_msg_manual_control_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_MANUAL_CONTROL_MIN_LEN,
      MAVLINK_MSG_ID_MANUAL_CONTROL_LEN, MAVLINK_MSG_ID_MANUAL_CONTROL_CRC);
}
...
static inline uint16_t mavlink_msg_manual_control_pack_chan(
    ...
    mavlink_message_t* msg, uint8_t target, int16_t x, int16_t y, int16_t z,
...
static inline uint16_t mavlink_msg_manual_control_encode(
  ...
  return mavlink_msg_manual_control_pack(
      system_id, component_id, msg, manual_control->target, manual_control->x,
      manual_control->y, manual_control->z, manual_control->r,
...
static inline uint16_t mavlink_msg_manual_control_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_manual_control_t* manual_control) {
  return mavlink_msg_manual_control_pack_chan(
      system_id, component_id, chan, msg, manual_control->target,
...
static inline void mavlink_msg_manual_control_send(mavlink_channel_t chan,
                                                   uint8_t target, int16_t x,
                                                   int16_t y, int16_t z,
                                                   int16_t r,
                                                   uint16_t buttons) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MANUAL_CONTROL, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_MANUAL_CONTROL, (const char*)&packet,
      MAVLINK_MSG_ID_MANUAL_CONTROL_MIN_LEN, MAVLINK_MSG_ID_MANUAL_CONTROL_LEN,
      MAVLINK_MSG_ID_MANUAL_CONTROL_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_manual_control_send_struct(
    mavlink_channel_t chan, const mavlink_manual_control_t* manual_control) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_manual_control_send(
      chan, manual_control->target, manual_control->x, manual_control->y,
      manual_control->z, manual_control->r, manual_control->buttons);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_MANUAL_CONTROL, (const char*)manual_control,
      MAVLINK_MSG_ID_MANUAL_CONTROL_MIN_LEN, MAVLINK_MSG_ID_MANUAL_CONTROL_LEN,
      MAVLINK_MSG_ID_MANUAL_CONTROL_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_manual_control_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target,
 ...
 *
 * @return  X-axis, normalized to the range [-1000,1000]. A value of INT16_MAX
 * indicates that this axis is invalid. Generally corresponds to
 * forward(1000)-backward(-1000) movement on a joystick and the pitch of a
 * vehicle.
 */
static inline int16_t mavlink_msg_manual_control_get_x(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Y-axis, normalized to the range [-1000,1000]. A value of INT16_MAX
 * indicates that this axis is invalid. Generally corresponds to
 * left(-1000)-right(1000) movement on a joystick and the roll of a vehicle.
 */
static inline int16_t mavlink_msg_manual_control_get_y(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Z-axis, normalized to the range [-1000,1000]. A value of INT16_MAX
 * indicates that this axis is invalid. Generally corresponds to a separate
 * slider movement with maximum being 1000 and minimum being -1000 on a joystick
 * and the thrust of a vehicle. Positive values are positive thrust, negative
 * values are negative thrust.
 */
static inline int16_t mavlink_msg_manual_control_get_z(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  R-axis, normalized to the range [-1000,1000]. A value of INT16_MAX
 * indicates that this axis is invalid. Generally corresponds to a twisting of
 * the joystick, with counter-clockwise being 1000 and clockwise being -1000,
 * and the yaw of a vehicle.
 */
static inline int16_t mavlink_msg_manual_control_get_r(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  A bitfield corresponding to the joystick buttons' current state, 1
 * for pressed, 0 for released. The lowest bit corresponds to Button 1.
 */
static inline uint16_t mavlink_msg_manual_control_get_buttons(
    const mavlink_message_t* msg) {
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_MANUAL_CONTROL_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_MANUAL_CONTROL_LEN;
