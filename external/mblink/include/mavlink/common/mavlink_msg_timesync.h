...
MAVPACKED(typedef struct __mavlink_timesync_t {
...
#define MAVLINK_MESSAGE_INFO_TIMESYNC                       \
  {                                                         \
    111, "TIMESYNC", 2, {                                   \
      {"tc1", NULL, MAVLINK_TYPE_INT64_T,                   \
       0,     0,    offsetof(mavlink_timesync_t, tc1)},     \
          {"ts1", NULL, MAVLINK_TYPE_INT64_T,               \
           0,     8,    offsetof(mavlink_timesync_t, ts1)}, \
    }                                                       \
  }
#else
#define MAVLINK_MESSAGE_INFO_TIMESYNC                       \
 ...
 */
static inline uint16_t mavlink_msg_timesync_pack(uint8_t system_id,
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_TIMESYNC_MIN_LEN,
...
static inline uint16_t mavlink_msg_timesync_pack_chan(
    ...
    mavlink_message_t* msg, int64_t tc1, int64_t ts1) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_TIMESYNC_LEN];
  _mav_put_int64_t(buf, 0, tc1);
  _mav_put_int64_t(buf, 8, ts1);
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_TIMESYNC_MIN_LEN,
      MAVLINK_MSG_ID_TIMESYNC_LEN, MAVLINK_MSG_ID_TIMESYNC_CRC);
}
...
static inline uint16_t mavlink_msg_timesync_encode(
  ...
  return mavlink_msg_timesync_pack(system_id, component_id, msg, timesync->tc1,
                                   timesync->ts1);
}
...
static inline uint16_t mavlink_msg_timesync_encode_chan(
  ...
  return mavlink_msg_timesync_pack_chan(system_id, component_id, chan, msg,
...
static inline void mavlink_msg_timesync_send(mavlink_channel_t chan,
                                             int64_t tc1, int64_t ts1) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_TIMESYNC_LEN];
  _mav_put_int64_t(buf, 0, tc1);
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_TIMESYNC, buf, MAVLINK_MSG_ID_TIMESYNC_MIN_LEN,
      MAVLINK_MSG_ID_TIMESYNC_LEN, MAVLINK_MSG_ID_TIMESYNC_CRC);
#else
  mavlink_timesync_t packet;
  packet.tc1 = tc1;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_TIMESYNC, (const char*)&packet,
      MAVLINK_MSG_ID_TIMESYNC_MIN_LEN, MAVLINK_MSG_ID_TIMESYNC_LEN,
 ...
 */
static inline void mavlink_msg_timesync_send_struct(
    mavlink_channel_t chan, const mavlink_timesync_t* timesync) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_timesync_send(chan, timesync->tc1, timesync->ts1);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_TIMESYNC, (const char*)timesync,
      MAVLINK_MSG_ID_TIMESYNC_MIN_LEN, MAVLINK_MSG_ID_TIMESYNC_LEN,
      MAVLINK_MSG_ID_TIMESYNC_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_timesync_send_buf(mavlink_message_t* msgbuf,
 ...
 */
static inline int64_t mavlink_msg_timesync_get_tc1(
 ...
 */
static inline int64_t mavlink_msg_timesync_get_ts1(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_timesync_decode(const mavlink_message_t* msg,
                                               mavlink_timesync_t* timesync) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  timesync->tc1 = mavlink_msg_timesync_get_tc1(msg);
  timesync->ts1 = mavlink_msg_timesync_get_ts1(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_TIMESYNC_LEN
                    ? msg->len
