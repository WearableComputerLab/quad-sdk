...
MAVPACKED(typedef struct __mavlink_terrain_report_t {
  int32_t lat;          /*< [degE7] Latitude*/
  int32_t lon;          /*< [degE7] Longitude*/
  float terrain_height; /*< [m] Terrain height MSL*/
  float current_height; /*< [m] Current vehicle height above lat/lon terrain
                           height*/
  uint16_t spacing;     /*<  grid spacing (zero if terrain at this location
                           unavailable)*/
  uint16_t pending; /*<  Number of 4x4 terrain blocks waiting to be received or
                       read from disk*/
...
#define MAVLINK_MESSAGE_INFO_TERRAIN_REPORT                               \
  {                                                                       \
    136, "TERRAIN_REPORT", 7, {                                           \
      {"lat", NULL, MAVLINK_TYPE_INT32_T,                                 \
       0,     0,    offsetof(mavlink_terrain_report_t, lat)},             \
          {"lon", NULL, MAVLINK_TYPE_INT32_T,                             \
           0,     4,    offsetof(mavlink_terrain_report_t, lon)},         \
          {"spacing", NULL, MAVLINK_TYPE_UINT16_T,                        \
           0,         16,   offsetof(mavlink_terrain_report_t, spacing)}, \
          {"terrain_height",                                              \
           NULL,                                                          \
           MAVLINK_TYPE_FLOAT,                                            \
           0,                                                             \
           8,                                                             \
           offsetof(mavlink_terrain_report_t, terrain_height)},           \
          {"current_height",                                              \
           NULL,                                                          \
           MAVLINK_TYPE_FLOAT,                                            \
           0,                                                             \
           12,                                                            \
           offsetof(mavlink_terrain_report_t, current_height)},           \
          {"pending", NULL, MAVLINK_TYPE_UINT16_T,                        \
           0,         18,   offsetof(mavlink_terrain_report_t, pending)}, \
          {"loaded", NULL, MAVLINK_TYPE_UINT16_T,                         \
           0,        20,   offsetof(mavlink_terrain_report_t, loaded)},   \
    }                                                                     \
  }
#else
#define MAVLINK_MESSAGE_INFO_TERRAIN_REPORT                               \
 ...
 * @param pending  Number of 4x4 terrain blocks waiting to be received or read
 * from disk
...
static inline uint16_t mavlink_msg_terrain_report_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_TERRAIN_REPORT_MIN_LEN,
      MAVLINK_MSG_ID_TERRAIN_REPORT_LEN, MAVLINK_MSG_ID_TERRAIN_REPORT_CRC);
}
...
static inline uint16_t mavlink_msg_terrain_report_pack_chan(
    ...
    mavlink_message_t* msg, int32_t lat, int32_t lon, uint16_t spacing,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_TERRAIN_REPORT_MIN_LEN,
      MAVLINK_MSG_ID_TERRAIN_REPORT_LEN, MAVLINK_MSG_ID_TERRAIN_REPORT_CRC);
}
...
static inline uint16_t mavlink_msg_terrain_report_encode(
  ...
  return mavlink_msg_terrain_report_pack(
      system_id, component_id, msg, terrain_report->lat, terrain_report->lon,
      terrain_report->spacing, terrain_report->terrain_height,
...
static inline uint16_t mavlink_msg_terrain_report_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_terrain_report_t* terrain_report) {
  return mavlink_msg_terrain_report_pack_chan(
      system_id, component_id, chan, msg, terrain_report->lat,
      terrain_report->lon, terrain_report->spacing,
      terrain_report->terrain_height, terrain_report->current_height,
...
static inline void mavlink_msg_terrain_report_send(
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TERRAIN_REPORT, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_TERRAIN_REPORT, (const char*)&packet,
      MAVLINK_MSG_ID_TERRAIN_REPORT_MIN_LEN, MAVLINK_MSG_ID_TERRAIN_REPORT_LEN,
      MAVLINK_MSG_ID_TERRAIN_REPORT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_terrain_report_send_struct(
    mavlink_channel_t chan, const mavlink_terrain_report_t* terrain_report) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_terrain_report_send(
      chan, terrain_report->lat, terrain_report->lon, terrain_report->spacing,
      terrain_report->terrain_height, terrain_report->current_height,
      terrain_report->pending, terrain_report->loaded);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_TERRAIN_REPORT, (const char*)terrain_report,
      MAVLINK_MSG_ID_TERRAIN_REPORT_MIN_LEN, MAVLINK_MSG_ID_TERRAIN_REPORT_LEN,
      MAVLINK_MSG_ID_TERRAIN_REPORT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_terrain_report_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, int32_t lat, int32_t lon,
    uint16_t spacing, float terrain_height, float current_height,
    uint16_t pending, uint16_t loaded) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline int32_t mavlink_msg_terrain_report_get_lat(
 ...
 */
static inline int32_t mavlink_msg_terrain_report_get_lon(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_terrain_report_get_spacing(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_terrain_report_get_terrain_height(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_terrain_report_get_current_height(
    const mavlink_message_t* msg) {
 ...
 * disk
 */
static inline uint16_t mavlink_msg_terrain_report_get_pending(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_terrain_report_get_loaded(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_terrain_report_decode(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_TERRAIN_REPORT_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_TERRAIN_REPORT_LEN;
