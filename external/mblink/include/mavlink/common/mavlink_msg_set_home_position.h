...
MAVPACKED(typedef struct __mavlink_set_home_position_t {
  ...
  float x;    /*< [m] Local X position of this position in the local coordinate
                 frame*/
  float y;    /*< [m] Local Y position of this position in the local coordinate
                 frame*/
  float z;    /*< [m] Local Z position of this position in the local coordinate
                 frame*/
  float q[4]; /*<  World to surface normal and heading transformation of the
                 takeoff position. Used to indicate the heading and slope of the
                 ground*/
  float approach_x; /*< [m] Local X position of the end of the approach vector.
                       ...
                       set it the same way as multicopters. Runway-landing fixed
                       wing aircraft should set it to the opposite direction of
                       the takeoff, assuming the takeoff happened from the
...
#define MAVLINK_MESSAGE_INFO_SET_HOME_POSITION                                   \
  {                                                                              \
    243, "SET_HOME_POSITION", 12, {                                              \
      {"target_system",                                                          \
       NULL,                                                                     \
       MAVLINK_TYPE_UINT8_T,                                                     \
       0,                                                                        \
       52,                                                                       \
       offsetof(mavlink_set_home_position_t, target_system)},                    \
          {"latitude", NULL, MAVLINK_TYPE_INT32_T,                               \
           0,          0,    offsetof(mavlink_set_home_position_t, latitude)},   \
          {"longitude", NULL, MAVLINK_TYPE_INT32_T,                              \
           0,           4,    offsetof(mavlink_set_home_position_t, longitude)}, \
          {"altitude", NULL, MAVLINK_TYPE_INT32_T,                               \
           0,          8,    offsetof(mavlink_set_home_position_t, altitude)},   \
          {"x", NULL, MAVLINK_TYPE_FLOAT,                                        \
           0,   12,   offsetof(mavlink_set_home_position_t, x)},                 \
          {"y", NULL, MAVLINK_TYPE_FLOAT,                                        \
           0,   16,   offsetof(mavlink_set_home_position_t, y)},                 \
          {"z", NULL, MAVLINK_TYPE_FLOAT,                                        \
           0,   20,   offsetof(mavlink_set_home_position_t, z)},                 \
          {"q", NULL, MAVLINK_TYPE_FLOAT,                                        \
           4,   24,   offsetof(mavlink_set_home_position_t, q)},                 \
          {"approach_x",                                                         \
           NULL,                                                                 \
           MAVLINK_TYPE_FLOAT,                                                   \
           0,                                                                    \
           40,                                                                   \
           offsetof(mavlink_set_home_position_t, approach_x)},                   \
          {"approach_y",                                                         \
           NULL,                                                                 \
           MAVLINK_TYPE_FLOAT,                                                   \
           0,                                                                    \
           44,                                                                   \
           offsetof(mavlink_set_home_position_t, approach_y)},                   \
          {"approach_z",                                                         \
           NULL,                                                                 \
           MAVLINK_TYPE_FLOAT,                                                   \
           0,                                                                    \
           48,                                                                   \
           offsetof(mavlink_set_home_position_t, approach_z)},                   \
          {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                             \
           0,           53,   offsetof(mavlink_set_home_position_t, time_usec)}, \
    }                                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_SET_HOME_POSITION                                   \
 ...
 * Runway-landing fixed wing aircraft should set it to the opposite direction of
 * the takeoff, assuming the takeoff happened from the threshold / touchdown
 * zone.
 ...
 */
static inline uint16_t mavlink_msg_set_home_position_pack(
    ...
    float approach_x, float approach_y, float approach_z, uint64_t time_usec) {
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_set_home_position_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint8_t target_system, int32_t latitude,
    int32_t longitude, int32_t altitude, float x, float y, float z,
    const float* q, float approach_x, float approach_y, float approach_z,
    uint64_t time_usec) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_SET_HOME_POSITION_LEN];
  _mav_put_int32_t(buf, 0, latitude);
 ...
 */
static inline uint16_t mavlink_msg_set_home_position_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_set_home_position_t* set_home_position) {
  return mavlink_msg_set_home_position_pack(
      system_id, component_id, msg, set_home_position->target_system,
      set_home_position->latitude, set_home_position->longitude,
      set_home_position->altitude, set_home_position->x, set_home_position->y,
      set_home_position->z, set_home_position->q, set_home_position->approach_x,
      set_home_position->approach_y, set_home_position->approach_z,
 ...
 * @param set_home_position C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_set_home_position_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_set_home_position_t* set_home_position) {
  return mavlink_msg_set_home_position_pack_chan(
      system_id, component_id, chan, msg, set_home_position->target_system,
      set_home_position->latitude, set_home_position->longitude,
      set_home_position->altitude, set_home_position->x, set_home_position->y,
      set_home_position->z, set_home_position->q, set_home_position->approach_x,
      set_home_position->approach_y, set_home_position->approach_z,
...
static inline void mavlink_msg_set_home_position_send(
    mavlink_channel_t chan, uint8_t target_system, int32_t latitude,
    int32_t longitude, int32_t altitude, float x, float y, float z,
    const float* q, float approach_x, float approach_y, float approach_z,
    uint64_t time_usec) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_put_uint64_t(buf, 53, time_usec);
  _mav_put_float_array(buf, 24, q, 4);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_HOME_POSITION, buf,
                                  MAVLINK_MSG_ID_SET_HOME_POSITION_MIN_LEN,
                                  MAVLINK_MSG_ID_SET_HOME_POSITION_LEN,
                                  MAVLINK_MSG_ID_SET_HOME_POSITION_CRC);
#else
  ...
  packet.time_usec = time_usec;
  mav_array_memcpy(packet.q, q, sizeof(float) * 4);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_HOME_POSITION,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_SET_HOME_POSITION_MIN_LEN,
                                  MAVLINK_MSG_ID_SET_HOME_POSITION_LEN,
                                  MAVLINK_MSG_ID_SET_HOME_POSITION_CRC);
 ...
 */
static inline void mavlink_msg_set_home_position_send_struct(
    mavlink_channel_t chan,
    const mavlink_set_home_position_t* set_home_position) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_set_home_position_send(
      chan, set_home_position->target_system, set_home_position->latitude,
      set_home_position->longitude, set_home_position->altitude,
      set_home_position->x, set_home_position->y, set_home_position->z,
 ...
 */
static inline void mavlink_msg_set_home_position_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system,
    int32_t latitude, int32_t longitude, int32_t altitude, float x, float y,
    float z, const float* q, float approach_x, float approach_y,
 ...
 * @return  System ID.
 */
static inline uint8_t mavlink_msg_set_home_position_get_target_system(
 ...
 */
static inline int32_t mavlink_msg_set_home_position_get_latitude(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_set_home_position_get_longitude(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_set_home_position_get_altitude(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_home_position_get_x(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_home_position_get_y(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  World to surface normal and heading transformation of the takeoff
 * position. Used to indicate the heading and slope of the ground
 */
static inline uint16_t mavlink_msg_set_home_position_get_q(
 ...
 *
 * @return [m] Local X position of the end of the approach vector. Multicopters
 * should set this position based on their takeoff path. Grass-landing fixed
 * wing aircraft should set it the same way as multicopters. Runway-landing
 ...
 */
static inline float mavlink_msg_set_home_position_get_approach_x(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [m] Local Y position of the end of the approach vector. Multicopters
 * should set this position based on their takeoff path. Grass-landing fixed
 * wing aircraft should set it the same way as multicopters. Runway-landing
 * fixed wing aircraft should set it to the opposite direction of the takeoff,
 * assuming the takeoff happened from the threshold / touchdown zone.
 */
static inline float mavlink_msg_set_home_position_get_approach_y(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [m] Local Z position of the end of the approach vector. Multicopters
 * should set this position based on their takeoff path. Grass-landing fixed
 * wing aircraft should set it the same way as multicopters. Runway-landing
 * fixed wing aircraft should set it to the opposite direction of the takeoff,
 * assuming the takeoff happened from the threshold / touchdown zone.
 */
static inline float mavlink_msg_set_home_position_get_approach_z(
    const mavlink_message_t* msg) {
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_set_home_position_get_time_usec(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_set_home_position_decode(
    const mavlink_message_t* msg,
  ...
  set_home_position->time_usec =
      mavlink_msg_set_home_position_get_time_usec(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SET_HOME_POSITION_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_SET_HOME_POSITION_LEN;
