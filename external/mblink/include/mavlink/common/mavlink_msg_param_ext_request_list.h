...
MAVPACKED(typedef struct __mavlink_param_ext_request_list_t {
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_REQUEST_LIST                       \
  {                                                                       \
    321, "PARAM_EXT_REQUEST_LIST", 2, {                                   \
      {"target_system",                                                   \
       NULL,                                                              \
       MAVLINK_TYPE_UINT8_T,                                              \
       0,                                                                 \
       0,                                                                 \
       offsetof(mavlink_param_ext_request_list_t, target_system)},        \
          {"target_component",                                            \
           NULL,                                                          \
           MAVLINK_TYPE_UINT8_T,                                          \
           0,                                                             \
           1,                                                             \
           offsetof(mavlink_param_ext_request_list_t, target_component)}, \
    }                                                                     \
  }
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_REQUEST_LIST                       \
  {                                                                       \
    "PARAM_EXT_REQUEST_LIST", 2, {                                        \
      {"target_system",                                                   \
       NULL,                                                              \
       MAVLINK_TYPE_UINT8_T,                                              \
       0,                                                                 \
 ...
 */
static inline uint16_t mavlink_msg_param_ext_request_list_pack(
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_param_ext_request_list_pack_chan(
 ...
 */
static inline uint16_t mavlink_msg_param_ext_request_list_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_param_ext_request_list_t* param_ext_request_list) {
  return mavlink_msg_param_ext_request_list_pack(
      system_id, component_id, msg, param_ext_request_list->target_system,
 ...
 * @param param_ext_request_list C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_param_ext_request_list_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_param_ext_request_list_t* param_ext_request_list) {
  return mavlink_msg_param_ext_request_list_pack_chan(
      system_id, component_id, chan, msg, param_ext_request_list->target_system,
      param_ext_request_list->target_component);
}
...
static inline void mavlink_msg_param_ext_request_list_send(
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST,
                                  buf,
                                  MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_MIN_LEN,
                                  MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_LEN,
                                  MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_CRC);
 ...
 */
static inline void mavlink_msg_param_ext_request_list_send_struct(
    mavlink_channel_t chan,
    const mavlink_param_ext_request_list_t* param_ext_request_list) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_param_ext_request_list_send(
      chan, param_ext_request_list->target_system,
      param_ext_request_list->target_component);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST,
                                  (const char*)param_ext_request_list,
                                  MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_MIN_LEN,
                                  MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_LEN,
                                  MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_CRC);
#endif
 ...
 */
static inline void mavlink_msg_param_ext_request_list_send_buf(
...
#else
  mavlink_param_ext_request_list_t* packet =
      (mavlink_param_ext_request_list_t*)msgbuf;
  packet->target_system = target_system;
  packet->target_component = target_component;
 ...
 * @return  Component ID
 */
static inline uint8_t mavlink_msg_param_ext_request_list_get_target_component(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_param_ext_request_list_decode(
    const mavlink_message_t* msg,
    mavlink_param_ext_request_list_t* param_ext_request_list) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  param_ext_request_list->target_system =
      mavlink_msg_param_ext_request_list_get_target_system(msg);
  param_ext_request_list->target_component =
      mavlink_msg_param_ext_request_list_get_target_component(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_LEN;
