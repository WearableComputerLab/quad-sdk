...
MAVPACKED(typedef struct __mavlink_set_actuator_control_target_t {
  ...
  float controls[8]; /*<  Actuator controls. Normed to -1..+1 where 0 is neutral
                        position. Throttle for single rotation direction motors
                        is 0..1, negative range for reverse direction. Standard
                        mapping for attitude controls (group 0): (index 0-7):
                        roll, pitch, yaw, throttle, flaps, spoilers, airbrakes,
                        landing gear. Load a pass-through mixer to repurpose
                        them as generic outputs.*/
  uint8_t group_mlx; /*<  Actuator group. The "_mlx" indicates this is a
                        multi-instance message and a MAVLink parser should use
...
#define MAVLINK_MESSAGE_INFO_SET_ACTUATOR_CONTROL_TARGET                       \
  {                                                                            \
    139, "SET_ACTUATOR_CONTROL_TARGET", 5, {                                   \
      {"time_usec",                                                            \
       NULL,                                                                   \
       MAVLINK_TYPE_UINT64_T,                                                  \
       0,                                                                      \
       0,                                                                      \
       offsetof(mavlink_set_actuator_control_target_t, time_usec)},            \
          {"group_mlx",                                                        \
           NULL,                                                               \
           MAVLINK_TYPE_UINT8_T,                                               \
           0,                                                                  \
           40,                                                                 \
           offsetof(mavlink_set_actuator_control_target_t, group_mlx)},        \
          {"target_system",                                                    \
           NULL,                                                               \
           MAVLINK_TYPE_UINT8_T,                                               \
           0,                                                                  \
           41,                                                                 \
           offsetof(mavlink_set_actuator_control_target_t, target_system)},    \
          {"target_component",                                                 \
           NULL,                                                               \
           MAVLINK_TYPE_UINT8_T,                                               \
           0,                                                                  \
           42,                                                                 \
           offsetof(mavlink_set_actuator_control_target_t, target_component)}, \
          {"controls",                                                         \
           NULL,                                                               \
           MAVLINK_TYPE_FLOAT,                                                 \
           8,                                                                  \
           8,                                                                  \
           offsetof(mavlink_set_actuator_control_target_t, controls)},         \
    }                                                                          \
  }
#else
#define MAVLINK_MESSAGE_INFO_SET_ACTUATOR_CONTROL_TARGET                       \
  {                                                                            \
    "SET_ACTUATOR_CONTROL_TARGET", 5, {                                        \
      {"time_usec",                                                            \
       NULL,                                                                   \
       MAVLINK_TYPE_UINT64_T,                                                  \
       0,                                                                      \
 ...
 * @param group_mlx  Actuator group. The "_mlx" indicates this is a
 * multi-instance message and a MAVLink parser should use this field to
 * difference between instances.
 * @param target_system  System ID
 * @param target_component  Component ID
 * @param controls  Actuator controls. Normed to -1..+1 where 0 is neutral
 * position. Throttle for single rotation direction motors is 0..1, negative
 * range for reverse direction. Standard mapping for attitude controls (group
 * 0): (index 0-7): roll, pitch, yaw, throttle, flaps, spoilers, airbrakes,
...
static inline uint16_t mavlink_msg_set_actuator_control_target_pack(
    ...
    uint64_t time_usec, uint8_t group_mlx, uint8_t target_system,
    uint8_t target_component, const float* controls) {
...
static inline uint16_t mavlink_msg_set_actuator_control_target_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_usec, uint8_t group_mlx,
    uint8_t target_system, uint8_t target_component, const float* controls) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  _mav_put_uint8_t(buf, 40, group_mlx);
...
static inline uint16_t mavlink_msg_set_actuator_control_target_encode(
  ...
  return mavlink_msg_set_actuator_control_target_pack(
      system_id, component_id, msg, set_actuator_control_target->time_usec,
...
static inline void mavlink_msg_set_actuator_control_target_send(
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET, buf,
      MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_MIN_LEN,
      MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_LEN,
      MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_CRC);
#else
  ...
  mav_array_memcpy(packet.controls, controls, sizeof(float) * 8);
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET, (const char*)&packet,
      MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_MIN_LEN,
      MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_LEN,
      MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_CRC);
#endif
 ...
 */
static inline void mavlink_msg_set_actuator_control_target_send_struct(
    mavlink_channel_t chan,
    const mavlink_set_actuator_control_target_t* set_actuator_control_target) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_set_actuator_control_target_send(
      chan, set_actuator_control_target->time_usec,
      set_actuator_control_target->group_mlx,
      set_actuator_control_target->target_system,
      set_actuator_control_target->target_component,
      set_actuator_control_target->controls);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET,
 ...
 */
static inline void mavlink_msg_set_actuator_control_target_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    uint8_t group_mlx, uint8_t target_system, uint8_t target_component,
...
#else
  mavlink_set_actuator_control_target_t* packet =
      (mavlink_set_actuator_control_target_t*)msgbuf;
  packet->time_usec = time_usec;
  packet->group_mlx = group_mlx;
  packet->target_system = target_system;
  packet->target_component = target_component;
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_set_actuator_control_target_get_time_usec(
 ...
 *
 * @return  Actuator group. The "_mlx" indicates this is a multi-instance
 * message and a MAVLink parser should use this field to difference between
 * instances.
 */
static inline uint8_t mavlink_msg_set_actuator_control_target_get_group_mlx(
    const mavlink_message_t* msg) {
 ...
 * @return  System ID
 */
static inline uint8_t mavlink_msg_set_actuator_control_target_get_target_system(
    const mavlink_message_t* msg) {
...
mavlink_msg_set_actuator_control_target_get_target_component(
    const mavlink_message_t* msg) {
 ...
 * reverse direction. Standard mapping for attitude controls (group 0): (index
 * 0-7): roll, pitch, yaw, throttle, flaps, spoilers, airbrakes, landing gear.
 * Load a pass-through mixer to repurpose them as generic outputs.
 */
static inline uint16_t mavlink_msg_set_actuator_control_target_get_controls(
    const mavlink_message_t* msg, float* controls) {
 ...
 * @param set_actuator_control_target C-struct to decode the message contents
 * into
 */
static inline void mavlink_msg_set_actuator_control_target_decode(
    const mavlink_message_t* msg,
  ...
  mavlink_msg_set_actuator_control_target_get_controls(
      msg, set_actuator_control_target->controls);
  set_actuator_control_target->group_mlx =
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_LEN;
  memset(set_actuator_control_target, 0,
         MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_LEN);
