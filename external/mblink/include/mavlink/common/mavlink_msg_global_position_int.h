...
MAVPACKED(typedef struct __mavlink_global_position_int_t {
  ...
  int32_t alt; /*< [mm] Altitude (MSL). Note that virtually all GPS modules
  ...
  uint16_t hdg; /*< [cdeg] Vehicle heading (yaw angle), 0.0..359.99 degrees. If
  ...
  {                                                                    \
    33, "GLOBAL_POSITION_INT", 9, {                                    \
      {"time_boot_ms",                                                 \
       ...
       0,                                                              \
       0,                                                              \
       offsetof(mavlink_global_position_int_t, time_boot_ms)},         \
          {"lat", NULL, MAVLINK_TYPE_INT32_T,                          \
           0,     4,    offsetof(mavlink_global_position_int_t, lat)}, \
          {"lon", NULL, MAVLINK_TYPE_INT32_T,                          \
           0,     8,    offsetof(mavlink_global_position_int_t, lon)}, \
          {"alt", NULL, MAVLINK_TYPE_INT32_T,                          \
           0,     12,   offsetof(mavlink_global_position_int_t, alt)}, \
          {"relative_alt",                                             \
           NULL,                                                       \
           MAVLINK_TYPE_INT32_T,                                       \
           0,                                                          \
           16,                                                         \
           offsetof(mavlink_global_position_int_t, relative_alt)},     \
          {"vx", NULL, MAVLINK_TYPE_INT16_T,                           \
           0,    20,   offsetof(mavlink_global_position_int_t, vx)},   \
          {"vy", NULL, MAVLINK_TYPE_INT16_T,                           \
           0,    22,   offsetof(mavlink_global_position_int_t, vy)},   \
          {"vz", NULL, MAVLINK_TYPE_INT16_T,                           \
           0,    24,   offsetof(mavlink_global_position_int_t, vz)},   \
          {"hdg", NULL, MAVLINK_TYPE_UINT16_T,                         \
           0,     26,   offsetof(mavlink_global_position_int_t, hdg)}, \
    }                                                                  \
  }
#else
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT                       \
  {                                                                    \
    "GLOBAL_POSITION_INT", 9, {                                        \
      {"time_boot_ms",                                                 \
       NULL,                                                           \
       MAVLINK_TYPE_UINT32_T,                                          \
       0,                                                              \
 ...
 * @param alt [mm] Altitude (MSL). Note that virtually all GPS modules provide
 * both WGS84 and MSL.
 ...
 * @param hdg [cdeg] Vehicle heading (yaw angle), 0.0..359.99 degrees. If
 * unknown, set to: UINT16_MAX
...
static inline uint16_t mavlink_msg_global_position_int_encode(
  ...
  return mavlink_msg_global_position_int_pack(
      system_id, component_id, msg, global_position_int->time_boot_ms,
      global_position_int->lat, global_position_int->lon,
      global_position_int->alt, global_position_int->relative_alt,
...
static inline uint16_t mavlink_msg_global_position_int_encode_chan(
  ...
  return mavlink_msg_global_position_int_pack_chan(
      system_id, component_id, chan, msg, global_position_int->time_boot_ms,
      global_position_int->lat, global_position_int->lon,
      global_position_int->alt, global_position_int->relative_alt,
      global_position_int->vx, global_position_int->vy, global_position_int->vz,
      global_position_int->hdg);
...
static inline void mavlink_msg_global_position_int_send(
    mavlink_channel_t chan, uint32_t time_boot_ms, int32_t lat, int32_t lon,
    int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz,
    uint16_t hdg) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN];
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GLOBAL_POSITION_INT, buf,
                                  MAVLINK_MSG_ID_GLOBAL_POSITION_INT_MIN_LEN,
                                  MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN,
                                  MAVLINK_MSG_ID_GLOBAL_POSITION_INT_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GLOBAL_POSITION_INT,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_GLOBAL_POSITION_INT_MIN_LEN,
                                  MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN,
                                  MAVLINK_MSG_ID_GLOBAL_POSITION_INT_CRC);
 ...
 */
static inline void mavlink_msg_global_position_int_send_struct(
    mavlink_channel_t chan,
    const mavlink_global_position_int_t* global_position_int) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_global_position_int_send(
      chan, global_position_int->time_boot_ms, global_position_int->lat,
 ...
 */
static inline void mavlink_msg_global_position_int_send_buf(
...
#else
  mavlink_global_position_int_t* packet =
      (mavlink_global_position_int_t*)msgbuf;
  packet->time_boot_ms = time_boot_ms;
  packet->lat = lat;
  packet->lon = lon;
  packet->alt = alt;
