...
MAVPACKED(typedef struct __mavlink_attitude_quaternion_cov_t {
...
#define MAVLINK_MESSAGE_INFO_ATTITUDE_QUATERNION_COV                   \
  {                                                                    \
    61, "ATTITUDE_QUATERNION_COV", 6, {                                \
      {"time_usec",                                                    \
       NULL,                                                           \
       MAVLINK_TYPE_UINT64_T,                                          \
       0,                                                              \
       0,                                                              \
       offsetof(mavlink_attitude_quaternion_cov_t, time_usec)},        \
          {"q", NULL, MAVLINK_TYPE_FLOAT,                              \
           4,   8,    offsetof(mavlink_attitude_quaternion_cov_t, q)}, \
          {"rollspeed",                                                \
           NULL,                                                       \
           MAVLINK_TYPE_FLOAT,                                         \
           0,                                                          \
           24,                                                         \
           offsetof(mavlink_attitude_quaternion_cov_t, rollspeed)},    \
          {"pitchspeed",                                               \
           NULL,                                                       \
           MAVLINK_TYPE_FLOAT,                                         \
           0,                                                          \
           28,                                                         \
           offsetof(mavlink_attitude_quaternion_cov_t, pitchspeed)},   \
          {"yawspeed",                                                 \
           NULL,                                                       \
           MAVLINK_TYPE_FLOAT,                                         \
           0,                                                          \
           32,                                                         \
           offsetof(mavlink_attitude_quaternion_cov_t, yawspeed)},     \
          {"covariance",                                               \
           NULL,                                                       \
           MAVLINK_TYPE_FLOAT,                                         \
           9,                                                          \
           36,                                                         \
           offsetof(mavlink_attitude_quaternion_cov_t, covariance)},   \
    }                                                                  \
  }
#else
#define MAVLINK_MESSAGE_INFO_ATTITUDE_QUATERNION_COV                   \
  {                                                                    \
    "ATTITUDE_QUATERNION_COV", 6, {                                    \
      {"time_usec",                                                    \
       NULL,                                                           \
       MAVLINK_TYPE_UINT64_T,                                          \
       0,                                                              \
 ...
 * @param covariance  Row-major representation of a 3x3 attitude covariance
 * matrix (states: roll, pitch, yaw; first three entries are the first ROW, next
 * three entries are the second row, etc.). If unknown, assign NaN value to
...
static inline uint16_t mavlink_msg_attitude_quaternion_cov_pack(
    ...
    uint64_t time_usec, const float* q, float rollspeed, float pitchspeed,
    float yawspeed, const float* covariance) {
...
static inline uint16_t mavlink_msg_attitude_quaternion_cov_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_usec, const float* q, float rollspeed,
    float pitchspeed, float yawspeed, const float* covariance) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  _mav_put_float(buf, 24, rollspeed);
...
static inline uint16_t mavlink_msg_attitude_quaternion_cov_encode(
  ...
  return mavlink_msg_attitude_quaternion_cov_pack(
      system_id, component_id, msg, attitude_quaternion_cov->time_usec,
      attitude_quaternion_cov->q, attitude_quaternion_cov->rollspeed,
      attitude_quaternion_cov->pitchspeed, attitude_quaternion_cov->yawspeed,
...
static inline uint16_t mavlink_msg_attitude_quaternion_cov_encode_chan(
  ...
  return mavlink_msg_attitude_quaternion_cov_pack_chan(
      system_id, component_id, chan, msg, attitude_quaternion_cov->time_usec,
      attitude_quaternion_cov->q, attitude_quaternion_cov->rollspeed,
      attitude_quaternion_cov->pitchspeed, attitude_quaternion_cov->yawspeed,
      attitude_quaternion_cov->covariance);
}
...
static inline void mavlink_msg_attitude_quaternion_cov_send(
    mavlink_channel_t chan, uint64_t time_usec, const float* q, float rollspeed,
    float pitchspeed, float yawspeed, const float* covariance) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV, buf,
      MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_MIN_LEN,
      MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_LEN,
      MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_CRC);
#else
  ...
  mav_array_memcpy(packet.covariance, covariance, sizeof(float) * 9);
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV, (const char*)&packet,
      MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_MIN_LEN,
      MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_LEN,
      MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_CRC);
#endif
 ...
 */
static inline void mavlink_msg_attitude_quaternion_cov_send_struct(
    mavlink_channel_t chan,
    const mavlink_attitude_quaternion_cov_t* attitude_quaternion_cov) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_attitude_quaternion_cov_send(
      chan, attitude_quaternion_cov->time_usec, attitude_quaternion_cov->q,
      attitude_quaternion_cov->rollspeed, attitude_quaternion_cov->pitchspeed,
      attitude_quaternion_cov->yawspeed, attitude_quaternion_cov->covariance);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV,
      (const char*)attitude_quaternion_cov,
      MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_MIN_LEN,
      MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_LEN,
      MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_CRC);
#endif
 ...
 */
static inline void mavlink_msg_attitude_quaternion_cov_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    const float* q, float rollspeed, float pitchspeed, float yawspeed,
...
#else
  mavlink_attitude_quaternion_cov_t* packet =
      (mavlink_attitude_quaternion_cov_t*)msgbuf;
  packet->time_usec = time_usec;
  packet->rollspeed = rollspeed;
  packet->pitchspeed = pitchspeed;
  packet->yawspeed = yawspeed;
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_attitude_quaternion_cov_get_time_usec(
 ...
 */
static inline uint16_t mavlink_msg_attitude_quaternion_cov_get_q(
 ...
 */
static inline float mavlink_msg_attitude_quaternion_cov_get_rollspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_attitude_quaternion_cov_get_pitchspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_attitude_quaternion_cov_get_yawspeed(
    const mavlink_message_t* msg) {
 ...
 * (states: roll, pitch, yaw; first three entries are the first ROW, next three
 * entries are the second row, etc.). If unknown, assign NaN value to first
 * element in the array.
 */
static inline uint16_t mavlink_msg_attitude_quaternion_cov_get_covariance(
 ...
 */
static inline void mavlink_msg_attitude_quaternion_cov_decode(
    const mavlink_message_t* msg,
    mavlink_attitude_quaternion_cov_t* attitude_quaternion_cov) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  attitude_quaternion_cov->time_usec =
      mavlink_msg_attitude_quaternion_cov_get_time_usec(msg);
  ...
  mavlink_msg_attitude_quaternion_cov_get_covariance(
      msg, attitude_quaternion_cov->covariance);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_LEN;
  memset(attitude_quaternion_cov, 0,
         MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_LEN);
