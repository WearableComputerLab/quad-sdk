...
MAVPACKED(typedef struct __mavlink_data_transmission_handshake_t {
  ...
  uint8_t
      payload; /*< [bytes] Payload size per packet (normally 253 byte, see DATA
...
#define MAVLINK_MESSAGE_INFO_DATA_TRANSMISSION_HANDSHAKE                         \
  {                                                                              \
    130, "DATA_TRANSMISSION_HANDSHAKE", 7, {                                     \
      {"type", NULL, MAVLINK_TYPE_UINT8_T,                                       \
       0,      10,   offsetof(mavlink_data_transmission_handshake_t, type)},     \
          {"size", NULL, MAVLINK_TYPE_UINT32_T,                                  \
           0,      0,    offsetof(mavlink_data_transmission_handshake_t, size)}, \
          {"width",                                                              \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT16_T,                                                \
           0,                                                                    \
           4,                                                                    \
           offsetof(mavlink_data_transmission_handshake_t, width)},              \
          {"height",                                                             \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT16_T,                                                \
           0,                                                                    \
           6,                                                                    \
           offsetof(mavlink_data_transmission_handshake_t, height)},             \
          {"packets",                                                            \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT16_T,                                                \
           0,                                                                    \
           8,                                                                    \
           offsetof(mavlink_data_transmission_handshake_t, packets)},            \
          {"payload",                                                            \
           NULL,                                                                 \
...
static inline uint16_t mavlink_msg_data_transmission_handshake_pack(
    ...
    uint8_t type, uint32_t size, uint16_t width, uint16_t height,
    uint16_t packets, uint8_t payload, uint8_t jpg_quality) {
...
static inline uint16_t mavlink_msg_data_transmission_handshake_pack_chan(
    ...
    mavlink_message_t* msg, uint8_t type, uint32_t size, uint16_t width,
    uint16_t height, uint16_t packets, uint8_t payload, uint8_t jpg_quality) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_LEN];
  _mav_put_uint32_t(buf, 0, size);
  _mav_put_uint16_t(buf, 4, width);
...
static inline uint16_t mavlink_msg_data_transmission_handshake_encode(
  ...
  return mavlink_msg_data_transmission_handshake_pack(
      system_id, component_id, msg, data_transmission_handshake->type,
      data_transmission_handshake->size, data_transmission_handshake->width,
      data_transmission_handshake->height, data_transmission_handshake->packets,
...
static inline uint16_t mavlink_msg_data_transmission_handshake_encode_chan(
  ...
  return mavlink_msg_data_transmission_handshake_pack_chan(
      system_id, component_id, chan, msg, data_transmission_handshake->type,
      data_transmission_handshake->size, data_transmission_handshake->width,
      data_transmission_handshake->height, data_transmission_handshake->packets,
      data_transmission_handshake->payload,
      data_transmission_handshake->jpg_quality);
...
static inline void mavlink_msg_data_transmission_handshake_send(
    mavlink_channel_t chan, uint8_t type, uint32_t size, uint16_t width,
    uint16_t height, uint16_t packets, uint8_t payload, uint8_t jpg_quality) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_LEN];
  _mav_put_uint32_t(buf, 0, size);
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE, buf,
      MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_MIN_LEN,
      MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_LEN,
      MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE, (const char*)&packet,
      MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_MIN_LEN,
      MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_LEN,
      MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_CRC);
#endif
 ...
 */
static inline void mavlink_msg_data_transmission_handshake_send_struct(
    mavlink_channel_t chan,
    const mavlink_data_transmission_handshake_t* data_transmission_handshake) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_data_transmission_handshake_send(
      chan, data_transmission_handshake->type,
      data_transmission_handshake->size, data_transmission_handshake->width,
      data_transmission_handshake->height, data_transmission_handshake->packets,
      data_transmission_handshake->payload,
      data_transmission_handshake->jpg_quality);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE,
 ...
 */
static inline void mavlink_msg_data_transmission_handshake_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t type,
    uint32_t size, uint16_t width, uint16_t height, uint16_t packets,
...
#else
  mavlink_data_transmission_handshake_t* packet =
      (mavlink_data_transmission_handshake_t*)msgbuf;
  packet->size = size;
  packet->width = width;
  packet->height = height;
  packet->packets = packets;
 ...
 */
static inline uint8_t mavlink_msg_data_transmission_handshake_get_type(
 ...
 */
static inline uint32_t mavlink_msg_data_transmission_handshake_get_size(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_data_transmission_handshake_get_width(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_data_transmission_handshake_get_height(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_data_transmission_handshake_get_packets(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [bytes] Payload size per packet (normally 253 byte, see DATA field
 * size in message ENCAPSULATED_DATA) (set on ACK only).
 */
static inline uint8_t mavlink_msg_data_transmission_handshake_get_payload(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_data_transmission_handshake_get_jpg_quality(
    const mavlink_message_t* msg) {
 ...
 * @param data_transmission_handshake C-struct to decode the message contents
 * into
 */
static inline void mavlink_msg_data_transmission_handshake_decode(
    const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_LEN;
  memset(data_transmission_handshake, 0,
         MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_LEN);
