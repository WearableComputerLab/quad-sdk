...
MAVPACKED(typedef struct __mavlink_serial_control_t {
...
#define MAVLINK_MESSAGE_INFO_SERIAL_CONTROL                                 \
  {                                                                         \
    126, "SERIAL_CONTROL", 6, {                                             \
      {"device", NULL, MAVLINK_TYPE_UINT8_T,                                \
       0,        6,    offsetof(mavlink_serial_control_t, device)},         \
          {"flags", NULL, MAVLINK_TYPE_UINT8_T,                             \
           0,       7,    offsetof(mavlink_serial_control_t, flags)},       \
          {"timeout", NULL, MAVLINK_TYPE_UINT16_T,                          \
           0,         4,    offsetof(mavlink_serial_control_t, timeout)},   \
          {"baudrate", NULL, MAVLINK_TYPE_UINT32_T,                         \
           0,          0,    offsetof(mavlink_serial_control_t, baudrate)}, \
          {"count", NULL, MAVLINK_TYPE_UINT8_T,                             \
           0,       8,    offsetof(mavlink_serial_control_t, count)},       \
          {"data", NULL, MAVLINK_TYPE_UINT8_T,                              \
           70,     9,    offsetof(mavlink_serial_control_t, data)},         \
    }                                                                       \
  }
#else
#define MAVLINK_MESSAGE_INFO_SERIAL_CONTROL                                 \
...
static inline uint16_t mavlink_msg_serial_control_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_SERIAL_CONTROL_MIN_LEN,
      MAVLINK_MSG_ID_SERIAL_CONTROL_LEN, MAVLINK_MSG_ID_SERIAL_CONTROL_CRC);
}
...
static inline uint16_t mavlink_msg_serial_control_pack_chan(
    ...
    mavlink_message_t* msg, uint8_t device, uint8_t flags, uint16_t timeout,
...
static inline uint16_t mavlink_msg_serial_control_encode(
  ...
  return mavlink_msg_serial_control_pack(
      system_id, component_id, msg, serial_control->device,
      serial_control->flags, serial_control->timeout, serial_control->baudrate,
...
static inline uint16_t mavlink_msg_serial_control_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_serial_control_t* serial_control) {
  return mavlink_msg_serial_control_pack_chan(
      system_id, component_id, chan, msg, serial_control->device,
      serial_control->flags, serial_control->timeout, serial_control->baudrate,
      serial_control->count, serial_control->data);
}
...
static inline void mavlink_msg_serial_control_send(
    mavlink_channel_t chan, uint8_t device, uint8_t flags, uint16_t timeout,
    uint32_t baudrate, uint8_t count, const uint8_t* data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_SERIAL_CONTROL_LEN];
  _mav_put_uint32_t(buf, 0, baudrate);
  ...
  _mav_put_uint8_t(buf, 8, count);
  _mav_put_uint8_t_array(buf, 9, data, 70);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SERIAL_CONTROL, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SERIAL_CONTROL, (const char*)&packet,
      MAVLINK_MSG_ID_SERIAL_CONTROL_MIN_LEN, MAVLINK_MSG_ID_SERIAL_CONTROL_LEN,
      MAVLINK_MSG_ID_SERIAL_CONTROL_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_serial_control_send_struct(
    mavlink_channel_t chan, const mavlink_serial_control_t* serial_control) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_serial_control_send(
      chan, serial_control->device, serial_control->flags,
      serial_control->timeout, serial_control->baudrate, serial_control->count,
      serial_control->data);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SERIAL_CONTROL, (const char*)serial_control,
      MAVLINK_MSG_ID_SERIAL_CONTROL_MIN_LEN, MAVLINK_MSG_ID_SERIAL_CONTROL_LEN,
      MAVLINK_MSG_ID_SERIAL_CONTROL_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_serial_control_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t device,
    uint8_t flags, uint16_t timeout, uint32_t baudrate, uint8_t count,
    const uint8_t* data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint8_t mavlink_msg_serial_control_get_device(
 ...
 */
static inline uint8_t mavlink_msg_serial_control_get_flags(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_serial_control_get_timeout(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_serial_control_get_baudrate(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_serial_control_get_count(
    const mavlink_message_t* msg) {
 ...
 * @return  serial data
 */
static inline uint16_t mavlink_msg_serial_control_get_data(
 ...
 */
static inline void mavlink_msg_serial_control_decode(
    const mavlink_message_t* msg, mavlink_serial_control_t* serial_control) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SERIAL_CONTROL_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_SERIAL_CONTROL_LEN;
