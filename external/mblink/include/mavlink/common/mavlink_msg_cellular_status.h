...
MAVPACKED(typedef struct __mavlink_cellular_status_t {
...
#define MAVLINK_MESSAGE_INFO_CELLULAR_STATUS                               \
  {                                                                        \
    334, "CELLULAR_STATUS", 7, {                                           \
      {"status", NULL, MAVLINK_TYPE_UINT16_T,                              \
       0,        4,    offsetof(mavlink_cellular_status_t, status)},       \
          {"type", NULL, MAVLINK_TYPE_UINT8_T,                             \
           0,      12,   offsetof(mavlink_cellular_status_t, type)},       \
          {"quality", NULL, MAVLINK_TYPE_UINT8_T,                          \
           0,         13,   offsetof(mavlink_cellular_status_t, quality)}, \
          {"mcc", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,     6,    offsetof(mavlink_cellular_status_t, mcc)},         \
          {"mnc", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,     8,    offsetof(mavlink_cellular_status_t, mnc)},         \
          {"lac", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,     10,   offsetof(mavlink_cellular_status_t, lac)},         \
          {"cid", NULL, MAVLINK_TYPE_UINT32_T,                             \
           0,     0,    offsetof(mavlink_cellular_status_t, cid)},         \
    }                                                                      \
  }
#else
#define MAVLINK_MESSAGE_INFO_CELLULAR_STATUS                               \
 ...
 */
static inline uint16_t mavlink_msg_cellular_status_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint16_t status, uint8_t type, uint8_t quality, uint16_t mcc, uint16_t mnc,
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_CELLULAR_STATUS_MIN_LEN,
      MAVLINK_MSG_ID_CELLULAR_STATUS_LEN, MAVLINK_MSG_ID_CELLULAR_STATUS_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_cellular_status_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint16_t status, uint8_t type, uint8_t quality,
 ...
 */
static inline uint16_t mavlink_msg_cellular_status_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_cellular_status_t* cellular_status) {
  return mavlink_msg_cellular_status_pack(
      system_id, component_id, msg, cellular_status->status,
      cellular_status->type, cellular_status->quality, cellular_status->mcc,
      cellular_status->mnc, cellular_status->lac, cellular_status->cid);
}
 ...
 * @param cellular_status C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_cellular_status_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_cellular_status_t* cellular_status) {
  return mavlink_msg_cellular_status_pack_chan(
      system_id, component_id, chan, msg, cellular_status->status,
      cellular_status->type, cellular_status->quality, cellular_status->mcc,
      cellular_status->mnc, cellular_status->lac, cellular_status->cid);
}
...
static inline void mavlink_msg_cellular_status_send(
    mavlink_channel_t chan, uint16_t status, uint8_t type, uint8_t quality,
    uint16_t mcc, uint16_t mnc, uint16_t lac, uint32_t cid) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_CELLULAR_STATUS_LEN];
  _mav_put_uint32_t(buf, 0, cid);
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CELLULAR_STATUS, buf,
                                  MAVLINK_MSG_ID_CELLULAR_STATUS_MIN_LEN,
                                  MAVLINK_MSG_ID_CELLULAR_STATUS_LEN,
                                  MAVLINK_MSG_ID_CELLULAR_STATUS_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_CELLULAR_STATUS, (const char*)&packet,
      MAVLINK_MSG_ID_CELLULAR_STATUS_MIN_LEN,
      MAVLINK_MSG_ID_CELLULAR_STATUS_LEN, MAVLINK_MSG_ID_CELLULAR_STATUS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_cellular_status_send_struct(
    mavlink_channel_t chan, const mavlink_cellular_status_t* cellular_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_cellular_status_send(
      chan, cellular_status->status, cellular_status->type,
      cellular_status->quality, cellular_status->mcc, cellular_status->mnc,
      cellular_status->lac, cellular_status->cid);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_CELLULAR_STATUS, (const char*)cellular_status,
      MAVLINK_MSG_ID_CELLULAR_STATUS_MIN_LEN,
      MAVLINK_MSG_ID_CELLULAR_STATUS_LEN, MAVLINK_MSG_ID_CELLULAR_STATUS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_cellular_status_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint16_t status,
    uint8_t type, uint8_t quality, uint16_t mcc, uint16_t mnc, uint16_t lac,
    uint32_t cid) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint16_t mavlink_msg_cellular_status_get_status(
 ...
 */
static inline uint8_t mavlink_msg_cellular_status_get_type(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_cellular_status_get_quality(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_cellular_status_get_mcc(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_cellular_status_get_mnc(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_cellular_status_get_lac(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_cellular_status_get_cid(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_cellular_status_decode(
    const mavlink_message_t* msg, mavlink_cellular_status_t* cellular_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_CELLULAR_STATUS_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_CELLULAR_STATUS_LEN;
