...
MAVPACKED(typedef struct __mavlink_actuator_output_status_t {
...
#define MAVLINK_MESSAGE_INFO_ACTUATOR_OUTPUT_STATUS                             \
  {                                                                             \
    375, "ACTUATOR_OUTPUT_STATUS", 3, {                                         \
      {"time_usec",                                                             \
       NULL,                                                                    \
       MAVLINK_TYPE_UINT64_T,                                                   \
       0,                                                                       \
       0,                                                                       \
       offsetof(mavlink_actuator_output_status_t, time_usec)},                  \
          {"active", NULL, MAVLINK_TYPE_UINT32_T,                               \
           0,        8,    offsetof(mavlink_actuator_output_status_t, active)}, \
          {"actuator",                                                          \
           NULL,                                                                \
           MAVLINK_TYPE_FLOAT,                                                  \
           32,                                                                  \
           12,                                                                  \
           offsetof(mavlink_actuator_output_status_t, actuator)},               \
    }                                                                           \
  }
#else
#define MAVLINK_MESSAGE_INFO_ACTUATOR_OUTPUT_STATUS                             \
  {                                                                             \
    "ACTUATOR_OUTPUT_STATUS", 3, {                                              \
      {"time_usec",                                                             \
       NULL,                                                                    \
       MAVLINK_TYPE_UINT64_T,                                                   \
       0,                                                                       \
 ...
 * @param actuator  Servo / motor output array values. Zero values indicate
 * unused channels.
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_actuator_output_status_pack(
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_actuator_output_status_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint64_t time_usec, uint32_t active,
 ...
 */
static inline uint16_t mavlink_msg_actuator_output_status_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_actuator_output_status_t* actuator_output_status) {
  return mavlink_msg_actuator_output_status_pack(
      system_id, component_id, msg, actuator_output_status->time_usec,
      actuator_output_status->active, actuator_output_status->actuator);
}
 ...
 * @param actuator_output_status C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_actuator_output_status_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_actuator_output_status_t* actuator_output_status) {
  return mavlink_msg_actuator_output_status_pack_chan(
      system_id, component_id, chan, msg, actuator_output_status->time_usec,
      actuator_output_status->active, actuator_output_status->actuator);
}
...
static inline void mavlink_msg_actuator_output_status_send(
    mavlink_channel_t chan, uint64_t time_usec, uint32_t active,
    const float* actuator) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_ACTUATOR_OUTPUT_STATUS_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  _mav_put_uint32_t(buf, 8, active);
  _mav_put_float_array(buf, 12, actuator, 32);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ACTUATOR_OUTPUT_STATUS,
                                  buf,
                                  MAVLINK_MSG_ID_ACTUATOR_OUTPUT_STATUS_MIN_LEN,
                                  MAVLINK_MSG_ID_ACTUATOR_OUTPUT_STATUS_LEN,
                                  MAVLINK_MSG_ID_ACTUATOR_OUTPUT_STATUS_CRC);
 ...
 */
static inline void mavlink_msg_actuator_output_status_send_struct(
    mavlink_channel_t chan,
    const mavlink_actuator_output_status_t* actuator_output_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_actuator_output_status_send(
      chan, actuator_output_status->time_usec, actuator_output_status->active,
 ...
 */
static inline void mavlink_msg_actuator_output_status_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    uint32_t active, const float* actuator) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  mavlink_actuator_output_status_t* packet =
      (mavlink_actuator_output_status_t*)msgbuf;
  packet->time_usec = time_usec;
  packet->active = active;
  mav_array_memcpy(packet->actuator, actuator, sizeof(float) * 32);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ACTUATOR_OUTPUT_STATUS,
 ...
 */
static inline uint64_t mavlink_msg_actuator_output_status_get_time_usec(
 ...
 */
static inline uint32_t mavlink_msg_actuator_output_status_get_active(
    const mavlink_message_t* msg) {
 ...
 * channels.
 */
static inline uint16_t mavlink_msg_actuator_output_status_get_actuator(
    const mavlink_message_t* msg, float* actuator) {
 ...
 */
static inline void mavlink_msg_actuator_output_status_decode(
    const mavlink_message_t* msg,
  ...
  mavlink_msg_actuator_output_status_get_actuator(
      msg, actuator_output_status->actuator);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_ACTUATOR_OUTPUT_STATUS_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_ACTUATOR_OUTPUT_STATUS_LEN;
