...
MAVPACKED(typedef struct __mavlink_mission_count_t {
  ...
  {                                                                  \
    44, "MISSION_COUNT", 4, {                                        \
      {"target_system",                                              \
       ...
       0,                                                            \
       2,                                                            \
       offsetof(mavlink_mission_count_t, target_system)},            \
          {"target_component",                                       \
           NULL,                                                     \
           MAVLINK_TYPE_UINT8_T,                                     \
           0,                                                        \
           3,                                                        \
           offsetof(mavlink_mission_count_t, target_component)},     \
          {"count", NULL, MAVLINK_TYPE_UINT16_T,                     \
           0,       0,    offsetof(mavlink_mission_count_t, count)}, \
          {"mission_type",                                           \
           NULL,                                                     \
           MAVLINK_TYPE_UINT8_T,                                     \
           0,                                                        \
           4,                                                        \
           offsetof(mavlink_mission_count_t, mission_type)},         \
    }                                                                \
  }
#else
#define MAVLINK_MESSAGE_INFO_MISSION_COUNT                           \
...
static inline uint16_t mavlink_msg_mission_count_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_MISSION_COUNT_MIN_LEN,
      MAVLINK_MSG_ID_MISSION_COUNT_LEN, MAVLINK_MSG_ID_MISSION_COUNT_CRC);
}
...
static inline uint16_t mavlink_msg_mission_count_encode(
  ...
  return mavlink_msg_mission_count_pack(
      system_id, component_id, msg, mission_count->target_system,
...
static inline uint16_t mavlink_msg_mission_count_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_mission_count_t* mission_count) {
  return mavlink_msg_mission_count_pack_chan(
      system_id, component_id, chan, msg, mission_count->target_system,
      mission_count->target_component, mission_count->count,
      mission_count->mission_type);
}
...
static inline void mavlink_msg_mission_count_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_COUNT, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_MISSION_COUNT, (const char*)&packet,
      MAVLINK_MSG_ID_MISSION_COUNT_MIN_LEN, MAVLINK_MSG_ID_MISSION_COUNT_LEN,
      MAVLINK_MSG_ID_MISSION_COUNT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_mission_count_send_struct(
    mavlink_channel_t chan, const mavlink_mission_count_t* mission_count) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_mission_count_send(
      chan, mission_count->target_system, mission_count->target_component,
      mission_count->count, mission_count->mission_type);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_MISSION_COUNT, (const char*)mission_count,
      MAVLINK_MSG_ID_MISSION_COUNT_MIN_LEN, MAVLINK_MSG_ID_MISSION_COUNT_LEN,
      MAVLINK_MSG_ID_MISSION_COUNT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_mission_count_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system,
    uint8_t target_component, uint16_t count, uint8_t mission_type) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  Mission type.
 */
static inline uint8_t mavlink_msg_mission_count_get_mission_type(
    const mavlink_message_t* msg) {
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_MISSION_COUNT_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_MISSION_COUNT_LEN;
