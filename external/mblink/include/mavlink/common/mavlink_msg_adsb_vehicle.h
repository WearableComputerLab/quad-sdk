...
MAVPACKED(typedef struct __mavlink_adsb_vehicle_t {
  ...
  uint16_t flags;  /*<  Bitmap to indicate various statuses including valid data
                      fields*/
  ...
  {                                                                       \
    246, "ADSB_VEHICLE", 13, {                                            \
      {"ICAO_address",                                                    \
       ...
       0,                                                                 \
       0,                                                                 \
       offsetof(mavlink_adsb_vehicle_t, ICAO_address)},                   \
          {"lat", NULL, MAVLINK_TYPE_INT32_T,                             \
           0,     4,    offsetof(mavlink_adsb_vehicle_t, lat)},           \
          {"lon", NULL, MAVLINK_TYPE_INT32_T,                             \
           0,     8,    offsetof(mavlink_adsb_vehicle_t, lon)},           \
          {"altitude_type",                                               \
           NULL,                                                          \
           MAVLINK_TYPE_UINT8_T,                                          \
           0,                                                             \
           26,                                                            \
           offsetof(mavlink_adsb_vehicle_t, altitude_type)},              \
          {"altitude", NULL, MAVLINK_TYPE_INT32_T,                        \
           0,          12,   offsetof(mavlink_adsb_vehicle_t, altitude)}, \
          {"heading", NULL, MAVLINK_TYPE_UINT16_T,                        \
           0,         16,   offsetof(mavlink_adsb_vehicle_t, heading)},   \
          {"hor_velocity",                                                \
           NULL,                                                          \
           MAVLINK_TYPE_UINT16_T,                                         \
           0,                                                             \
           18,                                                            \
           offsetof(mavlink_adsb_vehicle_t, hor_velocity)},               \
          {"ver_velocity",                                                \
           NULL,                                                          \
           MAVLINK_TYPE_INT16_T,                                          \
           0,                                                             \
           20,                                                            \
           offsetof(mavlink_adsb_vehicle_t, ver_velocity)},               \
          {"callsign", NULL, MAVLINK_TYPE_CHAR,                           \
           9,          27,   offsetof(mavlink_adsb_vehicle_t, callsign)}, \
          {"emitter_type",                                                \
           NULL,                                                          \
           MAVLINK_TYPE_UINT8_T,                                          \
           0,                                                             \
           36,                                                            \
           offsetof(mavlink_adsb_vehicle_t, emitter_type)},               \
          {"tslc", NULL, MAVLINK_TYPE_UINT8_T,                            \
           0,      37,   offsetof(mavlink_adsb_vehicle_t, tslc)},         \
          {"flags", NULL, MAVLINK_TYPE_UINT16_T,                          \
           0,       22,   offsetof(mavlink_adsb_vehicle_t, flags)},       \
          {"squawk", NULL, MAVLINK_TYPE_UINT16_T,                         \
           0,        24,   offsetof(mavlink_adsb_vehicle_t, squawk)},     \
    }                                                                     \
  }
#else
#define MAVLINK_MESSAGE_INFO_ADSB_VEHICLE                                 \
 ...
 */
static inline uint16_t mavlink_msg_adsb_vehicle_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint32_t ICAO_address, int32_t lat, int32_t lon, uint8_t altitude_type,
    int32_t altitude, uint16_t heading, uint16_t hor_velocity,
    int16_t ver_velocity, const char* callsign, uint8_t emitter_type,
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_ADSB_VEHICLE_MIN_LEN,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_adsb_vehicle_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint32_t ICAO_address, int32_t lat, int32_t lon,
 ...
 */
static inline uint16_t mavlink_msg_adsb_vehicle_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_adsb_vehicle_t* adsb_vehicle) {
  return mavlink_msg_adsb_vehicle_pack(
      system_id, component_id, msg, adsb_vehicle->ICAO_address,
      adsb_vehicle->lat, adsb_vehicle->lon, adsb_vehicle->altitude_type,
      adsb_vehicle->altitude, adsb_vehicle->heading, adsb_vehicle->hor_velocity,
 ...
 * @param adsb_vehicle C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_adsb_vehicle_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_adsb_vehicle_t* adsb_vehicle) {
  return mavlink_msg_adsb_vehicle_pack_chan(
      system_id, component_id, chan, msg, adsb_vehicle->ICAO_address,
      adsb_vehicle->lat, adsb_vehicle->lon, adsb_vehicle->altitude_type,
      adsb_vehicle->altitude, adsb_vehicle->heading, adsb_vehicle->hor_velocity,
      adsb_vehicle->ver_velocity, adsb_vehicle->callsign,
      adsb_vehicle->emitter_type, adsb_vehicle->tslc, adsb_vehicle->flags,
...
static inline void mavlink_msg_adsb_vehicle_send(
    mavlink_channel_t chan, uint32_t ICAO_address, int32_t lat, int32_t lon,
    uint8_t altitude_type, int32_t altitude, uint16_t heading,
    uint16_t hor_velocity, int16_t ver_velocity, const char* callsign,
    uint8_t emitter_type, uint8_t tslc, uint16_t flags, uint16_t squawk) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_put_uint8_t(buf, 37, tslc);
  _mav_put_char_array(buf, 27, callsign, 9);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ADSB_VEHICLE, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ADSB_VEHICLE, (const char*)&packet,
 ...
 */
static inline void mavlink_msg_adsb_vehicle_send_struct(
    mavlink_channel_t chan, const mavlink_adsb_vehicle_t* adsb_vehicle) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_adsb_vehicle_send(
      chan, adsb_vehicle->ICAO_address, adsb_vehicle->lat, adsb_vehicle->lon,
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ADSB_VEHICLE, (const char*)adsb_vehicle,
      MAVLINK_MSG_ID_ADSB_VEHICLE_MIN_LEN, MAVLINK_MSG_ID_ADSB_VEHICLE_LEN,
      MAVLINK_MSG_ID_ADSB_VEHICLE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_adsb_vehicle_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint32_t ICAO_address,
    int32_t lat, int32_t lon, uint8_t altitude_type, int32_t altitude,
    uint16_t heading, uint16_t hor_velocity, int16_t ver_velocity,
    const char* callsign, uint8_t emitter_type, uint8_t tslc, uint16_t flags,
    uint16_t squawk) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  ICAO address
 */
static inline uint32_t mavlink_msg_adsb_vehicle_get_ICAO_address(
 ...
 */
static inline int32_t mavlink_msg_adsb_vehicle_get_lat(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_adsb_vehicle_get_lon(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_adsb_vehicle_get_altitude_type(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_adsb_vehicle_get_altitude(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_adsb_vehicle_get_heading(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_adsb_vehicle_get_ver_velocity(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_adsb_vehicle_get_callsign(
    const mavlink_message_t* msg, char* callsign) {
 ...
 */
static inline uint8_t mavlink_msg_adsb_vehicle_get_emitter_type(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_adsb_vehicle_get_tslc(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_adsb_vehicle_get_flags(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_adsb_vehicle_decode(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_ADSB_VEHICLE_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_ADSB_VEHICLE_LEN;
