...
MAVPACKED(typedef struct __mavlink_mission_set_current_t {
...
#define MAVLINK_MESSAGE_INFO_MISSION_SET_CURRENT                       \
  {                                                                    \
    41, "MISSION_SET_CURRENT", 3, {                                    \
      {"target_system",                                                \
       NULL,                                                           \
       MAVLINK_TYPE_UINT8_T,                                           \
       0,                                                              \
       2,                                                              \
       offsetof(mavlink_mission_set_current_t, target_system)},        \
          {"target_component",                                         \
           NULL,                                                       \
           MAVLINK_TYPE_UINT8_T,                                       \
           0,                                                          \
           3,                                                          \
           offsetof(mavlink_mission_set_current_t, target_component)}, \
          {"seq", NULL, MAVLINK_TYPE_UINT16_T,                         \
           0,     0,    offsetof(mavlink_mission_set_current_t, seq)}, \
    }                                                                  \
  }
#else
#define MAVLINK_MESSAGE_INFO_MISSION_SET_CURRENT                       \
  {                                                                    \
    "MISSION_SET_CURRENT", 3, {                                        \
      {"target_system",                                                \
       NULL,                                                           \
       MAVLINK_TYPE_UINT8_T,                                           \
       0,                                                              \
...
static inline uint16_t mavlink_msg_mission_set_current_encode(
  ...
  return mavlink_msg_mission_set_current_pack(
      system_id, component_id, msg, mission_set_current->target_system,
...
static inline uint16_t mavlink_msg_mission_set_current_encode_chan(
  ...
  return mavlink_msg_mission_set_current_pack_chan(
      system_id, component_id, chan, msg, mission_set_current->target_system,
      mission_set_current->target_component, mission_set_current->seq);
}
...
static inline void mavlink_msg_mission_set_current_send(
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_SET_CURRENT, buf,
                                  MAVLINK_MSG_ID_MISSION_SET_CURRENT_MIN_LEN,
                                  MAVLINK_MSG_ID_MISSION_SET_CURRENT_LEN,
                                  MAVLINK_MSG_ID_MISSION_SET_CURRENT_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_SET_CURRENT,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_MISSION_SET_CURRENT_MIN_LEN,
                                  MAVLINK_MSG_ID_MISSION_SET_CURRENT_LEN,
                                  MAVLINK_MSG_ID_MISSION_SET_CURRENT_CRC);
 ...
 */
static inline void mavlink_msg_mission_set_current_send_struct(
    mavlink_channel_t chan,
    const mavlink_mission_set_current_t* mission_set_current) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_mission_set_current_send(chan, mission_set_current->target_system,
                                       mission_set_current->target_component,
                                       mission_set_current->seq);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_SET_CURRENT,
                                  (const char*)mission_set_current,
                                  MAVLINK_MSG_ID_MISSION_SET_CURRENT_MIN_LEN,
                                  MAVLINK_MSG_ID_MISSION_SET_CURRENT_LEN,
                                  MAVLINK_MSG_ID_MISSION_SET_CURRENT_CRC);
#endif
 ...
 */
static inline void mavlink_msg_mission_set_current_send_buf(
...
#else
  mavlink_mission_set_current_t* packet =
      (mavlink_mission_set_current_t*)msgbuf;
  packet->seq = seq;
  packet->target_system = target_system;
  packet->target_component = target_component;
