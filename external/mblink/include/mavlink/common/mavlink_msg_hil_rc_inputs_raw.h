...
MAVPACKED(typedef struct __mavlink_hil_rc_inputs_raw_t {
...
#define MAVLINK_MESSAGE_INFO_HIL_RC_INPUTS_RAW                                   \
  {                                                                              \
    92, "HIL_RC_INPUTS_RAW", 14, {                                               \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                                 \
       0,           0,    offsetof(mavlink_hil_rc_inputs_raw_t, time_usec)},     \
          {"chan1_raw", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,           8,    offsetof(mavlink_hil_rc_inputs_raw_t, chan1_raw)}, \
          {"chan2_raw", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,           10,   offsetof(mavlink_hil_rc_inputs_raw_t, chan2_raw)}, \
          {"chan3_raw", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,           12,   offsetof(mavlink_hil_rc_inputs_raw_t, chan3_raw)}, \
          {"chan4_raw", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,           14,   offsetof(mavlink_hil_rc_inputs_raw_t, chan4_raw)}, \
          {"chan5_raw", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,           16,   offsetof(mavlink_hil_rc_inputs_raw_t, chan5_raw)}, \
          {"chan6_raw", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,           18,   offsetof(mavlink_hil_rc_inputs_raw_t, chan6_raw)}, \
          {"chan7_raw", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,           20,   offsetof(mavlink_hil_rc_inputs_raw_t, chan7_raw)}, \
          {"chan8_raw", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,           22,   offsetof(mavlink_hil_rc_inputs_raw_t, chan8_raw)}, \
          {"chan9_raw", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,           24,   offsetof(mavlink_hil_rc_inputs_raw_t, chan9_raw)}, \
          {"chan10_raw",                                                         \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT16_T,                                                \
           0,                                                                    \
           26,                                                                   \
           offsetof(mavlink_hil_rc_inputs_raw_t, chan10_raw)},                   \
          {"chan11_raw",                                                         \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT16_T,                                                \
           0,                                                                    \
           28,                                                                   \
           offsetof(mavlink_hil_rc_inputs_raw_t, chan11_raw)},                   \
          {"chan12_raw",                                                         \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT16_T,                                                \
           0,                                                                    \
           30,                                                                   \
           offsetof(mavlink_hil_rc_inputs_raw_t, chan12_raw)},                   \
          {"rssi", NULL, MAVLINK_TYPE_UINT8_T,                                   \
           0,      32,   offsetof(mavlink_hil_rc_inputs_raw_t, rssi)},           \
    }                                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_HIL_RC_INPUTS_RAW                                   \
  {                                                                              \
    "HIL_RC_INPUTS_RAW", 14, {                                                   \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                                 \
       0,           0,    offsetof(mavlink_hil_rc_inputs_raw_t, time_usec)},     \
          {"chan1_raw", NULL, MAVLINK_TYPE_UINT16_T,                             \
           0,           8,    offsetof(mavlink_hil_rc_inputs_raw_t, chan1_raw)}, \
...
static inline uint16_t mavlink_msg_hil_rc_inputs_raw_encode(
  ...
  return mavlink_msg_hil_rc_inputs_raw_pack(
      system_id, component_id, msg, hil_rc_inputs_raw->time_usec,
      hil_rc_inputs_raw->chan1_raw, hil_rc_inputs_raw->chan2_raw,
      hil_rc_inputs_raw->chan3_raw, hil_rc_inputs_raw->chan4_raw,
      hil_rc_inputs_raw->chan5_raw, hil_rc_inputs_raw->chan6_raw,
      hil_rc_inputs_raw->chan7_raw, hil_rc_inputs_raw->chan8_raw,
      hil_rc_inputs_raw->chan9_raw, hil_rc_inputs_raw->chan10_raw,
      hil_rc_inputs_raw->chan11_raw, hil_rc_inputs_raw->chan12_raw,
...
static inline uint16_t mavlink_msg_hil_rc_inputs_raw_encode_chan(
  ...
  return mavlink_msg_hil_rc_inputs_raw_pack_chan(
      system_id, component_id, chan, msg, hil_rc_inputs_raw->time_usec,
      hil_rc_inputs_raw->chan1_raw, hil_rc_inputs_raw->chan2_raw,
      hil_rc_inputs_raw->chan3_raw, hil_rc_inputs_raw->chan4_raw,
      hil_rc_inputs_raw->chan5_raw, hil_rc_inputs_raw->chan6_raw,
      hil_rc_inputs_raw->chan7_raw, hil_rc_inputs_raw->chan8_raw,
...
static inline void mavlink_msg_hil_rc_inputs_raw_send(
    mavlink_channel_t chan, uint64_t time_usec, uint16_t chan1_raw,
    uint16_t chan2_raw, uint16_t chan3_raw, uint16_t chan4_raw,
    uint16_t chan5_raw, uint16_t chan6_raw, uint16_t chan7_raw,
    uint16_t chan8_raw, uint16_t chan9_raw, uint16_t chan10_raw,
    uint16_t chan11_raw, uint16_t chan12_raw, uint8_t rssi) {
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW, buf,
                                  MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW_MIN_LEN,
                                  MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW_LEN,
                                  MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW_MIN_LEN,
                                  MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW_LEN,
                                  MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW_CRC);
 ...
 */
static inline void mavlink_msg_hil_rc_inputs_raw_send_struct(
    mavlink_channel_t chan,
    const mavlink_hil_rc_inputs_raw_t* hil_rc_inputs_raw) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_hil_rc_inputs_raw_send(
      chan, hil_rc_inputs_raw->time_usec, hil_rc_inputs_raw->chan1_raw,
...
static inline void mavlink_msg_hil_rc_inputs_raw_decode(
  ...
  hil_rc_inputs_raw->time_usec =
      mavlink_msg_hil_rc_inputs_raw_get_time_usec(msg);
  hil_rc_inputs_raw->chan1_raw =
      mavlink_msg_hil_rc_inputs_raw_get_chan1_raw(msg);
  hil_rc_inputs_raw->chan2_raw =
      mavlink_msg_hil_rc_inputs_raw_get_chan2_raw(msg);
  hil_rc_inputs_raw->chan3_raw =
      mavlink_msg_hil_rc_inputs_raw_get_chan3_raw(msg);
  hil_rc_inputs_raw->chan4_raw =
      mavlink_msg_hil_rc_inputs_raw_get_chan4_raw(msg);
  hil_rc_inputs_raw->chan5_raw =
      mavlink_msg_hil_rc_inputs_raw_get_chan5_raw(msg);
  hil_rc_inputs_raw->chan6_raw =
      mavlink_msg_hil_rc_inputs_raw_get_chan6_raw(msg);
  hil_rc_inputs_raw->chan7_raw =
      mavlink_msg_hil_rc_inputs_raw_get_chan7_raw(msg);
  hil_rc_inputs_raw->chan8_raw =
      mavlink_msg_hil_rc_inputs_raw_get_chan8_raw(msg);
  hil_rc_inputs_raw->chan9_raw =
      mavlink_msg_hil_rc_inputs_raw_get_chan9_raw(msg);
  hil_rc_inputs_raw->chan10_raw =
      mavlink_msg_hil_rc_inputs_raw_get_chan10_raw(msg);
  hil_rc_inputs_raw->chan11_raw =
      mavlink_msg_hil_rc_inputs_raw_get_chan11_raw(msg);
  hil_rc_inputs_raw->chan12_raw =
      mavlink_msg_hil_rc_inputs_raw_get_chan12_raw(msg);
  hil_rc_inputs_raw->rssi = mavlink_msg_hil_rc_inputs_raw_get_rssi(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW_LEN;
