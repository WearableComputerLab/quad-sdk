...
#define MAVLINK_MESSAGE_INFO_EXTENDED_SYS_STATE                   \
  {                                                               \
    245, "EXTENDED_SYS_STATE", 2, {                               \
      {"vtol_state",                                              \
       NULL,                                                      \
       MAVLINK_TYPE_UINT8_T,                                      \
       0,                                                         \
       0,                                                         \
       offsetof(mavlink_extended_sys_state_t, vtol_state)},       \
          {"landed_state",                                        \
           NULL,                                                  \
           MAVLINK_TYPE_UINT8_T,                                  \
           0,                                                     \
           1,                                                     \
           offsetof(mavlink_extended_sys_state_t, landed_state)}, \
    }                                                             \
  }
#else
#define MAVLINK_MESSAGE_INFO_EXTENDED_SYS_STATE                   \
 ...
 */
static inline uint16_t mavlink_msg_extended_sys_state_pack(
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_extended_sys_state_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint8_t vtol_state, uint8_t landed_state) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_EXTENDED_SYS_STATE_LEN];
  _mav_put_uint8_t(buf, 0, vtol_state);
  _mav_put_uint8_t(buf, 1, landed_state);
 ...
 */
static inline uint16_t mavlink_msg_extended_sys_state_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @param extended_sys_state C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_extended_sys_state_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_extended_sys_state_t* extended_sys_state) {
  return mavlink_msg_extended_sys_state_pack_chan(
      system_id, component_id, chan, msg, extended_sys_state->vtol_state,
      extended_sys_state->landed_state);
}
...
static inline void mavlink_msg_extended_sys_state_send(mavlink_channel_t chan,
                                                       uint8_t vtol_state,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EXTENDED_SYS_STATE, buf,
                                  MAVLINK_MSG_ID_EXTENDED_SYS_STATE_MIN_LEN,
                                  MAVLINK_MSG_ID_EXTENDED_SYS_STATE_LEN,
                                  MAVLINK_MSG_ID_EXTENDED_SYS_STATE_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EXTENDED_SYS_STATE,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_EXTENDED_SYS_STATE_MIN_LEN,
                                  MAVLINK_MSG_ID_EXTENDED_SYS_STATE_LEN,
                                  MAVLINK_MSG_ID_EXTENDED_SYS_STATE_CRC);
 ...
 */
static inline void mavlink_msg_extended_sys_state_send_struct(
    mavlink_channel_t chan,
    const mavlink_extended_sys_state_t* extended_sys_state) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_extended_sys_state_send(chan, extended_sys_state->vtol_state,
                                      extended_sys_state->landed_state);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EXTENDED_SYS_STATE,
                                  (const char*)extended_sys_state,
                                  MAVLINK_MSG_ID_EXTENDED_SYS_STATE_MIN_LEN,
                                  MAVLINK_MSG_ID_EXTENDED_SYS_STATE_LEN,
                                  MAVLINK_MSG_ID_EXTENDED_SYS_STATE_CRC);
#endif
 ...
 */
static inline void mavlink_msg_extended_sys_state_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t vtol_state,
    uint8_t landed_state) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return  The VTOL state if applicable. Is set to MAV_VTOL_STATE_UNDEFINED if
 * UAV is not in VTOL configuration.
 */
static inline uint8_t mavlink_msg_extended_sys_state_get_vtol_state(
 ...
 * state is unknown.
 */
static inline uint8_t mavlink_msg_extended_sys_state_get_landed_state(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_extended_sys_state_decode(
    const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_EXTENDED_SYS_STATE_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_EXTENDED_SYS_STATE_LEN;
