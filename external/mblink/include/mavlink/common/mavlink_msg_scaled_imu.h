  ...
  {                                                               \
    26, "SCALED_IMU", 10, {                                       \
      {"time_boot_ms",                                            \
       ...
       0,                                                         \
       0,                                                         \
       offsetof(mavlink_scaled_imu_t, time_boot_ms)},             \
          {"xacc", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,      4,    offsetof(mavlink_scaled_imu_t, xacc)},   \
          {"yacc", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,      6,    offsetof(mavlink_scaled_imu_t, yacc)},   \
          {"zacc", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,      8,    offsetof(mavlink_scaled_imu_t, zacc)},   \
          {"xgyro", NULL, MAVLINK_TYPE_INT16_T,                   \
           0,       10,   offsetof(mavlink_scaled_imu_t, xgyro)}, \
          {"ygyro", NULL, MAVLINK_TYPE_INT16_T,                   \
           0,       12,   offsetof(mavlink_scaled_imu_t, ygyro)}, \
          {"zgyro", NULL, MAVLINK_TYPE_INT16_T,                   \
           0,       14,   offsetof(mavlink_scaled_imu_t, zgyro)}, \
          {"xmag", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,      16,   offsetof(mavlink_scaled_imu_t, xmag)},   \
          {"ymag", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,      18,   offsetof(mavlink_scaled_imu_t, ymag)},   \
          {"zmag", NULL, MAVLINK_TYPE_INT16_T,                    \
           0,      20,   offsetof(mavlink_scaled_imu_t, zmag)},   \
    }                                                             \
  }
#else
#define MAVLINK_MESSAGE_INFO_SCALED_IMU                           \
...
static inline uint16_t mavlink_msg_scaled_imu_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_SCALED_IMU_MIN_LEN,
...
static inline uint16_t mavlink_msg_scaled_imu_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_SCALED_IMU_MIN_LEN,
      MAVLINK_MSG_ID_SCALED_IMU_LEN, MAVLINK_MSG_ID_SCALED_IMU_CRC);
}
...
static inline uint16_t mavlink_msg_scaled_imu_encode(
  ...
  return mavlink_msg_scaled_imu_pack(
      system_id, component_id, msg, scaled_imu->time_boot_ms, scaled_imu->xacc,
      scaled_imu->yacc, scaled_imu->zacc, scaled_imu->xgyro, scaled_imu->ygyro,
      scaled_imu->zgyro, scaled_imu->xmag, scaled_imu->ymag, scaled_imu->zmag);
}
...
static inline uint16_t mavlink_msg_scaled_imu_encode_chan(
  ...
  return mavlink_msg_scaled_imu_pack_chan(
      system_id, component_id, chan, msg, scaled_imu->time_boot_ms,
      scaled_imu->xacc, scaled_imu->yacc, scaled_imu->zacc, scaled_imu->xgyro,
      scaled_imu->ygyro, scaled_imu->zgyro, scaled_imu->xmag, scaled_imu->ymag,
      scaled_imu->zmag);
}
...
static inline void mavlink_msg_scaled_imu_send(
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SCALED_IMU, buf, MAVLINK_MSG_ID_SCALED_IMU_MIN_LEN,
      MAVLINK_MSG_ID_SCALED_IMU_LEN, MAVLINK_MSG_ID_SCALED_IMU_CRC);
#else
  mavlink_scaled_imu_t packet;
  packet.time_boot_ms = time_boot_ms;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SCALED_IMU, (const char*)&packet,
      MAVLINK_MSG_ID_SCALED_IMU_MIN_LEN, MAVLINK_MSG_ID_SCALED_IMU_LEN,
 ...
 */
static inline void mavlink_msg_scaled_imu_send_struct(
    mavlink_channel_t chan, const mavlink_scaled_imu_t* scaled_imu) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_scaled_imu_send(
      chan, scaled_imu->time_boot_ms, scaled_imu->xacc, scaled_imu->yacc,
      scaled_imu->zacc, scaled_imu->xgyro, scaled_imu->ygyro, scaled_imu->zgyro,
      scaled_imu->xmag, scaled_imu->ymag, scaled_imu->zmag);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SCALED_IMU, (const char*)scaled_imu,
      MAVLINK_MSG_ID_SCALED_IMU_MIN_LEN, MAVLINK_MSG_ID_SCALED_IMU_LEN,
      MAVLINK_MSG_ID_SCALED_IMU_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_scaled_imu_send_buf(
 ...
 */
static inline void mavlink_msg_scaled_imu_decode(
    const mavlink_message_t* msg, mavlink_scaled_imu_t* scaled_imu) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SCALED_IMU_LEN
                    ? msg->len
