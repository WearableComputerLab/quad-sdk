...
MAVPACKED(typedef struct __mavlink_landing_target_t {
  ...
  float angle_x;  /*< [rad] X-axis angular offset of the target from the center
                     of the image*/
  float angle_y;  /*< [rad] Y-axis angular offset of the target from the center
                     of the image*/
  ...
  float q[4];   /*<  Quaternion of landing target orientation (w, x, y, z order,
                   zero-rotation is 1, 0, 0, 0)*/
  uint8_t type; /*<  Type of landing target*/
  uint8_t
      position_valid; /*<  Boolean indicating whether the position fields (x, y,
                         z, q, type) contain valid target position information
...
#define MAVLINK_MESSAGE_INFO_LANDING_TARGET                                 \
  {                                                                         \
    149, "LANDING_TARGET", 14, {                                            \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                            \
       0,           0,    offsetof(mavlink_landing_target_t, time_usec)},   \
          {"target_num",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           28,                                                              \
           offsetof(mavlink_landing_target_t, target_num)},                 \
          {"frame", NULL, MAVLINK_TYPE_UINT8_T,                             \
           0,       29,   offsetof(mavlink_landing_target_t, frame)},       \
          {"angle_x", NULL, MAVLINK_TYPE_FLOAT,                             \
           0,         8,    offsetof(mavlink_landing_target_t, angle_x)},   \
          {"angle_y", NULL, MAVLINK_TYPE_FLOAT,                             \
           0,         12,   offsetof(mavlink_landing_target_t, angle_y)},   \
          {"distance", NULL, MAVLINK_TYPE_FLOAT,                            \
           0,          16,   offsetof(mavlink_landing_target_t, distance)}, \
          {"size_x", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,        20,   offsetof(mavlink_landing_target_t, size_x)},     \
          {"size_y", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,        24,   offsetof(mavlink_landing_target_t, size_y)},     \
          {"x", NULL, MAVLINK_TYPE_FLOAT,                                   \
           0,   30,   offsetof(mavlink_landing_target_t, x)},               \
          {"y", NULL, MAVLINK_TYPE_FLOAT,                                   \
           0,   34,   offsetof(mavlink_landing_target_t, y)},               \
          {"z", NULL, MAVLINK_TYPE_FLOAT,                                   \
           0,   38,   offsetof(mavlink_landing_target_t, z)},               \
          {"q", NULL, MAVLINK_TYPE_FLOAT,                                   \
           4,   42,   offsetof(mavlink_landing_target_t, q)},               \
          {"type", NULL, MAVLINK_TYPE_UINT8_T,                              \
           0,      58,   offsetof(mavlink_landing_target_t, type)},         \
          {"position_valid",                                                \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           59,                                                              \
           offsetof(mavlink_landing_target_t, position_valid)},             \
    }                                                                       \
  }
#else
#define MAVLINK_MESSAGE_INFO_LANDING_TARGET                                 \
 ...
 * @param angle_x [rad] X-axis angular offset of the target from the center of
 * the image
 * @param angle_y [rad] Y-axis angular offset of the target from the center of
 * the image
 ...
 * @param q  Quaternion of landing target orientation (w, x, y, z order,
 * zero-rotation is 1, 0, 0, 0)
 * @param type  Type of landing target
 * @param position_valid  Boolean indicating whether the position fields (x, y,
 * z, q, type) contain valid target position information (valid: 1, invalid: 0).
 * Default is 0 (invalid).
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_landing_target_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint64_t time_usec, uint8_t target_num, uint8_t frame, float angle_x,
    float angle_y, float distance, float size_x, float size_y, float x, float y,
    float z, const float* q, uint8_t type, uint8_t position_valid) {
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_LANDING_TARGET_MIN_LEN,
      MAVLINK_MSG_ID_LANDING_TARGET_LEN, MAVLINK_MSG_ID_LANDING_TARGET_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_landing_target_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint64_t time_usec, uint8_t target_num,
    uint8_t frame, float angle_x, float angle_y, float distance, float size_x,
    float size_y, float x, float y, float z, const float* q, uint8_t type,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_LANDING_TARGET_MIN_LEN,
      MAVLINK_MSG_ID_LANDING_TARGET_LEN, MAVLINK_MSG_ID_LANDING_TARGET_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_landing_target_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_landing_target_t* landing_target) {
  return mavlink_msg_landing_target_pack(
      system_id, component_id, msg, landing_target->time_usec,
      landing_target->target_num, landing_target->frame,
      landing_target->angle_x, landing_target->angle_y,
      landing_target->distance, landing_target->size_x, landing_target->size_y,
      landing_target->x, landing_target->y, landing_target->z,
      landing_target->q, landing_target->type, landing_target->position_valid);
}
 ...
 * @param landing_target C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_landing_target_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_landing_target_t* landing_target) {
  return mavlink_msg_landing_target_pack_chan(
      system_id, component_id, chan, msg, landing_target->time_usec,
      landing_target->target_num, landing_target->frame,
      landing_target->angle_x, landing_target->angle_y,
      landing_target->distance, landing_target->size_x, landing_target->size_y,
      landing_target->x, landing_target->y, landing_target->z,
...
static inline void mavlink_msg_landing_target_send(
    mavlink_channel_t chan, uint64_t time_usec, uint8_t target_num,
    uint8_t frame, float angle_x, float angle_y, float distance, float size_x,
    float size_y, float x, float y, float z, const float* q, uint8_t type,
    uint8_t position_valid) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_put_uint8_t(buf, 59, position_valid);
  _mav_put_float_array(buf, 42, q, 4);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LANDING_TARGET, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LANDING_TARGET, (const char*)&packet,
      MAVLINK_MSG_ID_LANDING_TARGET_MIN_LEN, MAVLINK_MSG_ID_LANDING_TARGET_LEN,
      MAVLINK_MSG_ID_LANDING_TARGET_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_landing_target_send_struct(
    mavlink_channel_t chan, const mavlink_landing_target_t* landing_target) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_landing_target_send(
      chan, landing_target->time_usec, landing_target->target_num,
      landing_target->frame, landing_target->angle_x, landing_target->angle_y,
      landing_target->distance, landing_target->size_x, landing_target->size_y,
      landing_target->x, landing_target->y, landing_target->z,
      landing_target->q, landing_target->type, landing_target->position_valid);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LANDING_TARGET, (const char*)landing_target,
      MAVLINK_MSG_ID_LANDING_TARGET_MIN_LEN, MAVLINK_MSG_ID_LANDING_TARGET_LEN,
      MAVLINK_MSG_ID_LANDING_TARGET_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_landing_target_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    uint8_t target_num, uint8_t frame, float angle_x, float angle_y,
    float distance, float size_x, float size_y, float x, float y, float z,
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_landing_target_get_time_usec(
 ...
 */
static inline uint8_t mavlink_msg_landing_target_get_target_num(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_landing_target_get_frame(
    const mavlink_message_t* msg) {
 ...
 * image
 */
static inline float mavlink_msg_landing_target_get_angle_x(
    const mavlink_message_t* msg) {
 ...
 * image
 */
static inline float mavlink_msg_landing_target_get_angle_y(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_landing_target_get_distance(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_landing_target_get_size_x(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_landing_target_get_size_y(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_landing_target_get_x(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_landing_target_get_y(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_landing_target_get_z(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Quaternion of landing target orientation (w, x, y, z order,
 * zero-rotation is 1, 0, 0, 0)
 */
static inline uint16_t mavlink_msg_landing_target_get_q(
 ...
 */
static inline uint8_t mavlink_msg_landing_target_get_type(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Boolean indicating whether the position fields (x, y, z, q, type)
 * contain valid target position information (valid: 1, invalid: 0). Default is
 * 0 (invalid).
 */
static inline uint8_t mavlink_msg_landing_target_get_position_valid(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_landing_target_decode(
