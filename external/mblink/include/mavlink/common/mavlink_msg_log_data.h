...
MAVPACKED(typedef struct __mavlink_log_data_t {
  ...
  {                                                             \
    120, "LOG_DATA", 4, {                                       \
      {"id", NULL, MAVLINK_TYPE_UINT16_T,                       \
       0,    4,    offsetof(mavlink_log_data_t, id)},           \
          {"ofs", NULL, MAVLINK_TYPE_UINT32_T,                  \
           0,     0,    offsetof(mavlink_log_data_t, ofs)},     \
          {"count", NULL, MAVLINK_TYPE_UINT8_T,                 \
           0,       6,    offsetof(mavlink_log_data_t, count)}, \
          {"data", NULL, MAVLINK_TYPE_UINT8_T,                  \
           90,     7,    offsetof(mavlink_log_data_t, data)},   \
    }                                                           \
  }
#else
#define MAVLINK_MESSAGE_INFO_LOG_DATA                           \
...
static inline uint16_t mavlink_msg_log_data_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_LOG_DATA_MIN_LEN,
...
static inline uint16_t mavlink_msg_log_data_pack_chan(
    ...
    mavlink_message_t* msg, uint16_t id, uint32_t ofs, uint8_t count,
    const uint8_t* data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_LOG_DATA_LEN];
  _mav_put_uint32_t(buf, 0, ofs);
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_LOG_DATA_MIN_LEN,
      MAVLINK_MSG_ID_LOG_DATA_LEN, MAVLINK_MSG_ID_LOG_DATA_CRC);
}
...
static inline uint16_t mavlink_msg_log_data_encode(
  ...
  return mavlink_msg_log_data_pack(system_id, component_id, msg, log_data->id,
...
static inline uint16_t mavlink_msg_log_data_encode_chan(
  ...
  return mavlink_msg_log_data_pack_chan(system_id, component_id, chan, msg,
                                        log_data->id, log_data->ofs,
...
static inline void mavlink_msg_log_data_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_DATA, buf, MAVLINK_MSG_ID_LOG_DATA_MIN_LEN,
      MAVLINK_MSG_ID_LOG_DATA_LEN, MAVLINK_MSG_ID_LOG_DATA_CRC);
#else
  mavlink_log_data_t packet;
  packet.ofs = ofs;
  ...
  mav_array_memcpy(packet.data, data, sizeof(uint8_t) * 90);
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_DATA, (const char*)&packet,
      MAVLINK_MSG_ID_LOG_DATA_MIN_LEN, MAVLINK_MSG_ID_LOG_DATA_LEN,
 ...
 */
static inline void mavlink_msg_log_data_send_struct(
    mavlink_channel_t chan, const mavlink_log_data_t* log_data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_log_data_send(chan, log_data->id, log_data->ofs, log_data->count,
                            log_data->data);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_DATA, (const char*)log_data,
      MAVLINK_MSG_ID_LOG_DATA_MIN_LEN, MAVLINK_MSG_ID_LOG_DATA_LEN,
      MAVLINK_MSG_ID_LOG_DATA_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_log_data_send_buf(mavlink_message_t* msgbuf,
 ...
 */
static inline uint16_t mavlink_msg_log_data_get_id(
 ...
 */
static inline uint32_t mavlink_msg_log_data_get_ofs(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_log_data_get_count(
    const mavlink_message_t* msg) {
 ...
 * @return  log data
 */
static inline uint16_t mavlink_msg_log_data_get_data(
 ...
 */
static inline void mavlink_msg_log_data_decode(const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_LOG_DATA_LEN
                    ? msg->len
