...
MAVPACKED(typedef struct __mavlink_change_operator_control_ack_t {
  ...
  uint8_t control_request; /*<  0: request control of this MAV, 1: Release
                              control of this MAV*/
  uint8_t ack; /*<  0: ACK, 1: NACK: Wrong passkey, 2: NACK: Unsupported passkey
...
#define MAVLINK_MESSAGE_INFO_CHANGE_OPERATOR_CONTROL_ACK                       \
  {                                                                            \
    6, "CHANGE_OPERATOR_CONTROL_ACK", 3, {                                     \
      {"gcs_system_id",                                                        \
       NULL,                                                                   \
       MAVLINK_TYPE_UINT8_T,                                                   \
       0,                                                                      \
       0,                                                                      \
       offsetof(mavlink_change_operator_control_ack_t, gcs_system_id)},        \
          {"control_request",                                                  \
           NULL,                                                               \
           MAVLINK_TYPE_UINT8_T,                                               \
           0,                                                                  \
           1,                                                                  \
           offsetof(mavlink_change_operator_control_ack_t, control_request)},  \
          {"ack", NULL, MAVLINK_TYPE_UINT8_T,                                  \
           0,     2,    offsetof(mavlink_change_operator_control_ack_t, ack)}, \
    }                                                                          \
  }
#else
#define MAVLINK_MESSAGE_INFO_CHANGE_OPERATOR_CONTROL_ACK                       \
  {                                                                            \
    "CHANGE_OPERATOR_CONTROL_ACK", 3, {                                        \
      {"gcs_system_id",                                                        \
       NULL,                                                                   \
       MAVLINK_TYPE_UINT8_T,                                                   \
       0,                                                                      \
 ...
 * this MAV
 * @param ack  0: ACK, 1: NACK: Wrong passkey, 2: NACK: Unsupported passkey
 * encryption method, 3: NACK: Already under control
...
static inline uint16_t mavlink_msg_change_operator_control_ack_encode(
  ...
  return mavlink_msg_change_operator_control_ack_pack(
      system_id, component_id, msg, change_operator_control_ack->gcs_system_id,
...
static inline void mavlink_msg_change_operator_control_ack_send(
    mavlink_channel_t chan, uint8_t gcs_system_id, uint8_t control_request,
    uint8_t ack) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_LEN];
  _mav_put_uint8_t(buf, 0, gcs_system_id);
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK, buf,
      MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_MIN_LEN,
      MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_LEN,
      MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK, (const char*)&packet,
      MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_MIN_LEN,
      MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_LEN,
      MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_CRC);
#endif
 ...
 */
static inline void mavlink_msg_change_operator_control_ack_send_struct(
    mavlink_channel_t chan,
    const mavlink_change_operator_control_ack_t* change_operator_control_ack) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_change_operator_control_ack_send(
      chan, change_operator_control_ack->gcs_system_id,
      change_operator_control_ack->control_request,
      change_operator_control_ack->ack);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK,
      (const char*)change_operator_control_ack,
      MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_MIN_LEN,
      MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_LEN,
      MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_CRC);
#endif
 ...
 */
static inline void mavlink_msg_change_operator_control_ack_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t gcs_system_id,
    uint8_t control_request, uint8_t ack) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  mavlink_change_operator_control_ack_t* packet =
      (mavlink_change_operator_control_ack_t*)msgbuf;
  packet->gcs_system_id = gcs_system_id;
  packet->control_request = control_request;
  packet->ack = ack;
 ...
 *
 * @return  0: ACK, 1: NACK: Wrong passkey, 2: NACK: Unsupported passkey
 * encryption method, 3: NACK: Already under control
 */
 ...
 * @param change_operator_control_ack C-struct to decode the message contents
 * into
 */
...
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  change_operator_control_ack->gcs_system_id =
      mavlink_msg_change_operator_control_ack_get_gcs_system_id(msg);
  change_operator_control_ack->control_request =
      mavlink_msg_change_operator_control_ack_get_control_request(msg);
  change_operator_control_ack->ack =
      mavlink_msg_change_operator_control_ack_get_ack(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_LEN;
  memset(change_operator_control_ack, 0,
         MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_LEN);
