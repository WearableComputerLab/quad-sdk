...
MAVPACKED(typedef struct __mavlink_auth_key_t {
  char key[32]; /*<  key*/
})
mavlink_auth_key_t;
...
#define MAVLINK_MESSAGE_INFO_AUTH_KEY                   \
  {                                                     \
    7, "AUTH_KEY", 1, {                                 \
      {"key", NULL, MAVLINK_TYPE_CHAR,                  \
       32,    0,    offsetof(mavlink_auth_key_t, key)}, \
    }                                                   \
  }
#else
#define MAVLINK_MESSAGE_INFO_AUTH_KEY                   \
...
static inline uint16_t mavlink_msg_auth_key_pack(uint8_t system_id,
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_AUTH_KEY_MIN_LEN,
...
static inline uint16_t mavlink_msg_auth_key_pack_chan(uint8_t system_id,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_AUTH_KEY_MIN_LEN,
      MAVLINK_MSG_ID_AUTH_KEY_LEN, MAVLINK_MSG_ID_AUTH_KEY_CRC);
}
...
static inline uint16_t mavlink_msg_auth_key_encode_chan(
  ...
  return mavlink_msg_auth_key_pack_chan(system_id, component_id, chan, msg,
                                        auth_key->key);
}
...
static inline void mavlink_msg_auth_key_send(mavlink_channel_t chan,
                                             const char* key) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_AUTH_KEY_LEN];
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_AUTH_KEY, buf, MAVLINK_MSG_ID_AUTH_KEY_MIN_LEN,
      MAVLINK_MSG_ID_AUTH_KEY_LEN, MAVLINK_MSG_ID_AUTH_KEY_CRC);
#else
  mavlink_auth_key_t packet;
  ...
  mav_array_memcpy(packet.key, key, sizeof(char) * 32);
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_AUTH_KEY, (const char*)&packet,
      MAVLINK_MSG_ID_AUTH_KEY_MIN_LEN, MAVLINK_MSG_ID_AUTH_KEY_LEN,
 ...
 */
static inline void mavlink_msg_auth_key_send_struct(
    mavlink_channel_t chan, const mavlink_auth_key_t* auth_key) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_auth_key_send(chan, auth_key->key);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_AUTH_KEY, (const char*)auth_key,
      MAVLINK_MSG_ID_AUTH_KEY_MIN_LEN, MAVLINK_MSG_ID_AUTH_KEY_LEN,
      MAVLINK_MSG_ID_AUTH_KEY_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_auth_key_send_buf(mavlink_message_t* msgbuf,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_AUTH_KEY_LEN
                    ? msg->len
