...
MAVPACKED(typedef struct __mavlink_play_tune_t {
  ...
  {                                                              \
    258, "PLAY_TUNE", 4, {                                       \
      {"target_system",                                          \
       ...
       0,                                                        \
       0,                                                        \
       offsetof(mavlink_play_tune_t, target_system)},            \
          {"target_component",                                   \
           NULL,                                                 \
           MAVLINK_TYPE_UINT8_T,                                 \
           0,                                                    \
           1,                                                    \
           offsetof(mavlink_play_tune_t, target_component)},     \
          {"tune", NULL, MAVLINK_TYPE_CHAR,                      \
           30,     2,    offsetof(mavlink_play_tune_t, tune)},   \
          {"tune2", NULL, MAVLINK_TYPE_CHAR,                     \
           200,     32,   offsetof(mavlink_play_tune_t, tune2)}, \
    }                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_PLAY_TUNE                           \
 ...
 */
static inline uint16_t mavlink_msg_play_tune_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_PLAY_TUNE_MIN_LEN,
 ...
 */
static inline uint16_t mavlink_msg_play_tune_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_play_tune_t* play_tune) {
  return mavlink_msg_play_tune_pack(
      system_id, component_id, msg, play_tune->target_system,
      play_tune->target_component, play_tune->tune, play_tune->tune2);
}
 ...
 * @param play_tune C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_play_tune_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_play_tune_t* play_tune) {
  return mavlink_msg_play_tune_pack_chan(
      system_id, component_id, chan, msg, play_tune->target_system,
      play_tune->target_component, play_tune->tune, play_tune->tune2);
}
...
static inline void mavlink_msg_play_tune_send(mavlink_channel_t chan,
 ...
 */
static inline void mavlink_msg_play_tune_send_struct(
    mavlink_channel_t chan, const mavlink_play_tune_t* play_tune) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_play_tune_send(chan, play_tune->target_system,
                             play_tune->target_component, play_tune->tune,
                             play_tune->tune2);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_PLAY_TUNE, (const char*)play_tune,
      MAVLINK_MSG_ID_PLAY_TUNE_MIN_LEN, MAVLINK_MSG_ID_PLAY_TUNE_LEN,
      MAVLINK_MSG_ID_PLAY_TUNE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_play_tune_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system,
    uint8_t target_component, const char* tune, const char* tune2) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  System ID
 */
static inline uint8_t mavlink_msg_play_tune_get_target_system(
 ...
 * @return  Component ID
 */
static inline uint8_t mavlink_msg_play_tune_get_target_component(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_play_tune_get_tune(
    const mavlink_message_t* msg, char* tune) {
 ...
 */
static inline uint16_t mavlink_msg_play_tune_get_tune2(
    const mavlink_message_t* msg, char* tune2) {
 ...
 */
static inline void mavlink_msg_play_tune_decode(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_PLAY_TUNE_LEN
                    ? msg->len
