...
MAVPACKED(typedef struct __mavlink_high_latency_t {
  ...
  int8_t temperature_air; /*< [degC] Air temperature (degrees C) from airspeed
                             sensor*/
...
#define MAVLINK_MESSAGE_INFO_HIGH_LATENCY                                   \
  {                                                                         \
    234, "HIGH_LATENCY", 24, {                                              \
      {"base_mode", NULL, MAVLINK_TYPE_UINT8_T,                             \
       0,           26,   offsetof(mavlink_high_latency_t, base_mode)},     \
          {"custom_mode",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_UINT32_T,                                           \
           0,                                                               \
           0,                                                               \
           offsetof(mavlink_high_latency_t, custom_mode)},                  \
          {"landed_state",                                                  \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           27,                                                              \
           offsetof(mavlink_high_latency_t, landed_state)},                 \
          {"roll", NULL, MAVLINK_TYPE_INT16_T,                              \
           0,      12,   offsetof(mavlink_high_latency_t, roll)},           \
          {"pitch", NULL, MAVLINK_TYPE_INT16_T,                             \
           0,       14,   offsetof(mavlink_high_latency_t, pitch)},         \
          {"heading", NULL, MAVLINK_TYPE_UINT16_T,                          \
           0,         16,   offsetof(mavlink_high_latency_t, heading)},     \
          {"throttle", NULL, MAVLINK_TYPE_INT8_T,                           \
           0,          28,   offsetof(mavlink_high_latency_t, throttle)},   \
          {"heading_sp",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_INT16_T,                                            \
           0,                                                               \
           18,                                                              \
           offsetof(mavlink_high_latency_t, heading_sp)},                   \
          {"latitude", NULL, MAVLINK_TYPE_INT32_T,                          \
           0,          4,    offsetof(mavlink_high_latency_t, latitude)},   \
          {"longitude", NULL, MAVLINK_TYPE_INT32_T,                         \
           0,           8,    offsetof(mavlink_high_latency_t, longitude)}, \
          {"altitude_amsl",                                                 \
           NULL,                                                            \
           MAVLINK_TYPE_INT16_T,                                            \
           0,                                                               \
           20,                                                              \
           offsetof(mavlink_high_latency_t, altitude_amsl)},                \
          {"altitude_sp",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_INT16_T,                                            \
           0,                                                               \
           22,                                                              \
           offsetof(mavlink_high_latency_t, altitude_sp)},                  \
          {"airspeed", NULL, MAVLINK_TYPE_UINT8_T,                          \
           0,          29,   offsetof(mavlink_high_latency_t, airspeed)},   \
          {"airspeed_sp",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           30,                                                              \
           offsetof(mavlink_high_latency_t, airspeed_sp)},                  \
          {"groundspeed",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           31,                                                              \
           offsetof(mavlink_high_latency_t, groundspeed)},                  \
          {"climb_rate",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_INT8_T,                                             \
           0,                                                               \
           32,                                                              \
           offsetof(mavlink_high_latency_t, climb_rate)},                   \
          {"gps_nsat", NULL, MAVLINK_TYPE_UINT8_T,                          \
           0,          33,   offsetof(mavlink_high_latency_t, gps_nsat)},   \
          {"gps_fix_type",                                                  \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           34,                                                              \
           offsetof(mavlink_high_latency_t, gps_fix_type)},                 \
          {"battery_remaining",                                             \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           35,                                                              \
           offsetof(mavlink_high_latency_t, battery_remaining)},            \
          {"temperature",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_INT8_T,                                             \
           0,                                                               \
           36,                                                              \
           offsetof(mavlink_high_latency_t, temperature)},                  \
          {"temperature_air",                                               \
           NULL,                                                            \
           MAVLINK_TYPE_INT8_T,                                             \
           0,                                                               \
           37,                                                              \
           offsetof(mavlink_high_latency_t, temperature_air)},              \
          {"failsafe", NULL, MAVLINK_TYPE_UINT8_T,                          \
           0,          38,   offsetof(mavlink_high_latency_t, failsafe)},   \
          {"wp_num", NULL, MAVLINK_TYPE_UINT8_T,                            \
           0,        39,   offsetof(mavlink_high_latency_t, wp_num)},       \
          {"wp_distance",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           24,                                                              \
           offsetof(mavlink_high_latency_t, wp_distance)},                  \
    }                                                                       \
  }
#else
#define MAVLINK_MESSAGE_INFO_HIGH_LATENCY                                   \
 ...
 * @param temperature_air [degC] Air temperature (degrees C) from airspeed
 * sensor
 * @param failsafe  failsafe (each bit represents a failsafe where 0=ok,
 * 1=failsafe active (bit0:RC, bit1:batt, bit2:GPS, bit3:GCS, bit4:fence)
 * @param wp_num  current waypoint number
 * @param wp_distance [m] distance to target
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_high_latency_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint8_t base_mode, uint32_t custom_mode, uint8_t landed_state, int16_t roll,
    int16_t pitch, uint16_t heading, int8_t throttle, int16_t heading_sp,
    int32_t latitude, int32_t longitude, int16_t altitude_amsl,
    int16_t altitude_sp, uint8_t airspeed, uint8_t airspeed_sp,
    uint8_t groundspeed, int8_t climb_rate, uint8_t gps_nsat,
    uint8_t gps_fix_type, uint8_t battery_remaining, int8_t temperature,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_high_latency_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint8_t base_mode, uint32_t custom_mode,
    uint8_t landed_state, int16_t roll, int16_t pitch, uint16_t heading,
    int8_t throttle, int16_t heading_sp, int32_t latitude, int32_t longitude,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_HIGH_LATENCY_MIN_LEN,
      MAVLINK_MSG_ID_HIGH_LATENCY_LEN, MAVLINK_MSG_ID_HIGH_LATENCY_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_high_latency_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_high_latency_t* high_latency) {
  return mavlink_msg_high_latency_pack(
      system_id, component_id, msg, high_latency->base_mode,
      high_latency->custom_mode, high_latency->landed_state, high_latency->roll,
      high_latency->pitch, high_latency->heading, high_latency->throttle,
      high_latency->heading_sp, high_latency->latitude, high_latency->longitude,
 ...
 * @param high_latency C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_high_latency_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_high_latency_t* high_latency) {
  return mavlink_msg_high_latency_pack_chan(
      system_id, component_id, chan, msg, high_latency->base_mode,
      high_latency->custom_mode, high_latency->landed_state, high_latency->roll,
      high_latency->pitch, high_latency->heading, high_latency->throttle,
      high_latency->heading_sp, high_latency->latitude, high_latency->longitude,
      high_latency->altitude_amsl, high_latency->altitude_sp,
...
static inline void mavlink_msg_high_latency_send(
    mavlink_channel_t chan, uint8_t base_mode, uint32_t custom_mode,
    uint8_t landed_state, int16_t roll, int16_t pitch, uint16_t heading,
    int8_t throttle, int16_t heading_sp, int32_t latitude, int32_t longitude,
    int16_t altitude_amsl, int16_t altitude_sp, uint8_t airspeed,
    uint8_t airspeed_sp, uint8_t groundspeed, int8_t climb_rate,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HIGH_LATENCY, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIGH_LATENCY, (const char*)&packet,
      MAVLINK_MSG_ID_HIGH_LATENCY_MIN_LEN, MAVLINK_MSG_ID_HIGH_LATENCY_LEN,
      MAVLINK_MSG_ID_HIGH_LATENCY_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_high_latency_send_struct(
    mavlink_channel_t chan, const mavlink_high_latency_t* high_latency) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_high_latency_send(
      chan, high_latency->base_mode, high_latency->custom_mode,
      high_latency->landed_state, high_latency->roll, high_latency->pitch,
      high_latency->heading, high_latency->throttle, high_latency->heading_sp,
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIGH_LATENCY, (const char*)high_latency,
      MAVLINK_MSG_ID_HIGH_LATENCY_MIN_LEN, MAVLINK_MSG_ID_HIGH_LATENCY_LEN,
      MAVLINK_MSG_ID_HIGH_LATENCY_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_high_latency_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t base_mode,
    uint32_t custom_mode, uint8_t landed_state, int16_t roll, int16_t pitch,
    uint16_t heading, int8_t throttle, int16_t heading_sp, int32_t latitude,
    int32_t longitude, int16_t altitude_amsl, int16_t altitude_sp,
    uint8_t airspeed, uint8_t airspeed_sp, uint8_t groundspeed,
    int8_t climb_rate, uint8_t gps_nsat, uint8_t gps_fix_type,
    uint8_t battery_remaining, int8_t temperature, int8_t temperature_air,
    uint8_t failsafe, uint8_t wp_num, uint16_t wp_distance) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint8_t mavlink_msg_high_latency_get_base_mode(
 ...
 */
static inline uint32_t mavlink_msg_high_latency_get_custom_mode(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  The landed state. Is set to MAV_LANDED_STATE_UNDEFINED if landed
 * state is unknown.
 */
static inline uint8_t mavlink_msg_high_latency_get_landed_state(
    const mavlink_message_t* msg) {
 ...
 * @return [cdeg] roll
 */
static inline int16_t mavlink_msg_high_latency_get_roll(
    const mavlink_message_t* msg) {
 ...
 * @return [cdeg] pitch
 */
static inline int16_t mavlink_msg_high_latency_get_pitch(
    const mavlink_message_t* msg) {
 ...
 * @return [cdeg] heading
 */
static inline uint16_t mavlink_msg_high_latency_get_heading(
    const mavlink_message_t* msg) {
 ...
 */
static inline int8_t mavlink_msg_high_latency_get_throttle(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_high_latency_get_heading_sp(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_high_latency_get_latitude(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_high_latency_get_longitude(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_high_latency_get_altitude_amsl(
    const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_high_latency_get_altitude_sp(
    const mavlink_message_t* msg) {
 ...
 * @return [m/s] airspeed
 */
static inline uint8_t mavlink_msg_high_latency_get_airspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency_get_airspeed_sp(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency_get_groundspeed(
    const mavlink_message_t* msg) {
 ...
 */
static inline int8_t mavlink_msg_high_latency_get_climb_rate(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency_get_gps_nsat(
    const mavlink_message_t* msg) {
 ...
 * @return  GPS Fix type.
 */
static inline uint8_t mavlink_msg_high_latency_get_gps_fix_type(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency_get_battery_remaining(
    const mavlink_message_t* msg) {
 ...
 */
static inline int8_t mavlink_msg_high_latency_get_temperature(
    const mavlink_message_t* msg) {
 ...
 */
static inline int8_t mavlink_msg_high_latency_get_temperature_air(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  failsafe (each bit represents a failsafe where 0=ok, 1=failsafe
 * active (bit0:RC, bit1:batt, bit2:GPS, bit3:GCS, bit4:fence)
 */
static inline uint8_t mavlink_msg_high_latency_get_failsafe(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_high_latency_get_wp_num(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_high_latency_get_wp_distance(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_high_latency_decode(
    const mavlink_message_t* msg, mavlink_high_latency_t* high_latency) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_HIGH_LATENCY_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_HIGH_LATENCY_LEN;
