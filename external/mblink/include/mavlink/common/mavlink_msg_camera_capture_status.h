...
MAVPACKED(typedef struct __mavlink_camera_capture_status_t {
...
#define MAVLINK_MESSAGE_INFO_CAMERA_CAPTURE_STATUS                         \
  {                                                                        \
    262, "CAMERA_CAPTURE_STATUS", 6, {                                     \
      {"time_boot_ms",                                                     \
       NULL,                                                               \
       MAVLINK_TYPE_UINT32_T,                                              \
       0,                                                                  \
       0,                                                                  \
       offsetof(mavlink_camera_capture_status_t, time_boot_ms)},           \
          {"image_status",                                                 \
           NULL,                                                           \
           MAVLINK_TYPE_UINT8_T,                                           \
           0,                                                              \
           16,                                                             \
           offsetof(mavlink_camera_capture_status_t, image_status)},       \
          {"video_status",                                                 \
           NULL,                                                           \
           MAVLINK_TYPE_UINT8_T,                                           \
           0,                                                              \
          ...
          {"image_interval",                                               \
           ...
           0,                                                              \
           4,                                                              \
           offsetof(mavlink_camera_capture_status_t, image_interval)},     \
          {"recording_time_ms",                                            \
           NULL,                                                           \
           MAVLINK_TYPE_UINT32_T,                                          \
           0,                                                              \
           8,                                                              \
           offsetof(mavlink_camera_capture_status_t, recording_time_ms)},  \
          {"available_capacity",                                           \
           NULL,                                                           \
           MAVLINK_TYPE_FLOAT,                                             \
           0,                                                              \
           12,                                                             \
           offsetof(mavlink_camera_capture_status_t, available_capacity)}, \
    }                                                                      \
  }
#else
#define MAVLINK_MESSAGE_INFO_CAMERA_CAPTURE_STATUS                         \
  {                                                                        \
    "CAMERA_CAPTURE_STATUS", 6, {                                          \
      {"time_boot_ms",                                                     \
       NULL,                                                               \
       MAVLINK_TYPE_UINT32_T,                                              \
       0,                                                                  \
 ...
 * @param image_status  Current status of image capturing (0: idle, 1: capture
 * in progress, 2: interval set but idle, 3: interval set and capture in
 * progress)
 * @param video_status  Current status of video capturing (0: idle, 1: capture
 * in progress)
 ...
 */
static inline uint16_t mavlink_msg_camera_capture_status_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint32_t time_boot_ms, uint8_t image_status, uint8_t video_status,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_camera_capture_status_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint32_t time_boot_ms, uint8_t image_status,
    uint8_t video_status, float image_interval, uint32_t recording_time_ms,
    float available_capacity) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_LEN];
  _mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline uint16_t mavlink_msg_camera_capture_status_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_camera_capture_status_t* camera_capture_status) {
  return mavlink_msg_camera_capture_status_pack(
      system_id, component_id, msg, camera_capture_status->time_boot_ms,
      camera_capture_status->image_status, camera_capture_status->video_status,
 ...
 * @param camera_capture_status C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_camera_capture_status_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_camera_capture_status_t* camera_capture_status) {
  return mavlink_msg_camera_capture_status_pack_chan(
      system_id, component_id, chan, msg, camera_capture_status->time_boot_ms,
      camera_capture_status->image_status, camera_capture_status->video_status,
      camera_capture_status->image_interval,
      camera_capture_status->recording_time_ms,
      camera_capture_status->available_capacity);
...
static inline void mavlink_msg_camera_capture_status_send(
    mavlink_channel_t chan, uint32_t time_boot_ms, uint8_t image_status,
    uint8_t video_status, float image_interval, uint32_t recording_time_ms,
    float available_capacity) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_LEN];
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS,
                                  buf,
                                  MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_MIN_LEN,
                                  MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_LEN,
                                  MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_CRC);
 ...
 */
static inline void mavlink_msg_camera_capture_status_send_struct(
    mavlink_channel_t chan,
    const mavlink_camera_capture_status_t* camera_capture_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_camera_capture_status_send(
      chan, camera_capture_status->time_boot_ms,
      camera_capture_status->image_status, camera_capture_status->video_status,
      camera_capture_status->image_interval,
      camera_capture_status->recording_time_ms,
      camera_capture_status->available_capacity);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS,
                                  (const char*)camera_capture_status,
                                  MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_MIN_LEN,
                                  MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_LEN,
                                  MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_CRC);
#endif
...
static inline void mavlink_msg_camera_capture_status_send_buf(
    ...
    uint8_t image_status, uint8_t video_status, float image_interval,
...
#else
  mavlink_camera_capture_status_t* packet =
      (mavlink_camera_capture_status_t*)msgbuf;
  packet->time_boot_ms = time_boot_ms;
  packet->image_interval = image_interval;
  packet->recording_time_ms = recording_time_ms;
  packet->available_capacity = available_capacity;
 ...
 */
static inline uint32_t mavlink_msg_camera_capture_status_get_time_boot_ms(
 ...
 *
 * @return  Current status of image capturing (0: idle, 1: capture in progress,
 * 2: interval set but idle, 3: interval set and capture in progress)
 */
static inline uint8_t mavlink_msg_camera_capture_status_get_image_status(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_camera_capture_status_get_video_status(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_camera_capture_status_get_image_interval(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_camera_capture_status_get_recording_time_ms(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_camera_capture_status_get_available_capacity(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_camera_capture_status_decode(
    const mavlink_message_t* msg,
    mavlink_camera_capture_status_t* camera_capture_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  camera_capture_status->time_boot_ms =
      mavlink_msg_camera_capture_status_get_time_boot_ms(msg);
  camera_capture_status->image_interval =
      mavlink_msg_camera_capture_status_get_image_interval(msg);
  camera_capture_status->recording_time_ms =
      mavlink_msg_camera_capture_status_get_recording_time_ms(msg);
  camera_capture_status->available_capacity =
      mavlink_msg_camera_capture_status_get_available_capacity(msg);
  camera_capture_status->image_status =
      mavlink_msg_camera_capture_status_get_image_status(msg);
  camera_capture_status->video_status =
      mavlink_msg_camera_capture_status_get_video_status(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_LEN;
