...
MAVPACKED(typedef struct __mavlink_att_pos_mocap_t {
  ...
  float covariance[21]; /*<  Row-major representation of a pose 6x6
                           ...
                           x, y, z, roll, pitch, yaw; first six entries are the
                           first ROW, next five entries are the second ROW,
                           etc.). If unknown, assign NaN value to first element
                           in the array.*/
})
  ...
  {                                                                            \
    138, "ATT_POS_MOCAP", 6, {                                                 \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                               \
       0,           0,    offsetof(mavlink_att_pos_mocap_t, time_usec)},       \
          {"q", NULL, MAVLINK_TYPE_FLOAT,                                      \
           4,   8,    offsetof(mavlink_att_pos_mocap_t, q)},                   \
          {"x", NULL, MAVLINK_TYPE_FLOAT,                                      \
           0,   24,   offsetof(mavlink_att_pos_mocap_t, x)},                   \
          {"y", NULL, MAVLINK_TYPE_FLOAT,                                      \
           0,   28,   offsetof(mavlink_att_pos_mocap_t, y)},                   \
          {"z", NULL, MAVLINK_TYPE_FLOAT,                                      \
           0,   32,   offsetof(mavlink_att_pos_mocap_t, z)},                   \
          {"covariance", NULL, MAVLINK_TYPE_FLOAT,                             \
           21,           36,   offsetof(mavlink_att_pos_mocap_t, covariance)}, \
    }                                                                          \
  }
#else
#define MAVLINK_MESSAGE_INFO_ATT_POS_MOCAP                                     \
 ...
 * @param covariance  Row-major representation of a pose 6x6 cross-covariance
...
static inline uint16_t mavlink_msg_att_pos_mocap_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_ATT_POS_MOCAP_MIN_LEN,
      MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN, MAVLINK_MSG_ID_ATT_POS_MOCAP_CRC);
}
...
static inline uint16_t mavlink_msg_att_pos_mocap_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_usec, const float* q, float x,
    float y, float z, const float* covariance) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  _mav_put_float(buf, 24, x);
...
static inline uint16_t mavlink_msg_att_pos_mocap_encode(
  ...
  return mavlink_msg_att_pos_mocap_pack(
      system_id, component_id, msg, att_pos_mocap->time_usec, att_pos_mocap->q,
...
static inline uint16_t mavlink_msg_att_pos_mocap_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_att_pos_mocap_t* att_pos_mocap) {
  return mavlink_msg_att_pos_mocap_pack_chan(
      system_id, component_id, chan, msg, att_pos_mocap->time_usec,
      att_pos_mocap->q, att_pos_mocap->x, att_pos_mocap->y, att_pos_mocap->z,
      att_pos_mocap->covariance);
}
...
static inline void mavlink_msg_att_pos_mocap_send(mavlink_channel_t chan,
                                                  uint64_t time_usec,
                                                  const float* q, float x,
                                                  float y, float z,
                                                  const float* covariance) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN];
  ...
  _mav_put_float_array(buf, 8, q, 4);
  _mav_put_float_array(buf, 36, covariance, 21);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATT_POS_MOCAP, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ATT_POS_MOCAP, (const char*)&packet,
 ...
 */
static inline void mavlink_msg_att_pos_mocap_send_struct(
    mavlink_channel_t chan, const mavlink_att_pos_mocap_t* att_pos_mocap) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_att_pos_mocap_send(
      chan, att_pos_mocap->time_usec, att_pos_mocap->q, att_pos_mocap->x,
      att_pos_mocap->y, att_pos_mocap->z, att_pos_mocap->covariance);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ATT_POS_MOCAP, (const char*)att_pos_mocap,
      MAVLINK_MSG_ID_ATT_POS_MOCAP_MIN_LEN, MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN,
      MAVLINK_MSG_ID_ATT_POS_MOCAP_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_att_pos_mocap_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    const float* q, float x, float y, float z, const float* covariance) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_att_pos_mocap_get_time_usec(
 ...
 */
static inline uint16_t mavlink_msg_att_pos_mocap_get_q(
 ...
 */
static inline float mavlink_msg_att_pos_mocap_get_x(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_att_pos_mocap_get_y(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_att_pos_mocap_get_z(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Row-major representation of a pose 6x6 cross-covariance matrix upper
 ...
 */
static inline uint16_t mavlink_msg_att_pos_mocap_get_covariance(
 ...
 */
static inline void mavlink_msg_att_pos_mocap_decode(
    const mavlink_message_t* msg, mavlink_att_pos_mocap_t* att_pos_mocap) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN;
