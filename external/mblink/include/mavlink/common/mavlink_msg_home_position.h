...
MAVPACKED(typedef struct __mavlink_home_position_t {
...
#define MAVLINK_MESSAGE_INFO_HOME_POSITION                                   \
  {                                                                          \
    242, "HOME_POSITION", 11, {                                              \
      {"latitude", NULL, MAVLINK_TYPE_INT32_T,                               \
       0,          0,    offsetof(mavlink_home_position_t, latitude)},       \
          {"longitude", NULL, MAVLINK_TYPE_INT32_T,                          \
           0,           4,    offsetof(mavlink_home_position_t, longitude)}, \
          {"altitude", NULL, MAVLINK_TYPE_INT32_T,                           \
           0,          8,    offsetof(mavlink_home_position_t, altitude)},   \
          {"x", NULL, MAVLINK_TYPE_FLOAT,                                    \
           0,   12,   offsetof(mavlink_home_position_t, x)},                 \
          {"y", NULL, MAVLINK_TYPE_FLOAT,                                    \
           0,   16,   offsetof(mavlink_home_position_t, y)},                 \
          {"z", NULL, MAVLINK_TYPE_FLOAT,                                    \
           0,   20,   offsetof(mavlink_home_position_t, z)},                 \
          {"q", NULL, MAVLINK_TYPE_FLOAT,                                    \
           4,   24,   offsetof(mavlink_home_position_t, q)},                 \
          {"approach_x",                                                     \
           NULL,                                                             \
           MAVLINK_TYPE_FLOAT,                                               \
           0,                                                                \
           40,                                                               \
           offsetof(mavlink_home_position_t, approach_x)},                   \
          {"approach_y",                                                     \
           NULL,                                                             \
           MAVLINK_TYPE_FLOAT,                                               \
           0,                                                                \
           44,                                                               \
           offsetof(mavlink_home_position_t, approach_y)},                   \
          {"approach_z",                                                     \
           NULL,                                                             \
           MAVLINK_TYPE_FLOAT,                                               \
           0,                                                                \
           48,                                                               \
           offsetof(mavlink_home_position_t, approach_z)},                   \
          {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                         \
           0,           52,   offsetof(mavlink_home_position_t, time_usec)}, \
    }                                                                        \
  }
#else
#define MAVLINK_MESSAGE_INFO_HOME_POSITION                                   \
 ...
 */
static inline uint16_t mavlink_msg_home_position_pack(
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_home_position_pack_chan(
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_HOME_POSITION_MIN_LEN,
      MAVLINK_MSG_ID_HOME_POSITION_LEN, MAVLINK_MSG_ID_HOME_POSITION_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_home_position_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_home_position_t* home_position) {
  return mavlink_msg_home_position_pack(
      system_id, component_id, msg, home_position->latitude,
      home_position->longitude, home_position->altitude, home_position->x,
 ...
 * @param home_position C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_home_position_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_home_position_t* home_position) {
  return mavlink_msg_home_position_pack_chan(
      system_id, component_id, chan, msg, home_position->latitude,
      home_position->longitude, home_position->altitude, home_position->x,
      home_position->y, home_position->z, home_position->q,
      home_position->approach_x, home_position->approach_y,
      home_position->approach_z, home_position->time_usec);
...
static inline void mavlink_msg_home_position_send(
    mavlink_channel_t chan, int32_t latitude, int32_t longitude,
    int32_t altitude, float x, float y, float z, const float* q,
    float approach_x, float approach_y, float approach_z, uint64_t time_usec) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_HOME_POSITION_LEN];
  ...
  _mav_put_uint64_t(buf, 52, time_usec);
  _mav_put_float_array(buf, 24, q, 4);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HOME_POSITION, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HOME_POSITION, (const char*)&packet,
      MAVLINK_MSG_ID_HOME_POSITION_MIN_LEN, MAVLINK_MSG_ID_HOME_POSITION_LEN,
      MAVLINK_MSG_ID_HOME_POSITION_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_home_position_send_struct(
    mavlink_channel_t chan, const mavlink_home_position_t* home_position) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_home_position_send(
      chan, home_position->latitude, home_position->longitude,
      home_position->altitude, home_position->x, home_position->y,
      home_position->z, home_position->q, home_position->approach_x,
      home_position->approach_y, home_position->approach_z,
      home_position->time_usec);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HOME_POSITION, (const char*)home_position,
      MAVLINK_MSG_ID_HOME_POSITION_MIN_LEN, MAVLINK_MSG_ID_HOME_POSITION_LEN,
      MAVLINK_MSG_ID_HOME_POSITION_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_home_position_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, int32_t latitude,
 ...
 */
static inline int32_t mavlink_msg_home_position_get_latitude(
 ...
 */
static inline int32_t mavlink_msg_home_position_get_longitude(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_home_position_get_altitude(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_home_position_get_y(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_home_position_get_z(
    const mavlink_message_t* msg) {
 ...
 * position. Used to indicate the heading and slope of the ground
 */
static inline uint16_t mavlink_msg_home_position_get_q(
 ...
 */
static inline float mavlink_msg_home_position_get_approach_x(
    const mavlink_message_t* msg) {
 ...
 * assuming the takeoff happened from the threshold / touchdown zone.
 */
static inline float mavlink_msg_home_position_get_approach_y(
    const mavlink_message_t* msg) {
 ...
 * assuming the takeoff happened from the threshold / touchdown zone.
 */
static inline float mavlink_msg_home_position_get_approach_z(
    const mavlink_message_t* msg) {
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_home_position_get_time_usec(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_home_position_decode(
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_HOME_POSITION_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_HOME_POSITION_LEN;
