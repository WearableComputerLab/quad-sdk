...
MAVPACKED(typedef struct __mavlink_mount_orientation_t {
  ...
  float yaw_absolute; /*< [deg] Yaw in absolute frame, North is 0 (set to NaN
                         for invalid).*/
})
...
#define MAVLINK_MESSAGE_INFO_MOUNT_ORIENTATION                           \
  {                                                                      \
    265, "MOUNT_ORIENTATION", 5, {                                       \
      {"time_boot_ms",                                                   \
       NULL,                                                             \
       MAVLINK_TYPE_UINT32_T,                                            \
       0,                                                                \
       0,                                                                \
       offsetof(mavlink_mount_orientation_t, time_boot_ms)},             \
          {"roll", NULL, MAVLINK_TYPE_FLOAT,                             \
           0,      4,    offsetof(mavlink_mount_orientation_t, roll)},   \
          {"pitch", NULL, MAVLINK_TYPE_FLOAT,                            \
           0,       8,    offsetof(mavlink_mount_orientation_t, pitch)}, \
          {"yaw", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,     12,   offsetof(mavlink_mount_orientation_t, yaw)},     \
          {"yaw_absolute",                                               \
           NULL,                                                         \
           MAVLINK_TYPE_FLOAT,                                           \
           0,                                                            \
           16,                                                           \
           offsetof(mavlink_mount_orientation_t, yaw_absolute)},         \
    }                                                                    \
  }
#else
#define MAVLINK_MESSAGE_INFO_MOUNT_ORIENTATION                           \
 ...
 * @param yaw_absolute [deg] Yaw in absolute frame, North is 0 (set to NaN for
 * invalid).
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_mount_orientation_pack(
 ...
 */
static inline uint16_t mavlink_msg_mount_orientation_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_mount_orientation_t* mount_orientation) {
  return mavlink_msg_mount_orientation_pack(
      system_id, component_id, msg, mount_orientation->time_boot_ms,
      mount_orientation->roll, mount_orientation->pitch, mount_orientation->yaw,
 ...
 * @param mount_orientation C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_mount_orientation_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_mount_orientation_t* mount_orientation) {
  return mavlink_msg_mount_orientation_pack_chan(
      system_id, component_id, chan, msg, mount_orientation->time_boot_ms,
      mount_orientation->roll, mount_orientation->pitch, mount_orientation->yaw,
      mount_orientation->yaw_absolute);
}
...
static inline void mavlink_msg_mount_orientation_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MOUNT_ORIENTATION, buf,
                                  MAVLINK_MSG_ID_MOUNT_ORIENTATION_MIN_LEN,
                                  MAVLINK_MSG_ID_MOUNT_ORIENTATION_LEN,
                                  MAVLINK_MSG_ID_MOUNT_ORIENTATION_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MOUNT_ORIENTATION,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_MOUNT_ORIENTATION_MIN_LEN,
                                  MAVLINK_MSG_ID_MOUNT_ORIENTATION_LEN,
                                  MAVLINK_MSG_ID_MOUNT_ORIENTATION_CRC);
 ...
 */
static inline void mavlink_msg_mount_orientation_send_struct(
    mavlink_channel_t chan,
    const mavlink_mount_orientation_t* mount_orientation) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_mount_orientation_send(
      chan, mount_orientation->time_boot_ms, mount_orientation->roll,
 ...
 */
static inline void mavlink_msg_mount_orientation_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint32_t time_boot_ms,
    float roll, float pitch, float yaw, float yaw_absolute) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint32_t mavlink_msg_mount_orientation_get_time_boot_ms(
 ...
 */
static inline float mavlink_msg_mount_orientation_get_roll(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_mount_orientation_get_pitch(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_mount_orientation_get_yaw(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_mount_orientation_get_yaw_absolute(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_mount_orientation_decode(
    const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_MOUNT_ORIENTATION_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_MOUNT_ORIENTATION_LEN;
