...
MAVPACKED(typedef struct __mavlink_request_data_stream_t {
      ...
      {"target_system",                                                \
       ...
       offsetof(mavlink_request_data_stream_t, target_system)},        \
          ...
          {"start_stop",                                               \
           ...
           0,                                                          \
           5,                                                          \
           offsetof(mavlink_request_data_stream_t, start_stop)},       \
    }                                                                  \
  }
#else
#define MAVLINK_MESSAGE_INFO_REQUEST_DATA_STREAM                       \
...
static inline uint16_t mavlink_msg_request_data_stream_encode(
  ...
  return mavlink_msg_request_data_stream_pack(
      system_id, component_id, msg, request_data_stream->target_system,
...
static inline uint16_t mavlink_msg_request_data_stream_encode_chan(
  ...
  return mavlink_msg_request_data_stream_pack_chan(
      system_id, component_id, chan, msg, request_data_stream->target_system,
      request_data_stream->target_component, request_data_stream->req_stream_id,
      request_data_stream->req_message_rate, request_data_stream->start_stop);
}
...
static inline void mavlink_msg_request_data_stream_send(
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_REQUEST_DATA_STREAM,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_REQUEST_DATA_STREAM_MIN_LEN,
                                  MAVLINK_MSG_ID_REQUEST_DATA_STREAM_LEN,
                                  MAVLINK_MSG_ID_REQUEST_DATA_STREAM_CRC);
...
static inline void mavlink_msg_request_data_stream_send_struct(
  ...
  mavlink_msg_request_data_stream_send(
      chan, request_data_stream->target_system,
      request_data_stream->target_component, request_data_stream->req_stream_id,
      request_data_stream->req_message_rate, request_data_stream->start_stop);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_REQUEST_DATA_STREAM,
                                  (const char*)request_data_stream,
                                  MAVLINK_MSG_ID_REQUEST_DATA_STREAM_MIN_LEN,
                                  MAVLINK_MSG_ID_REQUEST_DATA_STREAM_LEN,
                                  MAVLINK_MSG_ID_REQUEST_DATA_STREAM_CRC);
#endif
 ...
 */
static inline void mavlink_msg_request_data_stream_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system,
    uint8_t target_component, uint8_t req_stream_id, uint16_t req_message_rate,
    uint8_t start_stop) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  mavlink_request_data_stream_t* packet =
      (mavlink_request_data_stream_t*)msgbuf;
  packet->req_message_rate = req_message_rate;
  packet->target_system = target_system;
  packet->target_component = target_component;
  packet->req_stream_id = req_stream_id;
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_REQUEST_DATA_STREAM_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_REQUEST_DATA_STREAM_LEN;
