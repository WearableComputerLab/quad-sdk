...
MAVPACKED(typedef struct __mavlink_mission_request_list_t {
...
#define MAVLINK_MESSAGE_INFO_MISSION_REQUEST_LIST                       \
  {                                                                     \
    43, "MISSION_REQUEST_LIST", 3, {                                    \
      {"target_system",                                                 \
       NULL,                                                            \
       MAVLINK_TYPE_UINT8_T,                                            \
       0,                                                               \
       0,                                                               \
       offsetof(mavlink_mission_request_list_t, target_system)},        \
          {"target_component",                                          \
           NULL,                                                        \
           MAVLINK_TYPE_UINT8_T,                                        \
           0,                                                           \
           1,                                                           \
           offsetof(mavlink_mission_request_list_t, target_component)}, \
          {"mission_type",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_UINT8_T,                                        \
           0,                                                           \
           2,                                                           \
           offsetof(mavlink_mission_request_list_t, mission_type)},     \
    }                                                                   \
  }
#else
#define MAVLINK_MESSAGE_INFO_MISSION_REQUEST_LIST                       \
  {                                                                     \
    "MISSION_REQUEST_LIST", 3, {                                        \
      {"target_system",                                                 \
       NULL,                                                            \
       MAVLINK_TYPE_UINT8_T,                                            \
       0,                                                               \
...
static inline uint16_t mavlink_msg_mission_request_list_encode(
  ...
  return mavlink_msg_mission_request_list_pack(
      system_id, component_id, msg, mission_request_list->target_system,
...
static inline uint16_t mavlink_msg_mission_request_list_encode_chan(
  ...
  return mavlink_msg_mission_request_list_pack_chan(
      system_id, component_id, chan, msg, mission_request_list->target_system,
      mission_request_list->target_component,
      mission_request_list->mission_type);
}
...
static inline void mavlink_msg_mission_request_list_send(
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_REQUEST_LIST,
                                  buf,
                                  MAVLINK_MSG_ID_MISSION_REQUEST_LIST_MIN_LEN,
                                  MAVLINK_MSG_ID_MISSION_REQUEST_LIST_LEN,
                                  MAVLINK_MSG_ID_MISSION_REQUEST_LIST_CRC);
 ...
 */
static inline void mavlink_msg_mission_request_list_send_struct(
    mavlink_channel_t chan,
    const mavlink_mission_request_list_t* mission_request_list) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_mission_request_list_send(chan,
 ...
 */
static inline void mavlink_msg_mission_request_list_send_buf(
...
#else
  mavlink_mission_request_list_t* packet =
      (mavlink_mission_request_list_t*)msgbuf;
  packet->target_system = target_system;
  packet->target_component = target_component;
  packet->mission_type = mission_type;
 ...
 * @return  Mission type.
 */
static inline uint8_t mavlink_msg_mission_request_list_get_mission_type(
    const mavlink_message_t* msg) {
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_MISSION_REQUEST_LIST_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_MISSION_REQUEST_LIST_LEN;
