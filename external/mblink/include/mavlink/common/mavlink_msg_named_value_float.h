...
MAVPACKED(typedef struct __mavlink_named_value_float_t {
...
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_FLOAT                           \
  {                                                                      \
    251, "NAMED_VALUE_FLOAT", 3, {                                       \
      {"time_boot_ms",                                                   \
       NULL,                                                             \
       MAVLINK_TYPE_UINT32_T,                                            \
       0,                                                                \
       0,                                                                \
       offsetof(mavlink_named_value_float_t, time_boot_ms)},             \
          {"name", NULL, MAVLINK_TYPE_CHAR,                              \
           10,     8,    offsetof(mavlink_named_value_float_t, name)},   \
          {"value", NULL, MAVLINK_TYPE_FLOAT,                            \
           0,       4,    offsetof(mavlink_named_value_float_t, value)}, \
    }                                                                    \
  }
#else
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_FLOAT                           \
...
static inline uint16_t mavlink_msg_named_value_float_encode(
  ...
  return mavlink_msg_named_value_float_pack(
      system_id, component_id, msg, named_value_float->time_boot_ms,
...
static inline uint16_t mavlink_msg_named_value_float_encode_chan(
  ...
  return mavlink_msg_named_value_float_pack_chan(
      system_id, component_id, chan, msg, named_value_float->time_boot_ms,
      named_value_float->name, named_value_float->value);
}
...
static inline void mavlink_msg_named_value_float_send(mavlink_channel_t chan,
  ...
  _mav_put_float(buf, 4, value);
  _mav_put_char_array(buf, 8, name, 10);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NAMED_VALUE_FLOAT, buf,
                                  MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_MIN_LEN,
                                  MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_LEN,
                                  MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_CRC);
#else
  ...
  packet.value = value;
  mav_array_memcpy(packet.name, name, sizeof(char) * 10);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NAMED_VALUE_FLOAT,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_MIN_LEN,
                                  MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_LEN,
                                  MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_CRC);
 ...
 */
static inline void mavlink_msg_named_value_float_send_struct(
    mavlink_channel_t chan,
    const mavlink_named_value_float_t* named_value_float) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_named_value_float_send(chan, named_value_float->time_boot_ms,
                                     named_value_float->name,
                                     named_value_float->value);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NAMED_VALUE_FLOAT,
                                  (const char*)named_value_float,
                                  MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_MIN_LEN,
                                  MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_LEN,
                                  MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_CRC);
#endif
 ...
 */
static inline void mavlink_msg_named_value_float_send_buf(
...
static inline void mavlink_msg_named_value_float_decode(
  ...
  named_value_float->time_boot_ms =
      mavlink_msg_named_value_float_get_time_boot_ms(msg);
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_LEN;
