...
MAVPACKED(typedef struct __mavlink_gps_input_t {
  ...
  uint16_t ignore_flags; /*<  Bitmap indicating which GPS input flags fields to
                            ignore.  All other fields must be provided.*/
  uint16_t time_week;    /*<  GPS week number*/
  uint8_t gps_id;        /*<  ID of the GPS for multiple GPS inputs*/
  uint8_t fix_type; /*<  0-1: no fix, 2: 2D fix, 3: 3D fix. 4: 3D with DGPS. 5:
                       3D with RTK*/
  ...
  {                                                                      \
    232, "GPS_INPUT", 18, {                                              \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                         \
       0,           0,    offsetof(mavlink_gps_input_t, time_usec)},     \
          {"gps_id", NULL, MAVLINK_TYPE_UINT8_T,                         \
           0,        60,   offsetof(mavlink_gps_input_t, gps_id)},       \
          {"ignore_flags",                                               \
           NULL,                                                         \
           MAVLINK_TYPE_UINT16_T,                                        \
           0,                                                            \
           56,                                                           \
           offsetof(mavlink_gps_input_t, ignore_flags)},                 \
          {"time_week_ms",                                               \
           NULL,                                                         \
           MAVLINK_TYPE_UINT32_T,                                        \
           0,                                                            \
           8,                                                            \
           offsetof(mavlink_gps_input_t, time_week_ms)},                 \
          {"time_week", NULL, MAVLINK_TYPE_UINT16_T,                     \
           0,           58,   offsetof(mavlink_gps_input_t, time_week)}, \
          {"fix_type", NULL, MAVLINK_TYPE_UINT8_T,                       \
           0,          61,   offsetof(mavlink_gps_input_t, fix_type)},   \
          {"lat", NULL, MAVLINK_TYPE_INT32_T,                            \
           0,     12,   offsetof(mavlink_gps_input_t, lat)},             \
          {"lon", NULL, MAVLINK_TYPE_INT32_T,                            \
           0,     16,   offsetof(mavlink_gps_input_t, lon)},             \
          {"alt", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,     20,   offsetof(mavlink_gps_input_t, alt)},             \
          {"hdop", NULL, MAVLINK_TYPE_FLOAT,                             \
           0,      24,   offsetof(mavlink_gps_input_t, hdop)},           \
          {"vdop", NULL, MAVLINK_TYPE_FLOAT,                             \
           0,      28,   offsetof(mavlink_gps_input_t, vdop)},           \
          {"vn", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,    32,   offsetof(mavlink_gps_input_t, vn)},               \
          {"ve", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,    36,   offsetof(mavlink_gps_input_t, ve)},               \
          {"vd", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,    40,   offsetof(mavlink_gps_input_t, vd)},               \
          {"speed_accuracy",                                             \
           NULL,                                                         \
           MAVLINK_TYPE_FLOAT,                                           \
           0,                                                            \
           44,                                                           \
           offsetof(mavlink_gps_input_t, speed_accuracy)},               \
          {"horiz_accuracy",                                             \
           NULL,                                                         \
           MAVLINK_TYPE_FLOAT,                                           \
           0,                                                            \
           48,                                                           \
           offsetof(mavlink_gps_input_t, horiz_accuracy)},               \
          {"vert_accuracy",                                              \
           NULL,                                                         \
           MAVLINK_TYPE_FLOAT,                                           \
           0,                                                            \
           52,                                                           \
           offsetof(mavlink_gps_input_t, vert_accuracy)},                \
          {"satellites_visible",                                         \
           NULL,                                                         \
           MAVLINK_TYPE_UINT8_T,                                         \
           0,                                                            \
           62,                                                           \
           offsetof(mavlink_gps_input_t, satellites_visible)},           \
    }                                                                    \
  }
#else
#define MAVLINK_MESSAGE_INFO_GPS_INPUT                                   \
 ...
 * @param ignore_flags  Bitmap indicating which GPS input flags fields to
 * ignore.  All other fields must be provided.
 * @param time_week_ms [ms] GPS time (from start of GPS week)
 * @param time_week  GPS week number
 * @param fix_type  0-1: no fix, 2: 2D fix, 3: 3D fix. 4: 3D with DGPS. 5: 3D
 * with RTK
 ...
 */
static inline uint16_t mavlink_msg_gps_input_pack(
    ...
    float vd, float speed_accuracy, float horiz_accuracy, float vert_accuracy,
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_GPS_INPUT_MIN_LEN,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_gps_input_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint64_t time_usec, uint8_t gps_id,
    uint16_t ignore_flags, uint32_t time_week_ms, uint16_t time_week,
    uint8_t fix_type, int32_t lat, int32_t lon, float alt, float hdop,
    float vdop, float vn, float ve, float vd, float speed_accuracy,
    float horiz_accuracy, float vert_accuracy, uint8_t satellites_visible) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_GPS_INPUT_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  _mav_put_uint32_t(buf, 8, time_week_ms);
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_GPS_INPUT_MIN_LEN,
      MAVLINK_MSG_ID_GPS_INPUT_LEN, MAVLINK_MSG_ID_GPS_INPUT_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_gps_input_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_gps_input_t* gps_input) {
  return mavlink_msg_gps_input_pack(
      system_id, component_id, msg, gps_input->time_usec, gps_input->gps_id,
      gps_input->ignore_flags, gps_input->time_week_ms, gps_input->time_week,
      gps_input->fix_type, gps_input->lat, gps_input->lon, gps_input->alt,
      gps_input->hdop, gps_input->vdop, gps_input->vn, gps_input->ve,
      gps_input->vd, gps_input->speed_accuracy, gps_input->horiz_accuracy,
 ...
 * @param gps_input C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_gps_input_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_gps_input_t* gps_input) {
  return mavlink_msg_gps_input_pack_chan(
      system_id, component_id, chan, msg, gps_input->time_usec,
      gps_input->gps_id, gps_input->ignore_flags, gps_input->time_week_ms,
      gps_input->time_week, gps_input->fix_type, gps_input->lat, gps_input->lon,
      gps_input->alt, gps_input->hdop, gps_input->vdop, gps_input->vn,
      gps_input->ve, gps_input->vd, gps_input->speed_accuracy,
      gps_input->horiz_accuracy, gps_input->vert_accuracy,
...
static inline void mavlink_msg_gps_input_send(
    mavlink_channel_t chan, uint64_t time_usec, uint8_t gps_id,
    uint16_t ignore_flags, uint32_t time_week_ms, uint16_t time_week,
    uint8_t fix_type, int32_t lat, int32_t lon, float alt, float hdop,
    float vdop, float vn, float ve, float vd, float speed_accuracy,
    float horiz_accuracy, float vert_accuracy, uint8_t satellites_visible) {
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_INPUT, buf, MAVLINK_MSG_ID_GPS_INPUT_MIN_LEN,
      MAVLINK_MSG_ID_GPS_INPUT_LEN, MAVLINK_MSG_ID_GPS_INPUT_CRC);
#else
  mavlink_gps_input_t packet;
  packet.time_usec = time_usec;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_INPUT, (const char*)&packet,
      MAVLINK_MSG_ID_GPS_INPUT_MIN_LEN, MAVLINK_MSG_ID_GPS_INPUT_LEN,
 ...
 */
static inline void mavlink_msg_gps_input_send_struct(
    mavlink_channel_t chan, const mavlink_gps_input_t* gps_input) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_gps_input_send(
      chan, gps_input->time_usec, gps_input->gps_id, gps_input->ignore_flags,
      gps_input->time_week_ms, gps_input->time_week, gps_input->fix_type,
      gps_input->lat, gps_input->lon, gps_input->alt, gps_input->hdop,
      gps_input->vdop, gps_input->vn, gps_input->ve, gps_input->vd,
      gps_input->speed_accuracy, gps_input->horiz_accuracy,
      gps_input->vert_accuracy, gps_input->satellites_visible);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS_INPUT, (const char*)gps_input,
      MAVLINK_MSG_ID_GPS_INPUT_MIN_LEN, MAVLINK_MSG_ID_GPS_INPUT_LEN,
      MAVLINK_MSG_ID_GPS_INPUT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_gps_input_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    uint8_t gps_id, uint16_t ignore_flags, uint32_t time_week_ms,
    uint16_t time_week, uint8_t fix_type, int32_t lat, int32_t lon, float alt,
    float hdop, float vdop, float vn, float ve, float vd, float speed_accuracy,
    float horiz_accuracy, float vert_accuracy, uint8_t satellites_visible) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_gps_input_get_time_usec(
 ...
 */
static inline uint8_t mavlink_msg_gps_input_get_gps_id(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Bitmap indicating which GPS input flags fields to ignore.  All other
 * fields must be provided.
 */
static inline uint16_t mavlink_msg_gps_input_get_ignore_flags(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_gps_input_get_time_week_ms(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_gps_input_get_time_week(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_gps_input_get_fix_type(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_gps_input_get_lat(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_gps_input_get_lon(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_gps_input_get_alt(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_gps_input_get_hdop(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_gps_input_get_vdop(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_gps_input_get_speed_accuracy(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_gps_input_get_horiz_accuracy(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_gps_input_get_satellites_visible(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_gps_input_decode(
    const mavlink_message_t* msg, mavlink_gps_input_t* gps_input) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_GPS_INPUT_LEN
                    ? msg->len
