...
MAVPACKED(typedef struct __mavlink_debug_float_array_t {
...
#define MAVLINK_MESSAGE_INFO_DEBUG_FLOAT_ARRAY                                 \
  {                                                                            \
    350, "DEBUG_FLOAT_ARRAY", 4, {                                             \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                               \
       0,           0,    offsetof(mavlink_debug_float_array_t, time_usec)},   \
          {"name", NULL, MAVLINK_TYPE_CHAR,                                    \
           10,     10,   offsetof(mavlink_debug_float_array_t, name)},         \
          {"array_id", NULL, MAVLINK_TYPE_UINT16_T,                            \
           0,          8,    offsetof(mavlink_debug_float_array_t, array_id)}, \
          {"data", NULL, MAVLINK_TYPE_FLOAT,                                   \
           58,     20,   offsetof(mavlink_debug_float_array_t, data)},         \
    }                                                                          \
  }
#else
#define MAVLINK_MESSAGE_INFO_DEBUG_FLOAT_ARRAY                                 \
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_debug_float_array_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint64_t time_usec, const char* name,
    uint16_t array_id, const float* data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  _mav_put_uint16_t(buf, 8, array_id);
 ...
 */
static inline uint16_t mavlink_msg_debug_float_array_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_debug_float_array_t* debug_float_array) {
  return mavlink_msg_debug_float_array_pack(
      system_id, component_id, msg, debug_float_array->time_usec,
      debug_float_array->name, debug_float_array->array_id,
 ...
 * @param debug_float_array C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_debug_float_array_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_debug_float_array_t* debug_float_array) {
  return mavlink_msg_debug_float_array_pack_chan(
      system_id, component_id, chan, msg, debug_float_array->time_usec,
      debug_float_array->name, debug_float_array->array_id,
      debug_float_array->data);
}
...
static inline void mavlink_msg_debug_float_array_send(mavlink_channel_t chan,
                                                      uint64_t time_usec,
                                                      const char* name,
                                                      uint16_t array_id,
                                                      const float* data) {
  ...
  _mav_put_char_array(buf, 10, name, 10);
  _mav_put_float_array(buf, 20, data, 58);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY, buf,
                                  MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY_MIN_LEN,
                                  MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY_LEN,
                                  MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY_CRC);
#else
 ...
 */
static inline void mavlink_msg_debug_float_array_send_struct(
    mavlink_channel_t chan,
    const mavlink_debug_float_array_t* debug_float_array) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_debug_float_array_send(
      chan, debug_float_array->time_usec, debug_float_array->name,
      debug_float_array->array_id, debug_float_array->data);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY,
                                  (const char*)debug_float_array,
                                  MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY_MIN_LEN,
                                  MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY_LEN,
                                  MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY_CRC);
#endif
 ...
 */
static inline void mavlink_msg_debug_float_array_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    const char* name, uint16_t array_id, const float* data) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_debug_float_array_get_time_usec(
 ...
 */
static inline uint16_t mavlink_msg_debug_float_array_get_name(
 ...
 */
static inline uint16_t mavlink_msg_debug_float_array_get_array_id(
    const mavlink_message_t* msg) {
 ...
 * @return  data
 */
static inline uint16_t mavlink_msg_debug_float_array_get_data(
    const mavlink_message_t* msg, float* data) {
 ...
 */
static inline void mavlink_msg_debug_float_array_decode(
    const mavlink_message_t* msg,
    mavlink_debug_float_array_t* debug_float_array) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  debug_float_array->time_usec =
      mavlink_msg_debug_float_array_get_time_usec(msg);
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY_LEN;
