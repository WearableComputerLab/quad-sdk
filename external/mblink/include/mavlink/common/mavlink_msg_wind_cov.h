...
MAVPACKED(typedef struct __mavlink_wind_cov_t {
  ...
  float var_horiz;    /*< [m/s] Variability of the wind in XY. RMS of a 1 Hz
                         lowpassed wind estimate.*/
  float var_vert;     /*< [m/s] Variability of the wind in Z. RMS of a 1 Hz
                         lowpassed wind estimate.*/
  ...
  {                                                                     \
    231, "WIND_COV", 9, {                                               \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                        \
       0,           0,    offsetof(mavlink_wind_cov_t, time_usec)},     \
          {"wind_x", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        8,    offsetof(mavlink_wind_cov_t, wind_x)},       \
          {"wind_y", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        12,   offsetof(mavlink_wind_cov_t, wind_y)},       \
          {"wind_z", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        16,   offsetof(mavlink_wind_cov_t, wind_z)},       \
          {"var_horiz", NULL, MAVLINK_TYPE_FLOAT,                       \
           0,           20,   offsetof(mavlink_wind_cov_t, var_horiz)}, \
          {"var_vert", NULL, MAVLINK_TYPE_FLOAT,                        \
           0,          24,   offsetof(mavlink_wind_cov_t, var_vert)},   \
          {"wind_alt", NULL, MAVLINK_TYPE_FLOAT,                        \
           0,          28,   offsetof(mavlink_wind_cov_t, wind_alt)},   \
          {"horiz_accuracy",                                            \
           NULL,                                                        \
           MAVLINK_TYPE_FLOAT,                                          \
           0,                                                           \
           32,                                                          \
           offsetof(mavlink_wind_cov_t, horiz_accuracy)},               \
          {"vert_accuracy",                                             \
           NULL,                                                        \
           MAVLINK_TYPE_FLOAT,                                          \
           0,                                                           \
           36,                                                          \
           offsetof(mavlink_wind_cov_t, vert_accuracy)},                \
    }                                                                   \
  }
#else
#define MAVLINK_MESSAGE_INFO_WIND_COV                                   \
 ...
 * @param var_horiz [m/s] Variability of the wind in XY. RMS of a 1 Hz lowpassed
 * wind estimate.
 * @param var_vert [m/s] Variability of the wind in Z. RMS of a 1 Hz lowpassed
 * wind estimate.
 ...
 */
static inline uint16_t mavlink_msg_wind_cov_pack(
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_wind_cov_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint64_t time_usec, float wind_x, float wind_y,
    float wind_z, float var_horiz, float var_vert, float wind_alt,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_WIND_COV_MIN_LEN,
      MAVLINK_MSG_ID_WIND_COV_LEN, MAVLINK_MSG_ID_WIND_COV_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_wind_cov_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_wind_cov_t* wind_cov) {
  return mavlink_msg_wind_cov_pack(
      system_id, component_id, msg, wind_cov->time_usec, wind_cov->wind_x,
      wind_cov->wind_y, wind_cov->wind_z, wind_cov->var_horiz,
      wind_cov->var_vert, wind_cov->wind_alt, wind_cov->horiz_accuracy,
 ...
 * @param wind_cov C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_wind_cov_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_wind_cov_t* wind_cov) {
  return mavlink_msg_wind_cov_pack_chan(
      system_id, component_id, chan, msg, wind_cov->time_usec, wind_cov->wind_x,
      wind_cov->wind_y, wind_cov->wind_z, wind_cov->var_horiz,
      wind_cov->var_vert, wind_cov->wind_alt, wind_cov->horiz_accuracy,
      wind_cov->vert_accuracy);
}
...
static inline void mavlink_msg_wind_cov_send(
    mavlink_channel_t chan, uint64_t time_usec, float wind_x, float wind_y,
    float wind_z, float var_horiz, float var_vert, float wind_alt,
    float horiz_accuracy, float vert_accuracy) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_WIND_COV_LEN];
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_WIND_COV, buf, MAVLINK_MSG_ID_WIND_COV_MIN_LEN,
      MAVLINK_MSG_ID_WIND_COV_LEN, MAVLINK_MSG_ID_WIND_COV_CRC);
#else
  mavlink_wind_cov_t packet;
  packet.time_usec = time_usec;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_WIND_COV, (const char*)&packet,
      MAVLINK_MSG_ID_WIND_COV_MIN_LEN, MAVLINK_MSG_ID_WIND_COV_LEN,
      MAVLINK_MSG_ID_WIND_COV_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_wind_cov_send_struct(
    mavlink_channel_t chan, const mavlink_wind_cov_t* wind_cov) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_wind_cov_send(
      chan, wind_cov->time_usec, wind_cov->wind_x, wind_cov->wind_y,
      wind_cov->wind_z, wind_cov->var_horiz, wind_cov->var_vert,
      wind_cov->wind_alt, wind_cov->horiz_accuracy, wind_cov->vert_accuracy);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_WIND_COV, (const char*)wind_cov,
      MAVLINK_MSG_ID_WIND_COV_MIN_LEN, MAVLINK_MSG_ID_WIND_COV_LEN,
      MAVLINK_MSG_ID_WIND_COV_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_wind_cov_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec,
    float wind_x, float wind_y, float wind_z, float var_horiz, float var_vert,
    float wind_alt, float horiz_accuracy, float vert_accuracy) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_wind_cov_get_time_usec(
 ...
 */
static inline float mavlink_msg_wind_cov_get_wind_x(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_wind_cov_get_wind_y(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_wind_cov_get_wind_z(
    const mavlink_message_t* msg) {
 ...
 * estimate.
 */
static inline float mavlink_msg_wind_cov_get_var_horiz(
    const mavlink_message_t* msg) {
 ...
 * estimate.
 */
static inline float mavlink_msg_wind_cov_get_var_vert(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_wind_cov_get_wind_alt(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_wind_cov_get_horiz_accuracy(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_wind_cov_get_vert_accuracy(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_wind_cov_decode(const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_WIND_COV_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_WIND_COV_LEN;
