...
MAVPACKED(typedef struct __mavlink_isbd_link_status_t {
  uint64_t timestamp; /*< [us] Timestamp (UNIX Epoch time or time since system
  ...
  uint64_t last_heartbeat;      /*< [us] Timestamp of the last successful sbd
                                   session. The receiving end can infer timestamp
  ...
  uint8_t rx_session_pending; /*<  1: Receiving session pending, 0: No receiving
                                 session pending.*/
})
...
#define MAVLINK_MESSAGE_INFO_ISBD_LINK_STATUS                               \
  {                                                                         \
    335, "ISBD_LINK_STATUS", 8, {                                           \
      {"timestamp", NULL, MAVLINK_TYPE_UINT64_T,                            \
       0,           0,    offsetof(mavlink_isbd_link_status_t, timestamp)}, \
          {"last_heartbeat",                                                \
           NULL,                                                            \
           MAVLINK_TYPE_UINT64_T,                                           \
           0,                                                               \
           8,                                                               \
           offsetof(mavlink_isbd_link_status_t, last_heartbeat)},           \
          {"failed_sessions",                                               \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           16,                                                              \
           offsetof(mavlink_isbd_link_status_t, failed_sessions)},          \
          {"successful_sessions",                                           \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           18,                                                              \
           offsetof(mavlink_isbd_link_status_t, successful_sessions)},      \
          {"signal_quality",                                                \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           20,                                                              \
           offsetof(mavlink_isbd_link_status_t, signal_quality)},           \
          {"ring_pending",                                                  \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           21,                                                              \
           offsetof(mavlink_isbd_link_status_t, ring_pending)},             \
          {"tx_session_pending",                                            \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           22,                                                              \
           offsetof(mavlink_isbd_link_status_t, tx_session_pending)},       \
          {"rx_session_pending",                                            \
           NULL,                                                            \
           MAVLINK_TYPE_UINT8_T,                                            \
           0,                                                               \
           23,                                                              \
           offsetof(mavlink_isbd_link_status_t, rx_session_pending)},       \
    }                                                                       \
  }
#else
#define MAVLINK_MESSAGE_INFO_ISBD_LINK_STATUS                               \
 ...
 * @param signal_quality  Signal quality equal to the number of bars displayed
 * on the ISU signal strength indicator. Range is 0 to 5, where 0 indicates no
 * signal and 5 indicates maximum signal strength.
 * @param ring_pending  1: Ring call pending, 0: No call pending.
 * @param tx_session_pending  1: Transmission session pending, 0: No
 * transmission session pending.
 * @param rx_session_pending  1: Receiving session pending, 0: No receiving
 * session pending.
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_isbd_link_status_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint64_t timestamp, uint64_t last_heartbeat, uint16_t failed_sessions,
    uint16_t successful_sessions, uint8_t signal_quality, uint8_t ring_pending,
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_ISBD_LINK_STATUS_MIN_LEN,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_isbd_link_status_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint64_t timestamp, uint64_t last_heartbeat,
    uint16_t failed_sessions, uint16_t successful_sessions,
    uint8_t signal_quality, uint8_t ring_pending, uint8_t tx_session_pending,
 ...
 */
static inline uint16_t mavlink_msg_isbd_link_status_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_isbd_link_status_t* isbd_link_status) {
  return mavlink_msg_isbd_link_status_pack(
      system_id, component_id, msg, isbd_link_status->timestamp,
      isbd_link_status->last_heartbeat, isbd_link_status->failed_sessions,
      isbd_link_status->successful_sessions, isbd_link_status->signal_quality,
      isbd_link_status->ring_pending, isbd_link_status->tx_session_pending,
 ...
 * @param isbd_link_status C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_isbd_link_status_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_isbd_link_status_t* isbd_link_status) {
  return mavlink_msg_isbd_link_status_pack_chan(
      system_id, component_id, chan, msg, isbd_link_status->timestamp,
      isbd_link_status->last_heartbeat, isbd_link_status->failed_sessions,
      isbd_link_status->successful_sessions, isbd_link_status->signal_quality,
      isbd_link_status->ring_pending, isbd_link_status->tx_session_pending,
      isbd_link_status->rx_session_pending);
...
static inline void mavlink_msg_isbd_link_status_send(
    mavlink_channel_t chan, uint64_t timestamp, uint64_t last_heartbeat,
    uint16_t failed_sessions, uint16_t successful_sessions,
    uint8_t signal_quality, uint8_t ring_pending, uint8_t tx_session_pending,
    uint8_t rx_session_pending) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ISBD_LINK_STATUS, buf,
                                  MAVLINK_MSG_ID_ISBD_LINK_STATUS_MIN_LEN,
                                  MAVLINK_MSG_ID_ISBD_LINK_STATUS_LEN,
                                  MAVLINK_MSG_ID_ISBD_LINK_STATUS_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ISBD_LINK_STATUS, (const char*)&packet,
      MAVLINK_MSG_ID_ISBD_LINK_STATUS_MIN_LEN,
      MAVLINK_MSG_ID_ISBD_LINK_STATUS_LEN, MAVLINK_MSG_ID_ISBD_LINK_STATUS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_isbd_link_status_send_struct(
    mavlink_channel_t chan,
    const mavlink_isbd_link_status_t* isbd_link_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_isbd_link_status_send(
      chan, isbd_link_status->timestamp, isbd_link_status->last_heartbeat,
      isbd_link_status->failed_sessions, isbd_link_status->successful_sessions,
      isbd_link_status->signal_quality, isbd_link_status->ring_pending,
      isbd_link_status->tx_session_pending,
      isbd_link_status->rx_session_pending);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_ISBD_LINK_STATUS, (const char*)isbd_link_status,
      MAVLINK_MSG_ID_ISBD_LINK_STATUS_MIN_LEN,
      MAVLINK_MSG_ID_ISBD_LINK_STATUS_LEN, MAVLINK_MSG_ID_ISBD_LINK_STATUS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_isbd_link_status_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t timestamp,
    uint64_t last_heartbeat, uint16_t failed_sessions,
    uint16_t successful_sessions, uint8_t signal_quality, uint8_t ring_pending,
    uint8_t tx_session_pending, uint8_t rx_session_pending) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_isbd_link_status_get_timestamp(
 ...
 *
 * @return [us] Timestamp of the last successful sbd session. The receiving end
 * can infer timestamp format (since 1.1.1970 or since system boot) by checking
 * for the magnitude the number.
 */
static inline uint64_t mavlink_msg_isbd_link_status_get_last_heartbeat(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_isbd_link_status_get_successful_sessions(
    const mavlink_message_t* msg) {
 ...
 * signal strength indicator. Range is 0 to 5, where 0 indicates no signal and 5
 * indicates maximum signal strength.
 */
static inline uint8_t mavlink_msg_isbd_link_status_get_signal_quality(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_isbd_link_status_get_ring_pending(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_isbd_link_status_get_tx_session_pending(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_isbd_link_status_get_rx_session_pending(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_isbd_link_status_decode(
    const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_ISBD_LINK_STATUS_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_ISBD_LINK_STATUS_LEN;
