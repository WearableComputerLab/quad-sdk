...
MAVPACKED(typedef struct __mavlink_camera_information_t {
...
#define MAVLINK_MESSAGE_INFO_CAMERA_INFORMATION                               \
  {                                                                           \
    259, "CAMERA_INFORMATION", 13, {                                          \
      {"time_boot_ms",                                                        \
       NULL,                                                                  \
       MAVLINK_TYPE_UINT32_T,                                                 \
       0,                                                                     \
       0,                                                                     \
       offsetof(mavlink_camera_information_t, time_boot_ms)},                 \
          {"vendor_name",                                                     \
           NULL,                                                              \
           MAVLINK_TYPE_UINT8_T,                                              \
           32,                                                                \
           30,                                                                \
           offsetof(mavlink_camera_information_t, vendor_name)},              \
          {"model_name",                                                      \
           NULL,                                                              \
           MAVLINK_TYPE_UINT8_T,                                              \
           32,                                                                \
           62,                                                                \
           offsetof(mavlink_camera_information_t, model_name)},               \
          {"firmware_version",                                                \
           NULL,                                                              \
           MAVLINK_TYPE_UINT32_T,                                             \
           0,                                                                 \
           4,                                                                 \
           offsetof(mavlink_camera_information_t, firmware_version)},         \
          {"focal_length",                                                    \
           NULL,                                                              \
           MAVLINK_TYPE_FLOAT,                                                \
           0,                                                                 \
           8,                                                                 \
           offsetof(mavlink_camera_information_t, focal_length)},             \
          {"sensor_size_h",                                                   \
           NULL,                                                              \
           MAVLINK_TYPE_FLOAT,                                                \
           0,                                                                 \
           12,                                                                \
           offsetof(mavlink_camera_information_t, sensor_size_h)},            \
          {"sensor_size_v",                                                   \
           NULL,                                                              \
           MAVLINK_TYPE_FLOAT,                                                \
           0,                                                                 \
           16,                                                                \
           offsetof(mavlink_camera_information_t, sensor_size_v)},            \
          {"resolution_h",                                                    \
           NULL,                                                              \
           MAVLINK_TYPE_UINT16_T,                                             \
           0,                                                                 \
           24,                                                                \
           offsetof(mavlink_camera_information_t, resolution_h)},             \
          {"resolution_v",                                                    \
           NULL,                                                              \
           MAVLINK_TYPE_UINT16_T,                                             \
           0,                                                                 \
           26,                                                                \
           offsetof(mavlink_camera_information_t, resolution_v)},             \
          {"lens_id", NULL, MAVLINK_TYPE_UINT8_T,                             \
           0,         94,   offsetof(mavlink_camera_information_t, lens_id)}, \
          {"flags", NULL, MAVLINK_TYPE_UINT32_T,                              \
           0,       20,   offsetof(mavlink_camera_information_t, flags)},     \
          {"cam_definition_version",                                          \
           NULL,                                                              \
           MAVLINK_TYPE_UINT16_T,                                             \
           0,                                                                 \
           28,                                                                \
           offsetof(mavlink_camera_information_t, cam_definition_version)},   \
          {"cam_definition_uri",                                              \
           NULL,                                                              \
           MAVLINK_TYPE_CHAR,                                                 \
           140,                                                               \
           95,                                                                \
           offsetof(mavlink_camera_information_t, cam_definition_uri)},       \
    }                                                                         \
  }
#else
#define MAVLINK_MESSAGE_INFO_CAMERA_INFORMATION                               \
  {                                                                           \
    "CAMERA_INFORMATION", 13, {                                               \
      {"time_boot_ms",                                                        \
       NULL,                                                                  \
       MAVLINK_TYPE_UINT32_T,                                                 \
       0,                                                                     \
 ...
 * @param firmware_version  Version of the camera firmware (v << 24 & 0xff =
 * Dev, v << 16 & 0xff = Patch, v << 8 & 0xff = Minor, v & 0xff = Major)
 ...
 * @param cam_definition_uri  Camera definition URI (if any, otherwise only
 * basic functions will be available).
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_camera_information_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint32_t time_boot_ms, const uint8_t* vendor_name,
    const uint8_t* model_name, uint32_t firmware_version, float focal_length,
    float sensor_size_h, float sensor_size_v, uint16_t resolution_h,
    uint16_t resolution_v, uint8_t lens_id, uint32_t flags,
    uint16_t cam_definition_version, const char* cam_definition_uri) {
  ...
  mav_array_memcpy(packet.cam_definition_uri, cam_definition_uri,
                   sizeof(char) * 140);
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_camera_information_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint32_t time_boot_ms, const uint8_t* vendor_name,
    const uint8_t* model_name, uint32_t firmware_version, float focal_length,
    float sensor_size_h, float sensor_size_v, uint16_t resolution_h,
    uint16_t resolution_v, uint8_t lens_id, uint32_t flags,
    uint16_t cam_definition_version, const char* cam_definition_uri) {
 ...
 */
static inline uint16_t mavlink_msg_camera_information_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_camera_information_t* camera_information) {
  return mavlink_msg_camera_information_pack(
      system_id, component_id, msg, camera_information->time_boot_ms,
      camera_information->vendor_name, camera_information->model_name,
      camera_information->firmware_version, camera_information->focal_length,
      camera_information->sensor_size_h, camera_information->sensor_size_v,
      camera_information->resolution_h, camera_information->resolution_v,
      camera_information->lens_id, camera_information->flags,
 ...
 * @param camera_information C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_camera_information_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_camera_information_t* camera_information) {
  return mavlink_msg_camera_information_pack_chan(
      system_id, component_id, chan, msg, camera_information->time_boot_ms,
      camera_information->vendor_name, camera_information->model_name,
      camera_information->firmware_version, camera_information->focal_length,
      camera_information->sensor_size_h, camera_information->sensor_size_v,
      camera_information->resolution_h, camera_information->resolution_v,
...
static inline void mavlink_msg_camera_information_send(
    mavlink_channel_t chan, uint32_t time_boot_ms, const uint8_t* vendor_name,
    const uint8_t* model_name, uint32_t firmware_version, float focal_length,
    float sensor_size_h, float sensor_size_v, uint16_t resolution_h,
    uint16_t resolution_v, uint8_t lens_id, uint32_t flags,
    uint16_t cam_definition_version, const char* cam_definition_uri) {
  ...
  _mav_put_uint8_t_array(buf, 62, model_name, 32);
  _mav_put_char_array(buf, 95, cam_definition_uri, 140);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CAMERA_INFORMATION, buf,
                                  MAVLINK_MSG_ID_CAMERA_INFORMATION_MIN_LEN,
                                  MAVLINK_MSG_ID_CAMERA_INFORMATION_LEN,
                                  MAVLINK_MSG_ID_CAMERA_INFORMATION_CRC);
#else
  ...
  mav_array_memcpy(packet.cam_definition_uri, cam_definition_uri,
                   sizeof(char) * 140);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CAMERA_INFORMATION,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_CAMERA_INFORMATION_MIN_LEN,
                                  MAVLINK_MSG_ID_CAMERA_INFORMATION_LEN,
                                  MAVLINK_MSG_ID_CAMERA_INFORMATION_CRC);
 ...
 */
static inline void mavlink_msg_camera_information_send_struct(
    mavlink_channel_t chan,
    const mavlink_camera_information_t* camera_information) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_camera_information_send(
      chan, camera_information->time_boot_ms, camera_information->vendor_name,
      camera_information->model_name, camera_information->firmware_version,
      camera_information->focal_length, camera_information->sensor_size_h,
      camera_information->sensor_size_v, camera_information->resolution_h,
      camera_information->resolution_v, camera_information->lens_id,
      camera_information->flags, camera_information->cam_definition_version,
      camera_information->cam_definition_uri);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CAMERA_INFORMATION,
                                  (const char*)camera_information,
                                  MAVLINK_MSG_ID_CAMERA_INFORMATION_MIN_LEN,
                                  MAVLINK_MSG_ID_CAMERA_INFORMATION_LEN,
                                  MAVLINK_MSG_ID_CAMERA_INFORMATION_CRC);
#endif
...
static inline void mavlink_msg_camera_information_send_buf(
    ...
    const uint8_t* vendor_name, const uint8_t* model_name,
    uint32_t firmware_version, float focal_length, float sensor_size_h,
    float sensor_size_v, uint16_t resolution_h, uint16_t resolution_v,
    uint8_t lens_id, uint32_t flags, uint16_t cam_definition_version,
 ...
 */
static inline uint32_t mavlink_msg_camera_information_get_time_boot_ms(
 ...
 */
static inline uint16_t mavlink_msg_camera_information_get_vendor_name(
    const mavlink_message_t* msg, uint8_t* vendor_name) {
 ...
 */
static inline uint16_t mavlink_msg_camera_information_get_model_name(
    const mavlink_message_t* msg, uint8_t* model_name) {
 ...
 *
 * @return  Version of the camera firmware (v << 24 & 0xff = Dev, v << 16 & 0xff
 * = Patch, v << 8 & 0xff = Minor, v & 0xff = Major)
 */
static inline uint32_t mavlink_msg_camera_information_get_firmware_version(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_camera_information_get_sensor_size_v(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_camera_information_get_resolution_h(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_camera_information_get_resolution_v(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_camera_information_get_lens_id(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_camera_information_get_flags(
    const mavlink_message_t* msg) {
...
mavlink_msg_camera_information_get_cam_definition_version(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Camera definition URI (if any, otherwise only basic functions will
 * be available).
 */
static inline uint16_t mavlink_msg_camera_information_get_cam_definition_uri(
    const mavlink_message_t* msg, char* cam_definition_uri) {
 ...
 */
static inline void mavlink_msg_camera_information_decode(
    const mavlink_message_t* msg,
    mavlink_camera_information_t* camera_information) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  camera_information->time_boot_ms =
      mavlink_msg_camera_information_get_time_boot_ms(msg);
  camera_information->firmware_version =
      mavlink_msg_camera_information_get_firmware_version(msg);
  camera_information->focal_length =
      mavlink_msg_camera_information_get_focal_length(msg);
  camera_information->sensor_size_h =
      mavlink_msg_camera_information_get_sensor_size_h(msg);
  camera_information->sensor_size_v =
      mavlink_msg_camera_information_get_sensor_size_v(msg);
  camera_information->flags = mavlink_msg_camera_information_get_flags(msg);
  camera_information->resolution_h =
      mavlink_msg_camera_information_get_resolution_h(msg);
  camera_information->resolution_v =
      mavlink_msg_camera_information_get_resolution_v(msg);
  camera_information->cam_definition_version =
      mavlink_msg_camera_information_get_cam_definition_version(msg);
  mavlink_msg_camera_information_get_vendor_name(
      msg, camera_information->vendor_name);
  mavlink_msg_camera_information_get_model_name(msg,
  ...
  mavlink_msg_camera_information_get_cam_definition_uri(
      msg, camera_information->cam_definition_uri);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_CAMERA_INFORMATION_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_CAMERA_INFORMATION_LEN;
