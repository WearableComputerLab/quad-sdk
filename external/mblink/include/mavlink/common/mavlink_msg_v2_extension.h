...
MAVPACKED(typedef struct __mavlink_v2_extension_t {
  uint16_t
      message_type; /*<  A code that identifies the software component that
                       understands this message (analogous to USB device classes
                       or mime type strings).  If this code is less than 32768,
                       it is considered a 'registered' protocol extension and
                       the corresponding entry should be added to
                       https://github.com/mavlink/mavlink/extension-message-ids.xml.
                       Software creators can register blocks of message IDs as
                       needed (useful for GCS specific metadata, etc...).
                       Message_types greater than 32767 are considered local
                       experiments and should not be checked in to any widely
                       distributed codebase.*/
  uint8_t target_network;   /*<  Network ID (0 for broadcast)*/
  uint8_t target_system;    /*<  System ID (0 for broadcast)*/
  uint8_t target_component; /*<  Component ID (0 for broadcast)*/
  uint8_t payload[249]; /*<  Variable length payload. The length is defined by
  ...
  {                                                                     \
    248, "V2_EXTENSION", 5, {                                           \
      {"target_network",                                                \
       ...
       0,                                                               \
       2,                                                               \
       offsetof(mavlink_v2_extension_t, target_network)},               \
          {"target_system",                                             \
           NULL,                                                        \
           MAVLINK_TYPE_UINT8_T,                                        \
           0,                                                           \
           3,                                                           \
           offsetof(mavlink_v2_extension_t, target_system)},            \
          {"target_component",                                          \
           NULL,                                                        \
           MAVLINK_TYPE_UINT8_T,                                        \
           0,                                                           \
           4,                                                           \
           offsetof(mavlink_v2_extension_t, target_component)},         \
          {"message_type",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_UINT16_T,                                       \
           0,                                                           \
           0,                                                           \
           offsetof(mavlink_v2_extension_t, message_type)},             \
          {"payload", NULL, MAVLINK_TYPE_UINT8_T,                       \
           249,       5,    offsetof(mavlink_v2_extension_t, payload)}, \
    }                                                                   \
  }
#else
#define MAVLINK_MESSAGE_INFO_V2_EXTENSION                               \
 ...
 * @param message_type  A code that identifies the software component that
 * understands this message (analogous to USB device classes or mime type
 * strings).  If this code is less than 32768, it is considered a 'registered'
 ...
 * codebase.
 * @param payload  Variable length payload. The length is defined by the
...
static inline uint16_t mavlink_msg_v2_extension_pack(
    ...
    uint8_t target_network, uint8_t target_system, uint8_t target_component,
...
static inline uint16_t mavlink_msg_v2_extension_pack_chan(
    ...
    mavlink_message_t* msg, uint8_t target_network, uint8_t target_system,
    uint8_t target_component, uint16_t message_type, const uint8_t* payload) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_V2_EXTENSION_LEN];
  _mav_put_uint16_t(buf, 0, message_type);
  _mav_put_uint8_t(buf, 2, target_network);
...
static inline uint16_t mavlink_msg_v2_extension_encode(
  ...
  return mavlink_msg_v2_extension_pack(
      ...
      v2_extension->target_system, v2_extension->target_component,
...
static inline uint16_t mavlink_msg_v2_extension_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_v2_extension_t* v2_extension) {
  return mavlink_msg_v2_extension_pack_chan(
      system_id, component_id, chan, msg, v2_extension->target_network,
      v2_extension->target_system, v2_extension->target_component,
      v2_extension->message_type, v2_extension->payload);
}
...
static inline void mavlink_msg_v2_extension_send(
    mavlink_channel_t chan, uint8_t target_network, uint8_t target_system,
    uint8_t target_component, uint16_t message_type, const uint8_t* payload) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_V2_EXTENSION_LEN];
  _mav_put_uint16_t(buf, 0, message_type);
  ...
  _mav_put_uint8_t(buf, 4, target_component);
  _mav_put_uint8_t_array(buf, 5, payload, 249);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_V2_EXTENSION, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_V2_EXTENSION, (const char*)&packet,
      MAVLINK_MSG_ID_V2_EXTENSION_MIN_LEN, MAVLINK_MSG_ID_V2_EXTENSION_LEN,
      MAVLINK_MSG_ID_V2_EXTENSION_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_v2_extension_send_struct(
    mavlink_channel_t chan, const mavlink_v2_extension_t* v2_extension) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_v2_extension_send(
      chan, v2_extension->target_network, v2_extension->target_system,
      v2_extension->target_component, v2_extension->message_type,
      v2_extension->payload);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_V2_EXTENSION, (const char*)v2_extension,
      MAVLINK_MSG_ID_V2_EXTENSION_MIN_LEN, MAVLINK_MSG_ID_V2_EXTENSION_LEN,
      MAVLINK_MSG_ID_V2_EXTENSION_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_v2_extension_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_network,
    uint8_t target_system, uint8_t target_component, uint16_t message_type,
 ...
 */
static inline uint8_t mavlink_msg_v2_extension_get_target_network(
 ...
 */
static inline uint8_t mavlink_msg_v2_extension_get_target_system(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_v2_extension_get_target_component(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  A code that identifies the software component that understands this
 * message (analogous to USB device classes or mime type strings).  If this code
 * is less than 32768, it is considered a 'registered' protocol extension and
 * the corresponding entry should be added to
 * https://github.com/mavlink/mavlink/extension-message-ids.xml.  Software
 * creators can register blocks of message IDs as needed (useful for GCS
 * specific metadata, etc...). Message_types greater than 32767 are considered
 ...
 * codebase.
 */
static inline uint16_t mavlink_msg_v2_extension_get_message_type(
    const mavlink_message_t* msg) {
 ...
 * message length when subtracting the header and other fields.  The entire
 * content of this block is opaque unless you understand any the encoding
 * message_type.  The particular encoding used can be extension specific and
 * might not always be documented as part of the mavlink specification.
 */
static inline uint16_t mavlink_msg_v2_extension_get_payload(
 ...
 */
static inline void mavlink_msg_v2_extension_decode(
    const mavlink_message_t* msg, mavlink_v2_extension_t* v2_extension) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_V2_EXTENSION_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_V2_EXTENSION_LEN;
