...
MAVPACKED(typedef struct __mavlink_local_position_ned_cov_t {
  ...
  float covariance[45]; /*<  Row-major representation of position, velocity and
                           acceleration 9x9 cross-covariance matrix upper right
                           triangle (states: x, y, z, vx, vy, vz, ax, ay, az;
                           first nine entries are the first ROW, next eight
                           entries are the second row, etc.). If unknown, assign
                           NaN value to first element in the array.*/
  uint8_t estimator_type; /*<  Class id of the estimator this estimate
                             originated from.*/
})
...
#define MAVLINK_MESSAGE_INFO_LOCAL_POSITION_NED_COV                     \
  {                                                                     \
    64, "LOCAL_POSITION_NED_COV", 12, {                                 \
      {"time_usec",                                                     \
       NULL,                                                            \
       MAVLINK_TYPE_UINT64_T,                                           \
       0,                                                               \
       0,                                                               \
       offsetof(mavlink_local_position_ned_cov_t, time_usec)},          \
          {"estimator_type",                                            \
           NULL,                                                        \
           MAVLINK_TYPE_UINT8_T,                                        \
           0,                                                           \
           224,                                                         \
           offsetof(mavlink_local_position_ned_cov_t, estimator_type)}, \
          {"x", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,   8,    offsetof(mavlink_local_position_ned_cov_t, x)},   \
          {"y", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,   12,   offsetof(mavlink_local_position_ned_cov_t, y)},   \
          {"z", NULL, MAVLINK_TYPE_FLOAT,                               \
           0,   16,   offsetof(mavlink_local_position_ned_cov_t, z)},   \
          {"vx", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,    20,   offsetof(mavlink_local_position_ned_cov_t, vx)}, \
          {"vy", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,    24,   offsetof(mavlink_local_position_ned_cov_t, vy)}, \
          {"vz", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,    28,   offsetof(mavlink_local_position_ned_cov_t, vz)}, \
          {"ax", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,    32,   offsetof(mavlink_local_position_ned_cov_t, ax)}, \
          {"ay", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,    36,   offsetof(mavlink_local_position_ned_cov_t, ay)}, \
          {"az", NULL, MAVLINK_TYPE_FLOAT,                              \
           0,    40,   offsetof(mavlink_local_position_ned_cov_t, az)}, \
          {"covariance",                                                \
           NULL,                                                        \
           MAVLINK_TYPE_FLOAT,                                          \
           45,                                                          \
           44,                                                          \
           offsetof(mavlink_local_position_ned_cov_t, covariance)},     \
    }                                                                   \
  }
#else
#define MAVLINK_MESSAGE_INFO_LOCAL_POSITION_NED_COV                     \
  {                                                                     \
    "LOCAL_POSITION_NED_COV", 12, {                                     \
      {"time_usec",                                                     \
       NULL,                                                            \
       MAVLINK_TYPE_UINT64_T,                                           \
       0,                                                               \
 ...
 * @param estimator_type  Class id of the estimator this estimate originated
 * from.
 ...
 * @param covariance  Row-major representation of position, velocity and
 * acceleration 9x9 cross-covariance matrix upper right triangle (states: x, y,
 * z, vx, vy, vz, ax, ay, az; first nine entries are the first ROW, next eight
 * entries are the second row, etc.). If unknown, assign NaN value to first
...
static inline uint16_t mavlink_msg_local_position_ned_cov_pack(
    ...
    uint64_t time_usec, uint8_t estimator_type, float x, float y, float z,
...
static inline uint16_t mavlink_msg_local_position_ned_cov_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_usec, uint8_t estimator_type, float x,
    float y, float z, float vx, float vy, float vz, float ax, float ay,
    float az, const float* covariance) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_LOCAL_POSITION_NED_COV_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  _mav_put_float(buf, 8, x);
...
static inline uint16_t mavlink_msg_local_position_ned_cov_encode(
  ...
  return mavlink_msg_local_position_ned_cov_pack(
      system_id, component_id, msg, local_position_ned_cov->time_usec,
      local_position_ned_cov->estimator_type, local_position_ned_cov->x,
      local_position_ned_cov->y, local_position_ned_cov->z,
      local_position_ned_cov->vx, local_position_ned_cov->vy,
      local_position_ned_cov->vz, local_position_ned_cov->ax,
      local_position_ned_cov->ay, local_position_ned_cov->az,
...
static inline uint16_t mavlink_msg_local_position_ned_cov_encode_chan(
  ...
  return mavlink_msg_local_position_ned_cov_pack_chan(
      system_id, component_id, chan, msg, local_position_ned_cov->time_usec,
      local_position_ned_cov->estimator_type, local_position_ned_cov->x,
      local_position_ned_cov->y, local_position_ned_cov->z,
      local_position_ned_cov->vx, local_position_ned_cov->vy,
      local_position_ned_cov->vz, local_position_ned_cov->ax,
...
static inline void mavlink_msg_local_position_ned_cov_send(
    mavlink_channel_t chan, uint64_t time_usec, uint8_t estimator_type, float x,
    float y, float z, float vx, float vy, float vz, float ax, float ay,
    float az, const float* covariance) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_LOCAL_POSITION_NED_COV_LEN];
  ...
  _mav_put_uint8_t(buf, 224, estimator_type);
  _mav_put_float_array(buf, 44, covariance, 45);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOCAL_POSITION_NED_COV,
                                  buf,
                                  MAVLINK_MSG_ID_LOCAL_POSITION_NED_COV_MIN_LEN,
                                  MAVLINK_MSG_ID_LOCAL_POSITION_NED_COV_LEN,
                                  MAVLINK_MSG_ID_LOCAL_POSITION_NED_COV_CRC);
 ...
 */
static inline void mavlink_msg_local_position_ned_cov_send_struct(
    mavlink_channel_t chan,
    const mavlink_local_position_ned_cov_t* local_position_ned_cov) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_local_position_ned_cov_send(
      chan, local_position_ned_cov->time_usec,
      local_position_ned_cov->estimator_type, local_position_ned_cov->x,
      local_position_ned_cov->y, local_position_ned_cov->z,
      local_position_ned_cov->vx, local_position_ned_cov->vy,
      local_position_ned_cov->vz, local_position_ned_cov->ax,
...
static inline void mavlink_msg_local_position_ned_cov_send_buf(
    ...
    uint8_t estimator_type, float x, float y, float z, float vx, float vy,
    float vz, float ax, float ay, float az, const float* covariance) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  mavlink_local_position_ned_cov_t* packet =
      (mavlink_local_position_ned_cov_t*)msgbuf;
  packet->time_usec = time_usec;
  packet->x = x;
  packet->y = y;
  packet->z = z;
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_local_position_ned_cov_get_time_usec(
 ...
 */
static inline uint8_t mavlink_msg_local_position_ned_cov_get_estimator_type(
    const mavlink_message_t* msg) {
 ...
 * @return [m] X Position
 */
static inline float mavlink_msg_local_position_ned_cov_get_x(
    const mavlink_message_t* msg) {
 ...
 * @return [m] Y Position
 */
static inline float mavlink_msg_local_position_ned_cov_get_y(
    const mavlink_message_t* msg) {
 ...
 * @return [m] Z Position
 */
static inline float mavlink_msg_local_position_ned_cov_get_z(
    const mavlink_message_t* msg) {
 ...
 * @return [m/s] X Speed
 */
static inline float mavlink_msg_local_position_ned_cov_get_vx(
    const mavlink_message_t* msg) {
 ...
 * @return [m/s] Y Speed
 */
static inline float mavlink_msg_local_position_ned_cov_get_vy(
    const mavlink_message_t* msg) {
 ...
 * @return [m/s] Z Speed
 */
static inline float mavlink_msg_local_position_ned_cov_get_vz(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_local_position_ned_cov_get_ax(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_local_position_ned_cov_get_ay(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_local_position_ned_cov_get_az(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Row-major representation of position, velocity and acceleration 9x9
 ...
 * array.
 */
static inline uint16_t mavlink_msg_local_position_ned_cov_get_covariance(
    const mavlink_message_t* msg, float* covariance) {
 ...
 */
static inline void mavlink_msg_local_position_ned_cov_decode(
    const mavlink_message_t* msg,
  ...
  mavlink_msg_local_position_ned_cov_get_covariance(
      msg, local_position_ned_cov->covariance);
  local_position_ned_cov->estimator_type =
      mavlink_msg_local_position_ned_cov_get_estimator_type(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_LOCAL_POSITION_NED_COV_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_LOCAL_POSITION_NED_COV_LEN;
