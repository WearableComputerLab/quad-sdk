...
MAVPACKED(typedef struct __mavlink_video_stream_status_t {
...
#define MAVLINK_MESSAGE_INFO_VIDEO_STREAM_STATUS                                 \
  {                                                                              \
    270, "VIDEO_STREAM_STATUS", 8, {                                             \
      {"stream_id", NULL, MAVLINK_TYPE_UINT8_T,                                  \
       0,           18,   offsetof(mavlink_video_stream_status_t, stream_id)},   \
          {"flags", NULL, MAVLINK_TYPE_UINT16_T,                                 \
           0,       8,    offsetof(mavlink_video_stream_status_t, flags)},       \
          {"framerate",                                                          \
           NULL,                                                                 \
           MAVLINK_TYPE_FLOAT,                                                   \
           0,                                                                    \
           0,                                                                    \
           offsetof(mavlink_video_stream_status_t, framerate)},                  \
          {"resolution_h",                                                       \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT16_T,                                                \
           0,                                                                    \
           10,                                                                   \
           offsetof(mavlink_video_stream_status_t, resolution_h)},               \
          {"resolution_v",                                                       \
           NULL,                                                                 \
           MAVLINK_TYPE_UINT16_T,                                                \
           0,                                                                    \
           12,                                                                   \
           offsetof(mavlink_video_stream_status_t, resolution_v)},               \
          {"bitrate", NULL, MAVLINK_TYPE_UINT32_T,                               \
           0,         4,    offsetof(mavlink_video_stream_status_t, bitrate)},   \
          {"rotation", NULL, MAVLINK_TYPE_UINT16_T,                              \
           0,          14,   offsetof(mavlink_video_stream_status_t, rotation)}, \
          {"hfov", NULL, MAVLINK_TYPE_UINT16_T,                                  \
           0,      16,   offsetof(mavlink_video_stream_status_t, hfov)},         \
    }                                                                            \
  }
#else
#define MAVLINK_MESSAGE_INFO_VIDEO_STREAM_STATUS                                 \
  {                                                                              \
    "VIDEO_STREAM_STATUS", 8, {                                                  \
      {"stream_id", NULL, MAVLINK_TYPE_UINT8_T,                                  \
       0,           18,   offsetof(mavlink_video_stream_status_t, stream_id)},   \
          {"flags", NULL, MAVLINK_TYPE_UINT16_T,                                 \
           0,       8,    offsetof(mavlink_video_stream_status_t, flags)},       \
 ...
 */
static inline uint16_t mavlink_msg_video_stream_status_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint8_t stream_id, uint16_t flags, float framerate, uint16_t resolution_h,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_video_stream_status_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint8_t stream_id, uint16_t flags, float framerate,
 ...
 */
static inline uint16_t mavlink_msg_video_stream_status_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_video_stream_status_t* video_stream_status) {
  return mavlink_msg_video_stream_status_pack(
      system_id, component_id, msg, video_stream_status->stream_id,
      video_stream_status->flags, video_stream_status->framerate,
      video_stream_status->resolution_h, video_stream_status->resolution_v,
      video_stream_status->bitrate, video_stream_status->rotation,
 ...
 * @param video_stream_status C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_video_stream_status_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_video_stream_status_t* video_stream_status) {
  return mavlink_msg_video_stream_status_pack_chan(
      system_id, component_id, chan, msg, video_stream_status->stream_id,
      video_stream_status->flags, video_stream_status->framerate,
      video_stream_status->resolution_h, video_stream_status->resolution_v,
      video_stream_status->bitrate, video_stream_status->rotation,
      video_stream_status->hfov);
...
static inline void mavlink_msg_video_stream_status_send(
    mavlink_channel_t chan, uint8_t stream_id, uint16_t flags, float framerate,
    uint16_t resolution_h, uint16_t resolution_v, uint32_t bitrate,
    uint16_t rotation, uint16_t hfov) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_VIDEO_STREAM_STATUS_LEN];
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VIDEO_STREAM_STATUS, buf,
                                  MAVLINK_MSG_ID_VIDEO_STREAM_STATUS_MIN_LEN,
                                  MAVLINK_MSG_ID_VIDEO_STREAM_STATUS_LEN,
                                  MAVLINK_MSG_ID_VIDEO_STREAM_STATUS_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VIDEO_STREAM_STATUS,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_VIDEO_STREAM_STATUS_MIN_LEN,
                                  MAVLINK_MSG_ID_VIDEO_STREAM_STATUS_LEN,
                                  MAVLINK_MSG_ID_VIDEO_STREAM_STATUS_CRC);
 ...
 */
static inline void mavlink_msg_video_stream_status_send_struct(
    mavlink_channel_t chan,
    const mavlink_video_stream_status_t* video_stream_status) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_video_stream_status_send(
      chan, video_stream_status->stream_id, video_stream_status->flags,
      video_stream_status->framerate, video_stream_status->resolution_h,
      video_stream_status->resolution_v, video_stream_status->bitrate,
      video_stream_status->rotation, video_stream_status->hfov);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VIDEO_STREAM_STATUS,
 ...
 */
static inline void mavlink_msg_video_stream_status_send_buf(
...
#else
  mavlink_video_stream_status_t* packet =
      (mavlink_video_stream_status_t*)msgbuf;
  packet->framerate = framerate;
  packet->bitrate = bitrate;
  packet->flags = flags;
  packet->resolution_h = resolution_h;
 ...
 */
static inline uint8_t mavlink_msg_video_stream_status_get_stream_id(
 ...
 */
static inline uint16_t mavlink_msg_video_stream_status_get_flags(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_video_stream_status_get_framerate(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_video_stream_status_get_resolution_h(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_video_stream_status_get_resolution_v(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_video_stream_status_get_bitrate(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_video_stream_status_get_rotation(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_video_stream_status_get_hfov(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_video_stream_status_decode(
    const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_VIDEO_STREAM_STATUS_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_VIDEO_STREAM_STATUS_LEN;
