...
MAVPACKED(typedef struct __mavlink_hil_sensor_t {
  ...
  uint32_t fields_updated; /*<  Bitmap for fields that have updated since last
                              message, bit 0 = xacc, bit 12: temperature, bit
                              31: full reset of attitude/position/velocities/etc
  ...
  {                                                                   \
    107, "HIL_SENSOR", 15, {                                          \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                      \
       0,           0,    offsetof(mavlink_hil_sensor_t, time_usec)}, \
          {"xacc", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,      8,    offsetof(mavlink_hil_sensor_t, xacc)},       \
          {"yacc", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,      12,   offsetof(mavlink_hil_sensor_t, yacc)},       \
          {"zacc", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,      16,   offsetof(mavlink_hil_sensor_t, zacc)},       \
          {"xgyro", NULL, MAVLINK_TYPE_FLOAT,                         \
           0,       20,   offsetof(mavlink_hil_sensor_t, xgyro)},     \
          {"ygyro", NULL, MAVLINK_TYPE_FLOAT,                         \
           0,       24,   offsetof(mavlink_hil_sensor_t, ygyro)},     \
          {"zgyro", NULL, MAVLINK_TYPE_FLOAT,                         \
           0,       28,   offsetof(mavlink_hil_sensor_t, zgyro)},     \
          {"xmag", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,      32,   offsetof(mavlink_hil_sensor_t, xmag)},       \
          {"ymag", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,      36,   offsetof(mavlink_hil_sensor_t, ymag)},       \
          {"zmag", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,      40,   offsetof(mavlink_hil_sensor_t, zmag)},       \
          {"abs_pressure",                                            \
           NULL,                                                      \
           MAVLINK_TYPE_FLOAT,                                        \
           0,                                                         \
           44,                                                        \
           offsetof(mavlink_hil_sensor_t, abs_pressure)},             \
          {"diff_pressure",                                           \
           NULL,                                                      \
           MAVLINK_TYPE_FLOAT,                                        \
           0,                                                         \
           48,                                                        \
           offsetof(mavlink_hil_sensor_t, diff_pressure)},            \
          {"pressure_alt",                                            \
           NULL,                                                      \
           MAVLINK_TYPE_FLOAT,                                        \
           0,                                                         \
           52,                                                        \
           offsetof(mavlink_hil_sensor_t, pressure_alt)},             \
          {"temperature",                                             \
           NULL,                                                      \
           MAVLINK_TYPE_FLOAT,                                        \
           0,                                                         \
           56,                                                        \
           offsetof(mavlink_hil_sensor_t, temperature)},              \
          {"fields_updated",                                          \
           NULL,                                                      \
           MAVLINK_TYPE_UINT32_T,                                     \
           0,                                                         \
           60,                                                        \
           offsetof(mavlink_hil_sensor_t, fields_updated)},           \
    }                                                                 \
  }
#else
#define MAVLINK_MESSAGE_INFO_HIL_SENSOR                               \
 ...
 * @param fields_updated  Bitmap for fields that have updated since last
 * message, bit 0 = xacc, bit 12: temperature, bit 31: full reset of
 * attitude/position/velocities/etc was performed in sim.
...
static inline uint16_t mavlink_msg_hil_sensor_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_usec, float xacc, float yacc,
    float zacc, float xgyro, float ygyro, float zgyro, float xmag, float ymag,
    float zmag, float abs_pressure, float diff_pressure, float pressure_alt,
    float temperature, uint32_t fields_updated) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_HIL_SENSOR_LEN];
  _mav_put_uint64_t(buf, 0, time_usec);
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_HIL_SENSOR_MIN_LEN,
      MAVLINK_MSG_ID_HIL_SENSOR_LEN, MAVLINK_MSG_ID_HIL_SENSOR_CRC);
}
...
static inline uint16_t mavlink_msg_hil_sensor_encode(
  ...
  return mavlink_msg_hil_sensor_pack(
      system_id, component_id, msg, hil_sensor->time_usec, hil_sensor->xacc,
      hil_sensor->yacc, hil_sensor->zacc, hil_sensor->xgyro, hil_sensor->ygyro,
      hil_sensor->zgyro, hil_sensor->xmag, hil_sensor->ymag, hil_sensor->zmag,
...
static inline uint16_t mavlink_msg_hil_sensor_encode_chan(
  ...
  return mavlink_msg_hil_sensor_pack_chan(
      system_id, component_id, chan, msg, hil_sensor->time_usec,
      hil_sensor->xacc, hil_sensor->yacc, hil_sensor->zacc, hil_sensor->xgyro,
      hil_sensor->ygyro, hil_sensor->zgyro, hil_sensor->xmag, hil_sensor->ymag,
      hil_sensor->zmag, hil_sensor->abs_pressure, hil_sensor->diff_pressure,
      hil_sensor->pressure_alt, hil_sensor->temperature,
      hil_sensor->fields_updated);
}
...
static inline void mavlink_msg_hil_sensor_send(
    mavlink_channel_t chan, uint64_t time_usec, float xacc, float yacc,
    float zacc, float xgyro, float ygyro, float zgyro, float xmag, float ymag,
    float zmag, float abs_pressure, float diff_pressure, float pressure_alt,
    float temperature, uint32_t fields_updated) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIL_SENSOR, buf, MAVLINK_MSG_ID_HIL_SENSOR_MIN_LEN,
      MAVLINK_MSG_ID_HIL_SENSOR_LEN, MAVLINK_MSG_ID_HIL_SENSOR_CRC);
#else
  mavlink_hil_sensor_t packet;
  packet.time_usec = time_usec;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIL_SENSOR, (const char*)&packet,
      MAVLINK_MSG_ID_HIL_SENSOR_MIN_LEN, MAVLINK_MSG_ID_HIL_SENSOR_LEN,
 ...
 */
static inline void mavlink_msg_hil_sensor_send_struct(
    mavlink_channel_t chan, const mavlink_hil_sensor_t* hil_sensor) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_hil_sensor_send(
      chan, hil_sensor->time_usec, hil_sensor->xacc, hil_sensor->yacc,
      hil_sensor->zacc, hil_sensor->xgyro, hil_sensor->ygyro, hil_sensor->zgyro,
...
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIL_SENSOR, (const char*)hil_sensor,
      MAVLINK_MSG_ID_HIL_SENSOR_MIN_LEN, MAVLINK_MSG_ID_HIL_SENSOR_LEN,
      MAVLINK_MSG_ID_HIL_SENSOR_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_hil_sensor_send_buf(
    ...
    float xmag, float ymag, float zmag, float abs_pressure, float diff_pressure,
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_hil_sensor_get_time_usec(
 ...
 */
static inline float mavlink_msg_hil_sensor_get_xacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_sensor_get_yacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_sensor_get_zacc(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_sensor_get_xgyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_sensor_get_ygyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_sensor_get_zgyro(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_sensor_get_xmag(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_sensor_get_ymag(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_sensor_get_zmag(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_sensor_get_abs_pressure(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_sensor_get_diff_pressure(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_sensor_get_pressure_alt(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_sensor_get_temperature(
    const mavlink_message_t* msg) {
 ...
 *
 * @return  Bitmap for fields that have updated since last message, bit 0 =
 * xacc, bit 12: temperature, bit 31: full reset of
 * attitude/position/velocities/etc was performed in sim.
 */
static inline uint32_t mavlink_msg_hil_sensor_get_fields_updated(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_hil_sensor_decode(
    const mavlink_message_t* msg, mavlink_hil_sensor_t* hil_sensor) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_HIL_SENSOR_LEN
                    ? msg->len
