...
MAVPACKED(typedef struct __mavlink_storage_information_t {
  ...
  float used_capacity;      /*< [MiB] Used capacity. If storage is not ready
                               (STORAGE_STATUS_READY) value will be ignored.*/
  float available_capacity; /*< [MiB] Available storage capacity. If storage is
                               not ready (STORAGE_STATUS_READY) value will be
                               ignored.*/
...
#define MAVLINK_MESSAGE_INFO_STORAGE_INFORMATION                             \
  {                                                                          \
    261, "STORAGE_INFORMATION", 9, {                                         \
      {"time_boot_ms",                                                       \
       NULL,                                                                 \
       MAVLINK_TYPE_UINT32_T,                                                \
       0,                                                                    \
       0,                                                                    \
       offsetof(mavlink_storage_information_t, time_boot_ms)},               \
          {"storage_id",                                                     \
           NULL,                                                             \
           MAVLINK_TYPE_UINT8_T,                                             \
           0,                                                                \
           24,                                                               \
           offsetof(mavlink_storage_information_t, storage_id)},             \
          {"storage_count",                                                  \
           NULL,                                                             \
           MAVLINK_TYPE_UINT8_T,                                             \
           0,                                                                \
           25,                                                               \
           offsetof(mavlink_storage_information_t, storage_count)},          \
          {"status", NULL, MAVLINK_TYPE_UINT8_T,                             \
           0,        26,   offsetof(mavlink_storage_information_t, status)}, \
          {"total_capacity",                                                 \
           NULL,                                                             \
           MAVLINK_TYPE_FLOAT,                                               \
           0,                                                                \
           4,                                                                \
           offsetof(mavlink_storage_information_t, total_capacity)},         \
          {"used_capacity",                                                  \
           NULL,                                                             \
           MAVLINK_TYPE_FLOAT,                                               \
           0,                                                                \
           8,                                                                \
           offsetof(mavlink_storage_information_t, used_capacity)},          \
          {"available_capacity",                                             \
           NULL,                                                             \
           MAVLINK_TYPE_FLOAT,                                               \
           0,                                                                \
           12,                                                               \
           offsetof(mavlink_storage_information_t, available_capacity)},     \
          {"read_speed",                                                     \
           NULL,                                                             \
           MAVLINK_TYPE_FLOAT,                                               \
           0,                                                                \
           16,                                                               \
           offsetof(mavlink_storage_information_t, read_speed)},             \
          {"write_speed",                                                    \
           NULL,                                                             \
           MAVLINK_TYPE_FLOAT,                                               \
           0,                                                                \
           20,                                                               \
           offsetof(mavlink_storage_information_t, write_speed)},            \
    }                                                                        \
  }
#else
#define MAVLINK_MESSAGE_INFO_STORAGE_INFORMATION                             \
  {                                                                          \
    "STORAGE_INFORMATION", 9, {                                              \
      {"time_boot_ms",                                                       \
       NULL,                                                                 \
       MAVLINK_TYPE_UINT32_T,                                                \
       0,                                                                    \
 ...
 */
static inline uint16_t mavlink_msg_storage_information_pack(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    uint32_t time_boot_ms, uint8_t storage_id, uint8_t storage_count,
    uint8_t status, float total_capacity, float used_capacity,
    float available_capacity, float read_speed, float write_speed) {
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_storage_information_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint32_t time_boot_ms, uint8_t storage_id,
    uint8_t storage_count, uint8_t status, float total_capacity,
    float used_capacity, float available_capacity, float read_speed,
    float write_speed) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_STORAGE_INFORMATION_LEN];
  _mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline uint16_t mavlink_msg_storage_information_encode(
    uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
    const mavlink_storage_information_t* storage_information) {
  return mavlink_msg_storage_information_pack(
      system_id, component_id, msg, storage_information->time_boot_ms,
      storage_information->storage_id, storage_information->storage_count,
      storage_information->status, storage_information->total_capacity,
      storage_information->used_capacity,
      storage_information->available_capacity, storage_information->read_speed,
 ...
 * @param storage_information C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_storage_information_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_storage_information_t* storage_information) {
  return mavlink_msg_storage_information_pack_chan(
      system_id, component_id, chan, msg, storage_information->time_boot_ms,
      storage_information->storage_id, storage_information->storage_count,
      storage_information->status, storage_information->total_capacity,
      storage_information->used_capacity,
      storage_information->available_capacity, storage_information->read_speed,
...
static inline void mavlink_msg_storage_information_send(
    mavlink_channel_t chan, uint32_t time_boot_ms, uint8_t storage_id,
    uint8_t storage_count, uint8_t status, float total_capacity,
    float used_capacity, float available_capacity, float read_speed,
    float write_speed) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_STORAGE_INFORMATION, buf,
                                  MAVLINK_MSG_ID_STORAGE_INFORMATION_MIN_LEN,
                                  MAVLINK_MSG_ID_STORAGE_INFORMATION_LEN,
                                  MAVLINK_MSG_ID_STORAGE_INFORMATION_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_STORAGE_INFORMATION,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_STORAGE_INFORMATION_MIN_LEN,
                                  MAVLINK_MSG_ID_STORAGE_INFORMATION_LEN,
                                  MAVLINK_MSG_ID_STORAGE_INFORMATION_CRC);
 ...
 */
static inline void mavlink_msg_storage_information_send_struct(
    mavlink_channel_t chan,
    const mavlink_storage_information_t* storage_information) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_storage_information_send(
      chan, storage_information->time_boot_ms, storage_information->storage_id,
      storage_information->storage_count, storage_information->status,
      storage_information->total_capacity, storage_information->used_capacity,
      storage_information->available_capacity, storage_information->read_speed,
      storage_information->write_speed);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_STORAGE_INFORMATION,
...
static inline void mavlink_msg_storage_information_send_buf(
    ...
    uint8_t storage_id, uint8_t storage_count, uint8_t status,
    float total_capacity, float used_capacity, float available_capacity,
...
#else
  mavlink_storage_information_t* packet =
      (mavlink_storage_information_t*)msgbuf;
  packet->time_boot_ms = time_boot_ms;
  packet->total_capacity = total_capacity;
  packet->used_capacity = used_capacity;
  packet->available_capacity = available_capacity;
 ...
 */
static inline uint32_t mavlink_msg_storage_information_get_time_boot_ms(
 ...
 */
static inline uint8_t mavlink_msg_storage_information_get_storage_id(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_storage_information_get_storage_count(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_storage_information_get_status(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [MiB] Total capacity. If storage is not ready (STORAGE_STATUS_READY)
 * value will be ignored.
 */
static inline float mavlink_msg_storage_information_get_total_capacity(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [MiB] Used capacity. If storage is not ready (STORAGE_STATUS_READY)
 * value will be ignored.
 */
static inline float mavlink_msg_storage_information_get_used_capacity(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [MiB] Available storage capacity. If storage is not ready
 * (STORAGE_STATUS_READY) value will be ignored.
 */
static inline float mavlink_msg_storage_information_get_available_capacity(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_storage_information_get_read_speed(
    const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_storage_information_get_write_speed(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_storage_information_decode(
    const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_STORAGE_INFORMATION_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_STORAGE_INFORMATION_LEN;
