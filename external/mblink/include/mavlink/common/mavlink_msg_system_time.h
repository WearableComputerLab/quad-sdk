...
MAVPACKED(typedef struct __mavlink_system_time_t {
  ...
  {                                                        \
    2, "SYSTEM_TIME", 2, {                                 \
      {"time_unix_usec",                                   \
       ...
       0,                                                  \
       0,                                                  \
       offsetof(mavlink_system_time_t, time_unix_usec)},   \
          {"time_boot_ms",                                 \
           NULL,                                           \
           MAVLINK_TYPE_UINT32_T,                          \
           0,                                              \
           8,                                              \
           offsetof(mavlink_system_time_t, time_boot_ms)}, \
    }                                                      \
  }
#else
#define MAVLINK_MESSAGE_INFO_SYSTEM_TIME                   \
...
static inline uint16_t mavlink_msg_system_time_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_unix_usec, uint32_t time_boot_ms) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_SYSTEM_TIME_LEN];
  _mav_put_uint64_t(buf, 0, time_unix_usec);
  _mav_put_uint32_t(buf, 8, time_boot_ms);
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_SYSTEM_TIME_MIN_LEN,
      MAVLINK_MSG_ID_SYSTEM_TIME_LEN, MAVLINK_MSG_ID_SYSTEM_TIME_CRC);
}
...
static inline uint16_t mavlink_msg_system_time_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_system_time_t* system_time) {
...
static inline void mavlink_msg_system_time_send(mavlink_channel_t chan,
                                                uint64_t time_unix_usec,
                                                uint32_t time_boot_ms) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_SYSTEM_TIME_LEN];
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SYSTEM_TIME, buf, MAVLINK_MSG_ID_SYSTEM_TIME_MIN_LEN,
      MAVLINK_MSG_ID_SYSTEM_TIME_LEN, MAVLINK_MSG_ID_SYSTEM_TIME_CRC);
#else
  mavlink_system_time_t packet;
  packet.time_unix_usec = time_unix_usec;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SYSTEM_TIME, (const char*)&packet,
      MAVLINK_MSG_ID_SYSTEM_TIME_MIN_LEN, MAVLINK_MSG_ID_SYSTEM_TIME_LEN,
 ...
 */
static inline void mavlink_msg_system_time_send_struct(
    mavlink_channel_t chan, const mavlink_system_time_t* system_time) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_system_time_send(chan, system_time->time_unix_usec,
                               system_time->time_boot_ms);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SYSTEM_TIME, (const char*)system_time,
      MAVLINK_MSG_ID_SYSTEM_TIME_MIN_LEN, MAVLINK_MSG_ID_SYSTEM_TIME_LEN,
      MAVLINK_MSG_ID_SYSTEM_TIME_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_system_time_send_buf(mavlink_message_t* msgbuf,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SYSTEM_TIME_LEN
                    ? msg->len
