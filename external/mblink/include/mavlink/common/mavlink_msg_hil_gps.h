...
MAVPACKED(typedef struct __mavlink_hil_gps_t {
  ...
  uint16_t eph; /*< [cm] GPS HDOP horizontal dilution of position. If unknown,
                   set to: 65535*/
  uint16_t epv; /*< [cm] GPS VDOP vertical dilution of position. If unknown, set
                   to: 65535*/
  uint16_t vel; /*< [cm/s] GPS ground speed. If unknown, set to: 65535*/
  int16_t
      vn; /*< [cm/s] GPS velocity in NORTH direction in earth-fixed NED frame*/
  int16_t
      ve; /*< [cm/s] GPS velocity in EAST direction in earth-fixed NED frame*/
  int16_t
      vd; /*< [cm/s] GPS velocity in DOWN direction in earth-fixed NED frame*/
  uint16_t cog;     /*< [cdeg] Course over ground (NOT heading, but direction of
                       movement), 0.0..359.99 degrees. If unknown, set to: 65535*/
  ...
  {                                                                  \
    113, "HIL_GPS", 13, {                                            \
      {"time_usec", NULL, MAVLINK_TYPE_UINT64_T,                     \
       0,           0,    offsetof(mavlink_hil_gps_t, time_usec)},   \
          {"fix_type", NULL, MAVLINK_TYPE_UINT8_T,                   \
           0,          34,   offsetof(mavlink_hil_gps_t, fix_type)}, \
          {"lat", NULL, MAVLINK_TYPE_INT32_T,                        \
           0,     8,    offsetof(mavlink_hil_gps_t, lat)},           \
          {"lon", NULL, MAVLINK_TYPE_INT32_T,                        \
           0,     12,   offsetof(mavlink_hil_gps_t, lon)},           \
          {"alt", NULL, MAVLINK_TYPE_INT32_T,                        \
           0,     16,   offsetof(mavlink_hil_gps_t, alt)},           \
          {"eph", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,     20,   offsetof(mavlink_hil_gps_t, eph)},           \
          {"epv", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,     22,   offsetof(mavlink_hil_gps_t, epv)},           \
          {"vel", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,     24,   offsetof(mavlink_hil_gps_t, vel)},           \
          {"vn", NULL, MAVLINK_TYPE_INT16_T,                         \
           0,    26,   offsetof(mavlink_hil_gps_t, vn)},             \
          {"ve", NULL, MAVLINK_TYPE_INT16_T,                         \
           0,    28,   offsetof(mavlink_hil_gps_t, ve)},             \
          {"vd", NULL, MAVLINK_TYPE_INT16_T,                         \
           0,    30,   offsetof(mavlink_hil_gps_t, vd)},             \
          {"cog", NULL, MAVLINK_TYPE_UINT16_T,                       \
           0,     32,   offsetof(mavlink_hil_gps_t, cog)},           \
          {"satellites_visible",                                     \
           NULL,                                                     \
           MAVLINK_TYPE_UINT8_T,                                     \
           0,                                                        \
           35,                                                       \
           offsetof(mavlink_hil_gps_t, satellites_visible)},         \
    }                                                                \
  }
#else
#define MAVLINK_MESSAGE_INFO_HIL_GPS                                 \
 ...
 * @param fix_type  0-1: no fix, 2: 2D fix, 3: 3D fix. Some applications will
 * not use the value of this field unless it is at least two, so always
 * correctly fill in the fix.
 * @param lat [degE7] Latitude (WGS84)
 * @param lon [degE7] Longitude (WGS84)
 * @param alt [mm] Altitude (MSL). Positive for up.
 * @param eph [cm] GPS HDOP horizontal dilution of position. If unknown, set to:
 * 65535
 * @param epv [cm] GPS VDOP vertical dilution of position. If unknown, set to:
 * 65535
 ...
 * @param cog [cdeg] Course over ground (NOT heading, but direction of
 * movement), 0.0..359.99 degrees. If unknown, set to: 65535
...
static inline uint16_t mavlink_msg_hil_gps_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_HIL_GPS_MIN_LEN,
...
static inline uint16_t mavlink_msg_hil_gps_pack_chan(
    ...
    mavlink_message_t* msg, uint64_t time_usec, uint8_t fix_type, int32_t lat,
    int32_t lon, int32_t alt, uint16_t eph, uint16_t epv, uint16_t vel,
    int16_t vn, int16_t ve, int16_t vd, uint16_t cog,
...
static inline uint16_t mavlink_msg_hil_gps_encode(
  ...
  return mavlink_msg_hil_gps_pack(
      system_id, component_id, msg, hil_gps->time_usec, hil_gps->fix_type,
      hil_gps->lat, hil_gps->lon, hil_gps->alt, hil_gps->eph, hil_gps->epv,
      hil_gps->vel, hil_gps->vn, hil_gps->ve, hil_gps->vd, hil_gps->cog,
...
static inline uint16_t mavlink_msg_hil_gps_encode_chan(
  ...
  return mavlink_msg_hil_gps_pack_chan(
      system_id, component_id, chan, msg, hil_gps->time_usec, hil_gps->fix_type,
      hil_gps->lat, hil_gps->lon, hil_gps->alt, hil_gps->eph, hil_gps->epv,
      hil_gps->vel, hil_gps->vn, hil_gps->ve, hil_gps->vd, hil_gps->cog,
      hil_gps->satellites_visible);
}
...
static inline void mavlink_msg_hil_gps_send(
    mavlink_channel_t chan, uint64_t time_usec, uint8_t fix_type, int32_t lat,
    int32_t lon, int32_t alt, uint16_t eph, uint16_t epv, uint16_t vel,
    int16_t vn, int16_t ve, int16_t vd, uint16_t cog,
    uint8_t satellites_visible) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIL_GPS, buf, MAVLINK_MSG_ID_HIL_GPS_MIN_LEN,
      MAVLINK_MSG_ID_HIL_GPS_LEN, MAVLINK_MSG_ID_HIL_GPS_CRC);
#else
  mavlink_hil_gps_t packet;
  packet.time_usec = time_usec;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIL_GPS, (const char*)&packet,
 ...
 */
static inline void mavlink_msg_hil_gps_send_struct(
    mavlink_channel_t chan, const mavlink_hil_gps_t* hil_gps) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_hil_gps_send(
      chan, hil_gps->time_usec, hil_gps->fix_type, hil_gps->lat, hil_gps->lon,
      hil_gps->alt, hil_gps->eph, hil_gps->epv, hil_gps->vel, hil_gps->vn,
      hil_gps->ve, hil_gps->vd, hil_gps->cog, hil_gps->satellites_visible);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_HIL_GPS, (const char*)hil_gps,
      MAVLINK_MSG_ID_HIL_GPS_MIN_LEN, MAVLINK_MSG_ID_HIL_GPS_LEN,
      MAVLINK_MSG_ID_HIL_GPS_CRC);
#endif
}
...
static inline void mavlink_msg_hil_gps_send_buf(
    ...
    uint16_t epv, uint16_t vel, int16_t vn, int16_t ve, int16_t vd,
 ...
 * boot) by checking for the magnitude the number.
 */
static inline uint64_t mavlink_msg_hil_gps_get_time_usec(
 ...
 *
 * @return  0-1: no fix, 2: 2D fix, 3: 3D fix. Some applications will not use
 * the value of this field unless it is at least two, so always correctly fill
 * in the fix.
 */
static inline uint8_t mavlink_msg_hil_gps_get_fix_type(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_hil_gps_get_lat(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_hil_gps_get_lon(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_hil_gps_get_alt(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [cm] GPS HDOP horizontal dilution of position. If unknown, set to:
 * 65535
 */
static inline uint16_t mavlink_msg_hil_gps_get_eph(
    const mavlink_message_t* msg) {
 ...
 *
 * @return [cm] GPS VDOP vertical dilution of position. If unknown, set to:
 * 65535
 */
static inline uint16_t mavlink_msg_hil_gps_get_epv(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_hil_gps_get_vel(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_hil_gps_get_cog(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_hil_gps_get_satellites_visible(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_hil_gps_decode(const mavlink_message_t* msg,
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_HIL_GPS_LEN
                    ? msg->len
