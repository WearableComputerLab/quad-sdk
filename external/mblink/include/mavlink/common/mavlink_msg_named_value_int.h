...
MAVPACKED(typedef struct __mavlink_named_value_int_t {
...
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_INT                           \
  {                                                                    \
    252, "NAMED_VALUE_INT", 3, {                                       \
      {"time_boot_ms",                                                 \
       NULL,                                                           \
       MAVLINK_TYPE_UINT32_T,                                          \
       0,                                                              \
       0,                                                              \
       offsetof(mavlink_named_value_int_t, time_boot_ms)},             \
          {"name", NULL, MAVLINK_TYPE_CHAR,                            \
           10,     8,    offsetof(mavlink_named_value_int_t, name)},   \
          {"value", NULL, MAVLINK_TYPE_INT32_T,                        \
           0,       4,    offsetof(mavlink_named_value_int_t, value)}, \
    }                                                                  \
  }
#else
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_INT                           \
...
static inline uint16_t mavlink_msg_named_value_int_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_NAMED_VALUE_INT_MIN_LEN,
      MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN, MAVLINK_MSG_ID_NAMED_VALUE_INT_CRC);
}
...
static inline uint16_t mavlink_msg_named_value_int_encode(
  ...
  return mavlink_msg_named_value_int_pack(
      system_id, component_id, msg, named_value_int->time_boot_ms,
...
static inline uint16_t mavlink_msg_named_value_int_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_named_value_int_t* named_value_int) {
  return mavlink_msg_named_value_int_pack_chan(
      system_id, component_id, chan, msg, named_value_int->time_boot_ms,
      named_value_int->name, named_value_int->value);
}
...
static inline void mavlink_msg_named_value_int_send(mavlink_channel_t chan,
  ...
  _mav_put_int32_t(buf, 4, value);
  _mav_put_char_array(buf, 8, name, 10);
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NAMED_VALUE_INT, buf,
                                  MAVLINK_MSG_ID_NAMED_VALUE_INT_MIN_LEN,
                                  MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN,
                                  MAVLINK_MSG_ID_NAMED_VALUE_INT_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_NAMED_VALUE_INT, (const char*)&packet,
      MAVLINK_MSG_ID_NAMED_VALUE_INT_MIN_LEN,
      MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN, MAVLINK_MSG_ID_NAMED_VALUE_INT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_named_value_int_send_struct(
    mavlink_channel_t chan, const mavlink_named_value_int_t* named_value_int) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_named_value_int_send(chan, named_value_int->time_boot_ms,
                                   named_value_int->name,
                                   named_value_int->value);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_NAMED_VALUE_INT, (const char*)named_value_int,
      MAVLINK_MSG_ID_NAMED_VALUE_INT_MIN_LEN,
      MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN, MAVLINK_MSG_ID_NAMED_VALUE_INT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_named_value_int_send_buf(
...
static inline void mavlink_msg_named_value_int_decode(
    const mavlink_message_t* msg, mavlink_named_value_int_t* named_value_int) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN;
