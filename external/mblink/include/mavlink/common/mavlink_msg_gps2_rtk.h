...
MAVPACKED(typedef struct __mavlink_gps2_rtk_t {
  uint32_t time_last_baseline_ms; /*< [ms] Time since boot of last baseline
                                     message received.*/
  uint32_t tow;                   /*< [ms] GPS Time of Week of last baseline*/
  int32_t baseline_a_mm; /*< [mm] Current baseline in ECEF x or NED north
                            component.*/
  int32_t baseline_b_mm; /*< [mm] Current baseline in ECEF y or NED east
                            component.*/
  int32_t baseline_c_mm; /*< [mm] Current baseline in ECEF z or NED down
                            component.*/
  ...
  {                                                                   \
    128, "GPS2_RTK", 13, {                                            \
      {"time_last_baseline_ms",                                       \
       ...
       0,                                                             \
       0,                                                             \
       offsetof(mavlink_gps2_rtk_t, time_last_baseline_ms)},          \
          {"rtk_receiver_id",                                         \
           NULL,                                                      \
           MAVLINK_TYPE_UINT8_T,                                      \
           0,                                                         \
           30,                                                        \
           offsetof(mavlink_gps2_rtk_t, rtk_receiver_id)},            \
          {"wn", NULL, MAVLINK_TYPE_UINT16_T,                         \
           0,    28,   offsetof(mavlink_gps2_rtk_t, wn)},             \
          {"tow", NULL, MAVLINK_TYPE_UINT32_T,                        \
           0,     4,    offsetof(mavlink_gps2_rtk_t, tow)},           \
          {"rtk_health",                                              \
           NULL,                                                      \
           MAVLINK_TYPE_UINT8_T,                                      \
           0,                                                         \
           31,                                                        \
           offsetof(mavlink_gps2_rtk_t, rtk_health)},                 \
          {"rtk_rate", NULL, MAVLINK_TYPE_UINT8_T,                    \
           0,          32,   offsetof(mavlink_gps2_rtk_t, rtk_rate)}, \
          {"nsats", NULL, MAVLINK_TYPE_UINT8_T,                       \
           0,       33,   offsetof(mavlink_gps2_rtk_t, nsats)},       \
          {"baseline_coords_type",                                    \
           NULL,                                                      \
           MAVLINK_TYPE_UINT8_T,                                      \
           0,                                                         \
           34,                                                        \
           offsetof(mavlink_gps2_rtk_t, baseline_coords_type)},       \
          {"baseline_a_mm",                                           \
           NULL,                                                      \
           MAVLINK_TYPE_INT32_T,                                      \
           0,                                                         \
           8,                                                         \
           offsetof(mavlink_gps2_rtk_t, baseline_a_mm)},              \
          {"baseline_b_mm",                                           \
           NULL,                                                      \
           MAVLINK_TYPE_INT32_T,                                      \
           0,                                                         \
           12,                                                        \
           offsetof(mavlink_gps2_rtk_t, baseline_b_mm)},              \
          {"baseline_c_mm",                                           \
           NULL,                                                      \
           MAVLINK_TYPE_INT32_T,                                      \
           0,                                                         \
           16,                                                        \
           offsetof(mavlink_gps2_rtk_t, baseline_c_mm)},              \
          {"accuracy", NULL, MAVLINK_TYPE_UINT32_T,                   \
           0,          20,   offsetof(mavlink_gps2_rtk_t, accuracy)}, \
          {"iar_num_hypotheses",                                      \
           NULL,                                                      \
           MAVLINK_TYPE_INT32_T,                                      \
           0,                                                         \
           24,                                                        \
           offsetof(mavlink_gps2_rtk_t, iar_num_hypotheses)},         \
    }                                                                 \
  }
#else
#define MAVLINK_MESSAGE_INFO_GPS2_RTK                                 \
...
static inline uint16_t mavlink_msg_gps2_rtk_pack_chan(
    ...
    mavlink_message_t* msg, uint32_t time_last_baseline_ms,
    uint8_t rtk_receiver_id, uint16_t wn, uint32_t tow, uint8_t rtk_health,
    uint8_t rtk_rate, uint8_t nsats, uint8_t baseline_coords_type,
    int32_t baseline_a_mm, int32_t baseline_b_mm, int32_t baseline_c_mm,
    uint32_t accuracy, int32_t iar_num_hypotheses) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_GPS2_RTK_LEN];
  _mav_put_uint32_t(buf, 0, time_last_baseline_ms);
  _mav_put_uint32_t(buf, 4, tow);
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_GPS2_RTK_MIN_LEN,
      MAVLINK_MSG_ID_GPS2_RTK_LEN, MAVLINK_MSG_ID_GPS2_RTK_CRC);
}
...
static inline uint16_t mavlink_msg_gps2_rtk_encode(
  ...
  return mavlink_msg_gps2_rtk_pack(
      system_id, component_id, msg, gps2_rtk->time_last_baseline_ms,
      ...
      gps2_rtk->baseline_b_mm, gps2_rtk->baseline_c_mm, gps2_rtk->accuracy,
...
static inline uint16_t mavlink_msg_gps2_rtk_encode_chan(
  ...
  return mavlink_msg_gps2_rtk_pack_chan(
      system_id, component_id, chan, msg, gps2_rtk->time_last_baseline_ms,
      gps2_rtk->rtk_receiver_id, gps2_rtk->wn, gps2_rtk->tow,
      gps2_rtk->rtk_health, gps2_rtk->rtk_rate, gps2_rtk->nsats,
      gps2_rtk->baseline_coords_type, gps2_rtk->baseline_a_mm,
      gps2_rtk->baseline_b_mm, gps2_rtk->baseline_c_mm, gps2_rtk->accuracy,
...
static inline void mavlink_msg_gps2_rtk_send(
    mavlink_channel_t chan, uint32_t time_last_baseline_ms,
    uint8_t rtk_receiver_id, uint16_t wn, uint32_t tow, uint8_t rtk_health,
    uint8_t rtk_rate, uint8_t nsats, uint8_t baseline_coords_type,
    int32_t baseline_a_mm, int32_t baseline_b_mm, int32_t baseline_c_mm,
    uint32_t accuracy, int32_t iar_num_hypotheses) {
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS2_RTK, buf, MAVLINK_MSG_ID_GPS2_RTK_MIN_LEN,
      MAVLINK_MSG_ID_GPS2_RTK_LEN, MAVLINK_MSG_ID_GPS2_RTK_CRC);
#else
  mavlink_gps2_rtk_t packet;
  packet.time_last_baseline_ms = time_last_baseline_ms;
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS2_RTK, (const char*)&packet,
      MAVLINK_MSG_ID_GPS2_RTK_MIN_LEN, MAVLINK_MSG_ID_GPS2_RTK_LEN,
      MAVLINK_MSG_ID_GPS2_RTK_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_gps2_rtk_send_struct(
    mavlink_channel_t chan, const mavlink_gps2_rtk_t* gps2_rtk) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_gps2_rtk_send(
      chan, gps2_rtk->time_last_baseline_ms, gps2_rtk->rtk_receiver_id,
      gps2_rtk->wn, gps2_rtk->tow, gps2_rtk->rtk_health, gps2_rtk->rtk_rate,
      gps2_rtk->nsats, gps2_rtk->baseline_coords_type, gps2_rtk->baseline_a_mm,
      gps2_rtk->baseline_b_mm, gps2_rtk->baseline_c_mm, gps2_rtk->accuracy,
      gps2_rtk->iar_num_hypotheses);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_GPS2_RTK, (const char*)gps2_rtk,
      MAVLINK_MSG_ID_GPS2_RTK_MIN_LEN, MAVLINK_MSG_ID_GPS2_RTK_LEN,
      MAVLINK_MSG_ID_GPS2_RTK_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_gps2_rtk_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan,
    uint32_t time_last_baseline_ms, uint8_t rtk_receiver_id, uint16_t wn,
    uint32_t tow, uint8_t rtk_health, uint8_t rtk_rate, uint8_t nsats,
    uint8_t baseline_coords_type, int32_t baseline_a_mm, int32_t baseline_b_mm,
    int32_t baseline_c_mm, uint32_t accuracy, int32_t iar_num_hypotheses) {
 ...
 */
static inline uint32_t mavlink_msg_gps2_rtk_get_time_last_baseline_ms(
 ...
 */
static inline uint8_t mavlink_msg_gps2_rtk_get_rtk_receiver_id(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_gps2_rtk_get_wn(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_gps2_rtk_get_tow(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_gps2_rtk_get_rtk_health(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_gps2_rtk_get_rtk_rate(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_gps2_rtk_get_nsats(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_gps2_rtk_get_baseline_coords_type(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_gps2_rtk_get_baseline_a_mm(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_gps2_rtk_get_baseline_b_mm(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_gps2_rtk_get_baseline_c_mm(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint32_t mavlink_msg_gps2_rtk_get_accuracy(
    const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_gps2_rtk_get_iar_num_hypotheses(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_gps2_rtk_decode(const mavlink_message_t* msg,
                                               mavlink_gps2_rtk_t* gps2_rtk) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  gps2_rtk->time_last_baseline_ms =
      mavlink_msg_gps2_rtk_get_time_last_baseline_ms(msg);
  ...
  gps2_rtk->iar_num_hypotheses =
      mavlink_msg_gps2_rtk_get_iar_num_hypotheses(msg);
  ...
  gps2_rtk->baseline_coords_type =
      mavlink_msg_gps2_rtk_get_baseline_coords_type(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_GPS2_RTK_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_GPS2_RTK_LEN;
