...
MAVPACKED(typedef struct __mavlink_log_request_end_t {
...
#define MAVLINK_MESSAGE_INFO_LOG_REQUEST_END                       \
  {                                                                \
    122, "LOG_REQUEST_END", 2, {                                   \
      {"target_system",                                            \
       NULL,                                                       \
       MAVLINK_TYPE_UINT8_T,                                       \
       0,                                                          \
       0,                                                          \
       offsetof(mavlink_log_request_end_t, target_system)},        \
          {"target_component",                                     \
           NULL,                                                   \
           MAVLINK_TYPE_UINT8_T,                                   \
           0,                                                      \
           1,                                                      \
           offsetof(mavlink_log_request_end_t, target_component)}, \
    }                                                              \
  }
#else
#define MAVLINK_MESSAGE_INFO_LOG_REQUEST_END                       \
...
static inline uint16_t mavlink_msg_log_request_end_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_log_request_end_t* log_request_end) {
  return mavlink_msg_log_request_end_pack_chan(
      system_id, component_id, chan, msg, log_request_end->target_system,
      log_request_end->target_component);
}
...
static inline void mavlink_msg_log_request_end_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOG_REQUEST_END, buf,
                                  MAVLINK_MSG_ID_LOG_REQUEST_END_MIN_LEN,
                                  MAVLINK_MSG_ID_LOG_REQUEST_END_LEN,
                                  MAVLINK_MSG_ID_LOG_REQUEST_END_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_REQUEST_END, (const char*)&packet,
      MAVLINK_MSG_ID_LOG_REQUEST_END_MIN_LEN,
      MAVLINK_MSG_ID_LOG_REQUEST_END_LEN, MAVLINK_MSG_ID_LOG_REQUEST_END_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_log_request_end_send_struct(
    mavlink_channel_t chan, const mavlink_log_request_end_t* log_request_end) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_log_request_end_send(chan, log_request_end->target_system,
                                   log_request_end->target_component);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_LOG_REQUEST_END, (const char*)log_request_end,
      MAVLINK_MSG_ID_LOG_REQUEST_END_MIN_LEN,
      MAVLINK_MSG_ID_LOG_REQUEST_END_LEN, MAVLINK_MSG_ID_LOG_REQUEST_END_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_log_request_end_send_buf(
 ...
 * @return  System ID
 */
static inline uint8_t mavlink_msg_log_request_end_get_target_system(
 ...
 * @return  Component ID
 */
static inline uint8_t mavlink_msg_log_request_end_get_target_component(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_log_request_end_decode(
    const mavlink_message_t* msg, mavlink_log_request_end_t* log_request_end) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  log_request_end->target_system =
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_LOG_REQUEST_END_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_LOG_REQUEST_END_LEN;
