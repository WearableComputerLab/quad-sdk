...
MAVPACKED(typedef struct __mavlink_mission_clear_all_t {
...
#define MAVLINK_MESSAGE_INFO_MISSION_CLEAR_ALL                       \
  {                                                                  \
    45, "MISSION_CLEAR_ALL", 3, {                                    \
      {"target_system",                                              \
       NULL,                                                         \
       MAVLINK_TYPE_UINT8_T,                                         \
       0,                                                            \
       0,                                                            \
       offsetof(mavlink_mission_clear_all_t, target_system)},        \
          {"target_component",                                       \
           NULL,                                                     \
           MAVLINK_TYPE_UINT8_T,                                     \
           0,                                                        \
           1,                                                        \
           offsetof(mavlink_mission_clear_all_t, target_component)}, \
          {"mission_type",                                           \
           NULL,                                                     \
           MAVLINK_TYPE_UINT8_T,                                     \
           0,                                                        \
           2,                                                        \
           offsetof(mavlink_mission_clear_all_t, mission_type)},     \
    }                                                                \
  }
#else
#define MAVLINK_MESSAGE_INFO_MISSION_CLEAR_ALL                       \
...
static inline uint16_t mavlink_msg_mission_clear_all_encode(
  ...
  return mavlink_msg_mission_clear_all_pack(
      system_id, component_id, msg, mission_clear_all->target_system,
      mission_clear_all->target_component, mission_clear_all->mission_type);
}
...
static inline uint16_t mavlink_msg_mission_clear_all_encode_chan(
  ...
  return mavlink_msg_mission_clear_all_pack_chan(
      system_id, component_id, chan, msg, mission_clear_all->target_system,
      mission_clear_all->target_component, mission_clear_all->mission_type);
}
...
static inline void mavlink_msg_mission_clear_all_send(mavlink_channel_t chan,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_CLEAR_ALL, buf,
                                  MAVLINK_MSG_ID_MISSION_CLEAR_ALL_MIN_LEN,
                                  MAVLINK_MSG_ID_MISSION_CLEAR_ALL_LEN,
                                  MAVLINK_MSG_ID_MISSION_CLEAR_ALL_CRC);
#else
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_CLEAR_ALL,
                                  (const char*)&packet,
                                  MAVLINK_MSG_ID_MISSION_CLEAR_ALL_MIN_LEN,
                                  MAVLINK_MSG_ID_MISSION_CLEAR_ALL_LEN,
                                  MAVLINK_MSG_ID_MISSION_CLEAR_ALL_CRC);
 ...
 */
static inline void mavlink_msg_mission_clear_all_send_struct(
    mavlink_channel_t chan,
    const mavlink_mission_clear_all_t* mission_clear_all) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_mission_clear_all_send(chan, mission_clear_all->target_system,
                                     mission_clear_all->target_component,
                                     mission_clear_all->mission_type);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_CLEAR_ALL,
                                  (const char*)mission_clear_all,
                                  MAVLINK_MSG_ID_MISSION_CLEAR_ALL_MIN_LEN,
                                  MAVLINK_MSG_ID_MISSION_CLEAR_ALL_LEN,
                                  MAVLINK_MSG_ID_MISSION_CLEAR_ALL_CRC);
#endif
 ...
 */
static inline void mavlink_msg_mission_clear_all_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system,
    uint8_t target_component, uint8_t mission_type) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  Mission type.
 */
static inline uint8_t mavlink_msg_mission_clear_all_get_mission_type(
    const mavlink_message_t* msg) {
...
static inline void mavlink_msg_mission_clear_all_decode(
  ...
  mission_clear_all->mission_type =
      mavlink_msg_mission_clear_all_get_mission_type(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_MISSION_CLEAR_ALL_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_MISSION_CLEAR_ALL_LEN;
