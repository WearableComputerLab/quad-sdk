...
MAVPACKED(typedef struct __mavlink_message_interval_t {
  int32_t interval_us; /*< [us] The interval between two messages. A value of -1
                          ...
                          not available, > 0 indicates the interval at which it
                          is sent.*/
  ...
  {                                                            \
    244, "MESSAGE_INTERVAL", 2, {                              \
      {"message_id",                                           \
       ...
       0,                                                      \
       4,                                                      \
       offsetof(mavlink_message_interval_t, message_id)},      \
          {"interval_us",                                      \
           NULL,                                               \
           MAVLINK_TYPE_INT32_T,                               \
           0,                                                  \
           0,                                                  \
           offsetof(mavlink_message_interval_t, interval_us)}, \
    }                                                          \
  }
#else
#define MAVLINK_MESSAGE_INFO_MESSAGE_INTERVAL                  \
 ...
 *
 * @param message_id  The ID of the requested MAVLink message. v1.0 is limited
 * to 254 messages.
 * @param interval_us [us] The interval between two messages. A value of -1
 * indicates this stream is disabled, 0 indicates it is not available, > 0
 * indicates the interval at which it is sent.
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_message_interval_pack(uint8_t system_id,
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_MESSAGE_INTERVAL_MIN_LEN,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_message_interval_pack_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, uint16_t message_id, int32_t interval_us) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN];
  _mav_put_int32_t(buf, 0, interval_us);
  _mav_put_uint16_t(buf, 4, message_id);
 ...
 */
static inline uint16_t mavlink_msg_message_interval_encode(
 ...
 * @param message_interval C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_message_interval_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg,
    const mavlink_message_interval_t* message_interval) {
  return mavlink_msg_message_interval_pack_chan(
      system_id, component_id, chan, msg, message_interval->message_id,
      message_interval->interval_us);
}
...
static inline void mavlink_msg_message_interval_send(mavlink_channel_t chan,
                                                     uint16_t message_id,
                                                     int32_t interval_us) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  char buf[MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN];
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MESSAGE_INTERVAL, buf,
                                  MAVLINK_MSG_ID_MESSAGE_INTERVAL_MIN_LEN,
                                  MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN,
                                  MAVLINK_MSG_ID_MESSAGE_INTERVAL_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_MESSAGE_INTERVAL, (const char*)&packet,
      MAVLINK_MSG_ID_MESSAGE_INTERVAL_MIN_LEN,
      MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN, MAVLINK_MSG_ID_MESSAGE_INTERVAL_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_message_interval_send_struct(
    mavlink_channel_t chan,
    const mavlink_message_interval_t* message_interval) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_message_interval_send(chan, message_interval->message_id,
                                    message_interval->interval_us);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_MESSAGE_INTERVAL, (const char*)message_interval,
      MAVLINK_MSG_ID_MESSAGE_INTERVAL_MIN_LEN,
      MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN, MAVLINK_MSG_ID_MESSAGE_INTERVAL_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_message_interval_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint16_t message_id,
    int32_t interval_us) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * messages.
 */
static inline uint16_t mavlink_msg_message_interval_get_message_id(
 ...
 *
 * @return [us] The interval between two messages. A value of -1 indicates this
 * stream is disabled, 0 indicates it is not available, > 0 indicates the
 * interval at which it is sent.
 */
static inline int32_t mavlink_msg_message_interval_get_interval_us(
    const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_message_interval_decode(
    const mavlink_message_t* msg,
    mavlink_message_interval_t* message_interval) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  message_interval->interval_us =
      mavlink_msg_message_interval_get_interval_us(msg);
  message_interval->message_id =
      mavlink_msg_message_interval_get_message_id(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN;
