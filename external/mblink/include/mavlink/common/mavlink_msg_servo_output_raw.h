...
MAVPACKED(typedef struct __mavlink_servo_output_raw_t {
  uint32_t time_usec;  /*< [us] Timestamp (UNIX Epoch time or time since system
...
#define MAVLINK_MESSAGE_INFO_SERVO_OUTPUT_RAW                               \
  {                                                                         \
    36, "SERVO_OUTPUT_RAW", 18, {                                           \
      {"time_usec", NULL, MAVLINK_TYPE_UINT32_T,                            \
       0,           0,    offsetof(mavlink_servo_output_raw_t, time_usec)}, \
          {"port", NULL, MAVLINK_TYPE_UINT8_T,                              \
           0,      20,   offsetof(mavlink_servo_output_raw_t, port)},       \
          {"servo1_raw",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           4,                                                               \
           offsetof(mavlink_servo_output_raw_t, servo1_raw)},               \
          {"servo2_raw",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           6,                                                               \
           offsetof(mavlink_servo_output_raw_t, servo2_raw)},               \
          {"servo3_raw",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           8,                                                               \
           offsetof(mavlink_servo_output_raw_t, servo3_raw)},               \
          {"servo4_raw",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           10,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo4_raw)},               \
          {"servo5_raw",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           12,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo5_raw)},               \
          {"servo6_raw",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           14,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo6_raw)},               \
          {"servo7_raw",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           16,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo7_raw)},               \
          {"servo8_raw",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           18,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo8_raw)},               \
          {"servo9_raw",                                                    \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           21,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo9_raw)},               \
          {"servo10_raw",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           23,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo10_raw)},              \
          {"servo11_raw",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           25,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo11_raw)},              \
          {"servo12_raw",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           27,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo12_raw)},              \
          {"servo13_raw",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           29,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo13_raw)},              \
          {"servo14_raw",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           31,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo14_raw)},              \
          {"servo15_raw",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           33,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo15_raw)},              \
          {"servo16_raw",                                                   \
           NULL,                                                            \
           MAVLINK_TYPE_UINT16_T,                                           \
           0,                                                               \
           35,                                                              \
           offsetof(mavlink_servo_output_raw_t, servo16_raw)},              \
    }                                                                       \
  }
#else
#define MAVLINK_MESSAGE_INFO_SERVO_OUTPUT_RAW                               \
 ...
 * @param port  Servo output port (set of 8 outputs = 1 port). Flight stacks
...
static inline uint16_t mavlink_msg_servo_output_raw_pack(
    ...
    uint32_t time_usec, uint8_t port, uint16_t servo1_raw, uint16_t servo2_raw,
    uint16_t servo3_raw, uint16_t servo4_raw, uint16_t servo5_raw,
    uint16_t servo6_raw, uint16_t servo7_raw, uint16_t servo8_raw,
    uint16_t servo9_raw, uint16_t servo10_raw, uint16_t servo11_raw,
    uint16_t servo12_raw, uint16_t servo13_raw, uint16_t servo14_raw,
    uint16_t servo15_raw, uint16_t servo16_raw) {
  ...
  return mavlink_finalize_message(
      ...
      MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_LEN, MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_CRC);
}
...
static inline uint16_t mavlink_msg_servo_output_raw_pack_chan(
    ...
    mavlink_message_t* msg, uint32_t time_usec, uint8_t port,
    uint16_t servo1_raw, uint16_t servo2_raw, uint16_t servo3_raw,
    uint16_t servo4_raw, uint16_t servo5_raw, uint16_t servo6_raw,
    uint16_t servo7_raw, uint16_t servo8_raw, uint16_t servo9_raw,
    uint16_t servo10_raw, uint16_t servo11_raw, uint16_t servo12_raw,
    uint16_t servo13_raw, uint16_t servo14_raw, uint16_t servo15_raw,
...
static inline uint16_t mavlink_msg_servo_output_raw_encode(
  ...
  return mavlink_msg_servo_output_raw_pack(
      system_id, component_id, msg, servo_output_raw->time_usec,
      servo_output_raw->port, servo_output_raw->servo1_raw,
      servo_output_raw->servo2_raw, servo_output_raw->servo3_raw,
      servo_output_raw->servo4_raw, servo_output_raw->servo5_raw,
      servo_output_raw->servo6_raw, servo_output_raw->servo7_raw,
      servo_output_raw->servo8_raw, servo_output_raw->servo9_raw,
      servo_output_raw->servo10_raw, servo_output_raw->servo11_raw,
      servo_output_raw->servo12_raw, servo_output_raw->servo13_raw,
      servo_output_raw->servo14_raw, servo_output_raw->servo15_raw,
...
static inline uint16_t mavlink_msg_servo_output_raw_encode_chan(
  ...
  return mavlink_msg_servo_output_raw_pack_chan(
      system_id, component_id, chan, msg, servo_output_raw->time_usec,
      servo_output_raw->port, servo_output_raw->servo1_raw,
      servo_output_raw->servo2_raw, servo_output_raw->servo3_raw,
      servo_output_raw->servo4_raw, servo_output_raw->servo5_raw,
      servo_output_raw->servo6_raw, servo_output_raw->servo7_raw,
...
static inline void mavlink_msg_servo_output_raw_send(
    mavlink_channel_t chan, uint32_t time_usec, uint8_t port,
    uint16_t servo1_raw, uint16_t servo2_raw, uint16_t servo3_raw,
    uint16_t servo4_raw, uint16_t servo5_raw, uint16_t servo6_raw,
    uint16_t servo7_raw, uint16_t servo8_raw, uint16_t servo9_raw,
    uint16_t servo10_raw, uint16_t servo11_raw, uint16_t servo12_raw,
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SERVO_OUTPUT_RAW, buf,
                                  MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_MIN_LEN,
                                  MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_LEN,
                                  MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_CRC);
#else
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SERVO_OUTPUT_RAW, (const char*)&packet,
      MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_MIN_LEN,
      MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_LEN, MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_servo_output_raw_send_struct(
    mavlink_channel_t chan,
    const mavlink_servo_output_raw_t* servo_output_raw) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_servo_output_raw_send(
      chan, servo_output_raw->time_usec, servo_output_raw->port,
      ...
      servo_output_raw->servo9_raw, servo_output_raw->servo10_raw,
      servo_output_raw->servo11_raw, servo_output_raw->servo12_raw,
      servo_output_raw->servo13_raw, servo_output_raw->servo14_raw,
      servo_output_raw->servo15_raw, servo_output_raw->servo16_raw);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_SERVO_OUTPUT_RAW, (const char*)servo_output_raw,
      MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_MIN_LEN,
      MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_LEN, MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_CRC);
#endif
}
...
static inline void mavlink_msg_servo_output_raw_send_buf(
    mavlink_message_t* msgbuf, mavlink_channel_t chan, uint32_t time_usec,
    uint8_t port, uint16_t servo1_raw, uint16_t servo2_raw, uint16_t servo3_raw,
    uint16_t servo4_raw, uint16_t servo5_raw, uint16_t servo6_raw,
    uint16_t servo7_raw, uint16_t servo8_raw, uint16_t servo9_raw,
    uint16_t servo10_raw, uint16_t servo11_raw, uint16_t servo12_raw,
    uint16_t servo13_raw, uint16_t servo14_raw, uint16_t servo15_raw,
 ...
 *
 * @return  Servo output port (set of 8 outputs = 1 port). Flight stacks running
 ...
 */
static inline uint16_t mavlink_msg_servo_output_raw_get_servo9_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_servo_output_raw_get_servo10_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_servo_output_raw_get_servo11_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_servo_output_raw_get_servo12_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_servo_output_raw_get_servo13_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_servo_output_raw_get_servo14_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_servo_output_raw_get_servo15_raw(
    const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_servo_output_raw_get_servo16_raw(
    const mavlink_message_t* msg) {
...
static inline void mavlink_msg_servo_output_raw_decode(
  ...
  servo_output_raw->servo9_raw =
      mavlink_msg_servo_output_raw_get_servo9_raw(msg);
  servo_output_raw->servo10_raw =
      mavlink_msg_servo_output_raw_get_servo10_raw(msg);
  servo_output_raw->servo11_raw =
      mavlink_msg_servo_output_raw_get_servo11_raw(msg);
  servo_output_raw->servo12_raw =
      mavlink_msg_servo_output_raw_get_servo12_raw(msg);
  servo_output_raw->servo13_raw =
      mavlink_msg_servo_output_raw_get_servo13_raw(msg);
  servo_output_raw->servo14_raw =
      mavlink_msg_servo_output_raw_get_servo14_raw(msg);
  servo_output_raw->servo15_raw =
      mavlink_msg_servo_output_raw_get_servo15_raw(msg);
  servo_output_raw->servo16_raw =
      mavlink_msg_servo_output_raw_get_servo16_raw(msg);
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_SERVO_OUTPUT_RAW_LEN;
