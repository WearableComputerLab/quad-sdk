  ...
  {                                                                     \
    76, "COMMAND_LONG", 11, {                                           \
      {"target_system",                                                 \
       ...
       0,                                                               \
       30,                                                              \
       offsetof(mavlink_command_long_t, target_system)},                \
          {"target_component",                                          \
           NULL,                                                        \
           MAVLINK_TYPE_UINT8_T,                                        \
           0,                                                           \
           31,                                                          \
           offsetof(mavlink_command_long_t, target_component)},         \
          {"command", NULL, MAVLINK_TYPE_UINT16_T,                      \
           0,         28,   offsetof(mavlink_command_long_t, command)}, \
          {"confirmation",                                              \
           NULL,                                                        \
           MAVLINK_TYPE_UINT8_T,                                        \
           0,                                                           \
           32,                                                          \
           offsetof(mavlink_command_long_t, confirmation)},             \
          {"param1", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        0,    offsetof(mavlink_command_long_t, param1)},   \
          {"param2", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        4,    offsetof(mavlink_command_long_t, param2)},   \
          {"param3", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        8,    offsetof(mavlink_command_long_t, param3)},   \
          {"param4", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        12,   offsetof(mavlink_command_long_t, param4)},   \
          {"param5", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        16,   offsetof(mavlink_command_long_t, param5)},   \
          {"param6", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        20,   offsetof(mavlink_command_long_t, param6)},   \
          {"param7", NULL, MAVLINK_TYPE_FLOAT,                          \
           0,        24,   offsetof(mavlink_command_long_t, param7)},   \
    }                                                                   \
  }
#else
#define MAVLINK_MESSAGE_INFO_COMMAND_LONG                               \
 ...
 * @param target_component  Component which should execute the command, 0 for
 * all components
 * @param command  Command ID (of command to send).
 * @param confirmation  0: First transmission of this command. 1-255:
 * Confirmation transmissions (e.g. for kill command)
...
static inline uint16_t mavlink_msg_command_long_pack(
  ...
  return mavlink_finalize_message(
      msg, system_id, component_id, MAVLINK_MSG_ID_COMMAND_LONG_MIN_LEN,
...
static inline uint16_t mavlink_msg_command_long_pack_chan(
    ...
    uint16_t command, uint8_t confirmation, float param1, float param2,
  ...
  return mavlink_finalize_message_chan(
      msg, system_id, component_id, chan, MAVLINK_MSG_ID_COMMAND_LONG_MIN_LEN,
      MAVLINK_MSG_ID_COMMAND_LONG_LEN, MAVLINK_MSG_ID_COMMAND_LONG_CRC);
}
...
static inline uint16_t mavlink_msg_command_long_encode(
  ...
  return mavlink_msg_command_long_pack(
      system_id, component_id, msg, command_long->target_system,
      command_long->target_component, command_long->command,
      command_long->confirmation, command_long->param1, command_long->param2,
      command_long->param3, command_long->param4, command_long->param5,
...
static inline uint16_t mavlink_msg_command_long_encode_chan(
    uint8_t system_id, uint8_t component_id, uint8_t chan,
    mavlink_message_t* msg, const mavlink_command_long_t* command_long) {
  return mavlink_msg_command_long_pack_chan(
      system_id, component_id, chan, msg, command_long->target_system,
      command_long->target_component, command_long->command,
      command_long->confirmation, command_long->param1, command_long->param2,
      command_long->param3, command_long->param4, command_long->param5,
      command_long->param6, command_long->param7);
...
static inline void mavlink_msg_command_long_send(
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_COMMAND_LONG, buf,
  ...
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_COMMAND_LONG, (const char*)&packet,
      MAVLINK_MSG_ID_COMMAND_LONG_MIN_LEN, MAVLINK_MSG_ID_COMMAND_LONG_LEN,
      MAVLINK_MSG_ID_COMMAND_LONG_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_command_long_send_struct(
    mavlink_channel_t chan, const mavlink_command_long_t* command_long) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_command_long_send(
      chan, command_long->target_system, command_long->target_component,
      command_long->command, command_long->confirmation, command_long->param1,
      command_long->param2, command_long->param3, command_long->param4,
      command_long->param5, command_long->param6, command_long->param7);
#else
  _mav_finalize_message_chan_send(
      chan, MAVLINK_MSG_ID_COMMAND_LONG, (const char*)command_long,
      MAVLINK_MSG_ID_COMMAND_LONG_MIN_LEN, MAVLINK_MSG_ID_COMMAND_LONG_LEN,
      MAVLINK_MSG_ID_COMMAND_LONG_CRC);
#endif
}
...
static inline void mavlink_msg_command_long_decode(
    const mavlink_message_t* msg, mavlink_command_long_t* command_long) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
  uint8_t len = msg->len < MAVLINK_MSG_ID_COMMAND_LONG_LEN
                    ? msg->len
                    : MAVLINK_MSG_ID_COMMAND_LONG_LEN;
