...
RBDL_DLLAPI inline Vector3d angular_velocity_from_angle_rates(
    const Vector3d &zyx_angles, const Vector3d &zyx_angle_rates) {
...
RBDL_DLLAPI inline Vector3d global_angular_velocity_from_rates(
    const Vector3d &zyx_angles, const Vector3d &zyx_rates) {
...
RBDL_DLLAPI inline Vector3d angular_acceleration_from_angle_rates(
    const Vector3d &zyx_angles, const Vector3d &zyx_angle_rates,
