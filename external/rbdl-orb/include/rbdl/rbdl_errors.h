 ...
 *
 * To add another error type just subclass this class, you only need to
 * implement the constructor and call the parent constructor with your error
 * message.
 *
 */
 ...
 *
 * This error class is thrown if a parameter supplied to a function can not be
 * used. This may have many reasons, details should be read from the error
 * message.
 *
 ...
 *
 * This error class is thrown if the operads of a calculation have incompatible
 * sizes. This mostly happens when matrices are of different sizes than
 * expected.
 *
 * Example of error thrown in addons/geometry/SmoothSegmentedFunction.cc:
 ...
 *
 * This error class is thrown if the parameter supplied does not match the
 * supported dof of the used model or the supplied dof is not supported by the
 * function used!
 *
 * Example of error thrown in addons/geometry/SmoothSegmentedFunction.cc:
 ...
 *
 * This error is thrown if RBDL is missing an implementation for your specific
 * use case!
 *
 * Example of error thrown in addons/muscle/Millard2016TorqueMuscle.cc:
 * \snippet{lineno} addons/muscle/Millard2016TorqueMuscle.cc Missing
 * Implementation
 */
 ...
 *
 * This error is thrown if the file that is beeing read contains formatting or
 * other errors, that cause the program to not beeing able to use the file as
 * expected.
 *
