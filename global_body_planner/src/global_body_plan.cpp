...
void GlobalBodyPlan::loadPlanData(int plan_status, FullState &start_state,
  ...
  // std::cout << "t_plan_[0]: " << t_plan_[0] << std::endl; // Also 0 for
  // output
...
void GlobalBodyPlan::addStateAndGRFToMsg(double t, int plan_index,
  ...
  // std::cout << "t: " << t << std::endl; // starts from 0... std::bad_alloc
  // error if printing but whatever
  // std::cout << "msg.global_plan_timestamp: " << msg.global_plan_timestamp <<
  // std::endl;
