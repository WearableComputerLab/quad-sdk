...
OfflineGlobalBodyPlanner2::OfflineGlobalBodyPlanner2(ros::NodeHandle nh) {
  ...
  terrain_map_sub_ =
      nh_.subscribe(terrain_map_topic_, 1,
                    &OfflineGlobalBodyPlanner2::terrainMapCallback, this);
  robot_state_sub_ =
      nh_.subscribe(robot_state_topic_, 1,
                    &OfflineGlobalBodyPlanner2::robotStateCallback, this);
  goal_state_sub_ = nh_.subscribe(
      goal_state_topic, 1, &OfflineGlobalBodyPlanner2::goalStateCallback, this);
...
void OfflineGlobalBodyPlanner2::terrainMapCallback(
...
bool OfflineGlobalBodyPlanner2::callPlanner() {
